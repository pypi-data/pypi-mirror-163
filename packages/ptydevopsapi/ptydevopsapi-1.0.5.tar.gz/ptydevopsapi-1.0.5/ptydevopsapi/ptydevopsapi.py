...
class PtyDevopsAPI:
    def __init__(self, url: str):
        ...
        :param url: api endpoint url, ex: http://example.com:1337/pty/v1/pim
        """
        self.url = url
    ...
    def __delete(self, resource: str, *args) -> requests.Response:
        ...
        """
        response = requests.delete(urljoin(self.url, resource.format(*args)), verify=False)
        return response
    ...
    def __get(self, resource: str, *args) -> requests.Response:
        ...
        :param resource: api resource url
        """
        response = requests.get(urljoin(self.url, resource.format(*args)), verify=False)
        return response
    ...
    def __post(
        ...
        response = requests.post(
            urljoin(self.url, resource.format(*args)),
            json=data,
