...
def set_config(config=None):
    ...
    1. kernel: When it is enable, exhaustive search method will be used to select
    ...
    2. layout: When it is enable, the best data layout such as NCHW or NHWC will be
    ...
    3. dataloader: When it is enable, the best num_workers will be selected to replace
