...
class EndpointAccess(
    ...
    def only_from(self, *cidr: builtins.str) -> "EndpointAccess":
        ...
        if __debug__:
            ...
            check_type(argname="argument cidr", value=cidr, expected_type=typing.Tuple[type_hints["cidr"], ...])
    ...
    def add_manifest(
        ...
        *manifest: typing.Mapping[builtins.str, typing.Any],
        ...
        if __debug__:
            ...
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument manifest", value=manifest, expected_type=typing.Tuple[type_hints["manifest"], ...])
