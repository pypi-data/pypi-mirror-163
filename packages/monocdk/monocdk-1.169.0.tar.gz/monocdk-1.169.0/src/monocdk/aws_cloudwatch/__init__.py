...
class AlarmRule(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_cloudwatch.AlarmRule"):
    ...
    def all_of(cls, *operands: "IAlarmRule") -> "IAlarmRule":
        ...
        if __debug__:
            ...
            check_type(argname="argument operands", value=operands, expected_type=typing.Tuple[type_hints["operands"], ...])
...
class Dashboard(
    ...
    def add_widgets(self, *widgets: "IWidget") -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument widgets", value=widgets, expected_type=typing.Tuple[type_hints["widgets"], ...])
...
class ConcreteWidget(
    ...
    def _copy_metric_warnings(self, *ms: IMetric) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument ms", value=ms, expected_type=typing.Tuple[type_hints["ms"], ...])
