...
class ComparablePrincipal(
    ...
    @jsii.member(jsii_name="dedupeStringFor") # type: ignore[misc]
    ...
    @jsii.member(jsii_name="isComparablePrincipal") # type: ignore[misc]
    @builtins.classmethod
...
class CompositeDependable(
    ...
    def __init__(self, *dependables: _IDependable_1175c9f7) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument dependables", value=dependables, expected_type=typing.Tuple[type_hints["dependables"], ...])
...
class Grant(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_iam.Grant"):
    ...
    def apply_before(self, *constructs: _IConstruct_5a0f9c5e) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument constructs", value=constructs, expected_type=typing.Tuple[type_hints["constructs"], ...])
...
class ManagedPolicy(
    ...
    def add_statements(self, *statement: "PolicyStatement") -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument statement", value=statement, expected_type=typing.Tuple[type_hints["statement"], ...])
...
class PolicyStatement(
    ...
    def add_not_actions(self, *not_actions: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument not_actions", value=not_actions, expected_type=typing.Tuple[type_hints["not_actions"], ...])
    ...
    def add_not_principals(self, *not_principals: IPrincipal) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument not_principals", value=not_principals, expected_type=typing.Tuple[type_hints["not_principals"], ...])
    ...
    def add_principals(self, *principals: IPrincipal) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument principals", value=principals, expected_type=typing.Tuple[type_hints["principals"], ...])
...
class PrincipalBase(
    ...
    @jsii.member(jsii_name="dedupeString") # type: ignore[misc]
    @abc.abstractmethod
    def dedupe_string(self) -> typing.Optional[builtins.str]:
...
class ServicePrincipal(
    ...
    @jsii.member(jsii_name="servicePrincipalName") # type: ignore[misc]
    @builtins.classmethod
