...
class RecordTarget(
    ...
    def from_ip_addresses(cls, *ip_addresses: builtins.str) -> "RecordTarget":
        ...
        if __debug__:
            ...
            check_type(argname="argument ip_addresses", value=ip_addresses, expected_type=typing.Tuple[type_hints["ip_addresses"], ...])
...
class PublicHostedZone(
    ...
    @jsii.member(jsii_name="fromPublicHostedZoneAttributes") # type: ignore[misc]
    @builtins.classmethod
