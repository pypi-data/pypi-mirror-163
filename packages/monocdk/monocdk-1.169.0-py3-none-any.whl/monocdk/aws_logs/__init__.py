...
class FilterPattern(
    ...
    def all_terms(cls, *terms: builtins.str) -> "IFilterPattern":
        ...
        if __debug__:
            ...
            check_type(argname="argument terms", value=terms, expected_type=typing.Tuple[type_hints["terms"], ...])
    ...
    def any_term_group(
        ...
        *term_groups: typing.List[builtins.str],
        ...
        if __debug__:
            ...
            check_type(argname="argument term_groups", value=term_groups, expected_type=typing.Tuple[type_hints["term_groups"], ...])
    ...
    def space_delimited(cls, *columns: builtins.str) -> "SpaceDelimitedTextPattern":
        ...
        if __debug__:
            ...
            check_type(argname="argument columns", value=columns, expected_type=typing.Tuple[type_hints["columns"], ...])
