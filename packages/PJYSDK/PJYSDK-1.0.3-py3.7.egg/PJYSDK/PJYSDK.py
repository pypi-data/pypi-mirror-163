...
class PJYSDK(object):
    def __init__(self, app_key, app_secret):
        self.debug = True
        self._lib_version = 'v1.0.3'
        self._protocol = 'http'
        self._hosts = ['api.paojiaoyun.com', 'api2.paojiaoyun.com', 'api.paojiaoyun.com']
    ...
    def timestamp():
        try:
            ret = requests.get('http://api.m.taobao.com/rest/api3.do?api=mtop.common.getTimestamp', timeout=5)
            data = ret.json()
