...
class Glyph(object):
    ...
    @staticmethod
    def RepeatModeEnumFromString(name: "char const *") -> "OpenCMISS::Zinc::Glyph::RepeatMode":
        return _glyph.Glyph_RepeatModeEnumFromString(name)

    @staticmethod
    def RepeatModeEnumToString(mode: "OpenCMISS::Zinc::Glyph::RepeatMode") -> "char *":
        return _glyph.Glyph_RepeatModeEnumToString(mode)

    @staticmethod
    def ShapeTypeEnumFromString(name: "char const *") -> "OpenCMISS::Zinc::Glyph::ShapeType":
        return _glyph.Glyph_ShapeTypeEnumFromString(name)

    @staticmethod
    def ShapeTypeEnumToString(type: "OpenCMISS::Zinc::Glyph::ShapeType") -> "char *":
    ...
    def castAxes(self) -> "OpenCMISS::Zinc::GlyphAxes":
        return _glyph.Glyph_castAxes(self)

    def castColourBar(self) -> "OpenCMISS::Zinc::GlyphColourBar":
...
def Glyph_RepeatModeEnumFromString(name: "char const *") -> "OpenCMISS::Zinc::Glyph::RepeatMode":
    return _glyph.Glyph_RepeatModeEnumFromString(name)

def Glyph_RepeatModeEnumToString(mode: "OpenCMISS::Zinc::Glyph::RepeatMode") -> "char *":
    return _glyph.Glyph_RepeatModeEnumToString(mode)

def Glyph_ShapeTypeEnumFromString(name: "char const *") -> "OpenCMISS::Zinc::Glyph::ShapeType":
    return _glyph.Glyph_ShapeTypeEnumFromString(name)

def Glyph_ShapeTypeEnumToString(type: "OpenCMISS::Zinc::Glyph::ShapeType") -> "char *":
    return _glyph.Glyph_ShapeTypeEnumToString(type)
...
class GlyphAxes(Glyph):
    ...
    def getAxisWidth(self) -> "double":
        return _glyph.GlyphAxes_getAxisWidth(self)

    def setAxisWidth(self, axisWidth: "double") -> "int":
        return _glyph.GlyphAxes_setAxisWidth(self, axisWidth)

    def getAxisLabel(self, axisNumber: "int") -> "char *":
        return _glyph.GlyphAxes_getAxisLabel(self, axisNumber)

    def setAxisLabel(self, axisNumber: "int", label: "char const *") -> "int":
        return _glyph.GlyphAxes_setAxisLabel(self, axisNumber, label)

    def getAxisMaterial(self, axisNumber: "int") -> "OpenCMISS::Zinc::Material":
        return _glyph.GlyphAxes_getAxisMaterial(self, axisNumber)

    def setAxisMaterial(self, axisNumber: "int", material: "Material") -> "int":
...
class GlyphColourBar(Glyph):
    ...
    def getTickLength(self) -> "double":
        return _glyph.GlyphColourBar_getTickLength(self)

    def setTickLength(self, tickLength: "double") -> "int":
...
class Glyphiterator(object):
    ...
    def next(self) -> "OpenCMISS::Zinc::Glyph":
...
class Glyphmodule(object):
    ...
    def getId(self) -> "cmzn_glyphmodule_id":
    ...
    def createGlyphAxes(self, axisGlyph: "Glyph", axisWidth: "double") -> "OpenCMISS::Zinc::GlyphAxes":
        return _glyph.Glyphmodule_createGlyphAxes(self, axisGlyph, axisWidth)

    def createGlyphColourBar(self, spectrum: "Spectrum") -> "OpenCMISS::Zinc::GlyphColourBar":
        return _glyph.Glyphmodule_createGlyphColourBar(self, spectrum)

    def createGlyphiterator(self) -> "OpenCMISS::Zinc::Glyphiterator":
        return _glyph.Glyphmodule_createGlyphiterator(self)

    def defineStandardGlyphs(self) -> "int":
        return _glyph.Glyphmodule_defineStandardGlyphs(self)

    def findGlyphByName(self, name: "char const *") -> "OpenCMISS::Zinc::Glyph":
        return _glyph.Glyphmodule_findGlyphByName(self, name)

    def findGlyphByGlyphShapeType(self, glyphShapeType: "OpenCMISS::Zinc::Glyph::ShapeType") -> "OpenCMISS::Zinc::Glyph":
        return _glyph.Glyphmodule_findGlyphByGlyphShapeType(self, glyphShapeType)

    def getDefaultPointGlyph(self) -> "OpenCMISS::Zinc::Glyph":
        return _glyph.Glyphmodule_getDefaultPointGlyph(self)

    def setDefaultPointGlyph(self, glyph: "Glyph") -> "int":
        return _glyph.Glyphmodule_setDefaultPointGlyph(self, glyph)

    def createStaticGlyphFromGraphics(self, graphics: "Graphics") -> "OpenCMISS::Zinc::Glyph":
        return _glyph.Glyphmodule_createStaticGlyphFromGraphics(self, graphics)

    def createGlyphmodulenotifier(self) -> "OpenCMISS::Zinc::Glyphmodulenotifier":
...
class Glyphmoduleevent(object):
    ...
    def getId(self) -> "cmzn_glyphmoduleevent_id":
        return _glyph.Glyphmoduleevent_getId(self)

    def getGlyphChangeFlags(self, glyph: "Glyph") -> "OpenCMISS::Zinc::Glyph::ChangeFlags":
        return _glyph.Glyphmoduleevent_getGlyphChangeFlags(self, glyph)

    def getSummaryGlyphChangeFlags(self) -> "OpenCMISS::Zinc::Glyph::ChangeFlags":
...
class Glyphmodulenotifier(object):
    ...
    def getId(self) -> "cmzn_glyphmodulenotifier_id":
