...
class StreaminformationScene(opencmiss.zinc.stream.Streaminformation):
    ...
    def getIODataType(self) -> "OpenCMISS::Zinc::StreaminformationScene::IODataType":
        return _streamscene.StreaminformationScene_getIODataType(self)

    def setIODataType(self, ioDataType: "OpenCMISS::Zinc::StreaminformationScene::IODataType") -> "int":
        return _streamscene.StreaminformationScene_setIODataType(self, ioDataType)

    def getIOFormat(self) -> "OpenCMISS::Zinc::StreaminformationScene::IOFormat":
        return _streamscene.StreaminformationScene_getIOFormat(self)

    def setIOFormat(self, ioFormat: "OpenCMISS::Zinc::StreaminformationScene::IOFormat") -> "int":
