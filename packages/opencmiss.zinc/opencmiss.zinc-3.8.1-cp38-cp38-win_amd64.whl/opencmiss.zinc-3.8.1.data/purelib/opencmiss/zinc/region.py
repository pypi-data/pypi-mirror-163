...
class Region(object):
    ...
    def beginHierarchicalChange(self) -> "int":
        return _region.Region_beginHierarchicalChange(self)

    def endHierarchicalChange(self) -> "int":
        return _region.Region_endHierarchicalChange(self)

    def createChild(self, name: "char const *") -> "OpenCMISS::Zinc::Region":
        return _region.Region_createChild(self, name)

    def createSubregion(self, path: "char const *") -> "OpenCMISS::Zinc::Region":
        return _region.Region_createSubregion(self, path)

    def createRegion(self) -> "OpenCMISS::Zinc::Region":
...
class Regionevent(object):
    ...
    def getId(self) -> "cmzn_regionevent_id":
...
class Regionnotifier(object):
    ...
    def getId(self) -> "cmzn_regionnotifier_id":
