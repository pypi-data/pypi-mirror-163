...
class Context(object):
    ...
    def getId(self) -> "cmzn_context_id":
    ...
    def getRevision(self) -> "char const *":
        return _context.Context_getRevision(self)

    def getVersionString(self) -> "char *":
    ...
    def getDefaultRegion(self) -> "OpenCMISS::Zinc::Region":
        return _context.Context_getDefaultRegion(self)

    def setDefaultRegion(self, region: "Region") -> "int":
    ...
    def getLogger(self) -> "OpenCMISS::Zinc::Logger":
