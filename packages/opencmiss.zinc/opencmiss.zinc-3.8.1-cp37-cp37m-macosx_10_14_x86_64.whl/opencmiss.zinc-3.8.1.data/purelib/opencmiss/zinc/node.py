...
class Node(object):
    ...
    def merge(self, nodeTemplate: "Nodetemplate") -> "int":
        return _node.Node_merge(self, nodeTemplate)

    @staticmethod
    def ValueLabelEnumFromString(name: "char const *") -> "OpenCMISS::Zinc::Node::ValueLabel":
        return _node.Node_ValueLabelEnumFromString(name)

    @staticmethod
    def ValueLabelEnumToString(valueLabel: "OpenCMISS::Zinc::Node::ValueLabel") -> "char *":
...
def Node_ValueLabelEnumFromString(name: "char const *") -> "OpenCMISS::Zinc::Node::ValueLabel":
    return _node.Node_ValueLabelEnumFromString(name)

def Node_ValueLabelEnumToString(valueLabel: "OpenCMISS::Zinc::Node::ValueLabel") -> "char *":
    return _node.Node_ValueLabelEnumToString(valueLabel)
...
class Nodeiterator(object):
    ...
    def next(self) -> "OpenCMISS::Zinc::Node":
...
class Nodetemplate(object):
    ...
    def getId(self) -> "cmzn_nodetemplate_id":
        return _node.Nodetemplate_getId(self)

    def defineField(self, field: "Field") -> "int":
        return _node.Nodetemplate_defineField(self, field)

    def defineFieldFromNode(self, field: "Field", node: "Node") -> "int":
        return _node.Nodetemplate_defineFieldFromNode(self, field, node)

    def getTimesequence(self, field: "Field") -> "OpenCMISS::Zinc::Timesequence":
        return _node.Nodetemplate_getTimesequence(self, field)

    def setTimesequence(self, field: "Field", timesequence: "Timesequence") -> "int":
        return _node.Nodetemplate_setTimesequence(self, field, timesequence)

    def getValueNumberOfVersions(self, field: "Field", componentNumber: "int", valueLabel: "OpenCMISS::Zinc::Node::ValueLabel") -> "int":
        return _node.Nodetemplate_getValueNumberOfVersions(self, field, componentNumber, valueLabel)

    def setValueNumberOfVersions(self, field: "Field", componentNumber: "int", valueLabel: "OpenCMISS::Zinc::Node::ValueLabel", numberOfVersions: "int") -> "int":
...
class Nodeset(object):
    ...
    def getId(self) -> "cmzn_nodeset_id":
        return _node.Nodeset_getId(self)

    def castGroup(self) -> "OpenCMISS::Zinc::NodesetGroup":
        return _node.Nodeset_castGroup(self)

    def containsNode(self, node: "Node") -> "bool":
        return _node.Nodeset_containsNode(self, node)

    def createNodetemplate(self) -> "OpenCMISS::Zinc::Nodetemplate":
        return _node.Nodeset_createNodetemplate(self)

    def createNode(self, identifier: "int", nodeTemplate: "Nodetemplate") -> "OpenCMISS::Zinc::Node":
        return _node.Nodeset_createNode(self, identifier, nodeTemplate)

    def createNodeiterator(self) -> "OpenCMISS::Zinc::Nodeiterator":
        return _node.Nodeset_createNodeiterator(self)

    def destroyAllNodes(self) -> "int":
        return _node.Nodeset_destroyAllNodes(self)

    def destroyNode(self, node: "Node") -> "int":
        return _node.Nodeset_destroyNode(self, node)

    def destroyNodesConditional(self, conditionalField: "Field") -> "int":
        return _node.Nodeset_destroyNodesConditional(self, conditionalField)

    def findNodeByIdentifier(self, identifier: "int") -> "OpenCMISS::Zinc::Node":
    ...
    def getMasterNodeset(self) -> "OpenCMISS::Zinc::Nodeset":
    ...
    def __eq__(self, other: "Nodeset") -> "bool":
...
class Nodesetchanges(object):
    ...
    def getNodeChangeFlags(self, node: "Node") -> "OpenCMISS::Zinc::Node::ChangeFlags":
    ...
    def getSummaryNodeChangeFlags(self) -> "OpenCMISS::Zinc::Node::ChangeFlags":
