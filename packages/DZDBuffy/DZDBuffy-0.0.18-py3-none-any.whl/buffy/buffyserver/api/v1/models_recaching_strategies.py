...
class ReCachingStrategy:
    """
    Wrapper class to contain all possible ReCachingStrategy. Similar to an Enum.
    ...
    class age(BaseReCachingStrategy):
        ...
        def request_needs_recache(
            ...
            if (
                not request.latest_request_is_processed
                and latest_response.cached_datetime_utc is None
            ):
                return True
            if (
    ...
    class when_requested(BaseReCachingStrategy):
        ...
        def request_needs_recache(
            ...
            if (
                not request.latest_request_is_processed
                or request.latest_request_is_processed is None
            ):
                return True
            return False
