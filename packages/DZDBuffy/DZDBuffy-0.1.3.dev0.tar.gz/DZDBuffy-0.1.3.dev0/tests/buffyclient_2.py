...
remote_file_url = "https://ftp.ncbi.nih.gov/gene/DATA/gene_orthologs.gz"
# connect to buffy server
c = BuffyPyClient(ssl=False, group_name="GeneLoader")

req = c.create_request(url=remote_file_url)
