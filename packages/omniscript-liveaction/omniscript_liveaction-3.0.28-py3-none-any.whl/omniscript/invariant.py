...
ENGINE_FORMAT_JSON = 0
ENGINE_FORMAT_PLAIN = 1
ENGINE_FORMAT_HTML = 2
ENGINE_FORMAT_TAG_STREAM = 3
...
MEDIA_TYPE_NAMES = [
    ...
    'ATM',                          # MEDIA_TYPE_ATM
    'Wireless WAM',                 # MEDIA_TYPE_WIRELESS_WAN
...
MODE_ACCEPT_ALL = 0
MODE_ACCEPT_MATCHING = 1
MODE_REJECT_ALL = 2
MODE_REJECT_MATCHING = 3
