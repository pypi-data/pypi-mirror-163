...
class BucketPolicy(
    ...
    @jsii.member(jsii_name="fromCfnBucketPolicy") # type: ignore[misc]
    ...
    def add_event_notification(
        ...
        *filters: "NotificationKeyFilter",
        ...
        if __debug__:
            ...
            check_type(argname="argument filters", value=filters, expected_type=typing.Tuple[type_hints["filters"], ...])
    ...
    def grant_public_access(
        ...
        *allowed_actions: builtins.str,
        ...
        if __debug__:
            ...
            check_type(argname="argument allowed_actions", value=allowed_actions, expected_type=typing.Tuple[type_hints["allowed_actions"], ...])
...
class Bucket(
    ...
    @jsii.member(jsii_name="fromCfnBucket") # type: ignore[misc]
    @builtins.classmethod
