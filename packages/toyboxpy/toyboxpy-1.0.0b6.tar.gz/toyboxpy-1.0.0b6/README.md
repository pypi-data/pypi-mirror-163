...
You can also add a nice ![](https://img.shields.io/badge/toybox.py-compatible-brightgreen) badge like this:

```
![](https://img.shields.io/badge/toybox.py-compatible-brightgreen)
```
