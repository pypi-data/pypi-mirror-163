...
Welcome to ``python-step-series`` contributor's guide.
...
If you experience bugs or general issues with ``python-step-series``, please have a look
...
You can help improve ``python-step-series`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``python-step-series`` documentation uses Sphinx_ as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way was a code contribution.
Docs are written using `reStructuredText`_.

.. tip::
   Please notice that the `GitHub web interface`_ provides a quick way of
   propose changes in ``python-step-series``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n python-step-series python=3 six virtualenv pytest pytest-cov
    conda activate python-step-series
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/python-step-series.git
...
.. _repository: https://github.com/ponoor/python-step-series
.. _issue tracker: hhttps://github.com/ponoor/python-step-series/issues
.. <-- end -->
