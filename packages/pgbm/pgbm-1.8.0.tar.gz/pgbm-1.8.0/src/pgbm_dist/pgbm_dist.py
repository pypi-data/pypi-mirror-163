...
if torch.cuda.is_available():
    load(name="split_decision_dist",
        sources=[f'{current_path}/pgbm/splitgain_cuda.cpp', 
                 f'{current_path}/pgbm/splitgain_kernel.cu'],
        is_python_module=False,
        verbose=True)  
else:
    load(name="split_decision_dist",
        sources=[f'{current_path}/pgbm/splitgain_cpu.cpp'],
        is_python_module=False,
        verbose=True)      
