...
class ApiClient(object):
    ...
    def get_snowflake_generated_queries(self, job_id, run_count, len=-1, offset=0, order='DESC'):
        ...
        response = self._get(app='jobrunner',
                             endpoint='/v{}/snowflakeQueries/getQueries'.format(self.api_version),
                             params=params)
        return Command(self, response)
    ...
    def return_all_jobs(self, organization, order_by, order, system, removed, filter_text, job_status, job_label, edge,
                        ...
                        template_job_id=None, with_wrapper=False, draft_run=False):
    ...
    def get_jobs_by_status(self, organization, offset=None, len=None, order_by='NAME', order='ASC', removed=False,
                           system=False, filter_text=None, job_status=None, edge=False, executor_type=None,
                           job_tag=None, with_wrapper=False):
