...
class Jobs(CollectionModel):
    ...
    def _get_all_results_from_api(self, id=None, organization=None, job_status=None, **kwargs):
...
class EnvironmentBuilder:
    ...
    def build(self, environment_name, **kwargs):
        ...
        self._environment.update({'name': environment_name,
                                  'allowSnapshotEngineVersions': kwargs.get('allow_nightly_engine_builds')})
...
class Engine(BaseModel):
    ...
    _REPR_METADATA = ['engine_url', 'running_pipelines_count', 'cpu_load', 'memory_used_mb', 'last_reported_time',
                      'engine_type']
...
class Engines(CollectionModel):
    ...
    def _get_all_results_from_api(self, label=None, version=None, engine_type='COLLECTOR', **kwargs):
        ...
        Returns:
            A :obj:`collections.namedtuple`: of
                ...
                class_kwargs (:obj:`dict`): a dict of additional arguments required by the class_type's init
        """
        kwargs_defaults = {'edge': None, 'offset': 0, 'len': None, 'order_by': 'LAST_REPORTED_TIME', 'order': 'ASC'}
        kwargs_instance = MutableKwargs(kwargs_defaults, kwargs)
        kwargs_unioned = kwargs_instance.union()
        response = self._control_hub.api_client.get_all_registered_engines(organization=self._organization,
                                                                           edge=kwargs_unioned['edge'],
                                                                           label=label,
                                                                           version=version,
                                                                           offset=kwargs_unioned['offset'],
