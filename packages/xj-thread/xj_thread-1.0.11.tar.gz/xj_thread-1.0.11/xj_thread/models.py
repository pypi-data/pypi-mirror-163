...
class ThreadExtendField(models.Model):
    ...
    # 数据库生成classify_id字段
    category_id = models.ForeignKey(verbose_name='分类ID', null=True, blank=True, to=ThreadCategory, db_column='category_id', related_name='+', on_delete=models.DO_NOTHING)
    classify_id = models.ForeignKey(verbose_name='分类ID', null=True, blank=True, to=ThreadClassify, db_column='classify_id', related_name='+', on_delete=models.DO_NOTHING)
