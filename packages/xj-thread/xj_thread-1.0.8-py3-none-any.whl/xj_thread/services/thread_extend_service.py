...
class ThreadExtendOutPutService():
    ...
    def __init__(self, classify_id_list=None, thread_id_list=None):
        if classify_id_list is None:
        ...
        # 字段映射关系
        self.filed_list = list(ThreadExtendField.objects.filter(classify_id__in=self.classify_id_list).values("extend_field", "field"))
