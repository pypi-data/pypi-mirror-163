...
class ThreadExtendFieldAdmin(admin.ModelAdmin):
    list_display = ("category_id", 'field', 'extend_field', 'value', 'type', 'unit')
    search_fields = ("category_id", 'field', 'extend_field', 'value', 'type', 'unit')
    fields = ("category_id", 'field', 'extend_field', 'value', 'type', 'unit')
