...
def HiCAT( X_cell_by_gene, marker_file, log_transformed = False,
               ...
               use_minor = True, minor_wgt = 0, 
               ref_correct = False, use_markers_for_pca = False, 
               comb_mkrs = False, knn_type = 1, knn_pmaj = 0.4, 
               thresholding_ms = (True, False), pct_cutoff_ms = (True, False) ):
        ...
        for tc in target_cell_lst.keys():
            ...
            if (len(list(mkr_lst.keys())) <= 1):
                ...
                if (np.sum(b_cur) < N_neighbors_minor):
                    ...
                    df_res_subset, df_GSA_score_subset = GSA_cell_subtyping( X_cur, X_pca_cur, mkr_lst, mkr_lst_neg, 
                                                                      verbose = verbose )
                    ...
                    df_res_cur, df_score_cur, df_GSA_score_cur = \
                        run_gsa_and_clf(X_pca_cur, X_cur, cobj, y_clust_cur, mkr_lst, mkr_lst_neg, 
                                         ...
                                         df_GSA_score = df_GSA_score_minor_cur)
