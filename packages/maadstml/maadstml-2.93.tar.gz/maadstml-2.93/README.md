...
- **viperpreprocessproducetotopicstream**
  - Users can pre-process data streams using the following functions: MIN, MAX, AVG, COUNT, DIFF, DIFFMARGIN, SUM, MEDIAN, VARIANCE, OUTLIERS, OUTLIERSX-Y,VARIED, 
	...
	CV (coefficient of Variation),Mad (Mean absolute deviation), Skewness, Kurtosis, Spikedetect, Unique, Uniquestr. Spikedetect uses a Zscore method to detect 
...
- If you only want to search for record that have a particular processtype, you can enter:
  ...
  AUTOCORR, TREND, CONSISTENCY, Unique, Uniquestr,
...
- If you only want to search for record that have a particular processtype, you can enter:
  ...
  Mad (Mean absolute deviation), Skewness, Kurtosis, Spikedetect, Unique, Uniquestr.  Spikedetect uses a Zscore method to detect spikes 
  in the data using lag of 5, StD of 3.5 from mean and influence of 0.5.   
...
- You can set conditions to aggregate functions: MIN, MAX, AVG, COUNT, DIFF, DIFFMARGIN, SUM, MEDIAN, VARIANCE, OUTLIERS, OUTLIERSX-Y, VARIED, 
  ...
  Mad (Mean absolute deviation),Skewness, Kurtosis, Spikedetect, Unique, Uniquestr.  Spikedetect uses a Zscore method to detect spikes in the data using lag of 5, 
...
- Here you need to specify how you want to pre-process the streams.  You can perform the following operations:
  ...
  IQR (InterQuartileRange), Midhinge, CONSISTENCY, GM (Geometric mean), HM (Harmonic mean), Trimean, CV (coefficient of Variation), 
  Mad (Mean absolute deviation), Skewness, Kurtosis, Spikedetect, Unique, Uniquestr.  
...
**33. maadstml.viperstreamcluster(vipertoken,host,port,topic,producerid,offset=-1,maxrows=0,enabletls=1,delay=100,brokerhost='',
                                          ...
                                          alertonclustersize=0,sendalertemailsto='',emailfrequencyinseconds=0,
