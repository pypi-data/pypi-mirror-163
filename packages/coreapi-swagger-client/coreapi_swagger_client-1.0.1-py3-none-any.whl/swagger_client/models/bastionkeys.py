...
class Bastionkeys(Status200OkSingle):
    ...
    def __init__(self, results=None, *args, **kwargs):  # noqa: E501
        """Bastionkeys - a model defined in Swagger"""  # noqa: E501
        self._results = None
    ...
    @property
    def results(self):
        """Gets the results of this Bastionkeys.  # noqa: E501


        :return: The results of this Bastionkeys.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Bastionkeys, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Bastionkeys):
            return False
