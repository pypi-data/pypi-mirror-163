...
class PeopleDetails(Status200OkSingle):
    ...
    def __init__(self, results=None, *args, **kwargs):  # noqa: E501
        """PeopleDetails - a model defined in Swagger"""  # noqa: E501
        self._results = None
    ...
    @property
    def results(self):
        """Gets the results of this PeopleDetails.  # noqa: E501


        :return: The results of this PeopleDetails.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PeopleDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PeopleDetails):
            return False
