...
class SshkeyPair(Status200OkSingle):
    ...
    @property
    def results(self):
        """Gets the results of this SshkeyPair.  # noqa: E501


        :return: The results of this SshkeyPair.  # noqa: E501
