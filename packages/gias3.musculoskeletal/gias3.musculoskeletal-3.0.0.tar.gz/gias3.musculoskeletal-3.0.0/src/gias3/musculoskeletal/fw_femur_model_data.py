...
regionBoundaryNodes = {
    'head': {1: [25, 26, 27, 28, 29, 71, 72, 73, 74, 97, 98, 99, 45, 46, 47, 48, ]},
...
assemblyElementsNumbers = {
    'head': 0, 'greatertrochanter': 1, 'proximalshaft': 2, 'distalshaft': 3, 'lateralcondyle': 4,
    'medialcondyle': 5}
