...
def plot_csbars(data, ax=None, width=0.6, colorup='k', colordn='k', coloroff='w', label=None):
    ...
    ax.bar(xvalues, height=high - low, bottom=low, edgecolor=edgecolor, width=0.0, linewidth=0.7,
           label=label)
    ax.bar(xvalues, height=upper - lower, bottom=lower, color=fillcolor, edgecolor=edgecolor, width=width,
           fill=True, linewidth=0.7)


def plot_cspoly(data, ax=None, width=0.6, colorup='k', colordn='k', coloroff='w', label=None):
    ...
    verts = [((x - half_bar, b), (x - half_bar, t),
              (x, t), (x, h), (x, t),
              (x + half_bar, t), (x + half_bar, b),
              (x, b), (x, l), (x, b)
              )
    ...
    poly = PolyCollection(verts, facecolors=facecolor, edgecolors=edgecolor,
