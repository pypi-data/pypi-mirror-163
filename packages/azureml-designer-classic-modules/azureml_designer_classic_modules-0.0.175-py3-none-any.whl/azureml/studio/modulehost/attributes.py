...
DEFAULT_CPU_IMAGE = "mcr.microsoft.com/azureml/openmpi3.1.2-ubuntu18.04:20211124.v1"
DEFAULT_GPU_IMAGE = "mcr.microsoft.com/azureml/openmpi3.1.2-cuda10.2-cudnn8-ubuntu18.04:20211124.v1"
...
DEFAULT_CONDA_DEPENDENCIES = Dependencies.update_from_default(
    ...
    pip_packages=[
        "spacy==3.4.0",
        "https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.4.0/en_core_web_sm-3.4.0.tar.gz#egg=en_core_web_sm",  # noqa: do not wrap long urls
