...
@jsii.implements(aws_cdk.aws_iotevents_alpha.IAction)
class ClearTimerAction(
    ...
    def __init__(self, timer_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ClearTimerAction.__init__)
...
class ResetTimerAction(
    ...
    def __init__(self, timer_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ResetTimerAction.__init__)
            check_type(argname="argument timer_name", value=timer_name, expected_type=type_hints["timer_name"])
        jsii.create(self.__class__, self, [timer_name])
...
class SetTimerAction(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SetTimerAction.__init__)
            check_type(argname="argument timer_name", value=timer_name, expected_type=type_hints["timer_name"])
...
class SetVariableAction(
    ...
    def __init__(
        ...
        value: aws_cdk.aws_iotevents_alpha.Expression,
    ) -> None:
        '''
...
class TimerDuration(
    ...
    @jsii.member(jsii_name="fromDuration") # type: ignore[misc]
    @builtins.classmethod
    def from_duration(cls, duration: aws_cdk.Duration) -> "TimerDuration":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimerDuration.from_duration)
            check_type(argname="argument duration", value=duration, expected_type=type_hints["duration"])
        return typing.cast("TimerDuration", jsii.sinvoke(cls, "fromDuration", [duration]))

    @jsii.member(jsii_name="fromExpression") # type: ignore[misc]
    @builtins.classmethod
    def from_expression(
        cls,
        expression: aws_cdk.aws_iotevents_alpha.Expression,
    ) -> "TimerDuration":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TimerDuration.from_expression)
