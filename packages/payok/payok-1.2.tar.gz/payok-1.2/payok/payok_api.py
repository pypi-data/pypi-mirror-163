...
__version__ = "1.2"
__author__ = "lolz.guru/members/2977610"
import hashlib
import urllib.parse
...
def createPay(
    ...
    if success_url:
        success_url = '&success_url=' + urllib.parse.quote_plus(success_url)
    if lang:
        lang = urllib.parse.quote_plus(lang)
    url = f"https://payok.io/pay?amount={amount}&payment={payment}&desc={desc}&shop={shop}&currency={currency}&sign={sign}&email={email}{success_url}&method={method}&customparam={custom}"
    return url
