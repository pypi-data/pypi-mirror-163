...
_MQTTTopicCallable = TypedDict(
    "_MQTTTopicCallable",
    {
        ...
        "avr/game/building/state": _AvrGameBuildingStateCallable,
    },
    total=False
)
...
_MQTTTopicPayload = TypedDict(
    "_MQTTTopicPayload",
    {
        ...
        "avr/game/building/state": AvrGameBuildingStatePayload,
    },
    total=False
)
...
class MQTTModule:
    ...
    @overload
    def send_message(self, topic: Literal["avr/game/building/state"], payload: AvrGameBuildingStatePayload) -> None: ...
