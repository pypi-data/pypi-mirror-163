...
class WellsAPI(BaseAPI):
    ...
    def _retrieve_multiple(self, request: WellByIdsRequest) -> List[Well]:
    ...
    def retrieve(
        ...
        return self._retrieve_multiple(WellByIdsRequest(items=items, output_crs=output_crs))[0]
    ...
    def retrieve_multiple(
        ...
        return WellList(self._retrieve_multiple(WellByIdsRequest(items=items, output_crs=output_crs)))
