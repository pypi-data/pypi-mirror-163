...
from johnsnowlabs.utils.enums import UrlDependency, ProductName, SparkVersion, JvmHardwareTarget, \
...
class HcLibResolver(JslLibDependencyResolverABC, metaclass=ABCMeta):
    ...
    compatible_spark_to_py_map = {
        SparkVersion.spark3xx: {
            ...
            PyInstallTypes.tar:
                UrlDependency(
                    'https://pypi.johnsnowlabs.com/{secret}/spark-nlp-jsl/spark-nlp-jsl-{lib_version}.tar.gz',
