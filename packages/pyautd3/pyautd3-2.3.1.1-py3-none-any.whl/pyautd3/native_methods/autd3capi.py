...
class NativeMethods(metaclass=Singleton):
    ...
    def init_dll(self):
        ...
        self.dll.AUTDAddDeviceQuaternion.argtypes = [ctypes.c_void_p, ctypes.c_double, ctypes.c_double,
        ...
        self.dll.AUTDTransPosition.argtypes = [
            ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double)]
        self.dll.AUTDTransPosition.restype = None

        self.dll.AUTDTransXDirection.argtypes = [
            ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double)]
        ...
        self.dll.AUTDTransYDirection.argtypes = [
            ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double)]
        ...
        self.dll.AUTDTransZDirection.argtypes = [
            ctypes.c_void_p, ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double), ctypes.POINTER(
                ctypes.c_double)]
        ...
        self.dll.AUTDGainBesselBeam.argtypes = [
            ctypes.POINTER(
                ctypes.c_void_p),
            ctypes.c_double,
            ctypes.c_double,
