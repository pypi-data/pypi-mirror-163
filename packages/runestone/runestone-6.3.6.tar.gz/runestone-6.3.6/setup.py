...
{'': ['*'],
 'runestone.common': ['project_template/*',
                      'project_template/_static/.gitignore',
                      'project_template/_templates/plugin_layouts/sphinx_bootstrap/static/bootstrap-sphinx.css_t',
                      'project_template/_templates/plugin_layouts/sphinx_bootstrap/theme.conf'],
