...
class Eslint(
    ...
    def add_extends(self, *extend_list: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument extend_list", value=extend_list, expected_type=typing.Tuple[type_hints["extend_list"], ...])
...
class NodePackage(
    ...
    def add_keywords(self, *keywords: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument keywords", value=keywords, expected_type=typing.Tuple[type_hints["keywords"], ...])
    ...
    def add_package_resolutions(self, *resolutions: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument resolutions", value=resolutions, expected_type=typing.Tuple[type_hints["resolutions"], ...])
...
class NodeProject(
    ...
    def add_compile_command(self, *commands: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument commands", value=commands, expected_type=typing.Tuple[type_hints["commands"], ...])
...
class UpgradeDependencies(
    ...
    def add_post_build_steps(self, *steps: _JobStep_c3287c05) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument steps", value=steps, expected_type=typing.Tuple[type_hints["steps"], ...])
