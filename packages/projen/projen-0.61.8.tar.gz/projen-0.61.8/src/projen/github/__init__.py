    ...
    def add_ignore(
        ...
        *versions: builtins.str,
        ...
        if __debug__:
            ...
            check_type(argname="argument versions", value=versions, expected_type=typing.Tuple[type_hints["versions"], ...])
    ...
    def add_pull_request_template(
        ...
        *content: builtins.str,
        ...
        if __debug__:
            ...
            check_type(argname="argument content", value=content, expected_type=typing.Tuple[type_hints["content"], ...])
...
class GithubWorkflow(
    ...
    def add_job(
        self,
        id: builtins.str,
        job: typing.Union[_JobCallingReusableWorkflow_12ad1018, _Job_20ffcf45],
    ) -> None:
    ...
    def add_jobs(
        self,
        jobs: typing.Mapping[builtins.str, typing.Union[_JobCallingReusableWorkflow_12ad1018, _Job_20ffcf45]],
    ) -> None:
