...
class GitAttributesFile(
    ...
    def add_attributes(self, glob: builtins.str, *attributes: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument attributes", value=attributes, expected_type=typing.Tuple[type_hints["attributes"], ...])
...
class _IDevEnvironmentProxy:
    ...
    def add_ports(self, *ports: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument ports", value=ports, expected_type=typing.Tuple[type_hints["ports"], ...])
    ...
    def add_tasks(self, *tasks: "Task") -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument tasks", value=tasks, expected_type=typing.Tuple[type_hints["tasks"], ...])
    ...
    def add_vscode_extensions(self, *extensions: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument extensions", value=extensions, expected_type=typing.Tuple[type_hints["extensions"], ...])
...
class IgnoreFile(FileBase, metaclass=jsii.JSIIMeta, jsii_type="projen.IgnoreFile"):
    ...
    def add_patterns(self, *patterns: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument patterns", value=patterns, expected_type=typing.Tuple[type_hints["patterns"], ...])
...
class Logger(Component, metaclass=jsii.JSIIMeta, jsii_type="projen.Logger"):
    ...
    def debug(self, *text: typing.Any) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument text", value=text, expected_type=typing.Tuple[type_hints["text"], ...])
...
class Makefile(FileBase, metaclass=jsii.JSIIMeta, jsii_type="projen.Makefile"):
    ...
    def add_alls(self, *targets: builtins.str) -> "Makefile":
        ...
        if __debug__:
            ...
            check_type(argname="argument targets", value=targets, expected_type=typing.Tuple[type_hints["targets"], ...])
...
class Project(metaclass=jsii.JSIIMeta, jsii_type="projen.Project"):
    ...
    def add_exclude_from_cleanup(self, *globs: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument globs", value=globs, expected_type=typing.Tuple[type_hints["globs"], ...])
