...
class COCO:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            logging.info("category names: {}".format([e["name"] for e in sorted(dataset["categories"], key=lambda x: x["id"])]))
    ...
    def download(self, tarDir = None, imgIds = [] ):
        ...
        for i, img in enumerate(imgs):
            ...
            logging.info('downloaded {}/{} images (t={:0.1f}s)'.format(i, N, time.time()- tic))
    ...
    def loadNumpyAnnotations(self, data):
        ...
        """
        logging.info('Converting ndarray to lists...')
