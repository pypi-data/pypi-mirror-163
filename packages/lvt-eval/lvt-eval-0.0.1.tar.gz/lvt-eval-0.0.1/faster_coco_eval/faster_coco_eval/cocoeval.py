...
from faster_coco_eval.faster_coco_eval import mask as maskUtils
import copy
        ...
        def _summarize(ap=1, iouThr=None, areaRng='all', maxDets=100):
            ...
            if s.shape[category_dimension] > 1:
                ...
                with np.printoptions(precision=3, suppress=True, sign=" ", floatmode="fixed"):
                    logger.info(iStr.format(titleStr, typeStr, iouStr, areaRng, maxDets, mean_s, per_category_mean_s))
            else:
