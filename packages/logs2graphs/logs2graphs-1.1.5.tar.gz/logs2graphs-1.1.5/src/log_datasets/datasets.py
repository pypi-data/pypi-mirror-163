...
class BGLDataset(LogDataset):
    ...
    def load_logs(self):
        ...
        anomalous_event_ids_dict = {k: 0 for k in list(self.logs[self.logs['Label'] != '-']['EvenId'].unique())}
    ...
    def load_event_templates(self):
        self.templates = pd.read_csv(f'{self.data_folder_path}/bgl/processed_logs.log_structured.csv')
