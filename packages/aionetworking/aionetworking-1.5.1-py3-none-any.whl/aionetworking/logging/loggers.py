...
class ConnectionLogger(Logger):
    ...
    def _msg_received(self, msg_obj: MessageObjectType, *args, msg: str = '', extra: Dict[str, Any] = None, **kwargs) -> None:
        extra = extra or {}
        extra.update({'msg_obj': msg_obj, 'direction': 'RECEIVED'})
        self._msg_received_logger.debug(msg, *args, detail=extra, **kwargs)
    ...
    def on_msg_decoded(self, msg_obj: MessageObjectType, **kwargs) -> None:
        self._msg_received(msg_obj, **kwargs)
