...
asset_core_fields_dict = {
    ...
    'asset_maintenance_type': 'ComplexAssetMaintenanceType',
    'asset_maintenance_subtype': 'ComplexAssetMaintenanceSubType',

    'assetic_criticality': "ComplexAssetCriticality",
    'asset_work_group': "ComplexAssetWorkGroup",
    'status': "CAStatus",
    'security_group': "ComplexAssetSecurityGroupName"
}
