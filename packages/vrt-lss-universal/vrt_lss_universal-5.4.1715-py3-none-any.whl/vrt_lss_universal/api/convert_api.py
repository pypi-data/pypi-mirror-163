...
class ConvertApi(object):
    ...
    def run_convert_json_to_xlsx(
        ...
        **kwargs
        ...
        Used for conversion of input and output data to the [VRt.Universal XLSX](#section/Description/VRt.Universal-XLSX) format.  
    ...
    def run_convert_xlsx_to_json(
        ...
        **kwargs
        ...
        Used for data conversion from the [VRt.Universal XLSX](#section/Description/VRt.Universal-XLSX) format to the VRt.Universal JSON format.   
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
