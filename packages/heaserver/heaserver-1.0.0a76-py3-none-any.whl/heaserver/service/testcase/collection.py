...
class CollectionKey:
    """
    A key to a collection that contains its name and relevant database manager class.
    ...
    def matches(self, other: 'str | CollectionKey', default_db_manager_cls: type[DatabaseManager] = DatabaseManager) -> bool:
...
def coll_is_relevant_to(key: str | CollectionKey, db_manager: DatabaseManager | type[DatabaseManager]):
