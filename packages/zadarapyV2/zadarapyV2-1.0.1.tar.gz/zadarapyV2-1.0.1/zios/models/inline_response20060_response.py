...
class InlineResponse20060Response(object):
    ...
    """
    swagger_types = {
        'user': 'InlineResponse20060ResponseUser',
        'status': 'int'
    }
    ...
    def __init__(self, user=None, status=None, _configuration=None):  # noqa: E501
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20060Response.  # noqa: E501


        :return: The user of this InlineResponse20060Response.  # noqa: E501
        :rtype: InlineResponse20060ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20060Response.


        :param user: The user of this InlineResponse20060Response.  # noqa: E501
        :type: InlineResponse20060ResponseUser
        """
