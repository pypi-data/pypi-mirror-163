...
class VolumesApi(object):
    ...
    def detach_node(self, volume_id, node_name, **kwargs):  # noqa: E501
        """Detach node from volume  # noqa: E501

        Detach node from volume  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detach_node(volume_id, node_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.detach_node_with_http_info(volume_id, node_name, **kwargs)  # noqa: E501
        else:
            (data) = self.detach_node_with_http_info(volume_id, node_name, **kwargs)  # noqa: E501
            return data

    def detach_node_with_http_info(self, volume_id, node_name, **kwargs):  # noqa: E501
        """Detach node from volume  # noqa: E501

        Detach node from volume  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.detach_node_with_http_info(volume_id, node_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['volume_id', 'node_name', 'detach_node_volume_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('node_name' not in params or
            ...
            raise ValueError("Missing the required parameter `node_name` when calling `detach_node`")  # noqa: E501
