...
class Search():
        ...
        if bool(rand_vars):
            ...
            if self.latent_class:
                try:
                    ...
                    # TODO? UPDATE
                    logger.warning("Exception during fit_lccm: {}".format(e))
    ...
    def check_sol_already_generated(self, sol):
        ...
        for har_mem_sol in new_har_mem:
            ...
            if np.all(bool_arr):
                logger.info("Sol already generated. Skipping estimation.")
                return True
    ...
    def run_search(self, HMS=10, HMCR_min=0.6, HMCR_max=0.9, PAR_max=0.85,
        ...
        logger.info("{} GPU device(s) available. searchlogit will {} use GPU processing".format(n_gpus, gpu_txt))
