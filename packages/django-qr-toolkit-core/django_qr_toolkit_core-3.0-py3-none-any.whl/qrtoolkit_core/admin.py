...
class ApiHitAdmin(admin.ModelAdmin):
    ...
    def get_list_filter(self, request):
        if request.method == 'GET' and request.GET.get('code__department__name', None) is not None:
            return 'code__department__name', 'code__title',
        return 'code__department__name',

    def lookup_allowed(self, lookup, value):
        if lookup in ('code__department__name', 'code__title'):
            return True
