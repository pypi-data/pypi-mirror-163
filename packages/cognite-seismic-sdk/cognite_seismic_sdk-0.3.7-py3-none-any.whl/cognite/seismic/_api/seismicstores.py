...
from cognite.seismic._api.utility import Metadata, get_coverage_spec, get_identifier
...
class SeismicStoreAPI(API):
    ...
    def search(
        ...
        *,
        ...
        return (SeismicStore._from_proto(s, self._api_client) for s in self.query.SearchSeismicStores(req))
    ...
    def edit(
        ...
        *,
        ...
        return SeismicStore._from_proto(self.query.EditSeismicStore(request), self._api_client)
    ...
    def delete(self, *, id: Optional[int] = None, external_id: Optional[str] = None):
        ...
        request = DeleteSeismicStoreRequest(seismic_store=get_identifier(id, external_id))
