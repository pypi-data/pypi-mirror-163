...
if not os.getenv("READ_THE_DOCS"):
    ...
    from cognite.seismic.protos.v1.seismic_service_datatypes_pb2 import CoverageSpec, Identifier, SearchSpec
...
def get_identifier(id: Optional[int] = None, external_id: Optional[str] = None) -> Identifier:
