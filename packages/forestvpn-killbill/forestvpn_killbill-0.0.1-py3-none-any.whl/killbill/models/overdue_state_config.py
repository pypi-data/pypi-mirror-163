...
class OverdueStateConfig(object):
    ...
    def __init__(self, name=None, is_clear_state=None, condition=None, external_message=None, is_block_changes=None, is_disable_entitlement=None, subscription_cancellation_policy=None, auto_reevaluation_interval_days=None, _configuration=None):  # noqa: E501
    ...
    def subscription_cancellation_policy(self, subscription_cancellation_policy):
        ...
        if (self._configuration.client_side_validation and
                subscription_cancellation_policy not in allowed_values):
            raise ValueError(
