...
class Tag(object):
    ...
    def __init__(self, tag_id=None, object_type=None, object_id=None, tag_definition_id=None, tag_definition_name=None, audit_logs=None, _configuration=None):  # noqa: E501
