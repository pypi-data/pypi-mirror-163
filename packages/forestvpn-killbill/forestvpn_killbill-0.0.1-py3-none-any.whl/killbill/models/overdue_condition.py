...
class OverdueCondition(object):
    ...
    def __init__(self, time_since_earliest_unpaid_invoice_equals_or_exceeds=None, control_tag_inclusion=None, control_tag_exclusion=None, number_of_unpaid_invoices_equals_or_exceeds=None, response_for_last_failed_payment=None, total_unpaid_invoice_balance_equals_or_exceeds=None, _configuration=None):  # noqa: E501
    ...
    def control_tag_inclusion(self, control_tag_inclusion):
        ...
        if (self._configuration.client_side_validation and
                control_tag_inclusion not in allowed_values):
            raise ValueError(
    ...
    def control_tag_exclusion(self, control_tag_exclusion):
        ...
        allowed_values = ["AUTO_PAY_OFF", "AUTO_INVOICING_OFF", "OVERDUE_ENFORCEMENT_OFF", "WRITTEN_OFF", "MANUAL_PAY", "TEST", "PARTNER", "AUTO_INVOICING_DRAFT", "AUTO_INVOICING_REUSE_DRAFT"]  # noqa: E501
        if (self._configuration.client_side_validation and
                control_tag_exclusion not in allowed_values):
            raise ValueError(
    ...
    def response_for_last_failed_payment(self, response_for_last_failed_payment):
        ...
        if (self._configuration.client_side_validation and
                not set(response_for_last_failed_payment).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
