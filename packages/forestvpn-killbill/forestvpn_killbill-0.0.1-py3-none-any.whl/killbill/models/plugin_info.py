...
class PluginInfo(object):
    ...
    def __init__(self, bundle_symbolic_name=None, plugin_key=None, plugin_name=None, version=None, state=None, is_selected_for_start=None, services=None, _configuration=None):  # noqa: E501
