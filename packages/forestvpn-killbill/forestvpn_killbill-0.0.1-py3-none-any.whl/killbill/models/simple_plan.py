...
class SimplePlan(object):
    ...
    def __init__(self, plan_id=None, product_name=None, product_category=None, currency=None, amount=None, billing_period=None, trial_length=None, trial_time_unit=None, available_base_products=None, _configuration=None):  # noqa: E501
    ...
    def trial_time_unit(self, trial_time_unit):
        ...
        if (self._configuration.client_side_validation and
                trial_time_unit not in allowed_values):
            raise ValueError(
