...
class SubscriptionUsageRecord(object):
    ...
    def __init__(self, subscription_id=None, tracking_id=None, unit_usage_records=None, _configuration=None):  # noqa: E501
    ...
    def unit_usage_records(self, unit_usage_records):
        ...
        """
        if self._configuration.client_side_validation and unit_usage_records is None:
