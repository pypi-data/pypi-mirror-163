...
class ComboHostedPaymentPage(object):
    ...
    def __init__(self, account=None, payment_method=None, hosted_payment_page_fields=None, payment_method_plugin_properties=None, audit_logs=None, _configuration=None):  # noqa: E501
