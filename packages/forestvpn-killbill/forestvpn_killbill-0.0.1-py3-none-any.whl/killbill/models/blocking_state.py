...
class BlockingState(object):
    ...
    def __init__(self, blocked_id=None, state_name=None, service=None, is_block_change=None, is_block_entitlement=None, is_block_billing=None, effective_date=None, type=None, audit_logs=None, _configuration=None):  # noqa: E501
