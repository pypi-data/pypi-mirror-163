...
class Tenant(object):
    ...
    def __init__(self, tenant_id=None, external_key=None, api_key=None, api_secret=None, audit_logs=None, _configuration=None):  # noqa: E501
    ...
    def api_secret(self, api_secret):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and api_secret is None:
