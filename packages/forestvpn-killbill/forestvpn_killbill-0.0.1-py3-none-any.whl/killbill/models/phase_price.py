...
class PhasePrice(object):
    ...
    def __init__(self, plan_name=None, phase_name=None, phase_type=None, fixed_price=None, recurring_price=None, usage_prices=None, _configuration=None):  # noqa: E501
