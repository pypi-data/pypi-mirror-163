...
class TagDefinition(object):
    ...
    def __init__(self, id=None, is_control_tag=None, name=None, description=None, applicable_object_types=None, audit_logs=None, _configuration=None):  # noqa: E501
    ...
    def applicable_object_types(self, applicable_object_types):
        ...
        if (self._configuration.client_side_validation and
                not set(applicable_object_types).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
