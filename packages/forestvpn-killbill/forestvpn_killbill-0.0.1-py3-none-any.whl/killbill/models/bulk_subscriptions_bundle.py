...
class BulkSubscriptionsBundle(object):
    ...
    def __init__(self, base_entitlement_and_add_ons=None, _configuration=None):  # noqa: E501
    ...
    def base_entitlement_and_add_ons(self, base_entitlement_and_add_ons):
        ...
        """
        if self._configuration.client_side_validation and base_entitlement_and_add_ons is None:
