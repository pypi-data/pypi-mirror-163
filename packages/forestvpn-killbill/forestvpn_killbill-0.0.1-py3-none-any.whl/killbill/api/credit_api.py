...
class CreditApi(object):
    ...
    def create_credits_with_http_info(self, body, x_killbill_created_by, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'x_killbill_created_by', 'auto_commit', 'plugin_property', 'x_killbill_reason', 'x_killbill_comment']  # noqa: E501
    ...
    def get_credit_with_http_info(self, credit_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('credit_id' not in params or
                                                       params['credit_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `credit_id` when calling `get_credit`")  # noqa: E501

        if self.api_client.client_side_validation and ('credit_id' in params and not re.search(r'\\w+-\\w+-\\w+-\\w+-\\w+', params['credit_id'])):  # noqa: E501
