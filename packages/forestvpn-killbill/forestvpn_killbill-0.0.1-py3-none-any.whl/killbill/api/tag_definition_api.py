...
class TagDefinitionApi(object):
    ...
    def delete_tag_definition_with_http_info(self, tag_definition_id, x_killbill_created_by, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tag_definition_id' not in params or
                                                       params['tag_definition_id'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tag_definition_id' in params and not re.search(r'\\w+-\\w+-\\w+-\\w+-\\w+', params['tag_definition_id'])):  # noqa: E501
