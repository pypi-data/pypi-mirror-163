...
def kdata(which, kind, fileln, file, filtln, filtyp, srclen, srcfil):
    r"""kdata(SpiceInt which, ConstSpiceChar * kind, SpiceInt fileln, SpiceChar * file, SpiceInt filtln, SpiceChar * filtyp, SpiceInt srclen, SpiceChar * srcfil)"""
    return _cspyce0.kdata(which, kind, fileln, file, filtln, filtyp, srclen, srcfil)
