...
def _format(response):
    ...
    result = {
        ...
        'processor': 'decidir',
        'payment_day': parse_date(response['date'])         # es igual a date_created
    }
    return result


class Payment:
    def __init__(self, url: str, private_key: str, public_key: str, merchant_name: str, site_id: str,
                 site_id_cadena: str):
        self.url = url
    ...
    def create(self, payment_data: dict):
        ...
        if r.status_code < 400:
            ...
            return ok(_format(response), r.status_code)
        return error(response, r.status_code)
    ...
    def get(self, payment_id: str):
        ...
        if len(list_results) == 1:
            return ok(_format(list_results[0]), r.status_code)
        else:
            return error('error_pago_no_encontrado', r.status_code)
    ...
    def search(self, filters: dict) -> dict:
        ...
        return ok(response, r.status_code)
