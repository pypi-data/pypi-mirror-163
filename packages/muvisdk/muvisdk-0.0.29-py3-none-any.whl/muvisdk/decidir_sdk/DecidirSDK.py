...
class DecidirSDK:
    def __init__(self, merchant, merchant_cadena=None,site_id=None,distributed=False):
        if distributed:
    ...
    def payment(self):
        return Payment(self.url, self.private_key, self.public_key, self.payment_type, self.site_id)
