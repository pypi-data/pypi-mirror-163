...
class ExergenicsApi:
    ...
    def getWhoAmI(self):
        return "component={};mode={};user={};database={}".format(self.componentId, self.mode, self.username, self.database)
    ...
    ********************************
    ...
    def plotlyBowlChart(self, dataFrame, title="title", xAxisTitle="xAxisTitle", yAxisTitle="yAxisTitle",
                        yAxis2="SecondAxis",
                        outputType="html", legendTitle="legendTitle", chartWidth=800, chartHeight=600,
    ...
    def portalChart_BowlChart3d(self, plantCode, chartName, portalCategory, dataFrame, x, y, z, title="title",
                                ...
                                legendSize=12, legendColor="black", legendBg="LightSteelBlue", titleFont="Arial",
                                titleColor="black"):
        urlToChart = self.plotlyBowlChart3d(dataFrame, x, y, z, title, xAxisTitle, yAxisTitle, zAxisTitle, outputType,
                                            legendTitle,
                                            chartWidth, chartHeight, backgroundColor, fontSize, fontFamily,
                                            fontColor, legendFamily, legendSize, legendColor, legendBg, titleFont,
                                            titleColor)
