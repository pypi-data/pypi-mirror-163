...
class SalureFunctions:
    ...
    @staticmethod
    def save_mutations_and_clean_overdue_mutations(changes_dir: os.PathLike, df: pd.DataFrame, max_retries: int = None, max_days: int = None) -> pd.DataFrame:
        """
    ...
    @staticmethod
    def handle_mutation_result(changes_dir: str, df: pd.DataFrame, row_index: Hashable, succes: bool):
        """
