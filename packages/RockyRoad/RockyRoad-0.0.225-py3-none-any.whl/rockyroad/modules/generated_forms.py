...
class Generated_Forms(Consumer):
    ...
    class __Groups(Consumer):
        ...
        def get(self, uid: str):
            """This call will get a list of all groups based on the criteria"""
        ...
        def assign_field_to_group(self, group_uid: str, field_uid: str):
            """This will assign a field to a group"""

        @delete("generated/forms/groups/fields/{group_uid}/{field_uid}")
        def remove_field_from_group(self, group_uid: str, field_uid: str):
            """This call will remove a field from a group."""

        @json
        @patch("generated/forms/groups/fields/{group_uid}/order")
        def order_fields_in_group(self, fields: Body, group_uid: str):
    ...
    class __Forms(Consumer):
        ...
        def assign_group_to_form(self, group_uid: str, form_uid: str):
