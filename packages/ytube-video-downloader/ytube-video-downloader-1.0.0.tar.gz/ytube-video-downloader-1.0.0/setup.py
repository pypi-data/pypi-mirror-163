...
setup(
    ...
    description=('YTube-Video-Downloader is a command-line application written in Python that downloads videos from a specific channel according to user-specified filters.'),
