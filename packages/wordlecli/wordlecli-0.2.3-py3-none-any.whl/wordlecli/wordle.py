...
def update_keyboard(guess: str, target: str, row1: dict[str, str], row2: dict[str, str], row3: dict[str, str]) -> None:
    '''
...
def print_keyboard(row1: dict[str, str], row2: dict[str, str], row3: dict[str, str]) -> None:
    '''
...
def print_result(num: int, guesses: list[str], share_list: list[str], win_status: bool) -> None:
    '''
