...
- NosoFileStream: A small class to mimic the Stream funtionality of other langauges
...
block_filename = 'path/to/NOSODATA/BLOCKS/48028.blk'

block = NosoBlock()
block.load_from_file(block_filename)

print('Block #:', block.number)
print('Time Start:', block.time_start)
print('Time End:', block.time_end)
