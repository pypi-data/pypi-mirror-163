        ...
        for i, line in enumerate(lines):
            ...
            if token_chain.is_valid():
                ...
                if '@input' == token_chain.get_command() and next_line != None:
                    ...
                    # append fodder
                    print(f'Line = {line} Indent = |' + token_chain.get_indentation() + '|')
                    print(f"{token_chain.get_indentation()}app.createInput({i}, 'Variable {lhs}', '')")
                    pass_1.append(line)
                    pass_1.append(f"{token_chain.get_indentation()}app.createInput({i}, 'Variable {lhs}', '')")
                ...
                if '@output' == token_chain.get_command() and next_line != None:
                    ...
                    pass_1.append(f"app.createOutput({i}, '{lhs}', {lhs}, '{componentType}', '', {token_chain.get_named_args()})")
