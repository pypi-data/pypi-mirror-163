...
class Config(OpenApiObject):
    ...
    def profiles(self):
        ...
        Key where all the profiles are storedKey where all the profiles are stored

        Returns: Profiles
        """
        return self._get_property('profiles', Profiles)
...
class Profiles(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'dataflow': {'type': 'ProfilesDataflow'},
    } # type: Dict[str, str]
    ...
    @property
    def dataflow(self):
        # type: () -> ProfilesDataflow
        """dataflow getter

        Dataflow specific profilesDataflow specific profiles

        Returns: ProfilesDataflow
        """
        return self._get_property('dataflow', ProfilesDataflow)


class ProfilesDataflow(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'host_management': {'type': 'ProfilesDataflowHostManagement'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None):
        super(ProfilesDataflow, self).__init__()
        self._parent = parent

    @property
    def host_management(self):
        # type: () -> ProfilesDataflowHostManagement
        """host_management getter

        

        Returns: ProfilesDataflowHostManagement
        """
        return self._get_property('host_management', ProfilesDataflowHostManagement)


class ProfilesDataflowHostManagement(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'eth_nic_profiles': {'type': 'EthNicSettingsIter'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None):
        super(ProfilesDataflowHostManagement, self).__init__()
        self._parent = parent

    @property
    def eth_nic_profiles(self):
        # type: () -> EthNicSettingsIter
        """eth_nic_profiles getter

        TBD

        Returns: EthNicSettingsIter
        """
        return self._get_property('eth_nic_profiles', EthNicSettingsIter, self._parent, self._choice)


class EthNicSettings(OpenApiObject):
    __slots__ = ('_parent')
    ...
    _TYPES = {
        ...
        'coalesce_tx_frames': {'type': int},
        'coalesce_rx_frames': {'type': int},
        'coalesce_tx_usecs': {'type': int},
        'coalesce_rx_usecs': {'type': int},
        'offload_rx_checksum': {'type': bool},
        'offload_tx_checksum': {'type': bool},
        'offload_sg': {'type': bool},
        'offload_tso': {'type': bool},
        'offload_gso': {'type': bool},
        'offload_gro': {'type': bool},
    ...
    def __init__(self, parent=None, name=None, nic_rx_buffer=None, nic_tx_buffer=None, nic_speed=None, management_address=None, nic_name=None, flow_control_autoneg=None, flow_control_rx=None, flow_control_tx=None, coalesce_adaptive_rx=None, coalesce_adaptive_tx=None, coalesce_tx_frames=None, coalesce_rx_frames=None, coalesce_tx_usecs=None, coalesce_rx_usecs=None, offload_rx_checksum=None, offload_tx_checksum=None, offload_sg=None, offload_tso=None, offload_gso=None, offload_gro=None, offload_lro=None, offload_tx_nocache_copy=None, offload_tx_udp_segmentation=None, tx_queue_len=None):
        super(EthNicSettings, self).__init__()
        self._parent = parent
        self._set_property('name', name)
        ...
        self._set_property('offload_gro', offload_gro)
    ...
    def name(self):
        ...
        Uniquely identifies an eth_nic profile
    ...
    def offload_gro(self):
        ...
        Returns: bool
        """
        return self._get_property('offload_gro')

    @offload_gro.setter
    def offload_gro(self, value):
        """offload_gro setter
        ...
        value: bool
        """
        self._set_property('offload_gro', value)
...
class EthNicSettingsIter(OpenApiIter):
    __slots__ = ('_parent', '_choice')

    _GETITEM_RETURNS_CHOICE_OBJECT = False

    def __init__(self, parent=None, choice=None):
        super(EthNicSettingsIter, self).__init__()
        self._parent = parent
        self._choice = choice

    def __getitem__(self, key):
        # type: (str) -> Union[EthNicSettings]
        return self._getitem(key)
    ...
    def ethnicsettings(self, name=None, nic_rx_buffer=None, nic_tx_buffer=None, nic_speed=None, management_address=None, nic_name=None, flow_control_autoneg=None, flow_control_rx=None, flow_control_tx=None, coalesce_adaptive_rx=None, coalesce_adaptive_tx=None, coalesce_tx_frames=None, coalesce_rx_frames=None, coalesce_tx_usecs=None, coalesce_rx_usecs=None, offload_rx_checksum=None, offload_tx_checksum=None, offload_sg=None, offload_tso=None, offload_gso=None, offload_gro=None, offload_lro=None, offload_tx_nocache_copy=None, offload_tx_udp_segmentation=None, tx_queue_len=None):
        # type: (str,int,int,int,str,str,bool,bool,bool,bool,bool,int,int,int,int,bool,bool,bool,bool,bool,bool,bool,bool,bool,int) -> EthNicSettingsIter
        """Factory method that creates an instance of the EthNicSettings class

        TBD

        Returns: EthNicSettingsIter
        """
        item = EthNicSettings(parent=self._parent, name=name, nic_rx_buffer=nic_rx_buffer, nic_tx_buffer=nic_tx_buffer, nic_speed=nic_speed, management_address=management_address, nic_name=nic_name, flow_control_autoneg=flow_control_autoneg, flow_control_rx=flow_control_rx, flow_control_tx=flow_control_tx, coalesce_adaptive_rx=coalesce_adaptive_rx, coalesce_adaptive_tx=coalesce_adaptive_tx, coalesce_tx_frames=coalesce_tx_frames, coalesce_rx_frames=coalesce_rx_frames, coalesce_tx_usecs=coalesce_tx_usecs, coalesce_rx_usecs=coalesce_rx_usecs, offload_rx_checksum=offload_rx_checksum, offload_tx_checksum=offload_tx_checksum, offload_sg=offload_sg, offload_tso=offload_tso, offload_gso=offload_gso, offload_gro=offload_gro, offload_lro=offload_lro, offload_tx_nocache_copy=offload_tx_nocache_copy, offload_tx_udp_segmentation=offload_tx_udp_segmentation, tx_queue_len=tx_queue_len)
        self._add(item)
        return self

    def add(self, name=None, nic_rx_buffer=None, nic_tx_buffer=None, nic_speed=None, management_address=None, nic_name=None, flow_control_autoneg=None, flow_control_rx=None, flow_control_tx=None, coalesce_adaptive_rx=None, coalesce_adaptive_tx=None, coalesce_tx_frames=None, coalesce_rx_frames=None, coalesce_tx_usecs=None, coalesce_rx_usecs=None, offload_rx_checksum=None, offload_tx_checksum=None, offload_sg=None, offload_tso=None, offload_gso=None, offload_gro=None, offload_lro=None, offload_tx_nocache_copy=None, offload_tx_udp_segmentation=None, tx_queue_len=None):
        # type: (str,int,int,int,str,str,bool,bool,bool,bool,bool,int,int,int,int,bool,bool,bool,bool,bool,bool,bool,bool,bool,int) -> EthNicSettings
        """Add method that creates and returns an instance of the EthNicSettings class

        TBD

        Returns: EthNicSettings
        """
        item = EthNicSettings(parent=self._parent, name=name, nic_rx_buffer=nic_rx_buffer, nic_tx_buffer=nic_tx_buffer, nic_speed=nic_speed, management_address=management_address, nic_name=nic_name, flow_control_autoneg=flow_control_autoneg, flow_control_rx=flow_control_rx, flow_control_tx=flow_control_tx, coalesce_adaptive_rx=coalesce_adaptive_rx, coalesce_adaptive_tx=coalesce_adaptive_tx, coalesce_tx_frames=coalesce_tx_frames, coalesce_rx_frames=coalesce_rx_frames, coalesce_tx_usecs=coalesce_tx_usecs, coalesce_rx_usecs=coalesce_rx_usecs, offload_rx_checksum=offload_rx_checksum, offload_tx_checksum=offload_tx_checksum, offload_sg=offload_sg, offload_tso=offload_tso, offload_gso=offload_gso, offload_gro=offload_gro, offload_lro=offload_lro, offload_tx_nocache_copy=offload_tx_nocache_copy, offload_tx_udp_segmentation=offload_tx_udp_segmentation, tx_queue_len=tx_queue_len)
        self._add(item)
        return item
