...
class ApiClientFactory:
    """
    The ApiClientFactory is responsible for providing the ability to create any of the finbournesdkclient APIs using the provided
    ...
    def __init__(self, sdk, **kwargs):
        ...
        :param module sdk: The OpenAPI Generated SDK library that this class should be used with e.g. lusid
        ...
        :param str api_url: finbournesdkclient API url
    ...
    def build(self, metaclass):
        """
        :param type metaclass:  type of the finbournesdkclient API to create
        :return: Initalised finbournesdkclient API for the type passed in
        """
        ...
        def init_impl(dest, src=None):
            ...
            elif type(src) == self.sdk.ApiClient:
                dest.api_client = src
