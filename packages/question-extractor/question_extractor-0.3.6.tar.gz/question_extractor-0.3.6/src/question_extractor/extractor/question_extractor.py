...
DATA_PATH1 = pkg_resources.resource_filename('question_extractor/extractor', 'data/no_context_question_sentences.txt')
DATA_PATH2 = pkg_resources.resource_filename('question_extractor/extractor', 'models/cnn_model_v2_40K.h5')
DATA_PATH3 = pkg_resources.resource_filename('question_extractor/extractor', 'models/vectorizer_v2_40K.pkl')
