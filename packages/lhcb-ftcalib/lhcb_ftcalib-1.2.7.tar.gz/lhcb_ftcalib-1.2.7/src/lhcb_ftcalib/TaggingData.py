...
from .printing import raise_error, raise_warning
...
class TaggingData:
    ...
    def _compute_calibrated_statistics(self, func, params, covariance, accurate):
        warnings = []
        if not accurate:
    ...
    def _compute_combination_statistics(self, eta, gradients, covariances):
        warnings = []
