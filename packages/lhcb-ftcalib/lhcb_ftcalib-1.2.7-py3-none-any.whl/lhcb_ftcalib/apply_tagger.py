...
class TargetTaggerCollection(TaggerCollection):
    ...
    def load_calibrations(self, filename_or_dict, tagger_mapping=None, style="flavour"):
...
class TargetTagger(TaggerBase):
    ...
    def apply(self, ignore_delta=True):
        ...
        self.stats._compute_calibrated_statistics(self.func, self.minimizer.values, self.minimizer.covariance, self.minimizer.accurate)
        self._calibrated = True

    def load(self, filename_or_dict, tagger_name, style="flavour"):
