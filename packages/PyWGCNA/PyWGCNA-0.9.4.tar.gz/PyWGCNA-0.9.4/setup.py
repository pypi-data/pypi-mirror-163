...
setup(
    ...
    download_url='https://github.com/mortazavilab/PyWGCNA/archive/refs/tags/V0.6.tar.gz',  # link to the tar.gz file associated with this release
