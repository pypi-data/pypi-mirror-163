...
from tdm.datamodel.fact.concept import ACCOUNT, ConceptFact, PLATFORM as PLATFORM_TYPE

PLATFORM = "platform_relation"
...
class RelationFact(AbstractFact[RelationLinkValue]):
    def __init__(self, id_: Optional[str], status: FactStatus, type_id: str, value: RelationLinkValue,
        ...
        if type_id == PLATFORM and (value.from_fact.type_id != ACCOUNT or value.to_fact.type_id != PLATFORM_TYPE):
