...
var Login = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, utils_1.REQUEST)({ url: '/api/login/', method: 'POST', data: data })];
            case 1:
                response = _a.sent();
...
var Submit = function (props, progress) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, (0, state_1.REQUEST)(config)];
            case 1:
                response = _a.sent();
                if (response.ok) {
            ...
            case 1:
                ...
                if (response.ok) {
                    ...
                    if (response.error.code === 404) {
                        set(store_1.Form, ['not-found', app_model]);
                    }
                }
                return [2];
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SubmitProgress = exports.FormErrors = exports.SubmitData = exports.Form = void 0;
var jotai_1 = __webpack_require__(1131);
...
var SubmitProgress = (0, jotai_1.atom)(null);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SubmitProgressAtom = exports.BFSData = void 0;
var jotai_1 = __webpack_require__(1131);
var store_1 = __webpack_require__(7000);
Object.defineProperty(exports, "SubmitProgressAtom", ({ enumerable: true, get: function () { return store_1.SubmitProgress; } }));
...
__exportStar(__webpack_require__(3011), exports);
...
var HandleError = function (error) {
    ...
    if (isAxiosError(error)) {
        if (error.response) {
            response = __assign(__assign({}, response), error.response.data);
        }
        else {
            response.error.message = error.message;
        }
        if (error.code === 'ERR_CANCELED' || error instanceof axios_1.CanceledError) {
            canceled = true;
...
var errors_1 = __webpack_require__(1899);
        ...
        switch (_a.label) {
            case 0:
                ...
                if (config.method === 'POST') {
                    config.headers = __assign(__assign({}, GetCSRFToken()), config.headers);
                }
            ...
            case 1:
                ...
                data = response.data;
                if (data.message)
                    ReactAlert.success(data.message);
                return [2, { ok: true, data: data }];
            case 2:
                error_1 = _a.sent();
                return [2, (0, errors_1.HandleError)(error_1)];
            case 3: return [2];
        }
    });
}); };
...
//# sourceMappingURL=source_maps/state.2f51ae031c3c4faf75d3.js.map