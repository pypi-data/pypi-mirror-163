...
from dashboard_clients import DashboardsClient
...
class E360Context(ClientStore):
    ...
    _dashboard_rest_client: DashboardsClient
    ...
    def get_dashboard_client(
        ...
        match_spec = MatchSpec(
            "E360-Dashboard-Service",
            "Dashboards",
            2,
            0,
            0,
            ["e360_dashboard_service"],
        )
        return self._get_service_client(
            match_spec, DashboardsClient, "_dashboard_rest_client", user_id, **kwargs
        )
    ...
    def create_workspace_container(
        ...
        if isinstance(target_container, ContainerModel):
            target_container = target_container.id
        ws_client = self.get_workspace_container_client()
        new_container = ws_client.create(
            ContainerModel(
    ...
    def upload_document_file(
        ...
        try:
            ...
            logger.error(f"Failed creating a workspace asset: {exc}")
            return None
