...
from ._restclients.designer.models import SubmitPipelineRunRequest, PipelineDraft, \
    ...
    ModuleScope, CloudPrioritySetting, PriorityConfiguration, RunSettingParameterAssignment
...
class Pipeline(Component, Visible, WorkspaceTelemetryMixin, Generic[T]):
    ...
    def submit(self, experiment_name=None, default_compute_target=None, default_datastore=None, description=None,
               ...
               continue_on_failed_optional_input=None) \
            -> Run:
        """
        ...
        pipeline_run_settings = None
        if continue_on_failed_optional_input is not None:
            pipeline_run_settings = [RunSettingParameterAssignment(
                name='Continue run on failed optional input',
                value=continue_on_failed_optional_input)]
