...
function GetOciCommandsToLongParams_optimizer() {
    $ociCommandsToLongParams = @{
        ...
        'optimizer resource-action-summary filter-resource-actions' = 'compartment-id compartment-id-in-subtree filter-query from-json help limit page recommendation-id'
