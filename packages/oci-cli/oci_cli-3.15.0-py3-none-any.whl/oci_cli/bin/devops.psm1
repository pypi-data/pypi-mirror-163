...
function GetOciSubcommands_devops() {
    $ociSubcommands = @{
        ...
        'devops connection' = 'create-bitbucket-cloud-connection create-bitbucket-server-connection create-github-connection create-gitlab-connection create-gitlab-server-connection delete get list update-bitbucket-cloud-connection update-bitbucket-server-connection update-github-connection update-gitlab-connection update-gitlab-server-connection'
        ...
        'devops trigger' = 'create-bitbucket-cloud-trigger create-bitbucket-server-trigger create-devops-code-repo-trigger create-github-trigger create-gitlab-server-trigger create-gitlab-trigger delete get list update-bitbucket-cloud-trigger update-bitbucket-server-trigger update-devops-code-repo-trigger update-github-trigger update-gitlab-server-trigger update-gitlab-trigger'
...
function GetOciCommandsToLongParams_devops() {
    $ociCommandsToLongParams = @{
        ...
        'devops deploy-artifact create-helm-repository-artifact' = 'argument-substitution-mode artifact-chart-url artifact-type artifact-version defined-tags description display-name freeform-tags from-json help max-wait-seconds project-id wait-for-state wait-interval-seconds'
        ...
        'devops deploy-artifact update-helm-repository-artifact' = 'argument-substitution-mode artifact-chart-url artifact-id artifact-version defined-tags deploy-artifact-type description display-name force freeform-tags from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'devops deploy-stage create-oke-helm-chart-stage' = 'defined-tags description display-name freeform-tags from-json helm-chart-artifact-id help max-wait-seconds namespace oke-cluster-environment-id pipeline-id release-name rollback-policy stage-predecessor-collection timeout-in-seconds values-artifact-ids wait-for-state wait-interval-seconds'
        ...
        'devops deploy-stage update-oke-helm-chart-stage' = 'defined-tags description display-name force freeform-tags from-json helm-chart-artifact-id help if-match max-wait-seconds namespace oke-cluster-environment-id release-name rollback-policy stage-id stage-predecessor-collection timeout-in-seconds values-artifact-ids wait-for-state wait-interval-seconds'
        ...
        'devops trigger create-bitbucket-cloud-trigger' = 'actions defined-tags description display-name freeform-tags from-json help max-wait-seconds project-id wait-for-state wait-interval-seconds'
        ...
        'devops trigger update-bitbucket-cloud-trigger' = 'actions defined-tags description display-name force freeform-tags from-json help if-match max-wait-seconds trigger-id wait-for-state wait-interval-seconds'
