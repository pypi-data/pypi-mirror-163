...
class DataV(object):
    def __init__(self, array, Xtable, Ytable, WaterMark=None):
        ...
        self.Ytable = YTable(Ytable, self.Settings)
    ...
    def Monotonic(self, axis: str):
        ...
        return DataV(arr, Xtable=self.Xtable, Ytable=self.Ytable, WaterMark=self.WaterMark)
    ...
    def Mean(self, axis: str):
        ...
        """
        arr          = np.mean(self.Data, axis=axis.Position )

        newTable     = self.Xtable.Remove(axis)

        return DataV(arr, Xtable=newTable, Ytable=self.Ytable, WaterMark=self.WaterMark)
    ...
    def Std(self, axis: str):
        ...
        newTable     = self.Xtable.Remove(axis)
        Array        = DataV(array=arr, Xtable=newTable, Ytable=self.Ytable, WaterMark=self.WaterMark)
    ...
    def Plot(self, x, y, Normalize=False, xScale='linear', yScale='linear', Std=None, Save=None, dpi=300, Directory='', xScaleFactor=None, **kwargs):
