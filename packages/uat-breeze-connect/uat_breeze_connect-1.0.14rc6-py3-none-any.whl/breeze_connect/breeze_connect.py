...
class BreezeConnect():
    ...
    def get_option_chain(self):
        if(self.api_handler):
            return self.api_handler.get_option_chain(stock_code, exchange_code, expiry_date, product_type, right, strike_price)
...
class ApificationBreeze():
    ...
    def get_option_chain(self,stock_code, exchange_code, expiry_date, product_type, right, strike_price):
        try:
            if exchange_code == "" or exchange_code == None or  exchange_code.lower()!="nfo":
                ...
                if((expiry_date=="" or expiry_date==None)  and (strike_price=="" or strike_price==None) and (right=="" or right==None)):
                    ...
                    return response
                elif((right!="" or right!=None) and (right!="call" and right!="put" and right!="others")):
                    response = {"Success": "", "Status": 500, "Error": "Right should be either 'call', 'put', or 'others'."}
                    return response
            body = {
                "stock_code": stock_code,
            ...
            print("get_option_chain() Error -",e)
