...
def liboverride_operation(type: str = 'OVERRIDE_LIBRARY_CREATE_HIERARCHY', selection_set: str = 'SELECTED') -> None:
...
def liboverride_troubleshoot_operation(type: str = 'OVERRIDE_LIBRARY_RESYNC_HIERARCHY', selection_set: str = 'SELECTED') -> None:
