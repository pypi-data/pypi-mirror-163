...
from algora.api.data.query import query_dataset
...
@data_request
def credit(filter: Optional[DataFilter] = None):
    """
...
@data_request
def equity(filter: Optional[DataFilter] = None):
    """
...
@data_request
def forex(filter: Optional[DataFilter] = None):
    """
...
@data_request
def rates(filter: Optional[DataFilter] = None):
    """
