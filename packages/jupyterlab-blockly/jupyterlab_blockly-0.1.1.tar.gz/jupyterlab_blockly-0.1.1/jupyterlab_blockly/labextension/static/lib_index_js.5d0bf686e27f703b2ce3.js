"use strict";
(self["webpackChunkjupyterlab_blockly_extension"] = self["webpackChunkjupyterlab_blockly_extension"] || []).push([["lib_index_js"],{
...
/* harmony import */ var jupyterlab_blockly__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! jupyterlab-blockly */ "webpack/sharing/consume/default/jupyterlab-blockly/jupyterlab-blockly");
/* harmony import */ var jupyterlab_blockly__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(jupyterlab_blockly__WEBPACK_IMPORTED_MODULE_9__);
...
const plugin = {
    ...
    provides: jupyterlab_blockly__WEBPACK_IMPORTED_MODULE_9__.IBlocklyRegistry,
    activate: (app, restorer, rendermime, editorServices, browserFactory, settings, translator, launcher, palette) => {
        ...
        const widgetFactory = new jupyterlab_blockly__WEBPACK_IMPORTED_MODULE_9__.BlocklyEditorFactory({
            name: FACTORY,
            modelName: 'text',
            fileTypes: ['blockly'],
            defaultFor: ['blockly'],
        ...
        widgetFactory.widgetCreated.connect((sender, widget) => {
            ...
            widget.title.icon = _icons__WEBPACK_IMPORTED_MODULE_10__.blockly_icon;
        ...
        commands.addCommand(command, {
            ...
            icon: args => (args['isPalette'] ? null : _icons__WEBPACK_IMPORTED_MODULE_10__.blockly_icon),
            execute: async (args) => {
...
//# sourceMappingURL=lib_index_js.5d0bf686e27f703b2ce3.js.map