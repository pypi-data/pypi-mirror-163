...
class NotificationServicer(object):
    ...
    def delete(self, request, context):
        """
        desc: Deletes a specific Notification. You must specify the `notification_id` of the Notification to delete.
        request_example: >-
        {
    ...
    def delete_all(self, request, context):
        """
        desc: Delete multiple Notifications. You must specify `notifications` of the list of Notifications to delete.
        request_example: >-
        {
        "notifications": [
