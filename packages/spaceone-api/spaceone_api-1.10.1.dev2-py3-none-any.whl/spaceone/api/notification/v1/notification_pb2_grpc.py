...
class NotificationServicer(object):
    ...
    def create(self, request, context):
        """
        desc: Create a new Notification. When a notification is created, it is propagated
        through the channel of the project to which the notification belongs, and if an internal channel or
        user channel is set, the notification is also propagated to the user.
        note: ''
        request_example: >-
        {
    ...
    def push(self, request, context):
        """
        desc: Push a new Notification directly.When a notification is created, it is propagated through the channel of the project to which the notification belongs, and if an internal channel or user channel is set, the notification is also propagated to the user.
        note: ''
        request_example: >-
        {
    ...
    def delete_all(self, request, context):
        """
        desc: Delete all Notifications. `When a notification is created,` `it is propagated through the channel of the project to which the notification belongs,` `and if an internal channel or user channel is set,` `the notification is also propagated to the user.`
        note: ''
        request_example: >-
        {
        "domain_id" : "xxxx-aws-abcd",
    ...
    def set_read(self, request, context):
        ...
        note: When the notification is created, the is_read value is False, and when the set_read method is used, the read state can be changed.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def list(self, request, context):
        ...
        note: Can search information using the query format provided by SpaceONE.
