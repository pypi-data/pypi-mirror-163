...
class Node(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.Node"):
    ...
    def labeled(cls, *label_selector: "NodeLabelQuery") -> LabeledNode:
        ...
        if __debug__:
            ...
            check_type(argname="argument label_selector", value=label_selector, expected_type=typing.Tuple[type_hints["label_selector"], ...])
    ...
    def tainted(cls, *taint_selector: "NodeTaintQuery") -> "TaintedNode":
        ...
        if __debug__:
            ...
            check_type(argname="argument taint_selector", value=taint_selector, expected_type=typing.Tuple[type_hints["taint_selector"], ...])
...
class PodDns(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.PodDns"):
    ...
    def add_nameserver(self, *nameservers: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument nameservers", value=nameservers, expected_type=typing.Tuple[type_hints["nameservers"], ...])
    ...
    def add_option(self, *options: DnsOption) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument options", value=options, expected_type=typing.Tuple[type_hints["options"], ...])
    ...
    def add_search(self, *searches: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument searches", value=searches, expected_type=typing.Tuple[type_hints["searches"], ...])
...
class ResourcePermissions(
    ...
    def grant_read(self, *subjects: ISubject) -> "RoleBinding":
        ...
        if __debug__:
            ...
            check_type(argname="argument subjects", value=subjects, expected_type=typing.Tuple[type_hints["subjects"], ...])
    ...
    def allow(
        ...
        *resources: IApiResource,
        ...
        if __debug__:
            ...
            check_type(argname="argument verbs", value=verbs, expected_type=type_hints["verbs"])
            check_type(argname="argument resources", value=resources, expected_type=typing.Tuple[type_hints["resources"], ...])
...
class Volume(
    ...
    @jsii.member(jsii_name="fromHostPath") # type: ignore[misc]
    @builtins.classmethod
    def from_host_path(
        cls,
        scope: constructs.Construct,
...
class Ingress(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-23.Ingress"):
    ...
    def add_rules(self, *rules: IngressRule) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument rules", value=rules, expected_type=typing.Tuple[type_hints["rules"], ...])
...
class Workload(
    ...
    def select(self, *selectors: LabelSelector) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument selectors", value=selectors, expected_type=typing.Tuple[type_hints["selectors"], ...])
    ...
    def allow(
        ...
        *endpoints: IApiEndpoint,
        ...
        if __debug__:
            ...
            check_type(argname="argument verbs", value=verbs, expected_type=type_hints["verbs"])
            check_type(argname="argument endpoints", value=endpoints, expected_type=typing.Tuple[type_hints["endpoints"], ...])
