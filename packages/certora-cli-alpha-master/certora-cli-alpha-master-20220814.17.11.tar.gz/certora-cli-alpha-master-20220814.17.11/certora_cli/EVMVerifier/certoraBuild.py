...
from Shared.certoraUtils import get_closest_strings, flatten_set_list, IsDebugging
...
class CertoraBuildGenerator:
    ...
    def get_contract_def_node_ref(self, build_arg_contract_file: str, contract_file: str, contract_name: str,
                                  get_contract_def_node_ref_func: typing.Callable[
                                      [Dict[int, Any], str, str], int]) -> int:
        """
        ...
        return get_contract_def_node_ref_func(
            contract_file_ast, contract_file,
            contract_name)
    ...
    def collect_contract_bytes(self, contract_file: str, contract_name: str, build_arg_contract_file: str,
        ...
        ref = self.get_contract_def_node_ref(build_arg_contract_file, contract_file, contract_name,
                                             compiler_collector_for_contract_file.get_contract_def_node_ref)
