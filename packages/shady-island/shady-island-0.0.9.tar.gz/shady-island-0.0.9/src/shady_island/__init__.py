...
class AssignOnLaunchProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AssignOnLaunchProps.__init__)
...
class CidrContextProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CidrContextProps.__init__)
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
...
class EncryptedLogGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EncryptedLogGroupProps.__init__)
...
class Tier(metaclass=jsii.JSIIMeta, jsii_type="shady-island.Tier"):
    ...
    def apply_tags(self, construct: constructs.IConstruct) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Tier.apply_tags)
    ...
    def matches(self, other: "Tier") -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Tier.matches)
...
class Workload(
    ...
    def is_workload(cls, x: typing.Any) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Workload.is_workload)
    ...
    def of(cls, construct: constructs.IConstruct) -> "Workload":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Workload.of)
            check_type(argname="argument construct", value=construct, expected_type=type_hints["construct"])
...
class AssignOnLaunch(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AssignOnLaunch.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class CidrContext(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CidrContext.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def _assign_private_subnet_cidrs(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CidrContext._assign_private_subnet_cidrs)
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
    ...
    def _assign_public_subnet_cidrs(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CidrContext._assign_public_subnet_cidrs)
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
            check_type(argname="argument cidrs", value=cidrs, expected_type=type_hints["cidrs"])
            check_type(argname="argument cidr_block", value=cidr_block, expected_type=type_hints["cidr_block"])
    ...
    def _validate_cidr_count(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CidrContext._validate_cidr_count)
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
            check_type(argname="argument cidr_count", value=cidr_count, expected_type=type_hints["cidr_count"])
...
class EncryptedLogGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EncryptedLogGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
