...
schemes_list = ['light_1', 'light_2',
        'light_3', 'middle_1', 'middle_2', 'middle_3', 'middle_4', 'middle_5',
        'middle_6', 'middle_7', 'middle_8', 'hard_1', 'hard_2', 'hard_3',
        'hard_4', 'hard_5', 'cyto_1', 'cyto_2', 'cyto_3', 'cyto_4', 'cyto_5',
        'cyto_6',
...
categ_cyto = ['has_odyshka_ili_zatrudnennoe_dyhanie','has_oschussh_zalozhen_v_grudnoi_kletke',
              'has_slabost_ili_lomota','Пол','IGG_DEF','IGM_DEF','PCR_N',
              'сахарный диабет', 'ожирение','ишемическая болезнь сердца',
              'has_kashel','kashel_type','NIT','resultat_KT'] + schemes_list
def_categ = {
