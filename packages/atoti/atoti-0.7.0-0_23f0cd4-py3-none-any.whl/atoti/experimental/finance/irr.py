...
def irr(
    *,
    cash_flows: MeasureDescription,
    market_value: MeasureDescription,
    date: Hierarchy,
    ...
    return IrrMeasure(
        _cash_flows_measure=cash_flows,
        _market_value_measure=market_value,
        _date_hierarchy_coordinates=date._coordinates,
