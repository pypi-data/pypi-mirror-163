...
from warden_sdk.utils import logger, capture_internal_exceptions
from warden_sdk.tracing import Transaction
from warden_sdk.attachments import Attachment
  ...
  def apply_to_event(
    ...
    if not is_transaction:
      event.setdefault("breadcrumbs",
                       {}).setdefault("values", []).extend(self._breadcrumbs)
