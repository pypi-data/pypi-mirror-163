...
class Lectio:
    ...
    def getSchedule(self, to_json=False):
    ...
    def getAllHomework(self, to_json=False, print_to_console=True):
        ...
        for i in rows:
            ...
            homework_end_result.append(Homework)
    ...
    def getTodaysSchedule(self, to_json=False):
        ...
        schedule = self.getSchedule(to_json=False)
