...
def do_deploy(
    ...
    flow.storage = Docker(
        registry_url=image_registry_url(gcp_project, gcp_region),
...
def image_registry_url(gcp_project, gcp_region, include_https=False):
    ...
    """
    registry = f"{gcp_region}-docker.pkg.dev/{gcp_project}/prefect-flows/"
