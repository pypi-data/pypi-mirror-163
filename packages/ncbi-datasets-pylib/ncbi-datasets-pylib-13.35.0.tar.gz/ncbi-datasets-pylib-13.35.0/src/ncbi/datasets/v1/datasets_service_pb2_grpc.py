...
class AssemblyDatasetStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAssemblyDatasetDescriptors = channel.unary_unary(
                '/ncbi.datasets.v1.AssemblyDataset/GetAssemblyDatasetDescriptors',
                request_serializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.AssemblyDatasetDescriptorsRequest.SerializeToString,
                response_deserializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.AssemblyDatasetDescriptors.FromString,
                )
        ...
        self.GetOrganismTaxid = channel.unary_unary(
                '/ncbi.datasets.v1.AssemblyDataset/GetOrganismTaxid',
                request_serializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.TaxidRequest.SerializeToString,
                response_deserializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.TaxidReply.FromString,
                )
        self.GetTaxTree = channel.unary_unary(
                '/ncbi.datasets.v1.AssemblyDataset/GetTaxTree',
        ...
        self.GetOrganismsThatMatch = channel.unary_unary(
                '/ncbi.datasets.v1.AssemblyDataset/GetOrganismsThatMatch',
...
def add_AssemblyDatasetServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAssemblyDatasetDescriptors': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.AssemblyDatasetDescriptorsRequest.FromString,
                    response_serializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.AssemblyDatasetDescriptors.SerializeToString,
            ),
            ...
            'GetOrganismTaxid': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.TaxidRequest.FromString,
                    response_serializer=ncbi_dot_datasets_dot_v1_dot_datasets__pb2.TaxidReply.SerializeToString,
            ),
...
class AssemblyDataset(object):
    ...
    def GetAssemblyDatasetDescriptors(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ncbi.datasets.v1.AssemblyDataset/GetAssemblyDatasetDescriptors',
            ncbi_dot_datasets_dot_v1_dot_datasets__pb2.AssemblyDatasetDescriptorsRequest.SerializeToString,
            ncbi_dot_datasets_dot_v1_dot_datasets__pb2.AssemblyDatasetDescriptors.FromString,
    ...
    def GetOrganismTaxid(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ncbi.datasets.v1.AssemblyDataset/GetOrganismTaxid',
            ncbi_dot_datasets_dot_v1_dot_datasets__pb2.TaxidRequest.SerializeToString,
            ncbi_dot_datasets_dot_v1_dot_datasets__pb2.TaxidReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetTaxTree(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ncbi.datasets.v1.AssemblyDataset/GetTaxTree',
    ...
    def GetOrganismsThatMatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ncbi.datasets.v1.AssemblyDataset/GetOrganismsThatMatch',
...
class DatasetDownloadStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Version = channel.unary_unary(
                '/ncbi.datasets.v1.DatasetDownload/Version',
...
class DatasetDownload(object):
    ...
    def Version(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ncbi.datasets.v1.DatasetDownload/Version',
