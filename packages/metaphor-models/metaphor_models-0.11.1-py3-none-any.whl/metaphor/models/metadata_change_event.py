...
class AssetGovernedTags:
    ...
    def from_dict(obj: Any) -> 'AssetGovernedTags':
        ...
        last_modified = from_union([AuditStamp.from_dict, from_none], obj.get("lastModified"))
        latest = from_union([from_bool, from_none], obj.get("latest"))
        return AssetGovernedTags(id, aspect_type, created_at, entity_id, governed_tag_ids, asset_governed_tags_id, last_modified, latest)
...
class PowerBIInfo:
    ...
    def from_dict(obj: Any) -> 'PowerBIInfo':
        ...
        return PowerBIInfo(app, power_bi_dashboard_type, workspace)
...
class DashboardInfo:
    ...
    def from_dict(obj: Any) -> 'DashboardInfo':
        ...
        return DashboardInfo(id, aspect_type, charts, created_at, description, entity_id, dashboard_info_id, latest, power_bi, title, view_count)
...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, asset_contacts, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, dashboard_id, last_modified_at, logical_id, source_info, upstream)
...
class DatasetFieldAssociations:
    ...
    def from_dict(obj: Any) -> 'DatasetFieldAssociations':
        ...
        last_modified = from_union([AuditStamp.from_dict, from_none], obj.get("lastModified"))
        latest = from_union([from_bool, from_none], obj.get("latest"))
        return DatasetFieldAssociations(id, aspect_type, created_at, entity_id, governed_tag_fields, dataset_field_associations_id, last_modified, latest)
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, asset_contacts, asset_governed_tags, dataset_created_at, deleted_at, display_name, documentation, entity_type, field_associations, field_statistics, dataset_id, last_modified_at, logical_id, ownership_assignment, query_history, schema, soda_data_quality, source_info, statistics, tag_assignment, upstream, usage, usage_history)
...
class KnowledgeCard:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCard':
        ...
        return KnowledgeCard(created_at, id, asset_contacts, asset_governed_tags, knowledge_card_created_at, deleted_at, display_name, entity_type, knowledge_card_id, knowledge_card_info, knowledge_card_validation, last_modified_at, logical_id)
...
class Metric:
    ...
    def from_dict(obj: Any) -> 'Metric':
        ...
        return Metric(created_at, id, metric_created_at, dbt_metric, deleted_at, display_name, entity_type, metric_id, last_modified_at, logical_id)
...
class PersonSlackProfile:
    ...
    def from_dict(obj: Any) -> 'PersonSlackProfile':
        ...
        return PersonSlackProfile(id, aspect_type, created_at, deleted, entity_id, person_slack_profile_id, latest, real_name, slack_id, team_id, username)
...
class Person:
    ...
    def from_dict(obj: Any) -> 'Person':
        ...
        return Person(created_at, id, activity, person_created_at, deleted_at, display_name, entity_type, person_id, last_modified_at, logical_id, organization, properties, slack_profile)
...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        workspace = from_union([PowerBIWorkspace.from_dict, from_none], obj.get("workspace"))
        return PowerBIDataset(id, aspect_type, created_at, description, entity_id, power_bi_dataset_id, latest, name, source_datasets, tables, url, workspace)
...
class TableauDatasource:
    ...
    def from_dict(obj: Any) -> 'TableauDatasource':
        ...
        source_virtual_views = from_union([lambda x: from_list(from_str, x), from_none], obj.get("sourceVirtualViews"))
        url = from_union([from_str, from_none], obj.get("url"))
        return TableauDatasource(id, aspect_type, created_at, description, embedded, entity_id, fields, tableau_datasource_id, latest, name, source_datasets, source_virtual_views, url)
...
class ThoughtSpotDataObject:
    ...
    def from_dict(obj: Any) -> 'ThoughtSpotDataObject':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        return ThoughtSpotDataObject(id, aspect_type, columns, created_at, description, entity_id, thought_spot_data_object_id, latest, name, source_datasets, source_virtual_views, tags, type, url)
...
class VirtualView:
    ...
    def from_dict(obj: Any) -> 'VirtualView':
        ...
        return VirtualView(created_at, id, asset_contacts, asset_governed_tags, virtual_view_created_at, dbt_model, deleted_at, display_name, entity_type, virtual_view_id, last_modified_at, logical_id, looker_explore, looker_view, ownership_assignment, power_bi_dataset, tableau_datasource, tag_assignment, thought_spot)
