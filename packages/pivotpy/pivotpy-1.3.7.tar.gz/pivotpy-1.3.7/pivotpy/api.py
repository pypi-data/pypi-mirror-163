...
__all__ = ['download_structure', '__all__', 'parse_text', 'POSCAR', 'LOCPOT', 'CHG', 'ELFCAR', 'PARCHG', 'get_axes',
           'Vasprun']
...
class CHG(LOCPOT):
    ...
    def __init__(self, path = None,e = True,m = False):
        super().__init__(path or 'CHG',e,m)

class ELFCAR(LOCPOT):
    __doc__ = LOCPOT.__doc__.replace('LOCPOT','ELFCAR')
    def __init__(self, path = None,e = True,m = False):
        super().__init__(path or 'ELFCAR',e,m)


class PARCHG(LOCPOT):
    __doc__ = LOCPOT.__doc__.replace('LOCPOT','PARCHG')
    def __init__(self, path = None,e = True,m = False):
        super().__init__(path or 'PARCHG',e,m)
