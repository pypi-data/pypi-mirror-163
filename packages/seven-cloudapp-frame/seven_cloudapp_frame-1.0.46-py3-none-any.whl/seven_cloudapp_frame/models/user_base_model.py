...
@LastEditTime: 2022-07-26 15:19:32
...
class UserBaseModel(FrameBaseModel):
    ...
    def _delete_user_info_cache(self, act_id, id_md5, delay_delete_time=0.01):
        ...
        :last_editors: HuangJianYi
        """
        UserInfoModel(sub_table=self.get_business_sub_table("user_info_tb", {"act_id": act_id, "user_id": 0})).delete_dependency_key(DependencyKey.user_info(act_id, id_md5),delay_delete_time)
    ...
    def save_user_by_openid(self, app_id, act_id, open_id, user_nick, avatar, union_id="",login_ip=""):
        """
        ...
        try:
            ...
            if not user_account:
                ...
                user_account.login_date = now_datetime
                user_account.login_ip = login_ip
                user_account_model.update_entity(user_account, "user_nick,user_nick_encrypt,avatar,union_id,login_date,login_ip")
