...
class QuoteClass:
    ...
    def calculate_price(
        ...
        for target_lang in target_langs:
            ...
            threshold = pricebook.get(str(target_lang), pricebook['default'])['threshold']
            word_price = pricebook.get(str(target_lang), pricebook['default'])['price']
            duration = pricebook.get(str(target_lang), pricebook['default'])['duration']
