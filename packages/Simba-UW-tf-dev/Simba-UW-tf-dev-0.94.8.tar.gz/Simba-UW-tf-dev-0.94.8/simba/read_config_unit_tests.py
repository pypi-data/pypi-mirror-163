...
def read_config_entry(config=None, section=None, option=None, data_type=None, default_value=None, options=None):
    try:
        if config.has_option(section, option):
            ...
            print('VALUE ERROR: SimBA could not find an entry for option {} under section {} in the project_config.ini. Please specify the settings in the settings menu.'.format(section, option))
            raise ValueError
    except ValueError:
        print(('VALUE ERROR: SimBA could not find an entry for option {} under section {} in the project_config.ini. Please specify the settings in the settings menu.'.format(section, option)))
        raise ValueError
