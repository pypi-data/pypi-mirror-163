...
class ROIPlot(object):
    def __init__(
        ...
        if len(list(set(self.video_shapes))) != len(self.video_shapes):
            print('ERROR: Some SIMBA ROI shapes have identical names. Please use unique names to visualize ROI data.')
...
# test = ROIPlot(ini_path=r'/Users/simon/Desktop/train_model_project/project_folder/project_config.ini', video_path=r"Together_1.avi")
# test.insert_data()
# test.visualize_ROI_data()
