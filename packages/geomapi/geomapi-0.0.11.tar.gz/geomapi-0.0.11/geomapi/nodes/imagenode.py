...
class ImageNode(Node):
    ...
    def __init__(self,  graph : Graph = None, 
        ...
        Args: \n
            ...
            3.resource (ndarray, PIL Image) : OpenCV, PIL (Note that this node will also contain the data)\n
...
#---------------------METHODS----------------------------
    ...
    def set_resource(self,value):
        ...
        Raises:
            ValueError: Resource must be np.ndarray (OpenCV), PIL Image, XMP file(str) or XML file .
        """
