...
class ConstructOptions:
    def __init__(self, *, node_factory: typing.Optional["INodeFactory"] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ConstructOptions.__init__)
...
class _INodeFactoryProxy:
    ...
    def create_node(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(INodeFactory.create_node)
...
class Node(metaclass=jsii.JSIIMeta, jsii_type="constructs.Node"):
    ...
    def add_error(self, message: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.add_error)
    ...
    def add_info(self, message: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.add_info)
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def add_warning(self, message: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.add_warning)
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
    ...
    def apply_aspect(self, aspect: IAspect) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.apply_aspect)
