...
class Dependable(metaclass=jsii.JSIIAbstractClass, jsii_type="constructs.Dependable"):
    ...
    def get(cls, instance: "IDependable") -> "Dependable":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Dependable.get)
    ...
    def implement(cls, instance: "IDependable", trait: "Dependable") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Dependable.implement)
            check_type(argname="argument instance", value=instance, expected_type=type_hints["instance"])
    ...
    def of(cls, instance: "IDependable") -> "Dependable":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Dependable.of)
            check_type(argname="argument instance", value=instance, expected_type=type_hints["instance"])
...
class MetadataOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MetadataOptions.__init__)
...
class Node(metaclass=jsii.JSIIMeta, jsii_type="constructs.Node"):
    ...
    def of(cls, construct: "IConstruct") -> "Node":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.of)
    ...
    def add_dependency(self, *deps: IDependable) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.add_dependency)
            check_type(argname="argument deps", value=deps, expected_type=typing.Tuple[type_hints["deps"], ...])
    ...
    def add_metadata(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.add_metadata)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument data", value=data, expected_type=type_hints["data"])
    ...
    def add_validation(self, validation: IValidation) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.add_validation)
    ...
    def find_all(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.find_all)
    ...
    def find_child(self, id: builtins.str) -> "IConstruct":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.find_child)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def set_context(self, key: builtins.str, value: typing.Any) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.set_context)
    ...
    def try_find_child(self, id: builtins.str) -> typing.Optional["IConstruct"]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.try_find_child)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def try_get_context(self, key: builtins.str) -> typing.Any:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.try_get_context)
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
    ...
    def try_remove_child(self, child_name: builtins.str) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Node.try_remove_child)
    ...
    def default_child(self, value: typing.Optional["IConstruct"]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(Node, "default_child").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DependencyGroup(metaclass=jsii.JSIIMeta, jsii_type="constructs.DependencyGroup"):
    ...
    def __init__(self, *deps: IDependable) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DependencyGroup.__init__)
            check_type(argname="argument deps", value=deps, expected_type=typing.Tuple[type_hints["deps"], ...])
    ...
    def add(self, *scopes: IDependable) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DependencyGroup.add)
            check_type(argname="argument scopes", value=scopes, expected_type=typing.Tuple[type_hints["scopes"], ...])
