...
def create_payment_data_for_sdk(price:int,
    ...
    payment_data['bin'] = card_data['bin'] if 'bin' in card_data else None,

    # Payer ###############################################

    payment_data['payer'] = {
        'first_name':client['nombre'],
        'first_name':client['apellido'],
        'email':client['email']}
    if processor == 'decidir':
        payment_data['payer']['id'] = client['decidir_id']
    elif processor == 'mercadopago':
        payment_data['payer']['id'] = client['mercadopago_id']
    ...
    payment_data['external_reference'] = str(boleta['_id'])
