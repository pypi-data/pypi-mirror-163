...
class Book():
    def __init__(self, network_address: str):
        ...
        self.BOOK_ABI = open("contracts/book.abi", "r").read()
        self.BOOK_BYTECODE = open("contracts/book.bin", "r").read()
...
class Library():
    def __init__(self, network_address: str):
        self.web3 = Web3(Web3.HTTPProvider(network_address))
        self.LIBRARY_ABI = open("contracts/library.abi", "r").read()
        self.LIBRARY_BYTECODE = open("contracts/library.bin", "r").read()
...
class BookIPFS():
    def __init__(self, network_address: str):
        self.web3 = Web3(Web3.HTTPProvider(network_address))
        self.BOOKIPFS_ABI = open("contracts/book_ipfs.abi", "r").read()
        self.BOOKIPFS_BYTECODE = open("contracts/book_ipfs.bin", "r").read()
