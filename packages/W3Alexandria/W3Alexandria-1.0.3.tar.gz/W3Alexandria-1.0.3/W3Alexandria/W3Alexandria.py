...
class Book():
    def __init__(self, network_address: str):
        ...
        self.BOOK_ABI = open("W3Alexandria/book.abi", "r").read()
        self.BOOK_BYTECODE = open("W3Alexandria/book.bin", "r").read()
...
class Library():
    def __init__(self, network_address: str):
        self.web3 = Web3(Web3.HTTPProvider(network_address))
        self.LIBRARY_ABI = open("W3Alexandria/library.abi", "r").read()
        self.LIBRARY_BYTECODE = open("W3Alexandria/library.bin", "r").read()
...
class BookIPFS():
    def __init__(self, network_address: str):
        self.web3 = Web3(Web3.HTTPProvider(network_address))
        self.BOOKIPFS_ABI = open("W3Alexandria/book_ipfs.abi", "r").read()
        self.BOOKIPFS_BYTECODE = open("W3Alexandria/book_ipfs.bin", "r").read()
