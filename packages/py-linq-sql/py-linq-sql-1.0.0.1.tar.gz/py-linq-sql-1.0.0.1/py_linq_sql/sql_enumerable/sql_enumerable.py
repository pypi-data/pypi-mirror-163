...
from ..utils.classes.other_classes import Command, Flags, SQLEnumerableData, equality
...
class SQLEnumerable:
    ...
    def _check_select(
        ...
        self_fquery = self_select.args.fquery  # type: ignore
        sqle_fquery = sqle_select.args.fquery  # type: ignore
    ...
    def _check_legality_terminal_alter(self, cmd: CT) -> None:
        """
    ...
    def _check_legality(self, cmd: CT) -> None:
        """
    ...
    def delete(
        ...
        *,
        ...
        Args:
            ...
            armagedon: True if you want to delete ALL your table, by default is False.

        Returns:
            Self.

        Raises:
            DeleteError: If we have an fquery and armagedon.
        ...
        self.cmd.append(Command(CT.DELETE, DotMap(armagedon=armagedon)))
    ...
    def insert(
        self,
        column: List[str] | str,
        data: Dict[str, Any] | List[Dict[str, Any]] | Tuple | List[Tuple],
    ) -> SQLEnumerable:
        """
    ...
    def contains(
        ...
        - Rawdata: Entier line of a table to know if the table contains this line.
    ...
    def all(self, fquery: Callable[[MagicDotPath], MagicDotPath]) -> SQLEnumerable:
        ...
        Args:
            fquery: Lambda function to give the predicat.
    ...
    def any(
        ...
        Args:
            fquery: Lambda function to give the predicat. Its optional.
    ...
    def except_(self, exclude: SQLEnumerable) -> SQLEnumerable:
        ...
        Args:
            exclude: SQLEnumerable to give the exclude predicat.
    ...
    def where(self, fquery: LambdaMagicDotPath) -> SQLEnumerable:
        ...
        Args:
            fquery: Lambda function the get the path of the predicat.
    ...
    def execute(self) -> Enumerable | int | tuple | bool:
        ...
        if not cmd_to_execute:
            match (
                ...
                case (True, _, _):  # noqa: E211
                    return None
                case (False, Terminal.ELEMENT_AT, _):  # noqa: E211
                    raise IndexError() from ReturnEmptyEnumerable
                case (_, _, True):  # noqa: E211
