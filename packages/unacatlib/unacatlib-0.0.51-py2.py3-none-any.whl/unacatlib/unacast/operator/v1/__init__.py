...
# sources: unacast/operator/v1/address_component_operator_service.proto, unacast/operator/v1/map_operator_service.proto, unacast/operator/v1/index_job.proto, unacast/operator/v1/metric_operator_service.proto, unacast/operator/v1/index_job_operator_service.proto, unacast/operator/v1/dimension_operator_service.proto, unacast/operator/v1/catalog_operator_service.proto
...
class AddressComponentOperatorServiceStub(betterproto.ServiceStub):
    """
    * This is the service used for operators to administrate the Address
    Components in Unacat
    """
...
class MetricOperatorServiceStub(betterproto.ServiceStub):
    ...
    * This is the service used for operators to administrate the Address
    ...
    async def get_metric(self, *, metric_id: str = "") -> "GetMetricResponse":
    ...
    async def update_metric_group(
        ...
        *,
        ...
        request.metric_id = metric_id
        request.key = key
        request.key_display_name = key_display_name
