...
def StringProperty(name: str = '', description: str = '', default: str = '', maxlen: int = 0, options: typing.Set[typing.Any] = {'ANIMATABLE'}, override: typing.Set[typing.Any] = set(), tags: typing.Set[typing.Any] = set(), subtype: str = 'NONE', update: typing.Callable = None, get: typing.Callable = None, set: typing.Callable = None, search: typing.Callable = None, search_options: typing.Set[typing.Any] = {'SUGGESTION'}) -> None:
