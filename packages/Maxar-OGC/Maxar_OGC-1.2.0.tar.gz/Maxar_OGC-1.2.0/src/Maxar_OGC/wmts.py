...
class WMTS:
    ...
    def wmts_convert(self, zoom_level, laty, longx):
        """
    ...
    def wmts_bbox_get_tile_list(self, zoom_level, bbox, **kwargs):
        ...
        min_tilerow, min_tilecol = self.wmts_convert(zoom_level, miny, minx)
        max_tilerow, max_tilecol = self.wmts_convert(zoom_level, maxy, maxx)
