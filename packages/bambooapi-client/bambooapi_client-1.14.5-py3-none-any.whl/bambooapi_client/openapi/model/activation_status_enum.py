...
class ActivationStatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["scheduled", "cancelled", "active", "success", "stopped", "failed", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["scheduled", "cancelled", "active", "success", "stopped", "failed", ]  # noqa: E501
