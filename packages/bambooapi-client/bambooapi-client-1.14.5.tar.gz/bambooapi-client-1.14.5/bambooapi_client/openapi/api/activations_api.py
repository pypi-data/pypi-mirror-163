...
class ActivationsApi(object):
    ...
    def update_activation(
        ...
        **kwargs
        ...
        Update an Activation with the following information:  - **activation_id**: ID of the activation - **end_time** (optional): end of the activation - **status** (optional): end of the activation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
