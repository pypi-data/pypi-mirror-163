...
class SiteWithIsLoadDistinct(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_name, flexumer_id, microgrid, site_id, is_load_distinct, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_name, flexumer_id, microgrid, site_id, is_load_distinct, *args, **kwargs):  # noqa: E501
        """SiteWithIsLoadDistinct - a model defined in OpenAPI
