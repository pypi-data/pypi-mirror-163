...
class Activation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, site_id, device_name, start_time, field, value, status, created, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, site_id, device_name, start_time, field, value, status, created, *args, **kwargs):  # noqa: E501
        """Activation - a model defined in OpenAPI
