...
class SitesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.post_insert_device_measurements_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'BearerAuth'
                ...
                'operation_id': 'post_insert_device_measurements',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.post_insert_site_measurements_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'post_insert_site_measurements',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.put_insert_device_measurements_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'BearerAuth'
                ...
                'endpoint_path': '/sites/{site_id}/devices/{device_name}/measurements',
                'operation_id': 'put_insert_device_measurements',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.put_insert_site_measurements_endpoint = _Endpoint(
            settings={
                'response_type': ([SiteMeasurements],),
                'auth': [
                    'BearerAuth'
                ...
                'endpoint_path': '/sites/{site_id}/measurements',
                'operation_id': 'put_insert_site_measurements',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def get_site_flexibility_forecast(
        ...
        **kwargs
        ...
        Keyword Args:
            horizon (bool, date, datetime, dict, float, int, list, str, none_type): The option `best_available` shows the best forecast that is available for each timestamp, favoring intra-day over day-ahead.. [optional]
    ...
    def post_insert_device_measurements(
        self,
        site_id,
        device_name,
        site_data_point,
        **kwargs
        ...
        >>> thread = api.post_insert_device_measurements(site_id, device_name, site_data_point, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_data_point'] = \
            site_data_point
        return self.post_insert_device_measurements_endpoint.call_with_http_info(**kwargs)

    def post_insert_site_measurements(
        self,
        site_id,
        site_measurements,
        **kwargs
    ):
        """Insert/update measurements for site devices  # noqa: E501

        Insert/update measurements for selected site.  - **Timestamps don't need to be pushed in any particular order** - **Data points will be stored exactly as pushed** (no transformation applied)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_insert_site_measurements(site_id, site_measurements, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_measurements'] = \
            site_measurements
        return self.post_insert_site_measurements_endpoint.call_with_http_info(**kwargs)

    def put_insert_device_measurements(
        self,
        site_id,
        device_name,
        site_data_point,
        **kwargs
        ...
        >>> thread = api.put_insert_device_measurements(site_id, device_name, site_data_point, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_data_point'] = \
            site_data_point
        return self.put_insert_device_measurements_endpoint.call_with_http_info(**kwargs)

    def put_insert_site_measurements(
        self,
        site_id,
        site_measurements,
        **kwargs
        ...
        >>> thread = api.put_insert_site_measurements(site_id, site_measurements, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_measurements'] = \
            site_measurements
        return self.put_insert_site_measurements_endpoint.call_with_http_info(**kwargs)
    ...
    def read_site_activations(
        ...
        **kwargs
        ...
        List scheduled and active activations of a site at a specific time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Args:
            site_id (int):
            time (datetime): A timestamp in RFC3339 format, in UTC timezone (\"YYYY-MM-DDT00:00:00Z\"). Make sure to specify the timezone either with \"Z\" or \"+00:00\"
