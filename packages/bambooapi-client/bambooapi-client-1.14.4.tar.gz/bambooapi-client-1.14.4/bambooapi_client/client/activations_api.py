...
class ActivationsApi(object):
    ...
    def create_activation(self, activation: ActivationCreate) -> Activation:
        """Createa new activation."""
        return self._api_instance.create_activation(activation)

    def get_activation(self, activation_id: int) -> Optional[Activation]:
    ...
    def update_activation(
        ...
        """Update activation."""
        return self._api_instance.update_activation(activation_id, activation)
