...
class FundamentalApi(object):
    ...
    def get_history_instruments(self, symbols, fields=None, start_date=None, end_date=None):
        ...
        for info in result:
            ...
            if inner_info is not None:
                for field, value in six.iteritems(inner_info):
                    ...
                    elif field in ["multiplier", "exercise_price", "conversion_price", "margin_ratio"]:
                        continue
        ...
        _fields = input_fields.split(",") if input_fields else ""
        if _fields:
            return [{k: v for k, v in r.items() if k in _fields} for r in result]
        return result
    ...
    def bond_convertible_get_call_info(self, symbols=None, start_date=None, end_date=None):
        ...
        req = GetConvertibleBondCallInfoReq(symbols=symbols, start_date=start_date, end_date=end_date)
