...
class Dataset(DataFrame):
    ...
    associated with either a :class:`tecton.interactive.FeatureService` or :class:`FeatureView`.
    ...
    Logged Datasets are generated automatically when declaring a :class:`tecton.interactive.FeatureService` with :class:`tecton.LoggingConfig`,
    ...
    def __init__(self, proto, spark_df, pandas_df):
        super().__init__(spark_df, pandas_df, None)
        self._proto = proto
