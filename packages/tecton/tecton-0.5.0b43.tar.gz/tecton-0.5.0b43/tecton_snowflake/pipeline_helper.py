...
class _PipelineBuilder:
    ...
    def _get_ds_sql_str(self, ds: VirtualDataSource, time_window: Optional[pendulum.Period]) -> str:
        ...
        snowflake_ds_name = f"{snowflake_args.database}_{snowflake_args.schema}_{snowflake_args.table}"
        cte_name = f"{TEMP_DS_PREFIX}_{hashlib.sha256(snowflake_ds_name.encode('utf-8')).hexdigest()}"
