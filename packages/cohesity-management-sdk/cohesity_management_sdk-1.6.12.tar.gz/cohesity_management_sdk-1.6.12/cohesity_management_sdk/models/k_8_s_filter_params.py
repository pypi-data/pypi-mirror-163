...
class PVCData(object):
    ...
    Attributes:
        entity_vec (list of Entity): List of entities included in filter. This
            ...
            intersection of labels specified by 'label_vec_vec'.
            This will be populated during backup run.
        label_vec_vec (list of K8SFilterParams_LabelVec): Array of Arrays of Label Ids that Specify Persistent Volumes (PV) and
        ...
        object_id_vec (list of long|int): IDs of objects to be included in filter.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('labelVecVec') != None:
            label_vec_vec = list()
            for structue in dictionary.get('labelVecVec'):
                label_vec_vec.append(cohesity_management_sdk.models.k_8_s_filter_params_label_vec.K8SFilterParams_LabelVec.from_dictionary(structue))
        object_id_vec = dictionary.get('objectIdVec')

        # Return an object of this model
        return cls(entity_vec,
                   label_vec_vec,
                   object_id_vec)
