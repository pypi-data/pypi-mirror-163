...
from humanloop.shared.settings import get_humanloop_settings
...
def init(api_key: Optional[str] = None, base_url: Optional[str] = None) -> None:
    ...
    console.print(f"Connecting to API at {base_url} with key {api_key}")
