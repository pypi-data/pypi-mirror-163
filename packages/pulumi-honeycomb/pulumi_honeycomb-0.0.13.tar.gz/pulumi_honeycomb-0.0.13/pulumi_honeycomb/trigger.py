...
class Trigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_get_query_specification = honeycomb.get_query_specification(calculations=[honeycomb.GetQuerySpecificationCalculationArgs(
                op="AVG",
                column="duration_ms",
            )],
        ...
        example_trigger = honeycomb.Trigger("exampleTrigger",
            ...
            recipients=[honeycomb.TriggerRecipientArgs(
                id=pd_prod.id,
                notification_details=honeycomb.TriggerRecipientNotificationDetailsArgs(
