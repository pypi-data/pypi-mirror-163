...
class StackInstances(
    ...
    @jsii.member(jsii_name="fromArtifactPath") # type: ignore[misc]
    @builtins.classmethod
    ...
    @jsii.member(jsii_name="inAccounts") # type: ignore[misc]
    @builtins.classmethod
    def in_accounts(
        cls,
    ...
    @jsii.member(jsii_name="inOrganizationalUnits") # type: ignore[misc]
    @builtins.classmethod
...
class StackSetDeploymentModel(
    ...
    @jsii.member(jsii_name="organizations") # type: ignore[misc]
    @builtins.classmethod
    def organizations(
        cls,
        *,
    ...
    @jsii.member(jsii_name="selfManaged") # type: ignore[misc]
    @builtins.classmethod
    def self_managed(
        cls,
        *,
...
class StackSetParameters(
    ...
    @jsii.member(jsii_name="fromLiteral") # type: ignore[misc]
    @builtins.classmethod
    def from_literal(
        cls,
