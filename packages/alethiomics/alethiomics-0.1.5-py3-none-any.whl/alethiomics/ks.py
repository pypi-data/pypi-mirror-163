...
def calc_ks_stats(adata, group_column, group_mutant, group_normal, gene_list = [], layer = None):
...
if __name__ == '__main__':
    ...
    table = calc_ks_stats(adata, 'cell_type', 'Monocyte', 'B', gene_list = gene_list, layer = 'log_transformed')
    print(table)