...
class CommandTreatmentWidget(qt.QWidget):
    ...
    def __init__(self, parent, module=None, decorator='@nxlib.treatment_function'):
        ...
        if module is not None:
            self.commandList = moduledescription.get_commandList(module, decorator=decorator)
        else:
            self.commandList = []
        ...
        if roisList:
            if isinstance(roisList[0], RectangleROI):
                ...
                for image in self.getAllImages():
                    ...
                    roiCenter = CrossROI()
                    # roiCenter.setSelectable(True)
                    # roiCenter.setEditable(True)
...
class FunctionListWidget(qt.QWidget):
    ...
    def __init__(self, parent=None, module=None, decorator='@nxlib.treatment_function'):
        ...
        if module is not None:
            self.module = module
            self.comboBox.addItems(moduledescription.get_functionList(module, decorator=decorator))
    ...
    def get_commandLine(self):
        if self.function_description is None:
            return
