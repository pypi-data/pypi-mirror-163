...
extras_require = \
{'docker': ['filelock'],
 'docker:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'docker:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'mongo': ['pymongo', 'filelock'],
 'mongo:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'mongo:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'mysql': ['pymysql>=1.0', 'filelock'],
 'mysql:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'mysql:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'postgres': ['psycopg2', 'filelock'],
 'postgres-async': ['asyncpg', 'filelock'],
 'postgres-async:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'postgres-async:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'postgres-binary': ['psycopg2-binary', 'filelock'],
 'postgres-binary:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'postgres-binary:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'postgres:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'postgres:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'redis': ['redis', 'filelock'],
 'redis:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'redis:python_version >= "3.7"': ['python-on-whales>=0.22.0'],
 'redshift': ['moto', 'boto3', 'sqlparse', 'filelock'],
 'redshift:python_version < "3.7"': ['python-on-whales<0.22.0'],
 'redshift:python_version >= "3.7"': ['python-on-whales>=0.22.0']}
