...
urlpatterns = [
    ...
    re_path(r'^basic_list/?$', user_list.UserListAPIView.as_view(), ),  # 用户列表
    re_path(r'^basic_info/?$', user_info.UserInfo.as_view(), ),

    re_path(r'^password/?$', user_password.UserPassword.as_view(), ),
    re_path(r'^contact_book/?$', user_contact_book.UserContactBook.as_view(), ),

    # 详细信息查询/新增/修改
    re_path(r'^detail_list/?$', user_detail_info.getInfoList.as_view(), ),
    re_path(r'^detail_info/?$', user_detail_info.getInfo.as_view(), ),
    re_path(r'^detail_create/?$', user_detail_info.createInfo.as_view(), ),
    re_path(r'^detail_edit/?$', user_detail_info.editInfo.as_view(), ),
