...
set_target_properties(proxsuite::proxsuite_pywrap PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/proxsuite/proxsuite_pywrap.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _cmake_import_check_targets proxsuite::proxsuite_pywrap )
list(APPEND _cmake_import_check_files_for_proxsuite::proxsuite_pywrap "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/proxsuite/proxsuite_pywrap.so" )
...
set_target_properties(proxsuite::proxsuite_pywrap_avx2 PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/proxsuite/proxsuite_pywrap_avx2.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _cmake_import_check_targets proxsuite::proxsuite_pywrap_avx2 )
list(APPEND _cmake_import_check_files_for_proxsuite::proxsuite_pywrap_avx2 "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/proxsuite/proxsuite_pywrap_avx2.so" )
...
set_target_properties(proxsuite::proxsuite_pywrap_avx512 PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/proxsuite/proxsuite_pywrap_avx512.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _cmake_import_check_targets proxsuite::proxsuite_pywrap_avx512 )
list(APPEND _cmake_import_check_files_for_proxsuite::proxsuite_pywrap_avx512 "${PACKAGE_PREFIX_DIR}/lib/python3.9/site-packages/proxsuite/proxsuite_pywrap_avx512.so" )
