...
from gias3.fieldwork.field.topology import element_types
...
# quartic line
def quartic_line():
    F = EFF.EnsembleFieldFunction('line', 1, debug=0)
    ...
    V.GFD = [50, 50]
    V.addGeometricField('line', G, lineEval, render_args={'tube_radius': 0.3})
...
def quartic_quad():
    ...
    V.drawElementBoundaries('quad', [50, ],
                            ...
                            render_args={'color': (0.6, 0.6, 0.6), 'tube_radius': 0.25, 'tube_sides': 12})
...
def quartic_quad_4_elements():
    ...
    V.addData('analytic', analyticData, render_args={'mode': 'point', 'color': (0, 0, 1)})
