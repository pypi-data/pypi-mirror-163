...
def main():
    ...
    if has_mayavi:
        v = fieldvi.FieldVi()
        v.addData('target points', target_points, render_args={'mode': 'point', 'color': (1, 0, 0)})
        v.addData('source points fitting', source_points_fitting, render_args={'mode': 'point'})
        v.addData('source points passive', source_points_passive, render_args={'mode': 'point'})
        v.addData('source points fitting reg1', source_points_fitting_reg1, render_args={'mode': 'point'})
        v.addData('source points fitting reg2', source_points_fitting_reg2, render_args={'mode': 'point'})
        v.addData('source points passive reg2', source_points_passive_reg2, render_args={'mode': 'point'})
        v.addData('source points fitting hmf', source_points_fitting_hmf, render_args={'mode': 'point'})
        v.addData('source points passive hmf', source_points_passive_hmf, render_args={'mode': 'point'})
