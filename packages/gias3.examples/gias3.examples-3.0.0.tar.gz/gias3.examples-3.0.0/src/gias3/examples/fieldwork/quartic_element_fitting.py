...
def main():
    ...
    fitG, pOpt, fitRMS = fitting_tools.fitSurfacePerItSearch(
        ...
        fixed_nodes=boundaryNodes, sample_elems=None,
        xtol=1e-4, it_max=5, it_max_per_it=2,
        data_weights=None, n_closest_points=1,
        tree_args={}, fit_verbose=True
    )
    ...
    if has_mayavi:
        ...
        V.addData('fitData', fitData, render_args={'mode': 'point', 'color': (0, 0, 1)})
