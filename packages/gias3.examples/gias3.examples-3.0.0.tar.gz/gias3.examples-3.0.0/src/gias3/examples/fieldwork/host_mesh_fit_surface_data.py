...
def main():
    ...
    if has_mayavi:
        ...
        v.addData('source points', source_points, render_args={'mode': 'point'})
        v.addData('source points reg1', source_points_reg1, render_args={'mode': 'point'})
        v.addData('source points reg2', source_points_reg2, render_args={'mode': 'point'})
        v.addData('source points reg2 hmf', source_points_reg2_hmf, render_args={'mode': 'point'})
        v.configure_traits()
