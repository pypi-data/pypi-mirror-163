...
setup(
    ...
    name="matos-gcp-provider",  # Required
    ...
    description="Python matos gcp provider",  # Optional
    ...
    install_requires=["protobuf==3.20.1", "google-api-core==2.3.2", "google-api-python-client==2.33.0", "google-auth==2.3.3",
                      ...
                      "google-resumable-media==2.1.0", "googleapis-common-protos", "grpc-google-iam-v1==0.12.3",
                      "grpcio==1.43.0"],  # Optional
