...
class ContractModel(BaseModel):
    ...
    note: str = Field(None, title="备注", max_length=1024)
    ...
    authorized_note: str = Field(None, title="授权备注", max_length=1024)
    ...
    update_note: str = Field(None, title="修改备注", max_length=1024)
