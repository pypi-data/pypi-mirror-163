...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  autoStart: true,
  requires: [IThemeManager, ICodeMirror],
  activate: (
    app: JupyterFrontEnd,
    ...
    registerFREDWithCodeMirror(codeMirror.CodeMirror);

    const logo = document.querySelector('#jp-MainLogo');
    if (logo) {
      logo.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="320" height="320" viewBox="0 0 320 320">
          <desc>Epistemix Icon</desc>
          <path d="M33.3 0h253.4c11.6 0 15.8 1.2 20 3.5 4.2 2.2 7.6 5.6 9.8 9.8 2.3 4.2 3.5 8.4 3.5 20v253.4c0 11.6-1.2 15.8-3.5 20a23.6 23.6 0 0 1-9.8 9.8c-4.2 2.3-8.4 3.5-20 3.5H33.3c-11.6 0-15.8-1.2-20-3.5a23.6 23.6 0 0 1-9.8-9.8c-2.3-4.2-3.5-8.4-3.5-20V33.3c0-11.6 1.2-15.8 3.5-20C5.7 9.1 9 5.7 13.3 3.5c4.2-2.3 8.4-3.5 20-3.5Z" fill="#6383F3"/>
