...
def n_login(driver: WebDriver, nid: str, pwd: str, keep_login: bool=False, ip_safe: bool=False, force: bool=False):
    """
    ...
    if ip_safe:
        if driver.find_element(By.CSS_SELECTOR, 'input#switch').get_attribute('value').lower() == 'off':
            driver.execute_script('arguments[0].click();', driver.find_element(By.CSS_SELECTOR, 'input#switch'))
    else:
        if driver.find_element(By.CSS_SELECTOR, 'input#switch').get_attribute('value').lower() == 'on':
            driver.execute_script('arguments[0].click();', driver.find_element(By.CSS_SELECTOR, 'input#switch'))
