...
class api:
    ...
    def reader_mark_multiple_series(self, operation: str, series_list: List[int]):
        """
    ...
    def reader_mark_multiple_series_read(self, series_list: List[int]):
        """
    ...
    def reader_mark_multiple_series_unread(self, series_list: List[int]):
        """
    ...
    def reader_progress(self, series: int, volume: int,
                        chapter: int, page: int, bookscroll: Optional[str] =None):
        """
        ...
        http_data: Optional[Dict[str,int|str]] = {"volumeId": volume,
                                        "chapterId": chapter,
                                        "pageNum": page,
                                        "seriesId": series,
