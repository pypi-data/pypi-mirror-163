...
from sdk.api.errors import RouteNotValidError, AuthenticationError

USER_AGENT = "vgs-api-client/0.0.1-dev202208120452/python"
        ...
        try:
            if self.auth_token is not None:
                if not auth_api.validate_access_token(self.auth_token):
                    auth_api.refresh_token(self.auth_api, refresh_token=self.auth_token)
