...
from mcli.utils.utils_logging import FAIL, err_console, get_indented_block
...
class RunEpilog:
    ...
    def __init__(self, name: str, namespace: str):
        ...
        self.pod_names = wait_for_job_pods(name, namespace)
