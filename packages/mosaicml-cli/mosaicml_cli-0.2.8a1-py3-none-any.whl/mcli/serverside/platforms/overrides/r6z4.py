...
R6Z4_INSTANCES = LocalPlatformInstances(available_instances={GPUType.NONE: [0]}, gpu_configurations=[a100_config])


class R6Z4Platform(GenericK8sPlatform):
    """ R6Z4 Platform Overrides """

    allowed_instances: PlatformInstances = R6Z4_INSTANCES
