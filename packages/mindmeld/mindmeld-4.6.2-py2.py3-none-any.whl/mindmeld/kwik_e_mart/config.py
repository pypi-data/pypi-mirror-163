...
ENTITY_RECOGNIZER_CONFIG = {
    ...
    "label_type": "entities",
    "model_settings": {
        "classifier_type": "torch-crf",
        "tag_scheme": "IOB",
        "feature_scaler": "max-abs",
    },
    'params': {"feat_type": "hash", "feat_num": 50000, "stratify_train_val_split": True, "drop_input": 0.2,
               "batch_size": 10, "patience": 5, "dev_split_ratio": 0.3, "optimizer": "adam"},
    # "param_selection": {
    #     "type": "k-fold",
    #     "k": 5,
    #     "scoring": "accuracy",
