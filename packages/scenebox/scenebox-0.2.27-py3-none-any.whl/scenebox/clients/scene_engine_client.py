...
from ..custom_exceptions import (AssetError, IndexingException,
                                 ...
                                 SetsError, ThumbnailNotAvailableError, SimilaritySearchError, SessionError)
...
class SceneEngineClient(object):
    ...
    def get_performance_metrics(self,
        ...
        """Gets the performance metrics including precision, recall, and f1 score
         for a given search on annotations comparisons asset space and iou threshold.
        ...
        assert comparison_task_id in comparison_task_ids, \
            "comparison_task_id ::: {} doesn't exist. Following ids exist; {} ".format(comparison_task_id, comparison_task_ids)
    ...
    def get_performance_metrics_per_dimension(
        ...
        """Gets the performance metrics including precision, recall, and f1 score per
        ...
        Dict
             ...
             The ID of the job that calculated the performances, and the performances.
             Example:
             {
                "job_id": "some_job_id",
                "performances": {
    ...
    def add_scalar_measurements(self,
        ...
        for chunk in chunked_entities:
            self.add_entities(entity_dicts=chunk)
        return entity_ids
