...
from typing import Callable, Dict, Iterable, Optional, List, Union
...
def split_list(input_list: list,
    ...
    if isinstance(percentages_or_sections, int):
        ...
        if sections > total_assets:
            raise ValueError("Cannot split list into more than {} subsets".format(total_assets))
