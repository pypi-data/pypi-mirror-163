...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mirror_checkBox.toggled['bool'].connect(
            self.mirroring_folder_text.setEnabled)  # type: ignore
        self.mirror_checkBox.toggled['bool'].connect(
            self.select_mirroring_folder.setEnabled)  # type: ignore
        self.watchdog_pushbutton.clicked['bool'].connect(
            MainWindow.toggled_watchdog)  # type: ignore
        self.open_explorer_pushbuttom.clicked.connect(
            MainWindow.open_browser)  # type: ignore
        self.edit_custom_html_file_pushbutton.clicked.connect(
            MainWindow.open_yaml_editor)  # type: ignore
        self.select_protocol_folder.clicked.connect(
            MainWindow.open_protocol_folder)  # type: ignore
        self.select_mirroring_folder.clicked.connect(
            MainWindow.open_mirroring_folder)  # type: ignore
        self.watchdog_pushbutton.toggled['bool'].connect(
            self.open_explorer_pushbuttom.setEnabled)  # type: ignore
        self.select_microscope_comboBox.currentIndexChanged['QString'].connect(
            MainWindow.changed_microscope)  # type: ignore
        self.mirror_checkBox.toggled['bool'].connect(
            MainWindow.toggled_mirroring)  # type: ignore
        self.protocol_folder_text.editingFinished.connect(
            MainWindow.validate_inputs)  # type: ignore
        self.mirroring_folder_text.editingFinished.connect(
            MainWindow.validate_inputs)  # type: ignore
        self.clean_logger_pushbutton.clicked.connect(
            MainWindow.clear_logger)  # type: ignore
        self.save_logger_pushbutton.clicked.connect(
            MainWindow.save_logger)  # type: ignore
        ...
        MainWindow.setTabOrder(
            self.select_microscope_comboBox, self.watchdog_pushbutton)
