...
class View(components.View):
    ...
    def create(cls, window: components.Tk, builder: components.Builder):
        ...
        #buttons
        builder.create('button', name='home', command=callbacks.switch_to_home, text='Home').place(row=0, col=0)
        builder.create('button', name='register', command=callbacks.switch_to_register, text='Register').place(row=0, col=1)
        builder.create('button', name='login', command=callbacks.switch_to_login, text='Login').place(row=0, col=2, sticky='nsew')
