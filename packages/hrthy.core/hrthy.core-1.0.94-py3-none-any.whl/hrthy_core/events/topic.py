...
class Topic(Enum):
    ...
    # Retry
    COMPANY_RETRY_V1 = 'hrthy.company.retry.v1'
    USER_RETRY_V1 = 'hrthy.user.retry.v1'
    USER_AUTH_RETRY_V1 = 'hrthy.user.auth.retry.v1'
    ROLE_RETRY_V1 = 'hrthy.role.retry.v1'
    CANDIDATE_RETRY_V1 = 'hrthy.candidate.retry.v1'
    CANDIDATE_AUTH_RETRY_V1 = 'hrthy.candidate.auth.retry.v1'
