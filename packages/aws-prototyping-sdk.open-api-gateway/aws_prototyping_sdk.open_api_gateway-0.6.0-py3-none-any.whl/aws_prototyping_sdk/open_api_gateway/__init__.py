    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(java_client_options, dict):
            java_client_options = JavaProjectOptions(**java_client_options)
        if isinstance(python_client_options, dict):
            python_client_options = PythonProjectOptions(**python_client_options)
        if isinstance(typescript_client_options, dict):
            typescript_client_options = TypeScriptProjectOptions(**typescript_client_options)
        if __debug__:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(workflow_git_identity, dict):
            workflow_git_identity = GitIdentity(**workflow_git_identity)
        ...
        if isinstance(tsconfig_dev, dict):
            tsconfig_dev = TypescriptConfigOptions(**tsconfig_dev)
        if isinstance(java_client_options, dict):
            java_client_options = JavaProjectOptions(**java_client_options)
        if isinstance(python_client_options, dict):
            python_client_options = PythonProjectOptions(**python_client_options)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(cors_options, dict):
            cors_options = CorsOptions(**cors_options)
        if __debug__:
