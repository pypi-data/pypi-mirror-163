...
from supervised_FCN.utils import get_git_root
...
class DatasetImporterUCR(object):
    ...
    def __init__(self, subset_name: str, data_scaling: bool, **kwargs):
        ...
        self.data_root = get_git_root().joinpath("datasets", "UCRArchive_2018", subset_name)
...
if __name__ == "__main__":
    ...
    # subset_names = sorted(os.listdir(os.path.join('datasets', 'UCRArchive_2018')))
    # for subset_name in subset_names:
    #     print('subset_name:', subset_name)
    #
    #     dataset_importer = DatasetImporterUCR(subset_name, data_scaling=True)
    #     dataset = UCRDataset("train", dataset_importer)
    #     data_loader = DataLoader(dataset, batch_size=32, num_workers=0, shuffle=True)
    #     for batch in data_loader:
    #         x, y = batch
