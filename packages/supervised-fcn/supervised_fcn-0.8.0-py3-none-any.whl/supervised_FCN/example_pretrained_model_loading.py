...
def load_pretrained_FCN(subset_dataset_name: str, in_channels: int = 1):
    ...
    :return:
    """
    ucr_summary = pd.read_csv(get_git_root().joinpath('supervised_FCN', 'datasets', 'DataSummary_UCR.csv'))
    ...
    # load
    ckpt_fname = get_git_root().joinpath('supervised_FCN', 'saved_models', f'{subset_dataset_name}.ckpt')
