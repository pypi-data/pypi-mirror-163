...
def load_pretrained_FCN(subset_dataset_name: str, in_channels: int = 1):
    ...
    :return:
    """
    ucr_summary = pd.read_csv(os.path.join('supervised_FCN', 'datasets', 'DataSummary_UCR.csv'))
    ...
    # load
    ckpt_fname = os.path.join('supervised_FCN', 'saved_models', f'{subset_dataset_name}.ckpt')
