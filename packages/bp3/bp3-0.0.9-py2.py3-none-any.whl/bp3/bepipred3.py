 ...
 Use method run_bp3_ensemble(antigens).")
            ...
            for acc, seq, ensemble_prob in data:
                ...
                if ensemble_pred_len < seq_len:
                    plot_title = f"BepiPred-3.0 epitope scores on {acc}. The sequence was too long and predictions are truncated to the first 1024 residues."

                else:
                    plot_title = f"BepiPred-3.0 epitope scores on {acc}"
