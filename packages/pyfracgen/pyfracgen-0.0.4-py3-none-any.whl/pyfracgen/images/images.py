...
def markus_lyapunov_image(res, cmap_negative, cmap_positive, gamma=1.0, ticks='off'):
    ...
    ax0.imshow(pos, cmap=cmap_positive, origin='lower')
    ax0.imshow(neg, cmap=cmap_negative, origin='lower', norm=colors.PowerNorm(gamma))
