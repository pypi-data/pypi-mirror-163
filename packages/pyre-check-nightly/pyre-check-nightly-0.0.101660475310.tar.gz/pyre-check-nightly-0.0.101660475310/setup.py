...
def main() -> None:
    ...
    run(
        ...
        package_version="0.0.101660475310",
        module_name="pyre_check",
        runtime_dependencies=json.loads(r"""["dataclasses; python_version < \"3.7\"", "async-generator", "click>=8.0", "dataclasses-json", "intervaltree", "libcst", "psutil", "pyre-extensions>=0.0.29", "tabulate", "testslide>=2.7.0", "typing_extensions"]"""),
        long_description=long_description,
    )
