...
{
    // derivative weights
    static double RK4_A[MAX_BUTCHER_TABLEAU_SIZE][MAX_BUTCHER_TABLEAU_SIZE] = {
        {0, 0, 0, 0},
        {0.5, 0, 0, 0},
        {0.5, 0.5, 0, 0},
        {1, 0, 0, 0}};
    ...
    // next step weights
    static double RK4_b[4] = {1.0 / 6.0, 1.0 / 3.0, 1.0 / 3.0, 1.0 / 6.0};

    // evaluation points
    static double RK4_c[4] = {0.0, 1.0 / 2.0, 1.0 / 2.0, 1.0};
