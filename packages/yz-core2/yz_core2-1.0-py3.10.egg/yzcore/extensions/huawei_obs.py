...
if __name__ == '__main__':
    ...
    obs_obj = ObsManager(**kwargs)
    file_name = 'bdab1dda1357051dd6168a9fa812cc26.png'
    # remote_name = 'cmltest.fbx'

    '''
    # 上传
    result_obj = obs_obj.upload(key='test/123.png', filepath=file_name)
    print(result_obj)
    callback_dict = {"app_uid": "hub", "project_id": "2332660985727287374", "parent_id": "2334646012505751563",
                     "property": {"is_reduce": False, "reduce": 50, "is_clear": False,
                                  "is_uv": False, "is_iuv": False, "is_bake_ao": False},
                     "type": "model", "action": "convert", "name": "__drill",
                     "hash": "d94cc79cc4d9cf4fe5cab87d0af0bb17", "size": 6460957, "user_id": "2332660985727287374",
                     "organiz_id": "2334646012505751563"
                     }
    policy = obs_obj.get_policy(file_name, callback_data=callback_dict)
    print(policy)
    print('--------policy--------')
    ...
    '''
    # 下载
    result = obs_obj.download(key='bdab1dda1357051dd6168a9fa812cc26.png', is_stream=True)
    print(type(result))
