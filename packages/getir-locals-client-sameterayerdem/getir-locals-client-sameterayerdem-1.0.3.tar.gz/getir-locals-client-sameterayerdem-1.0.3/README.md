...
*OrdersApi* | [**unapproved_orders_by_chain_id**](docs/OrdersApi.md#unapproved_orders_by_chain_id) | **GET** /v1/orders/unapproved/chain-based | It is used to get the list of unapproved orders by chainId.
