...
class OrdersApi(object):
    ...
    def unapproved_orders_by_chain_id(self, chain_id, **kwargs):  # noqa: E501
        """It is used to get the list of unapproved orders by chainId.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unapproved_orders_by_chain_id(chain_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unapproved_orders_by_chain_id_with_http_info(chain_id, **kwargs)  # noqa: E501
        else:
            (data) = self.unapproved_orders_by_chain_id_with_http_info(chain_id, **kwargs)  # noqa: E501
            return data

    def unapproved_orders_by_chain_id_with_http_info(self, chain_id, **kwargs):  # noqa: E501
        """It is used to get the list of unapproved orders by chainId.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unapproved_orders_by_chain_id_with_http_info(chain_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unapproved_orders_by_chain_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('chain_id' not in params or
            ...
            raise ValueError("Missing the required parameter `chain_id` when calling `unapproved_orders_by_chain_id`")  # noqa: E501
