...
Install required packages before running"""))
    ...
    nbf.write(nb, 'MLProvCodeGen/GeneratedNotebooks/ImageClassification_PyTorch.ipynb')
...
Install required packages before running"""))
    ...
    nbf.write(nb, 'MLProvCodeGen/GeneratedNotebooks/MulticlassClassification.ipynb')
