...
class Deployment(APIObject, DeploymentQueryBuilderMixin, BrowserMixin):
    ...
    @deprecated(
        deprecated_since_version="v2.29",
        will_remove_version="v2.30",
    ...
    def predict_batch(
        ...
        """
        Using a Deployment instance make batch predictions and return results as a DataFrame.

        If a DataFrame is passed as ``source`` then the prediction results will be merged with that
        original DataFrame and a new DataFrame will be returned.
        ...
        source: str, pd.DataFrame or file object
            Pass a URL, filepath, file or DataFrame for making a batch prediction.
        ...
        upload_read_timeout: int, optional
            Wait this many seconds for the server to respond after whole dataset upload.
            See :meth:`datarobot.models.BatchPredictionJob.score`.

        Returns
        -------
        pd.DataFrame
            Prediction results as a pandas DataFrame.
