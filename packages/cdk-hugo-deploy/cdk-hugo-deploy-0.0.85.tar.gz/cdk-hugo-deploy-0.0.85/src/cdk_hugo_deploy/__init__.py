...
class HugoDeploy(
    ...
    def __init__(
        ...
        *,
        ...
        zone: typing.Optional[aws_cdk.aws_route53.HostedZone] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HugoDeploy.__init__)
...
class HugoDeployProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HugoDeployProps.__init__)
    ...
    @builtins.property
    def zone(self) -> typing.Optional[aws_cdk.aws_route53.HostedZone]:
