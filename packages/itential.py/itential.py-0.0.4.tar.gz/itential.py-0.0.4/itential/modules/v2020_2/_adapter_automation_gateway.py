...
class AdapterAutomationGateway:
    ...
    def netmiko_send_command(
        client: "Itential", host: str, commands: List[str], connection_options: Dict[str, str]
    ) -> requests.Response:
        """
    ...
    def netmiko_send_config(
        client: "Itential", host: str, config_commands: List[str], connection_options: Dict[str, Union[int, str]]
    ) -> requests.Response:
        """
