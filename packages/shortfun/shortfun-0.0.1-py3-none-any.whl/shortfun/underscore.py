...
class UnderscoreShortFun:
    ...
    def __delattr__(self, rt: str):
        raise Exception("cannot use bc most return Nonetype")
    ...
    def __format__(self, *rt_args, **rt_kwargs):
        raise Exception("cannot use bc most return str")
    ...
    def __setattr__(self, attr_name, attr_value):
        return lambda cls: setattr(cls, attr_name, attr_value)
