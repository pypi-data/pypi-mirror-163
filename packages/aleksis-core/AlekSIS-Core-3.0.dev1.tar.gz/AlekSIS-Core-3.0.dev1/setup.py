...
{'': ['*'],
 'aleksis.core': ['assets/*',
                  'assets/components/*',
                  'assets/components/notifications/*',
                  'assets/css/*',
