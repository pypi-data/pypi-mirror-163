...
class ProcessSubscriptionView(ProcessTransactionBaseView):
    ...
    @swagger_auto_schema(
        ...
        operation_description=(
            ...
            "Statuses:<br>"
            "1. ok - ok :)<br>"
            "2. not valid - subscription is not valid<br>"
            "3. subscription already created - subscription with given payload was already processed<br>"
            "4. data is not valid - provided data is not valid to create purchase<br>"
            "5. error - some error occurred, check logs"
        ),
    )
