...
class S3FileSystemOperator(object):
    ...
    def write_into_s3_file(
        ...
        self.logger.debug(f"Writing to {bucket_name}/{file_name} started")
    ...
    def move_s3_file(
        ...
        self.logger.debug(f"Moving from {source_path} to {destination_path} started")
    ...
    def read_from_s3_file(
        ...
        self.logger.debug(f"Reading from {bucket_name}/{file_name} started")
...
class S3Operator(object):
    ...
    def upload_file_to_s3_bucket(
        ...
        """
        self.logger.debug(f"Upload to {bucket_name} started")
