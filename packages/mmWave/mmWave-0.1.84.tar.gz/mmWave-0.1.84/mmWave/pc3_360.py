...
class Pc3_360:
	...
	v6_col_names_rt = ['fN','type','elv','azimuth','doppler','range' ,'snr',  'sx', 'sy', 'sz' ] 
	...
	v7_col_names = ['time','fN','degree','type','tid','posX','posY','posZ','velX','velY','velZ','accX','accY','accZ','ec0','ec1','ec2','ec3','ec4','ec5','ec6','ec7','ec8','ec9','ec10','ec11','ec12','ec13','ec14','ec15','g','confi']
		...
		while True:
			...
			if lstate == 'header': # 40B := index 8:48
				...
				try: 
					...
					self.hdr.numTLVs,self.hdr.checksum) = struct.unpack('9I2H', uartBuf[idxFrom : idxTo]) 
