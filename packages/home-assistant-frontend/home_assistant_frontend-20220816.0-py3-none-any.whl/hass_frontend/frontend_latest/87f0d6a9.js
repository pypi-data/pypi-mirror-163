/*! For license information please see 87f0d6a9.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[2674],{84912:(e,t,i)=>{class s extends HTMLElement{static get version(){return"23.1.5"}}customElements.define("vaadin-material-styles",s);var o=i(70620);const r=o.iv`
  :host {
    /* Text colors */
...
`;(0,o.hC)("",c,{moduleId:"material-overlay"}),(0,o.hC)("vaadin-overlay",c,{moduleId:"material-vaadin-overlay"});var u=i(20723),_=i(87529),p=i(52521),m=i(28426);const g=e=>e.test(navigator.userAgent),v=e=>e.test(navigator.platform);g(/Android/),g(/Chrome/)&&/Google Inc/.test(navigator.vendor);g(/Firefox/);const b=v(/^iPad/)||v(/^Mac/)&&navigator.maxTouchPoints>1,f=v(/^iPhone/)||b,y=g(/^((?!chrome|android).)*safari/i),x=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();var I=i(76389);const C=(0,I.o)((e=>class extends e{constructor(){super(),this.__controllers=new Set}connectedCallback(){super.connectedCallback(),this.__controllers.forEach((e=>{e.hostConnected&&e.hostConnected()}))}disconnectedCallback(){super.disconnectedCallback(),this.__controllers.forEach((e=>{e.hostDisconnected&&e.hostDisconnected()}))}addController(e){this.__controllers.add(e),void 0!==this.$&&this.isConnected&&e.hostConnected&&e.hostConnected()}removeController(e){this.__controllers.delete(e)}}));class w{static detectScrollType(){const e=document.createElement("div");e.textContent="ABCD",e.dir="rtl",e.style.fontSize="14px",e.style.width="4px",e.style.height="1px",e.style.position="absolute",e.style.top="-1000px",e.style.overflow="scroll",document.body.appendChild(e);let t="reverse";return e.scrollLeft>0?t="default":(e.scrollLeft=2,e.scrollLeft<2&&(t="negative")),document.body.removeChild(e),t}static getNormalizedScrollLeft(e,t,i){const{scrollLeft:s}=i;if("rtl"!==t||!e)return s;switch(e){case"negative":return i.scrollWidth-i.clientWidth+s;case"reverse":return i.scrollWidth-i.clientWidth-s;default:return s}}static setNormalizedScrollLeft(e,t,i,s){if("rtl"===t&&e)switch(e){case"negative":i.scrollLeft=i.clientWidth-i.scrollWidth+s;break;case"reverse":i.scrollLeft=i.scrollWidth-i.clientWidth-s;break;default:i.scrollLeft=s}else i.scrollLeft=s}}const E=[];let S;function T(e,t,i=e.getAttribute("dir")){t?e.setAttribute("dir",t):null!=i&&e.removeAttribute("dir")}function O(){return document.documentElement.getAttribute("dir")}new MutationObserver((function(){const e=O();E.forEach((t=>{T(t,e)}))})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const k=e=>class extends e{static get properties(){return{dir:{type:String,value:"",reflectToAttribute:!0,converter:{fromAttribute:e=>e||"",toAttribute:e=>""===e?null:e}}}}static finalize(){super.finalize(),S||(S=w.detectScrollType())}connectedCallback(){super.connectedCallback(),this.hasAttribute("dir")||(this.__subscribe(),T(this,O(),null))}attributeChangedCallback(e,t,i){if(super.attributeChangedCallback(e,t,i),"dir"!==e)return;const s=O(),o=i===s&&-1===E.indexOf(this),r=!i&&t&&-1===E.indexOf(this),n=i!==s&&t===s;o||r?(this.__subscribe(),T(this,s,i)):n&&this.__subscribe(!1)}disconnectedCallback(){super.disconnectedCallback(),this.__subscribe(!1),this.removeAttribute("dir")}_valueToNodeAttribute(e,t,i){("dir"!==i||""!==t||e.hasAttribute("dir"))&&super._valueToNodeAttribute(e,t,i)}_attributeToProperty(e,t,i){"dir"!==e||t?super._attributeToProperty(e,t,i):this.dir=""}__subscribe(e=!0){e?E.includes(this)||E.push(this):E.includes(this)&&E.splice(E.indexOf(this),1)}__getNormalizedScrollLeft(e){return w.getNormalizedScrollLeft(S,this.getAttribute("dir")||"ltr",e)}__setNormalizedScrollLeft(e,t){return w.setNormalizedScrollLeft(S,this.getAttribute("dir")||"ltr",e,t)}};function V(e){const t=e.style;if("hidden"===t.visibility||"none"===t.display)return!0;const i=window.getComputedStyle(e);return"hidden"===i.visibility||"none"===i.display}function A(e,t){const i=Math.max(e.tabIndex,0),s=Math.max(t.tabIndex,0);return 0===i||0===s?s>i:i>s}function P(e){const t=e.length;if(t<2)return e;const i=Math.ceil(t/2);return function(e,t){const i=[];for(;e.length>0&&t.length>0;)A(e[0],t[0])?i.push(t.shift()):i.push(e.shift());return i.concat(e,t)}(P(e.slice(0,i)),P(e.slice(i)))}function L(e,t){if(e.nodeType!==Node.ELEMENT_NODE||V(e))return!1;const i=e,s=function(e){if(!function(e){return!e.matches('[tabindex="-1"]')&&(e.matches("input, select, textarea, button, object")?e.matches(":not([disabled])"):e.matches("a[href], area[href], iframe, [tabindex], [contentEditable]"))}(e))return-1;const t=e.getAttribute("tabindex")||0;return Number(t)}(i);let o=s>0;s>=0&&t.push(i);let r=[];return r="slot"===i.localName?i.assignedNodes({flatten:!0}):(i.shadowRoot||i).children,[...r].forEach((e=>{o=L(e,t)||o})),o}function z(e){return e.getRootNode().activeElement===e}const R=[];class N{constructor(e){this.host=e,this.__trapNode=null,this.__onKeyDown=this.__onKeyDown.bind(this)}hostConnected(){document.addEventListener("keydown",this.__onKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this.__onKeyDown)}trapFocus(e){if(this.__trapNode=e,0===this.__focusableElements.length)throw this.__trapNode=null,new Error("The trap node should have at least one focusable descendant or be focusable itself.");R.push(this),-1===this.__focusedElementIndex&&this.__focusableElements[0].focus()}releaseFocus(){this.__trapNode=null,R.pop()}__onKeyDown(e){if(this.__trapNode&&this===Array.from(R).pop()&&"Tab"===e.key){e.preventDefault();const t=e.shiftKey;this.__focusNextElement(t)}}__focusNextElement(e=!1){const t=this.__focusableElements,i=e?-1:1,s=this.__focusedElementIndex,o=t[(t.length+s+i)%t.length];o.focus(),"input"===o.localName&&o.select()}get __focusableElements(){return function(e){const t=[];return L(e,t)?P(t):t}(this.__trapNode)}get __focusedElementIndex(){const e=this.__focusableElements;return e.indexOf(e.filter(z).pop())}}class M extends((0,o.Tb)(k(C(m.H3)))){static get template(){return m.dy`
      <style>
        :host {
          z-index: 200;
          position: fixed;
...
`;(0,o.hC)("vaadin-combo-box-overlay",[D,H],{moduleId:"material-combo-box-overlay"});const B=o.iv`
  :host {
    display: flex;
    align-items: center;
    box-sizing: border-box;
...
`;(0,o.hC)("vaadin-item",B,{moduleId:"material-item"});const F=o.iv`
  :host {
    cursor: pointer;
    -webkit-tap-highlight-color: transparent;
    padding: 4px 10px;
...
`;(0,o.hC)("vaadin-combo-box-item",[B,F],{moduleId:"material-combo-box-item"});class $ extends((0,o.Tb)(k(m.H3))){static get template(){return m.dy`
      <style>
        :host {
          display: block;
        }
