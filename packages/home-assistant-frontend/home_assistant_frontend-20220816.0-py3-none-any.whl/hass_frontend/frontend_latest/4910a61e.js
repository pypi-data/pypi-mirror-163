/*! For license information please see 4910a61e.js.LICENSE.txt */
    ...
    `}},{kind:"method",key:"_unsupportedDialog",value:async function(){await(0,m.Ys)(this,{title:this.hass.localize("ui.dialogs.unsupported.title"),text:r.dy`${this.hass.localize("ui.dialogs.unsupported.description")}
        ...
        <ul>
          ${this._resolutionInfo.unhealthy.map((e=>r.dy`
            ...
            `))}
        </ul>`})}},{kind:"method",key:"_getSections",value:function(){const e=[];if(this._systemInfo){const t=Object.keys(this._systemInfo).sort(D);for(const i of t){const t=this._systemInfo[i],o=[];for(const e of Object.keys(t.info)){let n;if(t.info[e]&&"object"==typeof t.info[e]){const i=t.info[e];"pending"===i.type?n=r.dy`
...
//# sourceMappingURL=4910a61e.js.map