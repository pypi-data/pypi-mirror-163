/*! For license information please see 7701aaf9.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[20392],{14166:(e,t,r)=>{r.d(t,{W:()=>n});var i=function(){return i=Object.assign||function(e){for(var t,r=1,i=arguments.length;r<i;r++)for(var n in t=arguments[r])Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e},i.apply(this,arguments)};function n(e,t,r){void 0===t&&(t=Date.now()),void 0===r&&(r={});var n=i(i({},o),r||{}),a=(+e-+t)/1e3;if(Math.abs(a)<n.second)return{value:Math.round(a),unit:"second"};var s=a/60;if(Math.abs(s)<n.minute)return{value:Math.round(s),unit:"minute"};var l=a/3600;if(Math.abs(l)<n.hour)return{value:Math.round(l),unit:"hour"};var c=a/86400;if(Math.abs(c)<n.day)return{value:Math.round(c),unit:"day"};var d=new Date(e),h=new Date(t),p=d.getFullYear()-h.getFullYear();if(Math.round(Math.abs(p))>0)return{value:Math.round(p),unit:"year"};var u=12*p+d.getMonth()-h.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var f=a/604800;return{value:Math.round(f),unit:"week"}}var o={second:45,minute:45,hour:22,day:5}},27849:(e,t,r)=>{r(39841);var i=r(50856);r(28426);class n extends(customElements.get("app-header-layout")){static get template(){return i.d`
      <style>
        :host {
          display: block;
          /**
    ...
    `}},{kind:"method",key:"updated",value:function(e){x(A(r.prototype),"updated",this).call(this,e),!this._tip&&e.has("hass")&&(this._tip=((e,t)=>{const r=[];let n=[{content:e.localize("ui.panel.config.tips.join","forums",i.dy`<a
...
//# sourceMappingURL=7701aaf9.js.map