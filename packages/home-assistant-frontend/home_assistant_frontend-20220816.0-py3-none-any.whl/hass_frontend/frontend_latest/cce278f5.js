/*! For license information please see cce278f5.js.LICENSE.txt */
...
>
  ...
  ${e.icon}
    ...
    `]}]}}),r.K)},22814:(e,t,i)=>{"use strict";i.d(t,{uw:()=>r,iI:()=>n,W2:()=>s,TZ:()=>o});const r=`${location.protocol}//${location.host}`,n=(e,t)=>e.callWS({type:"auth/sign_path",path:t}),s=async(e,t,i,r)=>e.callWS({type:"config/auth_provider/homeassistant/create",user_id:t,username:i,password:r}),o=async(e,t,i)=>e.callWS({type:"config/auth_provider/homeassistant/admin_change_password",user_id:t,password:i})},89439:(e,t,i)=>{"use strict";i.d(t,{qW:()=>s,kU:()=>o,jU:()=>a,Ch:()=>l,nk:()=>d,i4:()=>c,Lr:()=>u,tb:()=>p,Xn:()=>f,Mw:()=>m,B:()=>v,zj:()=>_});var r=i(43426),n=i(22814);const s=2,o="hls",a="web_rtc",l=(e,t,i)=>`${e}&width=${t}&height=${i}`,d=e=>`/api/camera_proxy_stream/${e.entity_id}?token=${e.attributes.access_token}`,c=async(e,t,i,n)=>{const s=await(0,r.U)("_cameraTmbUrl",9e3,h,e,t);return l(s,i,n)},h=async(e,t)=>{const i=await(0,n.iI)(e,`/api/camera_proxy/${t}`);return e.hassUrl(i.path)},u=async(e,t,i)=>{const r={type:"camera/stream",entity_id:t};i&&(r.format=i);const n=await e.callWS(r);return n.url=e.hassUrl(n.url),n},p=(e,t,i)=>e.callWS({type:"camera/web_rtc_offer",entity_id:t,offer:i}),f=(e,t)=>e.callWS({type:"camera/get_prefs",entity_id:t}),m=(e,t,i)=>e.callWS({type:"camera/update_prefs",entity_id:t,...i}),y="media-source://camera/",v=e=>e.startsWith(y),_=e=>e.substring(y.length)},73728:(e,t,i)=>{"use strict";i.d(t,{pV:()=>o,P3:()=>a,Ky:()=>d,D4:()=>c,XO:()=>h,zO:()=>u,oi:()=>p,d4:()=>f,D7:()=>m,ZJ:()=>v,V3:()=>_,WW:()=>g});var r=i(97330),n=i(38346),s=i(5986);const o=32143==i.j?["bluetooth","dhcp","discovery","hassio","homekit","integration_discovery","mqtt","ssdp","unignore","usb","zeroconf"]:null,a=32143==i.j?["reauth"]:null,l={"HA-Frontend-Base":`${location.protocol}//${location.host}`},d=(e,t)=>{var i;return e.callApi("POST","config/config_entries/flow",{handler:t,show_advanced_options:Boolean(null===(i=e.userData)||void 0===i?void 0:i.showAdvanced)},l)},c=(e,t)=>e.callApi("GET",`config/config_entries/flow/${t}`,void 0,l),h=(e,t,i)=>e.callApi("POST",`config/config_entries/flow/${t}`,i,l),u=(e,t,i)=>e.callWS({type:"config_entries/ignore_flow",flow_id:t,title:i}),p=(e,t)=>e.callApi("DELETE",`config/config_entries/flow/${t}`),f=(e,t)=>e.callApi("GET","config/config_entries/flow_handlers"+(t?`?type=${t}`:"")),m=e=>e.sendMessagePromise({type:"config_entries/flow/progress"}),y=(e,t)=>e.subscribeEvents((0,n.D)((()=>m(e).then((e=>t.setState(e,!0)))),500,!0),"config_entry_discovered"),v=e=>(0,r._)(e,"_configFlowProgress",m,y),_=(e,t)=>v(e.connection).subscribe(t),g=(e,t)=>t.context.title_placeholders&&0!==Object.keys(t.context.title_placeholders).length?e(`component.${t.handler}.config.flow_title`,t.context.title_placeholders)||("name"in t.context.title_placeholders?t.context.title_placeholders.name:(0,s.Lh)(e,t.handler)):(0,s.Lh)(e,t.handler)},24833:(e,t,i)=>{"use strict";i.d(t,{oF:()=>c,kK:()=>h,k6:()=>u,zG:()=>p,BD:()=>f,hF:()=>y,Sk:()=>v,X4:()=>_,UJ:()=>g,Fj:()=>w,M$:()=>k});var r=i(49706);if(32143==i.j)var n=i(58831);if(32143==i.j)var s=i(22311);var o=i(40095);if(32143==i.j)var a=i(85415);if(32143==i.j)var l=i(26765);if(32143==i.j)var d=i(81796);const c=1,h=2,u=4,p=8,f=16,m=e=>(0,o.f)(e,u)&&"number"==typeof e.in_progress,y=(e,t=!1)=>(e.state===r.uo||t&&Boolean(e.attributes.skipped_version))&&(0,o.e)(e,c),v=e=>(e=>m(e.attributes))(e)||!!e.attributes.in_progress,_=e=>m(e)||!!e.in_progress,g=(e,t)=>e.callWS({type:"update/release_notes",entity_id:t}),b=e=>Object.values(e).filter((e=>"update"===(0,s.N)(e))).sort(((e,t)=>"Home Assistant Core"===e.attributes.title?-3:"Home Assistant Core"===t.attributes.title?3:"Home Assistant Operating System"===e.attributes.title?-2:"Home Assistant Operating System"===t.attributes.title?2:"Home Assistant Supervisor"===e.attributes.title?-1:"Home Assistant Supervisor"===t.attributes.title?1:(0,a.f)(e.attributes.title||e.attributes.friendly_name||"",t.attributes.title||t.attributes.friendly_name||""))),w=(e,t=!1)=>b(e).filter((e=>y(e,t))),k=async(e,t)=>{const i=b(t.states).map((e=>e.entity_id));if(!i.length)return void(0,l.Ys)(e,{title:t.localize("ui.panel.config.updates.no_update_entities.title"),text:t.localize("ui.panel.config.updates.no_update_entities.description"),warning:!0});let r=0;const s=await t.connection.subscribeEvents((i=>{"update"===(0,n.M)(i.data.entity_id)&&(r++,(0,d.C)(e,{message:t.localize("ui.panel.config.updates.updates_refreshed",{count:r})}))}),"state_changed");await t.callService("homeassistant","update_entity",{entity_id:i}),await new Promise((e=>setTimeout(e,1e4))),s(),0===r&&(0,d.C)(e,{message:t.localize("ui.panel.config.updates.no_new_updates")})}},52871:(e,t,i)=>{"use strict";i.d(t,{G:()=>n,w:()=>s});var r=i(47181);const n=()=>Promise.all([i.e(29563),i.e(98985),i.e(24103),i.e(88278),i.e(59799),i.e(41985),i.e(6294),i.e(85084),i.e(45507),i.e(2674),i.e(51644),i.e(49842),i.e(1548),i.e(49075),i.e(81480),i.e(5858),i.e(44512),i.e(12545),i.e(13701),i.e(77576),i.e(29925),i.e(65040),i.e(68101),i.e(4940),i.e(4548),i.e(79158)]).then(i.bind(i,81585)),s=(e,t,i)=>{(0,r.B)(e,"show-dialog",{dialogTag:"dialog-data-entry-flow",dialogImport:n,dialogParams:{...t,flowConfig:i,dialogParentElement:e}})}},17416:(e,t,i)=>{"use strict";i.d(t,{c:()=>c});var r=i(37500),n=i(5986);const s=(e,t)=>{var i;return e.callApi("POST","config/config_entries/options/flow",{handler:t,show_advanced_options:Boolean(null===(i=e.userData)||void 0===i?void 0:i.showAdvanced)})},o=(e,t)=>e.callApi("GET",`config/config_entries/options/flow/${t}`),a=(e,t,i)=>e.callApi("POST",`config/config_entries/options/flow/${t}`,i),l=(e,t)=>e.callApi("DELETE",`config/config_entries/options/flow/${t}`);var d=i(52871);const c=(e,t,i)=>(0,d.w)(e,{startFlowHandler:t.entry_id,domain:t.domain,manifest:i},{loadDevicesAndAreas:!1,createFlow:async(e,i)=>{const[r]=await Promise.all([s(e,i),e.loadBackendTranslation("options",t.domain)]);return r},fetchFlow:async(e,i)=>{const[r]=await Promise.all([o(e,i),e.loadBackendTranslation("options",t.domain)]);return r},handleFlowStep:a,deleteFlow:l,renderAbortDescription(e,i){const n=e.localize(`component.${t.domain}.options.abort.${i.reason}`,i.description_placeholders);return n?r.dy`
      ...
      <div class="form container">
        ...
        <ha-icon-picker
          ...
          .fallbackPath=${this._icon||null!=l&&l.attributes.icon||!l?void 0:(0,_.K)((0,v.M)(l.entity_id),l)}
          .disabled=${this._submitting}
        ></ha-icon-picker>
        ${this._deviceClassOptions?r.dy`
              ...
              >
                ...
                ${this._deviceClassesSorted(d,this._deviceClassOptions[0],this.hass.localize).map((e=>r.dy`
                ...
                ${this._deviceClassesSorted(d,this._deviceClassOptions[1],this.hass.localize).map((e=>r.dy`
                    <mwc-list-item .value=${e.deviceClass}>
                      ${e.label}
                    </mwc-list-item>
                  `))}
            ...
            `:""}
        ${"number"===d&&this._deviceClass&&null!=l&&l.attributes.unit_of_measurement&&null!==(t=W[this._deviceClass])&&void 0!==t&&t.includes(null==l?void 0:l.attributes.unit_of_measurement)?r.dy`
              <ha-select
                ...
                @closed=${y.U}
              >
                ${W[this._deviceClass].map((e=>r.dy`
                    <mwc-list-item .value=${e}>${e}</mwc-list-item>
                  `))}
              </ha-select>
            `:""}
        ${"sensor"===d&&this._deviceClass&&null!=l&&l.attributes.unit_of_measurement&&null!==(i=R[this._deviceClass])&&void 0!==i&&i.includes(null==l?void 0:l.attributes.unit_of_measurement)?r.dy`
              <ha-select
                .label=${this.hass.localize("ui.dialogs.entity_registry.editor.unit_of_measurement")}
                .value=${l.attributes.unit_of_measurement}
                naturalMenuWidth
        ...
        ${"weather"===d?r.dy`
              ...
              <ha-select
                ...
                @closed=${y.U}
              >
                ${V.wind_speed.map((e=>r.dy`
                    <mwc-list-item .value=${e}>${e}</mwc-list-item>
                  `))}
              </ha-select>
            `:""}
        ${"switch"===d?r.dy`<ha-select
              .label=${this.hass.localize("ui.dialogs.entity_registry.editor.device_class")}
              naturalMenuWidth
              fixedMenuPosition
            ...
            >
              ...
              ${this._switchAsDomainsSorted(N,this.hass.localize).map((e=>r.dy`
    ...
    `}},{kind:"method",key:"_renderTab",value:function(){switch(this._curTab){case"tab-settings":return this._entry?this._settingsElementTag?r.dy`
      ...
      `]}}]}}),r.oi)},27322:(e,t,i)=>{"use strict";i.d(t,{R:()=>r});const r=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`},86853:(e,t,i)=>{var r={"./entity-settings-helper-tab":[85511,41985,51644,49842,1548,49075,85718,26218,12545,13701,25506,18393],"./entity-settings-helper-tab.ts":[85511,41985,51644,49842,1548,49075,85718,26218,12545,13701,25506,18393]};function n(e){if(!i.o(r,e))return Promise.resolve().then((()=>{var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=r[e],n=t[0];return Promise.all(t.slice(1).map(i.e)).then((()=>i(n)))}n.keys=()=>Object.keys(r),n.id=86853,e.exports=n}}]);
//# sourceMappingURL=cce278f5.js.map