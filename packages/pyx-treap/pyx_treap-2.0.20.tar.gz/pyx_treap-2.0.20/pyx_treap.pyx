...
cdef class treap_node(object):
    ...
    cpdef check_tree_invariant(self):
    ...
    cpdef check_heap_invariant(self):
    ...
    cdef rotate_with_left_child(self, node):
    ...
    cdef rotate_with_right_child(self, node):
        # pylint: disable=R0201
        # R0201: Cython (Mar 28, 2011) doesn't like decorators on cdef's , so we disable the "method could be a function" warning
    ...
    cpdef detailed_inorder_traversal(self, visit, depth=0, from_left=0):
    ...
    cpdef inorder_traversal(self, visit):
