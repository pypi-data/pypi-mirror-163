# Solar_Functions is (c) 2020-2022 Milad Rastian <hzsami82@email.com>.
# The Solar_Functions module was contributed to Python as of Python 3.7 and thus
# was licensed under the Python license. Same license applies to all files in
# the Solar_Functions package project.
import os
try:
