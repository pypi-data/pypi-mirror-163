...
def has_separated_terminals(grammar: dict) -> bool:
...
def has_bifurcating_productions(grammar: dict) -> bool:
...
def has_no_epsilon_productions(
    grammar: dict, starting_exception: bool = False
) -> bool:
...
def has_no_unit_productions(grammar: dict) -> bool:
...
def has_chomsky_normal_form(grammar: dict, starting_exception: bool = True) -> bool:
...
def has_greibach_normal_form(grammar: dict) -> bool:
