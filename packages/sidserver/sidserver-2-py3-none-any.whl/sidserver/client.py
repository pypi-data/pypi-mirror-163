...
class Client():
    ...
    def parse_headers(self, data: str = None, type: str = None):
        return headers.ApisHeaders(deviceId=self.deviceId(), data=data, type=type).headers

	
    def sendActive(self,comId: str,data:str):
    ...
    def coin_gen(self,sid:str, comId: int,timers: list = None, tz: int = -time.timezone // 1000):
