...
image_path = '../../data/VOCdevkit/VOCdevkit/VOC2012/JPEGImages/2007_000272.jpg'
image = Image.open(image_path)
image = F.resize(image,(500,500))
...
grayscale_cam = cam(input_tensor, targets=targets)[0, :]
vis = renormalize_cam_in_bounding_boxes(boxes, image_float_np, grayscale_cam)
Image.fromarray(renormalize_cam_in_bounding_boxes(boxes, image_float_np, grayscale_cam))
plt.imshow(vis)
plt.show()