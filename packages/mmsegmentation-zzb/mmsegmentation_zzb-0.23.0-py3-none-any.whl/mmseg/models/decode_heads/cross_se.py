...
class LiteAsppCrossSe(BaseDecodeHead):
    def __init__(self, dilations=(2, 4), **kwargs):
        super(LiteAsppCrossSe, self).__init__(**kwargs)
        self.dilations = dilations
        self.last_conv = nn.Conv2d(in_channels=512, out_channels=112, kernel_size=1, stride=1)
        self.penultimate_conv = nn.Conv2d(in_channels=112, out_channels=40, kernel_size=1, stride=1)
        ...
        self.last_cross_se = CrossSEHead(in_channels=112)
        self.penultimate_cross_se = CrossSEHead(in_channels=40)
