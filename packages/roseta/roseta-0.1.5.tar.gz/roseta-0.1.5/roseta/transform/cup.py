...
from roseta.util.conf import get_conf
...
default_unit = conf["std_unit_check_dict"]["cup"][0]
...
def _func1(matched):
    n1, n2 = matched[0]
    if n1.isnumeric():
        num = int(cn2an(n1, mode="smart"))
        cup = n2
    else:
        num = int(cn2an(n2, mode="smart"))
        cup = n1
    ...
    # 欧码 65A-110H
        ...
        raise Exception(f"num 不在有效范围内 [32, 48] [65, 110]：{num}")
