...
from toolchain.pants.auth.client import AuthClient, AuthError, AuthState, RemoteCacheConfig
...
class AuthStore:
    def __init__(
        ...
        self._remote_cache_cfg: RemoteCacheConfig | None = None
    ...
    def _get_access_token(self) -> AuthToken | None:
        ...
        try:
            ...
            self._remote_cache_cfg = token_and_cfg.remote_cache_cfg
            self._state = AuthState.OK

        return self._access_token

    def get_remote_cache_config(self) -> RemoteCacheConfig | None:
        return self._remote_cache_cfg
