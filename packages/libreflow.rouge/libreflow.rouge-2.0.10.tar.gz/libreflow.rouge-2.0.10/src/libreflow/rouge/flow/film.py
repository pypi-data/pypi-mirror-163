    ...
    def check_files(self, paths):
        ...
        for path in paths:
            ...
            if os.path.isfile(path):
                ...
                if shot_name.endswith('_') or (shot_name[-1].isdigit() and shot_name[-2] == 't'):
                    shot_name = '_'.join(shot_name.split('_')[:-1])
                ...
                if shot != 'Create':
                    if shot.tasks[preset.task_name.get()].files.has_mapped_name(target_name) == True:
                        ...
                        if rev and file_name.endswith('_') == False or (shot_name[-1].isdigit() == False and shot_name[-2] != 't'):
            ...
            if os.path.isdir(path):
                ...
                for file_fullname in os.listdir(path):
                    ...
                    if '.plas' in file_fullname:
                        ...
                        if file_name.endswith('_') or (file_name[-1].isdigit() and file_name[-2] == 't'):
        ...
        for i in valid:
            ...
            for f in i['files']:
                ...
                if shot.files_map.has_mapped_name(i['shot'] + '_plas') == True:
                    ...
                    if name.endswith('_') or (name[-1].isdigit() and name[-2] == 't'):
                        continue
                ...
                if i['status'] == 'Create':
                    ...
                    if '.' in target_name:
                        target_name = target_name.replace('.', '_')
                    if i['status'].tasks[f['preset'].task_name.get()].files.has_mapped_name(target_name):
                        rev = i['status'].tasks[f['preset'].task_name.get()].files[target_name].get_head_revision()
