...
class Mongo(Module):
    ...
    async def prepare(self, scope):  # noqa
        ...
        _client = AsyncClient(
            self.module_settings.get('uri'),
            maxPoolSize=self.module_settings.get('pool_size'),
            minPoolSize=self.module_settings.get('pool_size'),
        )
    ...
    def collection_name(self) -> str:
        """Get collection name."""
        return self.module_settings.get('collection')
