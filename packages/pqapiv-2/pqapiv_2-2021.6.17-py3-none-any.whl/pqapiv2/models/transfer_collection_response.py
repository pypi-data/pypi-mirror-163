...
class TransferCollectionResponse(object):

    """Implementation of the 'transferCollection-Response' model.

    Response from a Transfer request

    Attributes:
        payload (list of TransferResponse): TODO: type description here.
    ...
    def __init__(self,
                 payload=None,
                 links=None):
        """Constructor for the TransferCollectionResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('payload') is not None:
            payload = [TransferResponse.from_dictionary(x) for x in dictionary.get('payload')]
        links = None
