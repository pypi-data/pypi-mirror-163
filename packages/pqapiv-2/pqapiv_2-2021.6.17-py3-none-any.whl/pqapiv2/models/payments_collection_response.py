...
class PaymentsCollectionResponse(object):

    """Implementation of the 'paymentsCollection-Response' model.

    Response from a Payment collection request

    Attributes:
        payload (list of PaymentResponse): TODO: type description here.
    ...
    def __init__(self,
                 payload=None,
                 links=None):
        """Constructor for the PaymentsCollectionResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('payload') is not None:
            payload = [PaymentResponse.from_dictionary(x) for x in dictionary.get('payload')]
        links = None
