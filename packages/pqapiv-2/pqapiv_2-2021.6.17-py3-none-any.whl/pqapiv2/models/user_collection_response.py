...
class UserCollectionResponse(object):
    ...
    """Implementation of the 'userCollection-Response' model.

    Response from a User Collection request

    Attributes:
        payload (list of UserResponse): TODO: type description here.
    ...
    def __init__(self,
                 payload=None,
                 links=None):
        """Constructor for the UserCollectionResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('payload') is not None:
            payload = [UserResponse.from_dictionary(x) for x in dictionary.get('payload')]
        links = None
