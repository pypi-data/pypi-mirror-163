...
release_notes = {
    '1.67.0': """
    Moving the items.csv file into RLBot so it can be used by both GUI and bots. - VirxEC
    """,
    '1.66.1': """
    Fix launching bots with venvs on non-windows. - VirxEC
    New epic_only launcher preference, and accepting Rocket League location option. - tarehart
    Bumping flatbuffers version. - VirxEC
    """,
    '1.65.1': """
