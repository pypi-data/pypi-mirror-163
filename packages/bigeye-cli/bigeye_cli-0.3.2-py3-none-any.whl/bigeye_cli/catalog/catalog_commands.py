...
from bigeye_sdk.generated.com.torodata.models.generated import MetricInfoList, WarehouseType, CreateSourceRequest, \
    TimeIntervalType, PredefinedMetricName, MetricCreationState, MetricConfiguration, TimeInterval, \
    BatchMetricConfigRequest, ForecastModelType
...
def delete_metrics(
    ...
    if metric_names:
        mil.metrics = [m for m in mil.metrics
                       if SimpleMetricCategory.get_metric_name(m.metric_configuration.metric_type) in metric_names]
