...
from taurex_2d.util.util import terminator2D, terminator2D3

class Clouds1DContribution(SimpleContribution, Contribution):
    """
    ...
    def contribute(self, model, start_layer, end_layer, density_offset, layer,
        ...
        tau[layer] += terminator2D3(self.sigma_xsec)[layer, :]
    ...
    def prepare_each(self, model, wngrid):
        ...
        contrib = np.zeros(shape=((model.nLayers,)+wngrid.shape))
        cloud_filtr = terminator2D(model.pressureProfile) >= self._cloud_pressure
