...
from mastapy.detailed_rigid_connectors.splines import (
    _1351, _1354, _1358, _1361,
    _1362, _1369, _1376, _1381
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1348.DetailedRigidConnectorDesign':
        ...
        if _1348.DetailedRigidConnectorDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1351.CustomSplineJointDesign':
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1354.DIN5480SplineJointDesign':
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1358.GBT3478SplineJointDesign':
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1361.ISO4156SplineJointDesign':
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1362.JISB1603SplineJointDesign':
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1369.SAESplineJointDesign':
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1376.SplineJointDesign':
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1381.StandardSplineJointDesign':
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1398.KeyedJointDesign':
        ...
        temp = self.wrapped.JointDesign
        if _1398.KeyedJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1406.InterferenceFitDesign':
