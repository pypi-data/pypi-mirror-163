...
from mastapy.detailed_rigid_connectors.keyed_joints import _1399, _1401
...
class KeyedJointDesign(_1406.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self) -> '_1399.KeyTypes':
        """KeyTypes: 'GeometryType' is the original name of this property."""

        temp = self.wrapped.GeometryType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1399.KeyTypes)(value) if value is not None else None

    @geometry_type.setter
    def geometry_type(self, value: '_1399.KeyTypes'):
    ...
    @property
    def number_of_keys(self) -> '_1401.NumberOfKeys':
        """NumberOfKeys: 'NumberOfKeys' is the original name of this property."""

        temp = self.wrapped.NumberOfKeys
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1401.NumberOfKeys)(value) if value is not None else None

    @number_of_keys.setter
    def number_of_keys(self, value: '_1401.NumberOfKeys'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
