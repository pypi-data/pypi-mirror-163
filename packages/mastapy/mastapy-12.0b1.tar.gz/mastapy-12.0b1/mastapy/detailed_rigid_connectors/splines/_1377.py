...
from mastapy.detailed_rigid_connectors.splines import _1359
...
class SplineMaterial(_260.Material):
    """SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_1359.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1359.HeatTreatmentTypes'):
