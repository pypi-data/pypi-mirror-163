...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1383
...
class SAESplineHalfDesign(_1380.StandardSplineHalfDesign):
    """SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1383.SAESplineTolerances':
