...
from mastapy.fe_tools.enums import _1227
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1227.ElementPropertyClass':
        ...
        return constructor.new_from_mastapy_type(_1227.ElementPropertyClass)(value) if value is not None else None
