...
from mastapy.nodal_analysis.dev_tools_analyses import _191, _181
...
class FEModel(_0.APIBase):
    ...
    @property
    def model_splitting_method(self) -> '_191.ModelSplittingMethod':
        ...
        return constructor.new_from_mastapy_type(_191.ModelSplittingMethod)(value) if value is not None else None

    @model_splitting_method.setter
    def model_splitting_method(self, value: '_191.ModelSplittingMethod'):
    ...
    def use_simplified_normal_calculation_when_deformed(self, value: 'bool'):
        self.wrapped.UseSimplifiedNormalCalculationWhenDeformed = bool(value) if value else False

    @property
    def beam_element_properties(self) -> 'List[_201.ElementPropertiesBeam]':
    ...
    @property
    def contact_pairs(self) -> 'List[_195.ContactPairReporting]':
    ...
    @property
    def coordinate_systems(self) -> 'List[_196.CoordinateSystemReporting]':
    ...
    @property
    def interface_element_properties(self) -> 'List[_202.ElementPropertiesInterface]':
    ...
    @property
    def mass_element_properties(self) -> 'List[_203.ElementPropertiesMass]':
    ...
    @property
    def materials(self) -> 'List[_209.MaterialPropertiesReporting]':
    ...
    @property
    def model_parts(self) -> 'List[_181.FEModelPart]':
    ...
    @property
    def other_element_properties(self) -> 'List[_200.ElementPropertiesBase]':
    ...
    @property
    def rigid_element_properties(self) -> 'List[_204.ElementPropertiesRigid]':
    ...
    @property
    def shell_element_properties(self) -> 'List[_205.ElementPropertiesShell]':
    ...
    @property
    def solid_element_properties(self) -> 'List[_206.ElementPropertiesSolid]':
    ...
    @property
    def spring_dashpot_element_properties(self) -> 'List[_207.ElementPropertiesSpringDashpot]':
    ...
    def get_all_element_details(self) -> '_199.ElementDetailsForFEModel':
    ...
    def get_all_node_details(self) -> '_210.NodeDetailsForFEModel':
