...
from mastapy.bearings import _1827
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1827.BearingRow':
        ...
        return constructor.new_from_mastapy_type(_1827.BearingRow)(value) if value is not None else None
