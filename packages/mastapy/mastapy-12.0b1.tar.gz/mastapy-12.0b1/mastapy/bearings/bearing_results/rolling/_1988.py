...
from mastapy.bearings.bearing_results.rolling import _1987, _1974
...
class LoadedSphericalRollerThrustBearingRow(_1974.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1987.LoadedSphericalRollerThrustBearingResults':
