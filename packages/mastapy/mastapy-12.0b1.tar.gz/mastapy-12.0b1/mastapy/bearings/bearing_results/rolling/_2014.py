...
from mastapy.bearings.bearing_results import _1893
from mastapy.bearings.bearing_results.rolling import _1922
...
class RollingBearingFrictionCoefficients(_1547.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    """RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1893.EquivalentLoadFactors':
    ...
    @property
    def iso14179_settings(self) -> '_1922.ISO14179Settings':
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1893.EquivalentLoadFactors':
