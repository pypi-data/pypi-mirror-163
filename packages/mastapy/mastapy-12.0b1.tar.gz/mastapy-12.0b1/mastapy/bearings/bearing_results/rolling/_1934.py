...
from mastapy.bearings.bearing_results.rolling import _1933, _1974
...
class LoadedAsymmetricSphericalRollerBearingRow(_1974.LoadedRollerBearingRow):
    """LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1933.LoadedAsymmetricSphericalRollerBearingResults':
