...
from mastapy.bearings.bearing_results.rolling import _2008, _1968
...
class LoadedCylindricalRollerBearingResults(_1968.LoadedNonBarrelRollerBearingResults):
    """LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_2008.PermissibleContinuousAxialLoadResults':
