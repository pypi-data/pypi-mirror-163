...
from mastapy.bearings.bearing_results.rolling import _1961, _1960, _1947
...
class LoadedFourPointContactBallBearingRow(_1947.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1961.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1960.LoadedFourPointContactBallBearingRaceResults]':
