...
from mastapy.bearings.bearing_results.rolling import _1992, _1969
...
class LoadedTaperRollerBearingRow(_1969.LoadedNonBarrelRollerBearingRow):
    """LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1992.LoadedTaperRollerBearingResults':
