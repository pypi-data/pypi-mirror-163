...
from mastapy.bearings.bearing_results.rolling import _1930, _1928
...
class LoadedAngularContactThrustBallBearingRow(_1928.LoadedAngularContactBallBearingRow):
    """LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1930.LoadedAngularContactThrustBallBearingResults':
