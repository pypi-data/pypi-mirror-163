...
from mastapy.bearings.bearing_results.rolling import _1938, _1941, _1969
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1969.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1938.LoadedAxialThrustCylindricalRollerBearingResults':
