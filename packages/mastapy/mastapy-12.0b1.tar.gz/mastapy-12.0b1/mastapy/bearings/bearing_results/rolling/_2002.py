...
from mastapy.bearings.bearing_results.rolling import _2001, _1974
...
class LoadedToroidalRollerBearingRow(_1974.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2001.LoadedToroidalRollerBearingResults':
