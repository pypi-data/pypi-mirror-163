...
class LoadedNonBarrelRollerBearingRow(_1974.LoadedRollerBearingRow):
    """LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1968.LoadedNonBarrelRollerBearingResults':
