...
from mastapy.bearings.bearing_results.rolling import _1980, _1947
...
class LoadedSelfAligningBallBearingRow(_1947.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1980.LoadedSelfAligningBallBearingResults':
