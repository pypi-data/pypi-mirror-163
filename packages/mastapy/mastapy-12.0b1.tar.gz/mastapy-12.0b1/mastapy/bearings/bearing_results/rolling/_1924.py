...
class ISO14179SettingsPerBearingType(_1547.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    """ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1845.RollingBearingType':
        ...
        return constructor.new_from_mastapy_type(_1845.RollingBearingType)(value) if value is not None else None
