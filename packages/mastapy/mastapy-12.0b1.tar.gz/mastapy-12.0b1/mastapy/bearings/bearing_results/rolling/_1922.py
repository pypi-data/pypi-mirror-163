...
from mastapy.math_utility.measured_data import _1527, _1528
...
class ISO14179Settings(_1785.NamedDatabaseItem):
    """ISO14179Settings
    ...
    @property
    def isotr141792001f1_specification_method(self) -> '_2009.PowerRatingF1EstimationMethod':
        ...
        return constructor.new_from_mastapy_type(_2009.PowerRatingF1EstimationMethod)(value) if value is not None else None

    @isotr141792001f1_specification_method.setter
    def isotr141792001f1_specification_method(self, value: '_2009.PowerRatingF1EstimationMethod'):
    ...
    @property
    def power_rating_f0_scaling_factor_one_dimensional_lookup_table(self) -> '_1527.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_one_dimensional_lookup_table(self) -> '_1527.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_scaling_factor_one_dimensional_lookup_table(self) -> '_1527.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_two_dimensional_lookup_table(self) -> '_1528.TwodimensionalFunctionLookupTable':
