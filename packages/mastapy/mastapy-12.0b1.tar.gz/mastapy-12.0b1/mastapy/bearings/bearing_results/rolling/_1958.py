...
from mastapy.bearings.bearing_results.rolling import _1921, _2018, _2017
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1921.InternalClearance':
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_2017.StressAtPosition]':
    ...
    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_2017.StressAtPosition]':
