...
from mastapy.bearings.tolerances import _1854
...
class ToleranceCombination(_0.APIBase):
    ...
    def fit(self) -> '_1854.FitType':
        ...
        return constructor.new_from_mastapy_type(_1854.FitType)(value) if value is not None else None
