...
from mastapy.bearings.bearing_designs.rolling import _2088
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_2088.BearingProtectionLevel':
        ...
        return constructor.new_from_mastapy_type(_2088.BearingProtectionLevel)(value) if value is not None else None
    ...
    @property
    def new_protection_level(self) -> '_2088.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_2088.BearingProtectionLevel'):
