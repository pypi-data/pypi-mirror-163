...
from mastapy.bearings.bearing_designs.rolling import _2096, _2102
...
class FourPointContactBallBearing(_2102.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_2096.FourPointContactAngleDefinition':
        ...
        return constructor.new_from_mastapy_type(_2096.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_2096.FourPointContactAngleDefinition'):
