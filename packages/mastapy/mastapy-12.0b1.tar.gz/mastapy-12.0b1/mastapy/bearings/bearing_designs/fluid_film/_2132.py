...
class PlainGreaseFilledJournalBearing(_2134.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_2133.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new_from_mastapy_type(_2133.PlainGreaseFilledJournalBearingHousingType)(value) if value is not None else None

    @housing_type.setter
    def housing_type(self, value: '_2133.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_2135.PlainJournalHousing':
        ...
        if _2135.PlainJournalHousing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_2128.CylindricalHousingJournalBearing':
        ...
        temp = self.wrapped.HousingDetail
        if _2128.CylindricalHousingJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_2129.MachineryEncasedJournalBearing':
        ...
        temp = self.wrapped.HousingDetail
        if _2129.MachineryEncasedJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_2131.PedestalJournalBearing':
        ...
        temp = self.wrapped.HousingDetail
        if _2131.PedestalJournalBearing.TYPE not in temp.__class__.__mro__:
