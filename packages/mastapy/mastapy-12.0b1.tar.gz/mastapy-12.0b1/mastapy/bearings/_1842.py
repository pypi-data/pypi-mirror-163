...
from mastapy.bearings import (
    _1845, _1843, _1818, _1834
)
from mastapy.math_utility import _1448
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1787
...
class RollingBearingDatabase(_1787.SQLDatabase['_1843.RollingBearingKey', '_2108.RollingBearing']):
    """RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2108.RollingBearing'):
    ...
    def create_bearing(self, type_: '_1845.RollingBearingType', designation: Optional['str'] = 'None') -> '_2108.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2108.RollingBearing':
        """ 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1845.RollingBearingType', designation: Optional['str'] = 'None') -> '_1843.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1843.RollingBearingKey':
        """ 'CreateKey' is the original name of this method.
    ...
    def remove_from_database(self, bearing: '_2108.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1818.BearingCatalog', type_: '_1845.RollingBearingType', bore_range: '_1448.Range', outer_diameter_range: '_1448.Range', width_range: '_1448.Range', dynamic_capacity_range: '_1448.Range', number_of_rows: 'int', material_type: '_1834.HybridSteelAll') -> 'List[_2108.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1818.BearingCatalog', type_: '_1845.RollingBearingType') -> 'List[_2108.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1818.BearingCatalog') -> '_2108.RollingBearing':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1818.BearingCatalog') -> 'List[_2108.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
