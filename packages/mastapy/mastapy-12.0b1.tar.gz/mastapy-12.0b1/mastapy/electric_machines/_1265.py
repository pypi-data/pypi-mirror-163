...
class NotchSpecification(_0.APIBase):
    ...
    @property
    def notch_shape(self) -> '_1264.NotchShape':
        """NotchShape: 'NotchShape' is the original name of this property."""

        temp = self.wrapped.NotchShape
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1264.NotchShape)(value) if value is not None else None

    @notch_shape.setter
    def notch_shape(self, value: '_1264.NotchShape'):
