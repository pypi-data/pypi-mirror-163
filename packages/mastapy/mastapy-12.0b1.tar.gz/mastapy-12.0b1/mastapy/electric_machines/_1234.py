...
from mastapy.electric_machines import _1235, _1229
...
class CADStator(_1229.AbstractStator):
    """CADStator
    ...
    def number_of_slots_for_imported_sector(self, value: 'int'):
        self.wrapped.NumberOfSlotsForImportedSector = int(value) if value else 0

    @property
    def tooth_and_slot(self) -> '_1235.CADToothAndSlot':
