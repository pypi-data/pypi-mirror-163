...
from mastapy.electric_machines.load_cases_and_analyses import _1340, _1316, _1323
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    @property
    def temperatures(self) -> '_1340.Temperatures':
    ...
    @property
    def analyses(self) -> 'List[_1316.ElectricMachineAnalysis]':
    ...
    def analysis_for(self, setup: '_1248.ElectricMachineSetup') -> '_1316.ElectricMachineAnalysis':
    ...
    def copy_to(self, another_group: '_1323.ElectricMachineLoadCaseGroup') -> 'ElectricMachineLoadCaseBase':
    ...
    def remove_analysis(self, electric_machine_analysis: '_1316.ElectricMachineAnalysis'):
    ...
    def remove_analysis_for(self, setup: '_1248.ElectricMachineSetup'):
