...
class ElectricMachineAnalysis(_0.APIBase):
    ...
    @property
    def load_case(self) -> '_1322.ElectricMachineLoadCaseBase':
        ...
        if _1322.ElectricMachineLoadCaseBase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_dynamic_force_load_case(self) -> '_1313.DynamicForceLoadCase':
        ...
        temp = self.wrapped.LoadCase
        if _1313.DynamicForceLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_efficiency_map_load_case(self) -> '_1315.EfficiencyMapLoadCase':
        ...
        temp = self.wrapped.LoadCase
        if _1315.EfficiencyMapLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_electric_machine_load_case(self) -> '_1321.ElectricMachineLoadCase':
    ...
    @property
    def load_case_of_type_non_linear_dq_model_multiple_operating_points_load_case(self) -> '_1329.NonLinearDQModelMultipleOperatingPointsLoadCase':
        ...
        temp = self.wrapped.LoadCase
        if _1329.NonLinearDQModelMultipleOperatingPointsLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_speed_torque_curve_load_case(self) -> '_1337.SpeedTorqueCurveLoadCase':
        ...
        temp = self.wrapped.LoadCase
        if _1337.SpeedTorqueCurveLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_speed_torque_load_case(self) -> '_1338.SpeedTorqueLoadCase':
        ...
        temp = self.wrapped.LoadCase
        if _1338.SpeedTorqueLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    def perform_analysis_with_progress(self, token: '_7471.TaskProgress'):
