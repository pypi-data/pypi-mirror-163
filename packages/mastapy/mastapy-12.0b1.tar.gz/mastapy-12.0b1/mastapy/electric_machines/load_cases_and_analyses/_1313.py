...
class DynamicForceLoadCase(_1329.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """DynamicForceLoadCase
    ...
    @property
    def number_of_steps_per_operating_point_specification_method(self) -> '_1330.NumberOfStepsPerOperatingPointSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_1330.NumberOfStepsPerOperatingPointSpecificationMethod)(value) if value is not None else None

    @number_of_steps_per_operating_point_specification_method.setter
    def number_of_steps_per_operating_point_specification_method(self, value: '_1330.NumberOfStepsPerOperatingPointSpecificationMethod'):
    ...
    @property
    def operating_points_specification_method(self) -> '_1331.OperatingPointsSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1331.OperatingPointsSpecificationMethod)(value) if value is not None else None

    @operating_points_specification_method.setter
    def operating_points_specification_method(self, value: '_1331.OperatingPointsSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OperatingPointsSpecificationMethod = value

    @property
    def speed_points_distribution(self) -> '_1335.SpeedPointsDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1335.SpeedPointsDistribution)(value) if value is not None else None

    @speed_points_distribution.setter
    def speed_points_distribution(self, value: '_1335.SpeedPointsDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpeedPointsDistribution = value

    @property
    def operating_points(self) -> 'List[_1339.SpeedTorqueOperatingPoint]':
    ...
    def add_operating_point_with_torque_and_speed(self, torque: 'float', speed: 'float') -> '_1339.SpeedTorqueOperatingPoint':
        """ 'AddOperatingPoint' is the original name of this method.
    ...
    def analysis_for(self, setup: '_1248.ElectricMachineSetup') -> '_1312.DynamicForceAnalysis':
    ...
    def remove_operating_point(self, operating_point: '_1339.SpeedTorqueOperatingPoint'):
