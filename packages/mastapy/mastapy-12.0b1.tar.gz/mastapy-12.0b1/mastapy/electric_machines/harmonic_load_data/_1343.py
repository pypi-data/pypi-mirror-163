...
class HarmonicLoadDataBase(_0.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_1471.FourierSeries]':
    ...
    def set_selected_harmonic_load_data(self, fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7472.MeasurementType'):
    ...
    def set_selected_harmonic_load_data_extended(self, amplitudes: 'List[float]', phases: 'List[float]', mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7472.MeasurementType'):
        """ 'SetSelectedHarmonicLoadData' is the original name of this method.
    ...
    def set_selected_harmonic_load_data_with_fourier_series(self, fourier_series: '_1471.FourierSeries'):
        """ 'SetSelectedHarmonicLoadData' is the original name of this method.
