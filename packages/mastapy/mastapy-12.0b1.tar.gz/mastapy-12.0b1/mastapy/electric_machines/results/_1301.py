...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def force_density_in_air_gap_mst_chart(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def results_for_stator_teeth(self) -> 'List[_1299.ElectricMachineResultsForStatorToothAtTimeStep]':
    ...
    @property
    def results_at_locations(self) -> 'List[_1302.ElectricMachineResultsTimeStepAtLocation]':
    ...
    @property
    def results_for_line_to_line(self) -> 'List[_1300.ElectricMachineResultsLineToLineAtTimeStep]':
    ...
    @property
    def results_for_phases(self) -> 'List[_1298.ElectricMachineResultsForPhaseAtTimeStep]':
