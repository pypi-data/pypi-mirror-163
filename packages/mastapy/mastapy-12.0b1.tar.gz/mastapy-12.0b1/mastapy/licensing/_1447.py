...
from mastapy.licensing import _7484, _7485, _7486
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_7484.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_7484.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_7485.ModuleDetails]':
    ...
    @staticmethod
    def get_available_module_details() -> 'Iterable[_7485.ModuleDetails]':
    ...
    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_7486.ModuleLicenceStatus]':
