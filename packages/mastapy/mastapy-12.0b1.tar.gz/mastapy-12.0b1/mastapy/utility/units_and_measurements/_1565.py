...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1558.RoundingMethods':
        """RoundingMethods: 'RoundingMethod' is the original name of this property."""

        temp = self.wrapped.RoundingMethod
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1558.RoundingMethods)(value) if value is not None else None

    @rounding_method.setter
    def rounding_method(self, value: '_1558.RoundingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RoundingMethod = value

    @property
    def current_unit(self) -> '_1570.Unit':
    ...
    @property
    def available_units(self) -> 'List[_1570.Unit]':
