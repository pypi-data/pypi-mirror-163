...
from mastapy.utility.databases import _1785, _1787, _1786
...
TValue = TypeVar('TValue', bound='_1785.NamedDatabaseItem')


class NamedDatabase(_1787.SQLDatabase['_1786.NamedKey', 'TValue'], Generic[TValue]):
    """NamedDatabase
    ...
    def create(self, name: 'str') -> 'TValue':
        ...
        return constructor.new(type_.Namespace, type_.Name)[TValue](method_result) if method_result is not None else None

    def duplicate(self, new_name: 'str', item: '_1785.NamedDatabaseItem') -> '_1785.NamedDatabaseItem':
    ...
    def rename(self, item: '_1785.NamedDatabaseItem', new_name: 'str') -> 'bool':
