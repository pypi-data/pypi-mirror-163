...
from mastapy.utility.report import _1728, _1731
...
TItem = TypeVar('TItem', bound='_1731.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1728.CustomReportMultiPropertyItemBase, Generic[TItem]):
    """CustomReportMultiPropertyItem
