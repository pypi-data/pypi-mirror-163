...
from mastapy.html import _295
from mastapy.utility.report import _1718
...
class CustomReportText(_1718.CustomReportDefinitionItem):
    """CustomReportText
    ...
    @property
    def heading_type(self) -> '_295.HeadingType':
        """HeadingType: 'HeadingType' is the original name of this property."""

        temp = self.wrapped.HeadingType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_295.HeadingType)(value) if value is not None else None

    @heading_type.setter
    def heading_type(self, value: '_295.HeadingType'):
