...
from mastapy.utility.report import _1743, _1736
...
class UserTextRow(_1736.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self) -> '_1743.HeadingSize':
        """HeadingSize: 'HeadingSize' is the original name of this property."""

        temp = self.wrapped.HeadingSize
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1743.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1743.HeadingSize'):
