...
from mastapy.utility.units_and_measurements.measurements import _1601
...
class DutyCyclePropertySummaryForce(_1793.DutyCyclePropertySummary['_1601.Force', 'T'], Generic[T]):
    """DutyCyclePropertySummaryForce
