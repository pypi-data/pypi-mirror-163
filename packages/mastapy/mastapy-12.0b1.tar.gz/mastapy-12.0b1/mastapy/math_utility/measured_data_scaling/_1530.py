...
from mastapy.math_utility.measured_data_scaling import _1531
...
TMeasurement = TypeVar('TMeasurement', bound='_1565.MeasurementBase')


class DataScalingReferenceValues(_1531.DataScalingReferenceValuesBase, Generic[TMeasurement]):
    """DataScalingReferenceValues
