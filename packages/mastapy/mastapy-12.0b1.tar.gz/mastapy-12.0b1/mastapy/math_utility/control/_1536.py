...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def differential_gain_vs_time_and_error(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def differential_gain_vs_time_and_error(self, value: '_1525.GriddedSurfaceAccessor'):
    ...
    @property
    def integral_gain_vs_time_and_error(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def integral_gain_vs_time_and_error(self, value: '_1525.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def proportional_gain_vs_time_and_error(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def proportional_gain_vs_time_and_error(self, value: '_1525.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def update_method(self) -> '_1481.PIDControlUpdateMethod':
        """PIDControlUpdateMethod: 'UpdateMethod' is the original name of this property."""

        temp = self.wrapped.UpdateMethod
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1481.PIDControlUpdateMethod)(value) if value is not None else None

    @update_method.setter
    def update_method(self, value: '_1481.PIDControlUpdateMethod'):
