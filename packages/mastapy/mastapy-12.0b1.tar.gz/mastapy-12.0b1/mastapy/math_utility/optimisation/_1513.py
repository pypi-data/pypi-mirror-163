...
from mastapy.math_utility.optimisation import _1514, _1512
...
class ParetoOptimistaionVariable(_1512.ParetoOptimisationVariableBase):
    """ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1514.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new_from_mastapy_type(_1514.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1514.PropertyTargetForDominantCandidateSearch'):
