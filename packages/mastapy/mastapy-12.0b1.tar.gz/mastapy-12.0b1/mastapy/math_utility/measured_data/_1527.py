...
from mastapy.math_utility.measured_data import _1526
...
class OnedimensionalFunctionLookupTable(_1526.LookupTableBase['OnedimensionalFunctionLookupTable']):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1493.Vector2DListAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1493.Vector2DListAccessor'):
