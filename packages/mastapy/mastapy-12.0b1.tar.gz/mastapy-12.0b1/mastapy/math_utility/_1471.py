...
class FourierSeries(_0.APIBase):
    ...
    def harmonic(self, index: 'int') -> '_1474.HarmonicValue':
    ...
    def harmonics_above_cut_off(self) -> 'List[_1474.HarmonicValue]':
    ...
    def harmonics_with_zeros_truncated(self) -> 'List[_1474.HarmonicValue]':
