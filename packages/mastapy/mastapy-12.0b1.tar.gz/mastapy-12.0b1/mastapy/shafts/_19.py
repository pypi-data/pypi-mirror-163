...
class ShaftDamageResults(_0.APIBase):
    ...
    @property
    def cyclic_degrees_of_utilisation(self) -> 'List[_1484.RealVector]':
    ...
    def shaft_damage_chart(self, item: 'str', title: 'str') -> '_1744.LegacyChartDefinition':
        ...
        Returns:
            mastapy.utility.report.LegacyChartDefinition
        """
