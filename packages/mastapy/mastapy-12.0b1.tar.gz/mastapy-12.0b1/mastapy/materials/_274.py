...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_275.SoundPressureEnclosureType':
        """SoundPressureEnclosureType: 'EnclosureType' is the original name of this property."""

        temp = self.wrapped.EnclosureType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_275.SoundPressureEnclosureType)(value) if value is not None else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_275.SoundPressureEnclosureType'):
