...
class OilPumpDetail(_1547.IndependentReportablePropertiesBase['OilPumpDetail']):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self) -> '_1493.Vector2DListAccessor':
    ...
    def electric_power_consumed_vs_speed(self, value: '_1493.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ElectricPowerConsumedVsSpeed = value

    @property
    def oil_flow_rate_vs_speed(self) -> '_1493.Vector2DListAccessor':
    ...
    def oil_flow_rate_vs_speed(self, value: '_1493.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.OilFlowRateVsSpeed = value

    @property
    def oil_pump_drive_type(self) -> '_290.OilPumpDriveType':
        """OilPumpDriveType: 'OilPumpDriveType' is the original name of this property."""

        temp = self.wrapped.OilPumpDriveType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_290.OilPumpDriveType)(value) if value is not None else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_290.OilPumpDriveType'):
    ...
    @property
    def operating_oil_pressure_vs_speed(self) -> '_1493.Vector2DListAccessor':
    ...
    def operating_oil_pressure_vs_speed(self, value: '_1493.Vector2DListAccessor'):
        value = value.wrapped if value else None
