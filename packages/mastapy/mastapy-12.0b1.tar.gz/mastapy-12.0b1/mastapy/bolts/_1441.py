...
class LoadedBolt(_0.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1424.AxialLoadType':
        """AxialLoadType: 'AxialLoadType' is the original name of this property."""

        temp = self.wrapped.AxialLoadType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1424.AxialLoadType)(value) if value is not None else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1424.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1440.JointTypes':
        """JointTypes: 'JointType' is the original name of this property."""

        temp = self.wrapped.JointType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1440.JointTypes)(value) if value is not None else None

    @joint_type.setter
    def joint_type(self, value: '_1440.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tightening_technique(self) -> '_1446.TighteningTechniques':
        """TighteningTechniques: 'TighteningTechnique' is the original name of this property."""

        temp = self.wrapped.TighteningTechnique
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1446.TighteningTechniques)(value) if value is not None else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1446.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bolt(self) -> '_1436.DetailedBoltDesign':
