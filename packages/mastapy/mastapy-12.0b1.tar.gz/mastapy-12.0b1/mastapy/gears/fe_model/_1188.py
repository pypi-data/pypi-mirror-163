...
class GearSetFEModel(_1217.GearSetImplementationDetail):
    """GearSetFEModel
    ...
    @property
    def gear_fe_models(self) -> 'List[_1185.GearFEModel]':
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1186.GearMeshFEModel]':
