...
from mastapy.gears.ltca import _828, _829
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    @property
    def columns(self) -> 'List[_828.GearFilletNodeStressResultsColumn]':
    ...
    @property
    def rows(self) -> 'List[_829.GearFilletNodeStressResultsRow]':
