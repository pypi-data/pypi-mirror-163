...
from mastapy.gears.ltca import _832, _830
...
class GearMeshLoadDistributionAnalysis(_1209.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self) -> '_1471.FourierSeries':
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1471.FourierSeries':
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_832.GearMeshLoadDistributionAtRotation]':
    ...
    def maximum_root_stress_with_flanks(self, gear: '_830.GearLoadDistributionAnalysis', flank: '_317.GearFlanks', stress_type: '_86.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_830.GearLoadDistributionAnalysis', stress_type: '_86.StressResultsType') -> 'float':
        """ 'MaximumRootStress' is the original name of this method.
