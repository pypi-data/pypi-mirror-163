...
from mastapy.gears import _314, _315
...
class CylindricalMeshLoadCase(_865.MeshLoadCase):
    """CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_315.CylindricalMisalignmentDataSource':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_315.CylindricalMisalignmentDataSource)(value) if value is not None else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_315.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_1049.LTCALoadCaseModifiableSettings':
