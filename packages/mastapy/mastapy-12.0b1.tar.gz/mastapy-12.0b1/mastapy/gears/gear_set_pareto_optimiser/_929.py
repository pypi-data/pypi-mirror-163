...
class StraightBevelGearSetParetoOptimiser(_902.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_954.StraightBevelGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_954.StraightBevelGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_954.StraightBevelGearSetDesign]':
