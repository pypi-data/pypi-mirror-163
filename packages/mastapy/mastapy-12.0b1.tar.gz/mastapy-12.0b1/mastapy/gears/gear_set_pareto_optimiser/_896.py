...
from mastapy.math_utility.optimisation import _1508, _1505, _1499
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_905.LargerOrSmaller':
        """LargerOrSmaller: 'RemoveCandidatesWith' is the original name of this property."""

        temp = self.wrapped.RemoveCandidatesWith
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_905.LargerOrSmaller)(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_905.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1508.ParetoOptimisationStrategy':
    ...
    @property
    def chart_details(self) -> 'List[_894.ChartInfoBase[TAnalysis, TCandidate]]':
    ...
    @property
    def filters(self) -> 'List[_1505.ParetoOptimisationFilter]':
    ...
    @property
    def input_setters(self) -> 'List[_1499.InputSetter[TAnalysis]]':
    ...
    @property
    def optimisation_targets(self) -> 'List[_912.OptimisationTarget[TAnalysis]]':
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_927.ReasonsForInvalidDesigns]':
    ...
    @property
    def table_filters(self) -> 'List[_930.TableFilter[TAnalysis, TCandidate]]':
        ...
        temp = self.wrapped.TableFilters
        value = conversion.pn_to_mp_objects_in_list(temp)
        return value
