...
class CylindricalGearSetParetoOptimiser(_902.GearSetParetoOptimiser):
    """CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_1019.CylindricalGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_1019.CylindricalGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_1019.CylindricalGearSetDesign]':
