...
class HypoidGearSetParetoOptimiser(_902.GearSetParetoOptimiser):
    """HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_978.HypoidGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_978.HypoidGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_978.HypoidGearSetDesign]':
