...
from mastapy.gears.manufacturing.bevel.control_parameters import _807
...
class ConicalManufacturingSGMControlParameters(_807.ConicalGearManufacturingControlParameters):
    """ConicalManufacturingSGMControlParameters
