...
from mastapy.gears.manufacturing.bevel import _788, _802
...
class ManufacturingMachine(_1785.NamedDatabaseItem):
    """ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_788.MachineTypes':
        """MachineTypes: 'MachineType' is the original name of this property."""

        temp = self.wrapped.MachineType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_788.MachineTypes)(value) if value is not None else None

    @machine_type.setter
    def machine_type(self, value: '_788.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_802.WheelFormatMachineTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_802.WheelFormatMachineTypes)(value) if value is not None else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_802.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
