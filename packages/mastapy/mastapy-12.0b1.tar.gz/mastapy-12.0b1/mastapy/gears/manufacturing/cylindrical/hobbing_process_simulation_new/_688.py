...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _652, _684
...
class WormGrindingProcessProfileCalculation(_684.WormGrindingProcessCalculation):
    """WormGrindingProcessProfileCalculation
    ...
    @property
    def left_flank(self) -> '_652.CalculateProfileDeviationAccuracy':
    ...
    @property
    def right_flank(self) -> '_652.CalculateProfileDeviationAccuracy':
