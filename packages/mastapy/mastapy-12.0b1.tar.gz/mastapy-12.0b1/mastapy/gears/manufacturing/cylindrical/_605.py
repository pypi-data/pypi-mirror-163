...
from mastapy.gears.manufacturing.cylindrical.cutters import _699
...
class CylindricalHobDatabase(_600.CylindricalCutterDatabase['_699.CylindricalGearHobDesign']):
    """CylindricalHobDatabase
