...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _746, _760, _745
...
class PlungeShavingDynamicsViewModel(_760.ShavingDynamicsViewModel['_745.PlungeShaverDynamics']):
    """PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_746.PlungeShaverDynamicSettings':
