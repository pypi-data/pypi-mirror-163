...
from mastapy.gears.manufacturing.cylindrical import _623, _622
...
class MicroGeometryInputsLead(_623.MicroGeometryInputs['_622.LeadModificationSegment']):
    """MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1448.Range':
