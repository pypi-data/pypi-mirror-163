...
from mastapy.gears.manufacturing.cylindrical import _624, _625
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_624.MicroGeometryInputsLead':
    ...
    @property
    def profile_micro_geometry(self) -> 'List[_625.MicroGeometryInputsProfile]':
