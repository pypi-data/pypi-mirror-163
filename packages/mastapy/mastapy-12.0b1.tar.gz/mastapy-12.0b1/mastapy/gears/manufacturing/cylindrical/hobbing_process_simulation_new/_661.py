...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _652, _656
...
class HobbingProcessProfileCalculation(_656.HobbingProcessCalculation):
    """HobbingProcessProfileCalculation
