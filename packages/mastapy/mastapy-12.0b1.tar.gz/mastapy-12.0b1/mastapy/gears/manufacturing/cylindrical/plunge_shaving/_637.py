...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _638, _647
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_638.PlungeShaverCalculationInputs':
    ...
    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_647.VirtualPlungeShaverOutputs':
