...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _632, _646
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1448.Range':
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_995.CrossedAxisCylindricalGearPairLineContact':
    ...
    @property
    def calculation_errors(self) -> 'List[_632.CalculationError]':
    ...
    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_646.ShaverPointOfInterest]':
