...
class ShavingDynamicsCalculationForDesignedGears(_756.ShavingDynamicsCalculation['T'], Generic[T]):
    """ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def end_of_shaving_profile(self) -> '_1016.CylindricalGearProfileMeasurement':
    ...
    @property
    def redressing(self) -> '_754.ShaverRedressing[T]':
    ...
    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_740.AxialShaverRedressing':
    ...
    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_747.PlungeShaverRedressing':
    ...
    @property
    def start_of_shaving_profile(self) -> '_1016.CylindricalGearProfileMeasurement':
