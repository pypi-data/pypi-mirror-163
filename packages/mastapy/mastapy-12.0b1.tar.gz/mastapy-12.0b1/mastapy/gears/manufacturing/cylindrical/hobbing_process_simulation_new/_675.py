...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def analysis_setting(self) -> '_649.AnalysisMethod':
        """AnalysisMethod: 'AnalysisSetting' is the original name of this property."""

        temp = self.wrapped.AnalysisSetting
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_649.AnalysisMethod)(value) if value is not None else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_649.AnalysisMethod'):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_653.CentreDistanceOffsetMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_653.CentreDistanceOffsetMethod)(value) if value is not None else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_653.CentreDistanceOffsetMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1493.Vector2DListAccessor':
    ...
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1493.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight = value

    @property
    def cutter_head_slide_error(self) -> '_654.CutterHeadSlideError':
    ...
    @property
    def cutter_mounting_error(self) -> '_680.RackMountingError':
    ...
    @property
    def gear_mounting_error(self) -> '_655.GearMountingError':
