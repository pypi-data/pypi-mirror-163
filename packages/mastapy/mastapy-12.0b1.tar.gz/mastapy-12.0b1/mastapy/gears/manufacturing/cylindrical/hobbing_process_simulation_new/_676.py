...
T = TypeVar('T', bound='_675.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def gear_tooth_shape_calculation(self) -> '_671.ProcessGearShape':
    ...
    @property
    def lead_calculation(self) -> '_672.ProcessLeadCalculation':
    ...
    @property
    def pitch_calculation(self) -> '_673.ProcessPitchCalculation':
    ...
    @property
    def profile_calculation(self) -> '_674.ProcessProfileCalculation':
    ...
    @property
    def total_modification_calculation(self) -> '_678.ProcessTotalModificationCalculation':
