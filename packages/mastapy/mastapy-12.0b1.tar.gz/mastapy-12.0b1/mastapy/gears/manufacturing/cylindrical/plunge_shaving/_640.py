...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _635, _636, _643
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_643.PointOfInterest]':
    ...
    @property
    def points_of_interest_right_flank(self) -> 'List[_643.PointOfInterest]':
