...
class CylindricalGearFormGrindingWheel(_703.CylindricalGearRealCutterDesign):
    """CylindricalGearFormGrindingWheel
    ...
    @property
    def right_hand_cutting_edge_shape(self) -> '_1493.Vector2DListAccessor':
    ...
    def right_hand_cutting_edge_shape(self, value: '_1493.Vector2DListAccessor'):
