...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _651, _684
...
class WormGrindingProcessPitchCalculation(_684.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def left_flank(self) -> '_651.CalculatePitchDeviationAccuracy':
    ...
    @property
    def right_flank(self) -> '_651.CalculatePitchDeviationAccuracy':
