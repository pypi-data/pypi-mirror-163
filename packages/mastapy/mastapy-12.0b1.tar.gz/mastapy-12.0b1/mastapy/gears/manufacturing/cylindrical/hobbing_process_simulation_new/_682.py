...
class WormGrindingCutterCalculation(_684.WormGrindingProcessCalculation):
    """WormGrindingCutterCalculation
    ...
    @property
    def grinder_tooth_shape_chart(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def input_gear_point_of_interest(self) -> '_643.PointOfInterest':
