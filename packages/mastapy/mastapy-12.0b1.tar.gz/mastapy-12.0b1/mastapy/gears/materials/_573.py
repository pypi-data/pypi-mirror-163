...
from mastapy.materials import _233, _231, _232
...
class AGMACylindricalGearMaterial(_581.CylindricalGearMaterial):
    """AGMACylindricalGearMaterial
    ...
    def grade(self) -> '_233.AGMAMaterialGrade':
        ...
        return constructor.new_from_mastapy_type(_233.AGMAMaterialGrade)(value) if value is not None else None
    ...
    def material_application(self) -> '_231.AGMAMaterialApplications':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_231.AGMAMaterialApplications)(value) if value is not None else None
    ...
    def material_class(self) -> '_232.AGMAMaterialClasses':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_232.AGMAMaterialClasses)(value) if value is not None else None
