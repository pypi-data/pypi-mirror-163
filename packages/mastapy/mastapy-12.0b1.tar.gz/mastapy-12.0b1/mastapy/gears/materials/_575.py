...
from mastapy.gears.materials import _577
...
class BevelGearISOMaterial(_577.BevelGearMaterial):
    """BevelGearISOMaterial
    ...
    def quality_grade(self) -> '_269.QualityGrade':
        ...
        return constructor.new_from_mastapy_type(_269.QualityGrade)(value) if value is not None else None
