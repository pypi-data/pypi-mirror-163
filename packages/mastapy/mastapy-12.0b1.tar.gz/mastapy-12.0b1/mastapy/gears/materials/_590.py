...
from mastapy.gears.materials import _585, _591
...
class KlingelnbergConicalGearMaterialDatabase(_585.GearMaterialDatabase['_591.KlingelnbergCycloPalloidConicalGearMaterial']):
    """KlingelnbergConicalGearMaterialDatabase
