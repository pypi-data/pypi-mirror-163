...
class BevelHypoidGearDesignSettingsItem(_1785.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    def quality_grade_type(self) -> '_335.QualityGradeTypes':
    ...
    def quality_grade_type(self, value: '_335.QualityGradeTypes'):
