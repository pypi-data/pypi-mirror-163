...
from mastapy.gleason_smt_link import _296
from mastapy.gears import _336, _339
from mastapy.gears.gear_designs.conical import _1153, _1144
...
class AGMAGleasonConicalGearSetDesign(_1144.ConicalGearSetDesign):
    """AGMAGleasonConicalGearSetDesign
    ...
    @property
    def manufacturing_method(self) -> '_296.CutterMethod':
        """CutterMethod: 'ManufacturingMethod' is the original name of this property."""

        temp = self.wrapped.ManufacturingMethod
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_296.CutterMethod)(value) if value is not None else None

    @manufacturing_method.setter
    def manufacturing_method(self, value: '_296.CutterMethod'):
    ...
    @property
    def reliability_requirement_agma(self) -> '_336.SafetyRequirementsAGMA':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_336.SafetyRequirementsAGMA)(value) if value is not None else None

    @reliability_requirement_agma.setter
    def reliability_requirement_agma(self, value: '_336.SafetyRequirementsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ReliabilityRequirementAGMA = value

    @property
    def reliability_requirement_gleason(self) -> '_1153.GleasonSafetyRequirements':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1153.GleasonSafetyRequirements)(value) if value is not None else None

    @reliability_requirement_gleason.setter
    def reliability_requirement_gleason(self, value: '_1153.GleasonSafetyRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_taper(self) -> '_339.SpiralBevelToothTaper':
        """SpiralBevelToothTaper: 'ToothTaper' is the original name of this property."""

        temp = self.wrapped.ToothTaper
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_339.SpiralBevelToothTaper)(value) if value is not None else None

    @tooth_taper.setter
    def tooth_taper(self, value: '_339.SpiralBevelToothTaper'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def conical_meshes(self) -> 'List[_1182.AGMAGleasonConicalGearMeshDesign]':
    ...
    @property
    def meshes(self) -> 'List[_1182.AGMAGleasonConicalGearMeshDesign]':
