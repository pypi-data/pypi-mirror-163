...
from mastapy.gears.gear_designs.cylindrical import _1014, _998
...
class CylindricalGearPinionTypeCutterFlank(_998.CylindricalGearAbstractRackFlank):
    """CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_1014.CylindricalGearPinionTypeCutter':
