...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_997.CylindricalGearAbstractRack':
        ...
        if _997.CylindricalGearAbstractRack.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_999.CylindricalGearBasicRack':
        ...
        temp = self.wrapped.CylindricalGearCutter
        if _999.CylindricalGearBasicRack.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_1014.CylindricalGearPinionTypeCutter':
        ...
        temp = self.wrapped.CylindricalGearCutter
        if _1014.CylindricalGearPinionTypeCutter.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_1066.StandardRack':
        ...
        temp = self.wrapped.CylindricalGearCutter
        if _1066.StandardRack.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def manufacturing_configuration(self) -> '_602.CylindricalGearManufacturingConfig':
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_1022.CylindricalGearSetManufacturingConfigurationSelection':
