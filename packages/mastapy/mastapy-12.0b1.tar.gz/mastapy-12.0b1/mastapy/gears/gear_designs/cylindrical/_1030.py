...
from mastapy.gears.gear_designs.cylindrical import _1073, _990
...
class CylindricalMeshLinearBacklashSpecification(_1073.TolerancedValueSpecification['_990.BacklashSpecification']):
    """CylindricalMeshLinearBacklashSpecification
