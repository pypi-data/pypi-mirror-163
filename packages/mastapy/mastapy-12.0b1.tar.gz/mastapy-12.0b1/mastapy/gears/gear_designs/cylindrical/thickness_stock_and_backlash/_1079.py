...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _1080
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.gears.gear_designs.cylindrical import (
    _1073, _1027, _1030, _1058
)
...
class FinishStockSpecification(_1058.RelativeValuesSpecification['FinishStockSpecification']):
    """FinishStockSpecification
    ...
    @property
    def finish_stock_rough_thickness_specification_method(self) -> '_1080.FinishStockType':
        ...
        return constructor.new_from_mastapy_type(_1080.FinishStockType)(value) if value is not None else None

    @finish_stock_rough_thickness_specification_method.setter
    def finish_stock_rough_thickness_specification_method(self, value: '_1080.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockRoughThicknessSpecificationMethod = value

    @property
    def normal(self) -> '_1073.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1073.TolerancedValueSpecification[FinishStockSpecification].TYPE not in temp.__class__.__mro__:
    ...
    @property
    def tangent_to_reference_circle(self) -> '_1073.TolerancedValueSpecification[FinishStockSpecification]':
