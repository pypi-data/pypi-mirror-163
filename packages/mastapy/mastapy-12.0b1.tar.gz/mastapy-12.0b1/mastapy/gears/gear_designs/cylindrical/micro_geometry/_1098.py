...
from mastapy.gears.gear_two_d_fe_analysis import _887
...
class CylindricalGearSetMicroGeometryDutyCycle(_1216.GearSetImplementationAnalysisDutyCycle):
    """CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def rating(self) -> '_454.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def tiff_analysis(self) -> '_887.CylindricalGearSetTIFFAnalysisDutyCycle':
    ...
    @property
    def meshes(self) -> 'List[_1089.CylindricalGearMeshMicroGeometryDutyCycle]':
