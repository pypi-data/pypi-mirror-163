...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_1102.DrawDefiningGearOrBoth':
        """DrawDefiningGearOrBoth: 'GearOption' is the original name of this property."""

        temp = self.wrapped.GearOption
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1102.DrawDefiningGearOrBoth)(value) if value is not None else None

    @gear_option.setter
    def gear_option(self, value: '_1102.DrawDefiningGearOrBoth'):
