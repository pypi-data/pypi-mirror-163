...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_1003.CylindricalGearDesign':
    ...
    @property
    def left_flank(self) -> '_998.CylindricalGearAbstractRackFlank':
        ...
        if _998.CylindricalGearAbstractRackFlank.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_1000.CylindricalGearBasicRackFlank':
        ...
        temp = self.wrapped.LeftFlank
        if _1000.CylindricalGearBasicRackFlank.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_1015.CylindricalGearPinionTypeCutterFlank':
        ...
        temp = self.wrapped.LeftFlank
        if _1015.CylindricalGearPinionTypeCutterFlank.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_standard_rack_flank(self) -> '_1067.StandardRackFlank':
        ...
        temp = self.wrapped.LeftFlank
        if _1067.StandardRackFlank.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_998.CylindricalGearAbstractRackFlank':
    ...
    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_1000.CylindricalGearBasicRackFlank':
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_1015.CylindricalGearPinionTypeCutterFlank':
    ...
    @property
    def right_flank_of_type_standard_rack_flank(self) -> '_1067.StandardRackFlank':
    ...
    @property
    def shaper_for_agma_rating(self) -> '_704.CylindricalGearShaper':
    ...
    @property
    def flanks(self) -> 'List[_998.CylindricalGearAbstractRackFlank]':
    ...
    @property
    def both_flanks(self) -> '_998.CylindricalGearAbstractRackFlank':
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_1000.CylindricalGearBasicRackFlank':
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_1015.CylindricalGearPinionTypeCutterFlank':
    ...
    @property
    def both_flanks_of_type_standard_rack_flank(self) -> '_1067.StandardRackFlank':
