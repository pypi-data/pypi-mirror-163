...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1086
...
class CylindricalGearLeadModificationAtProfilePosition(_1086.CylindricalGearLeadModification):
    """CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_1016.CylindricalGearProfileMeasurement':
