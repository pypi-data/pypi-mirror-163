...
class AGMA20151AccuracyGrades(_1128.CylindricalAccuracyGrades):
    """AGMA20151AccuracyGrades
    ...
    @property
    def cylindrical_gear_rating_settings(self) -> '_445.CylindricalGearDesignAndRatingSettingsItem':
