...
from mastapy.utility.report import _1738
...
class CylindricalGearTableWithMGCharts(_1738.CustomTable):
    """CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_1024.CylindricalGearTableMGItemDetail':
        """CylindricalGearTableMGItemDetail: 'ItemDetail' is the original name of this property."""

        temp = self.wrapped.ItemDetail
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1024.CylindricalGearTableMGItemDetail)(value) if value is not None else None

    @item_detail.setter
    def item_detail(self, value: '_1024.CylindricalGearTableMGItemDetail'):
