...
from mastapy.gears.gear_designs.conical import _1156, _1144
...
class KlingelnbergConicalGearSetDesign(_1144.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1156.KlingelnbergFinishingMethods':
        """KlingelnbergFinishingMethods: 'GearFinish' is the original name of this property."""

        temp = self.wrapped.GearFinish
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1156.KlingelnbergFinishingMethods)(value) if value is not None else None

    @gear_finish.setter
    def gear_finish(self, value: '_1156.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_973.KlingelnbergConicalGearMeshDesign]':
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_973.KlingelnbergConicalGearMeshDesign]':
