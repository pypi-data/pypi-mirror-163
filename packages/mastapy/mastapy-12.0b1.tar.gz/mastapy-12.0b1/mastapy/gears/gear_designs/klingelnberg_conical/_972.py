...
class KlingelnbergConicalGearDesign(_1142.ConicalGearDesign):
    """KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_591.KlingelnbergCycloPalloidConicalGearMaterial':
