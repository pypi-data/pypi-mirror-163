...
from mastapy.gears.gear_designs.straight_bevel import _954, _952, _955
...
class StraightBevelGearMeshDesign(_1169.BevelGearMeshDesign):
    """StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_meshed_gears(self) -> 'List[_955.StraightBevelMeshedGearDesign]':
