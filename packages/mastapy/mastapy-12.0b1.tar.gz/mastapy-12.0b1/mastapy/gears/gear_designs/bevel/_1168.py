...
class BevelGearDesign(_1181.AGMAGleasonConicalGearDesign):
    """BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1174.FinishingMethods':
        """FinishingMethods: 'FinishingMethod' is the original name of this property."""

        temp = self.wrapped.FinishingMethod
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1174.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1174.FinishingMethods'):
