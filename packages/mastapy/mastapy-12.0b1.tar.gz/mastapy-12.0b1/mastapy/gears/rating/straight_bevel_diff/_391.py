...
from mastapy.gears.rating.straight_bevel_diff import _390, _389
...
class StraightBevelDiffGearSetRating(_532.ConicalGearSetRating):
    """StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_958.StraightBevelDiffGearSetDesign':
    ...
    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_389.StraightBevelDiffGearMeshRating]':
