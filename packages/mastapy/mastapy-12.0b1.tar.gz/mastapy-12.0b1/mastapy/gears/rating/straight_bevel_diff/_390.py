...
from mastapy.gears.rating.conical import _530
...
class StraightBevelDiffGearRating(_530.ConicalGearRating):
    """StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_956.StraightBevelDiffGearDesign':
