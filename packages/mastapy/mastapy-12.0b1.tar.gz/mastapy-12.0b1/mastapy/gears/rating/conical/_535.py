...
from mastapy.gears.gear_designs.conical import _1140
...
class ConicalMeshedGearRating(_0.APIBase):
    ...
    @property
    def active_flank(self) -> '_1140.ConicalFlanks':
        ...
        return constructor.new_from_mastapy_type(_1140.ConicalFlanks)(value) if value is not None else None
