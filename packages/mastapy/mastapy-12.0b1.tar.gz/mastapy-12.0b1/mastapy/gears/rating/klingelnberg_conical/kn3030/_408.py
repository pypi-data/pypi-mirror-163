...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _407
...
class KlingelnbergCycloPalloidHypoidGearSingleFlankRating(_407.KlingelnbergCycloPalloidConicalGearSingleFlankRating):
    """KlingelnbergCycloPalloidHypoidGearSingleFlankRating
