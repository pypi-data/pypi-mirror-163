...
class KlingelnbergCycloPalloidSpiralBevelGearMeshRating(_402.KlingelnbergCycloPalloidConicalGearMeshRating):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshRating
    ...
    @property
    def kn3030_klingelnberg_mesh_single_flank_rating(self) -> '_410.KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_965.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
