...
from mastapy.gears.rating.cylindrical.iso6336 import _498, _509
...
class ISO63362006GearSingleFlankRating(_509.ISO6336AbstractMetalGearSingleFlankRating):
    """ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_498.CylindricalGearToothFatigueFractureResults':
