...
class ISO6336AbstractMetalMeshSingleFlankRating(_508.ISO6336AbstractMeshSingleFlankRating):
    """ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_471.ScuffingFlashTemperatureRatingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_471.ScuffingFlashTemperatureRatingMethod)(value) if value is not None else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_472.ScuffingIntegralTemperatureRatingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_472.ScuffingIntegralTemperatureRatingMethod)(value) if value is not None else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_1063.ScuffingTemperatureMethodsISO':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1063.ScuffingTemperatureMethodsISO)(value) if value is not None else None
    ...
    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_504.ISO63362006MeshSingleFlankRating':
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_450.CylindricalGearMicroPittingResults':
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_509.ISO6336AbstractMetalGearSingleFlankRating]':
