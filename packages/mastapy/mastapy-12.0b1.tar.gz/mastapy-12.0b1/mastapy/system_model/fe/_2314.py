...
from mastapy.electric_machines.results import _1305
...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2313.ElectricMachineDataSet]':
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2313.ElectricMachineDataSet':
    ...
    def add_electric_machine_data_set_from_masta_dynamic_force_analysis(self, analysis: '_1305.IHaveDynamicForceResults', slice_index: 'int') -> '_2313.ElectricMachineDataSet':
        ...
        method_result = self.wrapped.AddElectricMachineDataSetFromMASTADynamicForceAnalysis(analysis.wrapped if analysis else None, slice_index if slice_index else 0)
        type_ = method_result.GetType()
        return constructor.new(type_.Namespace, type_.Name)(method_result) if method_result is not None else None
