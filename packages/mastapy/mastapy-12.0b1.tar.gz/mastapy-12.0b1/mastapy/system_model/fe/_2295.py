...
from mastapy.math_utility import _1451, _1450
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.system_model.fe import _2306
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1451.Axis':
        ...
        return constructor.new_from_mastapy_type(_1451.Axis)(value) if value is not None else None

    @component_direction_normal_to_surface.setter
    def component_direction_normal_to_surface(self, value: '_1451.Axis'):
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1450.AlignmentAxis':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1450.AlignmentAxis)(value) if value is not None else None

    @fe_axis_approximately_in_perpendicular_direction.setter
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1450.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FEAxisApproximatelyInPerpendicularDirection = value

    @property
    def first_component_alignment_axis(self) -> '_1451.Axis':
    ...
    def first_component_alignment_axis(self, value: '_1451.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FirstComponentAlignmentAxis = value

    @property
    def first_fe_alignment_axis(self) -> '_1450.AlignmentAxis':
    ...
    def first_fe_alignment_axis(self, value: '_1450.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
