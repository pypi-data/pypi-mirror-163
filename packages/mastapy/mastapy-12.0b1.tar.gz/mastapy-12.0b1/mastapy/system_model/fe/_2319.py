...
from mastapy.system_model.fe import _2328
...
class FEPartWithBatchOptions(_0.APIBase):
    ...
    @property
    def f_es(self) -> 'List[_2328.FESubstructureWithBatchOptions]':
    ...
    @property
    def f_es_with_external_files(self) -> 'List[_2328.FESubstructureWithBatchOptions]':
