...
from mastapy.nodal_analysis.dev_tools_analyses import _171, _180
from mastapy.nodal_analysis import _64
from mastapy.system_model.fe import _2326, _2329
...
class FESubstructureWithSelectionForModalAnalysis(_2329.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_180.FEModelModalAnalysisDrawStyle':
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2326.FESubstructureNodeModeShapes]':
