...
from mastapy.electric_machines.harmonic_load_data import _1345
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6890.TorqueRippleInputType':
        ...
        return constructor.new_from_mastapy_type(_6890.TorqueRippleInputType)(value) if value is not None else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6890.TorqueRippleInputType'):
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7472.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7472.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_fe_node(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', node: '_2324.FESubstructureNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7472.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', node: '_2324.FESubstructureNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7472.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType') -> '_1479.MultipleFourierSeriesInterpolator':
    ...
    def multiple_fourier_series_interpolator_for_with_fe_node(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', node: '_2324.FESubstructureNode') -> '_1479.MultipleFourierSeriesInterpolator':
        """ 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
