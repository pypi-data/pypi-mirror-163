...
class FESubstructureNode(_67.FEStiffnessNode):
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system(self) -> '_1523.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system_with_gravity_in_fex_direction(self) -> '_1523.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system_with_gravity_in_fey_direction(self) -> '_1523.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system_with_gravity_in_fez_direction(self) -> '_1523.VectorWithLinearAndAngularComponents':
