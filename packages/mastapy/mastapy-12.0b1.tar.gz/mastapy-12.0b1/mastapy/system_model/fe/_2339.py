...
from mastapy.system_model.fe import _2311, _2312
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_angular(self) -> 'List[_2311.DegreeOfFreedomBoundaryConditionAngular]':
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2312.DegreeOfFreedomBoundaryConditionLinear]':
