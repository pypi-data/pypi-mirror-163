...
from mastapy.system_model.drawing import _2196
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2738.ShaftSystemDeflection':
    ...
    @property
    def node_results(self) -> 'List[_2196.ShaftDeflectionDrawingNodeItem]':
