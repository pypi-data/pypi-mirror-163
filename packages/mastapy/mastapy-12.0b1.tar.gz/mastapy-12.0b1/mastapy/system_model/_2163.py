...
from mastapy.math_utility import _1450
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.system_model import _2164
from mastapy import _0
from mastapy.system_model.part_model import _2384
...
T = TypeVar('T', bound='_2384.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1450.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1450.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_2164.RelativeOffsetOption':
        """RelativeOffsetOption: 'AxialOffset' is the original name of this property."""

        temp = self.wrapped.AxialOffset
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2164.RelativeOffsetOption)(value) if value is not None else None

    @axial_offset.setter
    def axial_offset(self, value: '_2164.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
