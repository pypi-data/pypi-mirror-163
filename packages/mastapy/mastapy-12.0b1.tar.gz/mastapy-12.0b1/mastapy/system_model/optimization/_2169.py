...
from mastapy.system_model.optimization import _2178, _2170
...
class ConicalGearOptimisationStrategy(_2178.OptimizationStrategy['_2170.ConicalGearOptimizationStep']):
    """ConicalGearOptimisationStrategy
