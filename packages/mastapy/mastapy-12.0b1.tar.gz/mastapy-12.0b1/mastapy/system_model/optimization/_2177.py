...
from mastapy.system_model.optimization import _2176
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_2176.MicroGeometryOptimisationTarget':
        ...
        return constructor.new_from_mastapy_type(_2176.MicroGeometryOptimisationTarget)(value) if value is not None else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_2176.MicroGeometryOptimisationTarget'):
