...
from mastapy.materials.efficiency import _291, _292
...
class OilSeal(_2387.Connector):
    ...
    @property
    def drag_torque_vs_rotational_speed(self) -> '_1493.Vector2DListAccessor':
    ...
    def drag_torque_vs_rotational_speed(self, value: '_1493.Vector2DListAccessor'):
    ...
    @property
    def oil_seal_material(self) -> '_292.OilSealMaterialType':
        """OilSealMaterialType: 'OilSealMaterial' is the original name of this property."""

        temp = self.wrapped.OilSealMaterial
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_292.OilSealMaterialType)(value) if value is not None else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_292.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1908.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1908.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
