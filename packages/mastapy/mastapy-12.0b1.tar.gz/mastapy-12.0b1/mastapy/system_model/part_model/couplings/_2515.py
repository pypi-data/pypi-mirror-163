...
from mastapy.system_model.part_model.couplings import _2516, _2529
from mastapy.system_model.connections_and_sockets import _2208
...
class BeltDrive(_2416.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2516.BeltDriveType':
        """BeltDriveType: 'TypeOfBelt' is the original name of this property."""

        temp = self.wrapped.TypeOfBelt
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2516.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2516.BeltDriveType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfBelt = value

    @property
    def belt_connections(self) -> 'List[_2208.BeltConnection]':
    ...
    @property
    def pulleys(self) -> 'List[_2529.Pulley]':
