...
from mastapy.system_model.part_model.couplings import _2542, _2544
...
class SynchroniserHalf(_2544.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2542.SynchroniserCone]':
