...
from mastapy.system_model.part_model.couplings import _2547, _2549, _2522
...
class TorqueConverter(_2522.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self) -> '_2547.TorqueConverterPump':
    ...
    @property
    def turbine(self) -> '_2549.TorqueConverterTurbine':
