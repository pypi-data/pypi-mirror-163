...
from mastapy.detailed_rigid_connectors.splines import (
    _1371, _1356, _1376, _1351,
    _1354, _1358, _1361, _1362,
    _1369, _1381
)
from mastapy.system_model.part_model.couplings import (
    _2530, _2531, _2533, _2534,
    _2538, _2532
)
from mastapy.detailed_rigid_connectors.interference_fits import _1406
from mastapy.detailed_rigid_connectors.keyed_joints import _1398
...
class ShaftHubConnection(_2387.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self) -> '_1371.SplineDesignTypes':
        """SplineDesignTypes: 'SplineType' is the original name of this property."""

        temp = self.wrapped.SplineType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1371.SplineDesignTypes)(value) if value is not None else None

    @spline_type.setter
    def spline_type(self, value: '_1371.SplineDesignTypes'):
    ...
    @property
    def tilt_stiffness_type(self) -> '_2531.RigidConnectorTiltStiffnessTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2531.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2531.RigidConnectorTiltStiffnessTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def interference_fit_design(self) -> '_1406.InterferenceFitDesign':
        ...
        if _1406.InterferenceFitDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def left_flank_lead_relief(self) -> '_2538.SplineLeadRelief':
    ...
    @property
    def right_flank_lead_relief(self) -> '_2538.SplineLeadRelief':
    ...
    @property
    def spline_joint_design(self) -> '_1376.SplineJointDesign':
        ...
        if _1376.SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1351.CustomSplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1351.CustomSplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1354.DIN5480SplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1354.DIN5480SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1358.GBT3478SplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1358.GBT3478SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1361.ISO4156SplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1361.ISO4156SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1362.JISB1603SplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1362.JISB1603SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1369.SAESplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1369.SAESplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1381.StandardSplineJointDesign':
        ...
        temp = self.wrapped.SplineJointDesign
        if _1381.StandardSplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def lead_reliefs(self) -> 'List[_2538.SplineLeadRelief]':
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2532.RigidConnectorToothLocation]':
