...
from mastapy.system_model.part_model.couplings import _2519, _2522
...
class Clutch(_2522.Coupling):
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def angular_speed_temperature_grid(self, value: '_1525.GriddedSurfaceAccessor'):
    ...
    @property
    def clutch_type(self) -> '_2519.ClutchType':
        """ClutchType: 'ClutchType' is the original name of this property."""

        temp = self.wrapped.ClutchType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2519.ClutchType)(value) if value is not None else None

    @clutch_type.setter
    def clutch_type(self, value: '_2519.ClutchType'):
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1493.Vector2DListAccessor':
    ...
    def flow_rate_vs_speed(self, value: '_1493.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_speed_temperature_grid(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def linear_speed_temperature_grid(self, value: '_1525.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def spring_type(self) -> '_5327.ClutchSpringType':
        """ClutchSpringType: 'SpringType' is the original name of this property."""

        temp = self.wrapped.SpringType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5327.ClutchSpringType)(value) if value is not None else None

    @spring_type.setter
    def spring_type(self, value: '_5327.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2282.ClutchConnection':
