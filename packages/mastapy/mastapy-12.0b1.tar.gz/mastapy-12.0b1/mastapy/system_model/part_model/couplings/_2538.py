...
from mastapy.math_utility.stiffness_calculators import _1495
...
from mastapy.system_model.part_model.couplings import _2524
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1495.IndividualContactPosition':
        ...
        return constructor.new_from_mastapy_type(_1495.IndividualContactPosition)(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def crowning(self) -> '_2524.CrowningSpecification':
