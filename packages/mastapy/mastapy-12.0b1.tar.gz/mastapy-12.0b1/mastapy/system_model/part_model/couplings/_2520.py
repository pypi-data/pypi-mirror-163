...
class ConceptCoupling(_2522.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1493.Vector2DListAccessor':
    ...
    def efficiency_vs_speed_ratio(self, value: '_1493.Vector2DListAccessor'):
