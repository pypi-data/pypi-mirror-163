...
from mastapy.system_model.part_model.part_groups import _2427, _2429, _2426
...
class ParallelPartGroup(_2426.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2427.ConcentricPartGroup]':
    ...
    @property
    def design_measurements(self) -> 'List[_2429.DesignMeasurements]':
