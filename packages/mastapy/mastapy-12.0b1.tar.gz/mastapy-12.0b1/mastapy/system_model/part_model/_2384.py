...
from mastapy.math_utility import _1458, _1459
from mastapy.system_model.connections_and_sockets import (
    _2210, _2212, _2236, _2231
)
from mastapy.system_model.part_model import _2385, _2408
...
class Component(_2408.Part):
    ...
    @property
    def local_coordinate_system(self) -> '_1458.CoordinateSystem3D':
    ...
    @property
    def component_connections(self) -> 'List[_2210.ComponentConnection]':
    ...
    def can_delete_connection(self, connection: '_2212.Connection') -> 'bool':
    ...
    def connect_to_socket(self, socket: '_2236.Socket') -> '_2385.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2385.ComponentsConnectedResult':
        """ 'ConnectTo' is the original name of this method.
    ...
    def create_coordinate_system_editor(self) -> '_1459.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_2212.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2212.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2236.Socket') -> 'List[_2236.Socket]':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2236.Socket]':
        """ 'PossibleSocketsToConnectWith' is the original name of this method.
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2231.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1458.CoordinateSystem3D') -> '_2231.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2231.RealignmentResult':
    ...
    def socket_named(self, socket_name: 'str') -> '_2236.Socket':
    ...
    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2385.ComponentsConnectedResult':
