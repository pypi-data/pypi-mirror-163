...
from mastapy.system_model import _2158
...
class PlanetCarrierSettings(_1554.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_2158.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new_from_mastapy_type(_2158.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value is not None else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_2158.PlanetPinManufacturingErrorsCoordinateSystem'):
