...
class Shaft(_2376.AbstractShaft):
    """Shaft
    ...
    @property
    def guide_image(self) -> '_2396.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2322.FESubstructure':
    ...
    def mount_component(self, component: '_2404.MountableComponent', offset: 'float'):
