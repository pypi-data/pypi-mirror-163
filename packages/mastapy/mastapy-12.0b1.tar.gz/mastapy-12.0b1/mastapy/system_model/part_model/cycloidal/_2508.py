...
from mastapy.cycloidal import _1415, _1416, _1422
...
from mastapy.system_model.part_model import _2401, _2376
from mastapy.system_model.connections_and_sockets.cycloidal import _2279
...
class CycloidalDisc(_2376.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1415.CycloidalDiscDesign':
    ...
    @property
    def disc_material(self) -> '_260.Material':
    ...
    @property
    def load_sharing_settings(self) -> '_2401.LoadSharingSettings':
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2279.CycloidalDiscPlanetaryBearingSocket]':
