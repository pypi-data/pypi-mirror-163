...
from mastapy.system_model.part_model.gears import _2465, _2481, _2464
...
class CylindricalGearMesh(_2253.GearMesh):
    """CylindricalGearMesh
    ...
    @property
    def centre_distance_range(self) -> '_1524.ShortLengthRange':
    ...
    @property
    def active_gear_mesh_design(self) -> '_1009.CylindricalGearMeshDesign':
    ...
    @property
    def cylindrical_gear_mesh_design(self) -> '_1009.CylindricalGearMeshDesign':
    ...
    @property
    def cylindrical_gear_set(self) -> '_2465.CylindricalGearSet':
