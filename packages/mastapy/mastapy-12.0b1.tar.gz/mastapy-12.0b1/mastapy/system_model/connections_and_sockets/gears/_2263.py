...
class SpiralBevelGearMesh(_2243.BevelGearMesh):
    """SpiralBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_961.SpiralBevelGearMeshDesign':
    ...
    @property
    def spiral_bevel_gear_mesh_design(self) -> '_961.SpiralBevelGearMeshDesign':
