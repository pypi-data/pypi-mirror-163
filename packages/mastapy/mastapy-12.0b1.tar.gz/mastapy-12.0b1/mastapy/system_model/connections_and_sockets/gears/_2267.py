...
class StraightBevelGearMesh(_2243.BevelGearMesh):
    """StraightBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_953.StraightBevelGearMeshDesign':
    ...
    @property
    def straight_bevel_gear_mesh_design(self) -> '_953.StraightBevelGearMeshDesign':
