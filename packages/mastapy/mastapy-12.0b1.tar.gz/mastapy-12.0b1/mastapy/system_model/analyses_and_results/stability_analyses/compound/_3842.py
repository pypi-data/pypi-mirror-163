...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3840, _3841, _3847
...
class BevelDifferentialGearSetCompoundStabilityAnalysis(_3847.BevelGearSetCompoundStabilityAnalysis):
    """BevelDifferentialGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3709.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_stability_analysis(self) -> 'List[_3840.BevelDifferentialGearCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_stability_analysis(self) -> 'List[_3841.BevelDifferentialGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3709.BevelDifferentialGearSetStabilityAnalysis]':
