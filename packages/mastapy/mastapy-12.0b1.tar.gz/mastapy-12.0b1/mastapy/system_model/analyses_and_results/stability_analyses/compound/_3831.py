...
from mastapy.system_model.analyses_and_results.stability_analyses import _3698
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3854
...
class AbstractShaftOrHousingCompoundStabilityAnalysis(_3854.ComponentCompoundStabilityAnalysis):
    """AbstractShaftOrHousingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3698.AbstractShaftOrHousingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3698.AbstractShaftOrHousingStabilityAnalysis]':
