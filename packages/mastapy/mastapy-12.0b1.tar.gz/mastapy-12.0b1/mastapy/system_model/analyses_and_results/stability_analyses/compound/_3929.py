...
class SpiralBevelGearMeshCompoundStabilityAnalysis(_3846.BevelGearMeshCompoundStabilityAnalysis):
    """SpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3797.SpiralBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3797.SpiralBevelGearMeshStabilityAnalysis]':
