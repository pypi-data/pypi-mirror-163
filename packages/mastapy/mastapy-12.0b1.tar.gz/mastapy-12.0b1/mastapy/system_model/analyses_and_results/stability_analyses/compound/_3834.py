...
from mastapy.system_model.analyses_and_results.stability_analyses import _3701
...
class AGMAGleasonConicalGearMeshCompoundStabilityAnalysis(_3862.ConicalGearMeshCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3701.AGMAGleasonConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3701.AGMAGleasonConicalGearMeshStabilityAnalysis]':
