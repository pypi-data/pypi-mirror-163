...
class ConceptCouplingCompoundStabilityAnalysis(_3866.CouplingCompoundStabilityAnalysis):
    """ConceptCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3725.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3725.ConceptCouplingStabilityAnalysis]':
