...
class SpringDamperConnectionCompoundStabilityAnalysis(_3867.CouplingConnectionCompoundStabilityAnalysis):
    """SpringDamperConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3800.SpringDamperConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3800.SpringDamperConnectionStabilityAnalysis]':
