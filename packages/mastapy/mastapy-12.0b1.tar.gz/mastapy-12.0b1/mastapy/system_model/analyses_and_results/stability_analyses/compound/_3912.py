...
class PlanetaryConnectionCompoundStabilityAnalysis(_3926.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """PlanetaryConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3781.PlanetaryConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3781.PlanetaryConnectionStabilityAnalysis]':
