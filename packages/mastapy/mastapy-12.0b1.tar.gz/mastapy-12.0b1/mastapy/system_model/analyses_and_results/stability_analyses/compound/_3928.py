...
class SpiralBevelGearCompoundStabilityAnalysis(_3845.BevelGearCompoundStabilityAnalysis):
    """SpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3799.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3799.SpiralBevelGearStabilityAnalysis]':
