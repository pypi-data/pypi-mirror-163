...
class RingPinsCompoundStabilityAnalysis(_3906.MountableComponentCompoundStabilityAnalysis):
    """RingPinsCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3787.RingPinsStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3787.RingPinsStabilityAnalysis]':
