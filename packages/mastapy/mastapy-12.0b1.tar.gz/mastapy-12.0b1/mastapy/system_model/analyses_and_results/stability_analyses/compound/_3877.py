...
class CylindricalGearMeshCompoundStabilityAnalysis(_3888.GearMeshCompoundStabilityAnalysis):
    """CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3745.CylindricalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3745.CylindricalGearMeshStabilityAnalysis]':
