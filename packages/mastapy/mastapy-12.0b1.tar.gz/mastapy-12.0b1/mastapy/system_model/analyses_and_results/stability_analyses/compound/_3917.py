...
class PulleyCompoundStabilityAnalysis(_3868.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3786.PulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3786.PulleyStabilityAnalysis]':
