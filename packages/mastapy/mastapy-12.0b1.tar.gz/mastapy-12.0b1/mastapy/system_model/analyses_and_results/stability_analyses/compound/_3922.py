...
class RollingRingConnectionCompoundStabilityAnalysis(_3894.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RollingRingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3790.RollingRingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3790.RollingRingConnectionStabilityAnalysis]':
