...
class CoaxialConnectionCompoundStabilityAnalysis(_3926.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3721.CoaxialConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3721.CoaxialConnectionStabilityAnalysis]':
