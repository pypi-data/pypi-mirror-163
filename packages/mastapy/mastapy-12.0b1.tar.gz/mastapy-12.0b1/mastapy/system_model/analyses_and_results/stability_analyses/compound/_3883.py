...
class FaceGearMeshCompoundStabilityAnalysis(_3888.GearMeshCompoundStabilityAnalysis):
    """FaceGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3751.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3751.FaceGearMeshStabilityAnalysis]':
