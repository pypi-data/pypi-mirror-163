...
class RollingRingCompoundStabilityAnalysis(_3868.CouplingHalfCompoundStabilityAnalysis):
    """RollingRingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3791.RollingRingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3791.RollingRingStabilityAnalysis]':
