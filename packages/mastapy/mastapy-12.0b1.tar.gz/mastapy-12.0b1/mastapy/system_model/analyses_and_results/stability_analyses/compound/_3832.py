...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3864
...
class AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3864.ConnectionCompoundStabilityAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3700.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3700.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
