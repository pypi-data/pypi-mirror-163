...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3853.CoaxialConnectionCompoundStabilityAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3742.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3742.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
