...
from mastapy.system_model.analyses_and_results.stability_analyses import _3713
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3834
...
class BevelGearMeshCompoundStabilityAnalysis(_3834.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """BevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3713.BevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3713.BevelGearMeshStabilityAnalysis]':
