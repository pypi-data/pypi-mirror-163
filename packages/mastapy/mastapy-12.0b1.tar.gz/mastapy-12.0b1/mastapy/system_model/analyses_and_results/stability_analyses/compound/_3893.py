...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3891, _3892, _3835
...
class HypoidGearSetCompoundStabilityAnalysis(_3835.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """HypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3761.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def hypoid_gears_compound_stability_analysis(self) -> 'List[_3891.HypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_stability_analysis(self) -> 'List[_3892.HypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3761.HypoidGearSetStabilityAnalysis]':
