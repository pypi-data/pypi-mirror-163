...
class PointLoadCompoundStabilityAnalysis(_3951.VirtualComponentCompoundStabilityAnalysis):
    """PointLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3784.PointLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3784.PointLoadStabilityAnalysis]':
