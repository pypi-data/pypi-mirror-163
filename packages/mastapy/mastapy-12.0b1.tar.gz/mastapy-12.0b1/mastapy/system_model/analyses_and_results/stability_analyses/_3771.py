...
from mastapy.system_model.analyses_and_results.stability_analyses import _3772, _3770, _3765
...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(_3765.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_stability_analysis(self) -> 'List[_3772.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_stability_analysis(self) -> 'List[_3770.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
