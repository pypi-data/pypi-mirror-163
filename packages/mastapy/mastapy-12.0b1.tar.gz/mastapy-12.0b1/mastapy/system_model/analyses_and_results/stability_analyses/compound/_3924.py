...
class ShaftCompoundStabilityAnalysis(_3830.AbstractShaftCompoundStabilityAnalysis):
    """ShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3794.ShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3794.ShaftStabilityAnalysis]':
