...
class ClutchConnectionCompoundStabilityAnalysis(_3867.CouplingConnectionCompoundStabilityAnalysis):
    """ClutchConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3718.ClutchConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3718.ClutchConnectionStabilityAnalysis]':
