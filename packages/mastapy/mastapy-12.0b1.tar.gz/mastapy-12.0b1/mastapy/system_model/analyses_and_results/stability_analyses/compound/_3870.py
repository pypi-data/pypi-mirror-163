...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3839
...
class CVTCompoundStabilityAnalysis(_3839.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3740.CVTStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3740.CVTStabilityAnalysis]':
