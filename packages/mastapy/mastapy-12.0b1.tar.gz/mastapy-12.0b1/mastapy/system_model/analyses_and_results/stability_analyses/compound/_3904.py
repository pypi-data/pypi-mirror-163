...
class MassDiscCompoundStabilityAnalysis(_3951.VirtualComponentCompoundStabilityAnalysis):
    """MassDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3773.MassDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3773.MassDiscStabilityAnalysis]':
