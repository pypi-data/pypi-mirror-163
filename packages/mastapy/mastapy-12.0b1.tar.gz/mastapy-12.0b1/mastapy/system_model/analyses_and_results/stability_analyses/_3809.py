...
from mastapy.system_model.analyses_and_results.stability_analyses import _3810, _3808, _3714
...
class StraightBevelGearSetStabilityAnalysis(_3714.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3810.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3808.StraightBevelGearMeshStabilityAnalysis]':
