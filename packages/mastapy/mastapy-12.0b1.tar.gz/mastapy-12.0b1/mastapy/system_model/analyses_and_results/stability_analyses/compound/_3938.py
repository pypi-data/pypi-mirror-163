...
class StraightBevelGearMeshCompoundStabilityAnalysis(_3846.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3808.StraightBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3808.StraightBevelGearMeshStabilityAnalysis]':
