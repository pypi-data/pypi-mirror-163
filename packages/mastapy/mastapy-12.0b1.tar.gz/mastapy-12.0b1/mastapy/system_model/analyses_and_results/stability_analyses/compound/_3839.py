...
from mastapy.system_model.analyses_and_results.stability_analyses import _3707
...
class BeltDriveCompoundStabilityAnalysis(_3927.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BeltDriveCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3707.BeltDriveStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3707.BeltDriveStabilityAnalysis]':
