...
class PlanetCarrierCompoundStabilityAnalysis(_3906.MountableComponentCompoundStabilityAnalysis):
    """PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3783.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3783.PlanetCarrierStabilityAnalysis]':
