...
class KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis(_3862.ConicalGearMeshCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3764.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3764.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
