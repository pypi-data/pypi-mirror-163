...
from mastapy.system_model.analyses_and_results.stability_analyses import _3737, _3699
...
class ShaftStabilityAnalysis(_3699.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3737.CriticalSpeed]':
