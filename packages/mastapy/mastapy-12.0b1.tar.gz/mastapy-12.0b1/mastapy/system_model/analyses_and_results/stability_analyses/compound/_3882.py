...
class FaceGearCompoundStabilityAnalysis(_3887.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3753.FaceGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3753.FaceGearStabilityAnalysis]':
