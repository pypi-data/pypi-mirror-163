...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3864.ConnectionCompoundStabilityAnalysis):
    """InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3763.InterMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3763.InterMountableComponentConnectionStabilityAnalysis]':
