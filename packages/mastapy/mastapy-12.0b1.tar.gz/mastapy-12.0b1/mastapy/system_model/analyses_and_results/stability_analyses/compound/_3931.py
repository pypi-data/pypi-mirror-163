...
class SpringDamperCompoundStabilityAnalysis(_3866.CouplingCompoundStabilityAnalysis):
    """SpringDamperCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3802.SpringDamperStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3802.SpringDamperStabilityAnalysis]':
