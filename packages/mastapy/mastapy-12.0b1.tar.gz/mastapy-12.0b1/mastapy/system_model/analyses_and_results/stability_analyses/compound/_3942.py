...
class SynchroniserCompoundStabilityAnalysis(_3927.SpecialisedAssemblyCompoundStabilityAnalysis):
    """SynchroniserCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3816.SynchroniserStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3816.SynchroniserStabilityAnalysis]':
