...
class AbstractShaftCompoundStabilityAnalysis(_3831.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3699.AbstractShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3699.AbstractShaftStabilityAnalysis]':
