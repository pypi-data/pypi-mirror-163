...
class ExternalCADModelCompoundStabilityAnalysis(_3854.ComponentCompoundStabilityAnalysis):
    """ExternalCADModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3750.ExternalCADModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3750.ExternalCADModelStabilityAnalysis]':
