...
class GearCompoundStabilityAnalysis(_3906.MountableComponentCompoundStabilityAnalysis):
    """GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3758.GearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3758.GearStabilityAnalysis]':
