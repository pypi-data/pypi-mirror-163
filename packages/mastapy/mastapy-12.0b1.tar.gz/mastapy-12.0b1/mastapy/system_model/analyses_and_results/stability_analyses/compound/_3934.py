...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3845.BevelGearCompoundStabilityAnalysis):
    """StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3807.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3807.StraightBevelDiffGearStabilityAnalysis]':
