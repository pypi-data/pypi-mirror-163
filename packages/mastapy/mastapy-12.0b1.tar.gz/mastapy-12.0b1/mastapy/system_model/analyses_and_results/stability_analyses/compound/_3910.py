...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3867
...
class PartToPartShearCouplingConnectionCompoundStabilityAnalysis(_3867.CouplingConnectionCompoundStabilityAnalysis):
    """PartToPartShearCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3778.PartToPartShearCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3778.PartToPartShearCouplingConnectionStabilityAnalysis]':
