...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3832
...
class CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis(_3832.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3743.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3743.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
