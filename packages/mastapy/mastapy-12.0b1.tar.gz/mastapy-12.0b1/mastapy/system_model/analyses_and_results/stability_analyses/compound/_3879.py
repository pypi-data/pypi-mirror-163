...
class CylindricalPlanetGearCompoundStabilityAnalysis(_3876.CylindricalGearCompoundStabilityAnalysis):
    """CylindricalPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3748.CylindricalPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3748.CylindricalPlanetGearStabilityAnalysis]':
