...
class GearMeshCompoundStabilityAnalysis(_3894.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """GearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3756.GearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3756.GearMeshStabilityAnalysis]':
