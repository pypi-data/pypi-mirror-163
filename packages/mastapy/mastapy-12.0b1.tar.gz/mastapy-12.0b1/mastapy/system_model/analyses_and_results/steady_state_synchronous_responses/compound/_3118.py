...
class KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse(_3084.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2985.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2985.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
