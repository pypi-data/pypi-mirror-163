...
class TorqueConverterCompoundSteadyStateSynchronousResponse(_3087.CouplingCompoundSteadyStateSynchronousResponse):
    """TorqueConverterCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3040.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3040.TorqueConverterSteadyStateSynchronousResponse]':
