...
class CoaxialConnectionCompoundSteadyStateSynchronousResponse(_3147.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2941.CoaxialConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2941.CoaxialConnectionSteadyStateSynchronousResponse]':
