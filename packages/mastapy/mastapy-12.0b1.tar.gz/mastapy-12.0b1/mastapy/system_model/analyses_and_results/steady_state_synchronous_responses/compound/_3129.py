...
class PartCompoundSteadyStateSynchronousResponse(_7458.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2997.PartSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2997.PartSteadyStateSynchronousResponse]':
