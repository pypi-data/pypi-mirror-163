...
class TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(_3089.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """TorqueConverterTurbineCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3041.TorqueConverterTurbineSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3041.TorqueConverterTurbineSteadyStateSynchronousResponse]':
