...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3031, _3029, _2934
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_2934.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3031.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3029.StraightBevelGearMeshSteadyStateSynchronousResponse]':
