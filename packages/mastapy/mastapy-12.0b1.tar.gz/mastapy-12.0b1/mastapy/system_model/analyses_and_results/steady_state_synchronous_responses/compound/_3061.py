...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponse(_3066.BevelGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2930.BevelDifferentialGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2930.BevelDifferentialGearSteadyStateSynchronousResponse]':
