...
class BevelGearCompoundSteadyStateSynchronousResponse(_3054.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """BevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2935.BevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2935.BevelGearSteadyStateSynchronousResponse]':
