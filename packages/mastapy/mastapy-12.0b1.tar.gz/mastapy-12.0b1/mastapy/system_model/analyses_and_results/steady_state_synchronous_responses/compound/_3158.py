...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(_3066.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3031.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3031.StraightBevelGearSteadyStateSynchronousResponse]':
