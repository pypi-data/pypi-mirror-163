...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3097, _3098, _3110
...
class CylindricalGearSetCompoundSteadyStateSynchronousResponse(_3110.GearSetCompoundSteadyStateSynchronousResponse):
    """CylindricalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2965.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gears_compound_steady_state_synchronous_response(self) -> 'List[_3097.CylindricalGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3098.CylindricalGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2965.CylindricalGearSetSteadyStateSynchronousResponse]':
