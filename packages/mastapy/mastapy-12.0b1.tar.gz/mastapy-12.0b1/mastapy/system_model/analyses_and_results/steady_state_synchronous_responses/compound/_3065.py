...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponse(_3061.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialSunGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2932.BevelDifferentialSunGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2932.BevelDifferentialSunGearSteadyStateSynchronousResponse]':
