...
class RingPinsCompoundSteadyStateSynchronousResponse(_3127.MountableComponentCompoundSteadyStateSynchronousResponse):
    """RingPinsCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3007.RingPinsSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3007.RingPinsSteadyStateSynchronousResponse]':
