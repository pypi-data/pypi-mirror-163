...
class CVTPulleyCompoundSteadyStateSynchronousResponse(_3138.PulleyCompoundSteadyStateSynchronousResponse):
    """CVTPulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2958.CVTPulleySteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2958.CVTPulleySteadyStateSynchronousResponse]':
