...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3085
...
class AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3085.ConnectionCompoundSteadyStateSynchronousResponse):
    """AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2920.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2920.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
