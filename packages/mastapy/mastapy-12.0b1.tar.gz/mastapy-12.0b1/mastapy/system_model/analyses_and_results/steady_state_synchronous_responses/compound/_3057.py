...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
    _3058, _3060, _3063, _3070,
    _3069, _3091, _3071, _3076,
    _3081, _3093, _3095, _3099,
    _3106, _3105, _3107, _3114,
    _3121, _3124, _3125, _3126,
    _3128, _3130, _3135, _3136,
    _3137, _3139, _3141, _3146,
    _3145, _3151, _3152, _3157,
    _3160, _3163, _3167, _3171,
    _3175, _3178, _3050
)
...
class AssemblyCompoundSteadyStateSynchronousResponse(_3050.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    """AssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2924.AssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def bearings(self) -> 'List[_3058.BearingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def belt_drives(self) -> 'List[_3060.BeltDriveCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3063.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3070.BoltedJointCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolts(self) -> 'List[_3069.BoltCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cv_ts(self) -> 'List[_3091.CVTCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def clutches(self) -> 'List[_3071.ClutchCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3076.ConceptCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3081.ConceptGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3093.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3095.CycloidalDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3099.CylindricalGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def fe_parts(self) -> 'List[_3106.FEPartCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3105.FaceGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3107.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3114.HypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3121.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3124.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def mass_discs(self) -> 'List[_3125.MassDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def measurement_components(self) -> 'List[_3126.MeasurementComponentCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def oil_seals(self) -> 'List[_3128.OilSealCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3130.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3135.PlanetCarrierCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def point_loads(self) -> 'List[_3136.PointLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def power_loads(self) -> 'List[_3137.PowerLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def ring_pins(self) -> 'List[_3139.RingPinsCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3141.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3146.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shafts(self) -> 'List[_3145.ShaftCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3151.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3152.SpringDamperCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3157.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3160.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def synchronisers(self) -> 'List[_3163.SynchroniserCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def torque_converters(self) -> 'List[_3167.TorqueConverterCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3171.UnbalancedMassCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3175.WormGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3178.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2924.AssemblySteadyStateSynchronousResponse]':
