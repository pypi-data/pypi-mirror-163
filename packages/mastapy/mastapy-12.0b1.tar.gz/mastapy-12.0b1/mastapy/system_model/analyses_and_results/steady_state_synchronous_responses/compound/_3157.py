...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3155, _3156, _3068
...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(_3068.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3027.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(self) -> 'List[_3155.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3156.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3027.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
