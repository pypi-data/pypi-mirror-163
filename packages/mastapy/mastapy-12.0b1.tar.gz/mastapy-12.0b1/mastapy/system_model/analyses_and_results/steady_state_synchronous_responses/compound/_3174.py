...
class WormGearMeshCompoundSteadyStateSynchronousResponse(_3109.GearMeshCompoundSteadyStateSynchronousResponse):
    """WormGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3044.WormGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3044.WormGearMeshSteadyStateSynchronousResponse]':
