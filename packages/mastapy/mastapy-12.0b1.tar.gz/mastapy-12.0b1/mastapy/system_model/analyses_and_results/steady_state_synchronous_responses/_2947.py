...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2948, _2946, _2977
...
class ConceptGearSetSteadyStateSynchronousResponse(_2977.GearSetSteadyStateSynchronousResponse):
    """ConceptGearSetSteadyStateSynchronousResponse
    ...
    @property
    def concept_gears_steady_state_synchronous_response(self) -> 'List[_2948.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response(self) -> 'List[_2946.ConceptGearMeshSteadyStateSynchronousResponse]':
