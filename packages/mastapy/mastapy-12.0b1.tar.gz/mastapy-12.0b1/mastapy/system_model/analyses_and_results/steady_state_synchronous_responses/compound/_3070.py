...
class BoltedJointCompoundSteadyStateSynchronousResponse(_3148.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BoltedJointCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2936.BoltedJointSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2936.BoltedJointSteadyStateSynchronousResponse]':
