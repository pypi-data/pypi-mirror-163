...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2982, _2980, _2922
...
class HypoidGearSetSteadyStateSynchronousResponse(_2922.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse):
    """HypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2982.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2980.HypoidGearMeshSteadyStateSynchronousResponse]':
