...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3066.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3019.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3019.SpiralBevelGearSteadyStateSynchronousResponse]':
