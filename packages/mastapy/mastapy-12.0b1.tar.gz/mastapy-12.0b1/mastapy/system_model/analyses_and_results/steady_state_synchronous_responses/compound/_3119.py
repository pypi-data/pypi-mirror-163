...
class KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse(_3116.KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2989.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2989.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
