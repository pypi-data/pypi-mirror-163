...
class InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3085.ConnectionCompoundSteadyStateSynchronousResponse):
    """InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2983.InterMountableComponentConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2983.InterMountableComponentConnectionSteadyStateSynchronousResponse]':
