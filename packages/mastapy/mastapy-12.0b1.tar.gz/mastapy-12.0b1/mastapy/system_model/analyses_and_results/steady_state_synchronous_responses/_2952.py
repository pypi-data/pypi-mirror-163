...
class ConnectionSteadyStateSynchronousResponse(_7453.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3023.SteadyStateSynchronousResponse':
