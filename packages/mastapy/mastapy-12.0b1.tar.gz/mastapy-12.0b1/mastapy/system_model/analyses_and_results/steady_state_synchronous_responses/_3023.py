...
from mastapy.system_model.analyses_and_results.analysis_cases import _7449
...
class SteadyStateSynchronousResponse(_7449.CompoundAnalysisCase):
    """SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3025.SteadyStateSynchronousResponseOptions':
