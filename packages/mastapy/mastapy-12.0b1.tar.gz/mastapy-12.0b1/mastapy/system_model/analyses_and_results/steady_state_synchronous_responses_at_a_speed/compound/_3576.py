...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3446
...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(_3604.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """BearingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3446.BearingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3446.BearingSteadyStateSynchronousResponseAtASpeed]':
