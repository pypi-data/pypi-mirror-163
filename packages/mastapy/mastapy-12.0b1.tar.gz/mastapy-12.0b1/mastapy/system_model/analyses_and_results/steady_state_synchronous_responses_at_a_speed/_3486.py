...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3487, _3485, _3497
...
class CylindricalGearSetSteadyStateSynchronousResponseAtASpeed(_3497.GearSetSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3487.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3485.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
