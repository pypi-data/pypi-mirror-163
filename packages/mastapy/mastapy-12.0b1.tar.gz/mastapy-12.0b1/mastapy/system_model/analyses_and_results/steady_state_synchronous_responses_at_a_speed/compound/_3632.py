...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3630, _3631, _3574
...
class HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3574.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3501.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3630.HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3631.HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3501.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]':
