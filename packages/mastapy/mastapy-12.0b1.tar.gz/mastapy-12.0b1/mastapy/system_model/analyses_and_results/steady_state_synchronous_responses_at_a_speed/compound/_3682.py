...
class SynchroniserHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3683.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3552.SynchroniserHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3552.SynchroniserHalfSteadyStateSynchronousResponseAtASpeed]':
