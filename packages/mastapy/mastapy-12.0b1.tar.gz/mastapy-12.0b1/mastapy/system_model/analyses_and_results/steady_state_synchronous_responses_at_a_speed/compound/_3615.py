...
class CylindricalGearCompoundSteadyStateSynchronousResponseAtASpeed(_3626.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3487.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3487.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
