...
class RingPinsCompoundSteadyStateSynchronousResponseAtASpeed(_3645.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3527.RingPinsSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3527.RingPinsSteadyStateSynchronousResponseAtASpeed]':
