...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed(_3607.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3557.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3557.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
