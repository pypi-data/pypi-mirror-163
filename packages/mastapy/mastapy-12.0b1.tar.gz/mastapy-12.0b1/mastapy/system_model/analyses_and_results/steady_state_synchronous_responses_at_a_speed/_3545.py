...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3546, _3544, _3455
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed(_3455.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3546.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3544.StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed]':
