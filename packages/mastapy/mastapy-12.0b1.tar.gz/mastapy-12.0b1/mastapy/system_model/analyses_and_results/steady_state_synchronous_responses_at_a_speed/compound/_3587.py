...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(_3593.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3458.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3458.BoltSteadyStateSynchronousResponseAtASpeed]':
