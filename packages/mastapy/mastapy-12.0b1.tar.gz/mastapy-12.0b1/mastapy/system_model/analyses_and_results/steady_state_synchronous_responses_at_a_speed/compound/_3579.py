...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3451
...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed(_3584.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3451.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3451.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
