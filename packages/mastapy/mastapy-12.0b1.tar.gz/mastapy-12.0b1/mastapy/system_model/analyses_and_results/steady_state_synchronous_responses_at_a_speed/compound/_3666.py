...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3568
...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3568.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3536.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3536.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed]':
