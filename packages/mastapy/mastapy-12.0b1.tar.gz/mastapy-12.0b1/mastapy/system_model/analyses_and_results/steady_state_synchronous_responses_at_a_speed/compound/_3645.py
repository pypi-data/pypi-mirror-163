...
class MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3593.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3515.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3515.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
