...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_3673.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3551.StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3551.StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed]':
