...
class ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed(_3626.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3469.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3469.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
