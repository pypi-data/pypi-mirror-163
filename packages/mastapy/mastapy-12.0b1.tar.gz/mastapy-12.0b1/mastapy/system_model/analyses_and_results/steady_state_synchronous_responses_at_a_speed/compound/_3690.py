...
class VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3645.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3561.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3561.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
