...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3567, _3565, _3455
...
class ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3455.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3567.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3565.ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
