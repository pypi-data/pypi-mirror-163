...
class RollingRingCompoundSteadyStateSynchronousResponseAtASpeed(_3607.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3531.RollingRingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3531.RollingRingSteadyStateSynchronousResponseAtASpeed]':
