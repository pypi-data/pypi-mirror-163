...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3667, _3668, _3586
...
class SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3586.BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3538.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3667.SpiralBevelGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3668.SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3538.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
