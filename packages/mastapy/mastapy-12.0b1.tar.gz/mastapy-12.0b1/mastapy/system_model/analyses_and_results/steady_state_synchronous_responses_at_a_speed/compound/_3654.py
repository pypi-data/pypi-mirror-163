...
class PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3690.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PointLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3524.PointLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3524.PointLoadSteadyStateSynchronousResponseAtASpeed]':
