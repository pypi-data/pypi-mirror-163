...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3691, _3692, _3628
...
class WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3628.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3563.WormGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3691.WormGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3692.WormGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3563.WormGearSetSteadyStateSynchronousResponseAtASpeed]':
