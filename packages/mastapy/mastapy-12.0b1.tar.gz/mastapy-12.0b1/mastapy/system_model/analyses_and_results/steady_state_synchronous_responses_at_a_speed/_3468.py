...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3469, _3467, _3497
...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(_3497.GearSetSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def concept_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3469.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3467.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
