...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3621, _3622, _3628
...
class FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3628.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3492.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3621.FaceGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3622.FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3492.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
