...
class BevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3572.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3456.BevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3456.BevelGearSteadyStateSynchronousResponseAtASpeed]':
