...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3647.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3438.AbstractAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3438.AbstractAssemblySteadyStateSynchronousResponseAtASpeed]':
