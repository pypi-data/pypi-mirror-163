...
class SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed(_3666.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3555.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3555.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
