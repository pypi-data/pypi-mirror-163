...
class SpringDamperHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3607.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpringDamperHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3541.SpringDamperHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3541.SpringDamperHalfSteadyStateSynchronousResponseAtASpeed]':
