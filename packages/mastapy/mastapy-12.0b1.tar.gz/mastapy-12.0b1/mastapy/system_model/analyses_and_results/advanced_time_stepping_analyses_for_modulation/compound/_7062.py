...
class BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7118.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6932.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6932.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
