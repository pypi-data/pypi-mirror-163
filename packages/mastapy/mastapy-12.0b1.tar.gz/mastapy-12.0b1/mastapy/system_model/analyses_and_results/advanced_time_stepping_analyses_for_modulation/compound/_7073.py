...
class BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation(_7151.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2383.BoltedJoint':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6943.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6943.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
