...
class VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7046.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7046.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
