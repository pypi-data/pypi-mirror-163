...
class ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6982.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2658.ConicalGearMeshSystemDeflection':
