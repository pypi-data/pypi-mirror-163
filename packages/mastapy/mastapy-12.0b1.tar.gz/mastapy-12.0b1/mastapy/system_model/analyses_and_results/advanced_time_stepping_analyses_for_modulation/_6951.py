...
class ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation(_6962.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6753.ConceptCouplingHalfLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2652.ConceptCouplingHalfSystemDeflection':
