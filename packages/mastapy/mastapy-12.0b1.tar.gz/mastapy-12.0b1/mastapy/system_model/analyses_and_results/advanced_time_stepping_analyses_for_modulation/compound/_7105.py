...
class ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation(_7078.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6975.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6975.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
