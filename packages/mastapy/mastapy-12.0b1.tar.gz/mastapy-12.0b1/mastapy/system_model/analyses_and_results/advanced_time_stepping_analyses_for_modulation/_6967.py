...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6920.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6773.CycloidalDiscLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2672.CycloidalDiscSystemDeflection':
