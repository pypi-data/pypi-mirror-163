...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7106, _7107, _7113
...
class FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7113.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6978.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7106.FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7107.FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6978.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
