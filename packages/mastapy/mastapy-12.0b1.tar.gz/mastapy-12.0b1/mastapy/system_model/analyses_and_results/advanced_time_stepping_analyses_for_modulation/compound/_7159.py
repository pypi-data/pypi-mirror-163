...
class StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7030.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7030.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
