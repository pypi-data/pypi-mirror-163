...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_7039.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2757.SynchroniserSleeveSystemDeflection':
