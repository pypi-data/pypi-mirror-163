...
class SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(_6939.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2743.SpiralBevelGearSystemDeflection':
