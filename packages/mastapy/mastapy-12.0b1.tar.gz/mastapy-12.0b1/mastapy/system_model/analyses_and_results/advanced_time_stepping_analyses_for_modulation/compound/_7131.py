...
class OilSealCompoundAdvancedTimeSteppingAnalysisForModulation(_7089.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """OilSealCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7002.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7002.OilSealAdvancedTimeSteppingAnalysisForModulation]':
