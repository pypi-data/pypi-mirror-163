...
class ClutchHalfAdvancedTimeSteppingAnalysisForModulation(_6962.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """ClutchHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6748.ClutchHalfLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2646.ClutchHalfSystemDeflection':
