...
class MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7078.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7001.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7001.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
