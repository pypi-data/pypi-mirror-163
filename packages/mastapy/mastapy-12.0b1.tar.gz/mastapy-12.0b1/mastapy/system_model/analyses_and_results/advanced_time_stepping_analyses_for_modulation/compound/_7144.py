...
class RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7151.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2536.RollingRingAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7016.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7016.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
