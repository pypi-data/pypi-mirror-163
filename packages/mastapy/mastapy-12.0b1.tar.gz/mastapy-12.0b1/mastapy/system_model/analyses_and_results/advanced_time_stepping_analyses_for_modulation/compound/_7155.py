...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7090.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2539.SpringDamper':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7026.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7026.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
