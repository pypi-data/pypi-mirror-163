...
class RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation(_7022.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2731.RollingRingAssemblySystemDeflection':
