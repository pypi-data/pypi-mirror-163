...
class PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7175.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7011.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7011.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
