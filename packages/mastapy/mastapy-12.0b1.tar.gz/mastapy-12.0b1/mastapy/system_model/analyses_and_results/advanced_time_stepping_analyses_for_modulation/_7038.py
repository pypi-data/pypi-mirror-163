...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_7039.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2755.SynchroniserHalfSystemDeflection':
