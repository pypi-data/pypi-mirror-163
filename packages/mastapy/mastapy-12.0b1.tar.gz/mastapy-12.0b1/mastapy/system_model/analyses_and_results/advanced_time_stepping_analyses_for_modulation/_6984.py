...
class GuideDxfModelAdvancedTimeSteppingAnalysisForModulation(_6948.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """GuideDxfModelAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2696.GuideDxfModelSystemDeflection':
