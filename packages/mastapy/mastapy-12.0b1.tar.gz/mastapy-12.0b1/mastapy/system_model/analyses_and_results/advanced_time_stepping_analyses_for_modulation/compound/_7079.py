...
class ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7090.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2520.ConceptCoupling':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6949.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6949.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
