...
class RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation(_6989.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6860.RollingRingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2732.RollingRingConnectionSystemDeflection':
