...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7102
...
class PlanetaryGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.CylindricalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7008.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7008.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation]':
