...
class BevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6928.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2641.BevelGearSetSystemDeflection':
