...
class RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7118.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2281.RingPinsToDiscConnection':
    ...
    @property
    def connection_design(self) -> '_2281.RingPinsToDiscConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7014.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7014.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
