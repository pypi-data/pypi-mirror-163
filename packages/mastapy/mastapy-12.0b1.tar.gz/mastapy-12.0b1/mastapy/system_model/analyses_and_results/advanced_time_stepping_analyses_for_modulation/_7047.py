...
class WormGearAdvancedTimeSteppingAnalysisForModulation(_6981.GearAdvancedTimeSteppingAnalysisForModulation):
    """WormGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2772.WormGearSystemDeflection':
