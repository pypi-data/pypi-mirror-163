...
class StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7069.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7032.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7032.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
