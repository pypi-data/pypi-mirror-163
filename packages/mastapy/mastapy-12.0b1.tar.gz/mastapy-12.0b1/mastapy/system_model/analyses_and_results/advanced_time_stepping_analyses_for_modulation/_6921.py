...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6948.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2625.AbstractShaftOrHousingSystemDeflection':
