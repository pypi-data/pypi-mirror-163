...
class WormGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7111.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """WormGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7047.WormGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7047.WormGearAdvancedTimeSteppingAnalysisForModulation]':
