...
class StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7069.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7029.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7029.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
