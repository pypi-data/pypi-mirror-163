...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6942
...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(_7078.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6942.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6942.BoltAdvancedTimeSteppingAnalysisForModulation]':
