...
class AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation(_7078.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6921.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6921.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
