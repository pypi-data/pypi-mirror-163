...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(_7078.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """DatumCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6974.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6974.DatumAdvancedTimeSteppingAnalysisForModulation]':
