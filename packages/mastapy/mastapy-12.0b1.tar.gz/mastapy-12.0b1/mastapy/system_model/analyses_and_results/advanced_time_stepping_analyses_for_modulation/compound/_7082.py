...
class ConceptGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7111.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6952.ConceptGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6952.ConceptGearAdvancedTimeSteppingAnalysisForModulation]':
