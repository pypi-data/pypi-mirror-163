...
class BevelDifferentialGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6935.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6935.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
