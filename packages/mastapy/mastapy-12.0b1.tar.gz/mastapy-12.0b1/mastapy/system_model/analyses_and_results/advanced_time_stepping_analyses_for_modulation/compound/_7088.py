...
from mastapy.system_model.analyses_and_results.analysis_cases import _7451
...
class ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6958.ConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6958.ConnectionAdvancedTimeSteppingAnalysisForModulation]':
