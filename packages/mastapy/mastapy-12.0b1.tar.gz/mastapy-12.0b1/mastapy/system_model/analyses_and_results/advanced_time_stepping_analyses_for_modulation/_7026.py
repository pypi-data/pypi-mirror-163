...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_6960.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2746.SpringDamperSystemDeflection':
