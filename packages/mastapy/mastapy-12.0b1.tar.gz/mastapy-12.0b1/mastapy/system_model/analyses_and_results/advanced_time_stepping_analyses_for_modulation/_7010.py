...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_7046.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6852.PointLoadLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2725.PointLoadSystemDeflection':
