...
class InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7088.ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6989.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6989.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation]':
