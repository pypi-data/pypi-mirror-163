...
class PlanetCarrierAdvancedTimeSteppingAnalysisForModulation(_7001.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2724.PlanetCarrierSystemDeflection':
