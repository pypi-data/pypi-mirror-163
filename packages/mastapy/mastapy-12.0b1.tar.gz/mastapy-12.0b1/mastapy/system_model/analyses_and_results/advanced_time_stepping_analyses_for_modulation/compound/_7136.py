...
class PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7150.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2227.PlanetaryConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7007.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7007.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
