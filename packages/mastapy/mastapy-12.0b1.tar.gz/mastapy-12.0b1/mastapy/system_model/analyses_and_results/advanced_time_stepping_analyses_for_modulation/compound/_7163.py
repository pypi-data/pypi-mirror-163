...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7161, _7162, _7071
...
class StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7071.BevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7034.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7161.StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7162.StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7034.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
