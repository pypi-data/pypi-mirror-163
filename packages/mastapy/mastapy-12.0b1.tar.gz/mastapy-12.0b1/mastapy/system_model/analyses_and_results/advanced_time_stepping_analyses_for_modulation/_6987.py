...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6927.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2697.HypoidGearMeshSystemDeflection':
