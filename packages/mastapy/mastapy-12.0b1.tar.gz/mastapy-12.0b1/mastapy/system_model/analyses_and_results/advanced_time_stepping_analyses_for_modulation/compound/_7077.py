...
class CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7150.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2209.CoaxialConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6947.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6947.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]':
