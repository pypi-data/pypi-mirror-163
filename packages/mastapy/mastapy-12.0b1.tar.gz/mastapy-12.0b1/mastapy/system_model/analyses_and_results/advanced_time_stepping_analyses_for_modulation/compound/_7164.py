...
class StraightBevelPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7158.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7035.StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7035.StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation]':
