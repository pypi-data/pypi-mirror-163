...
class PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7175.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7010.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7010.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
