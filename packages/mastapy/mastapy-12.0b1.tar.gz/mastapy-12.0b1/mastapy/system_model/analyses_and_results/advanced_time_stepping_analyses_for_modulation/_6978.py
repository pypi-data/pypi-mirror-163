...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6976, _6977, _6983
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(_6983.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def face_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6976.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6977.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
