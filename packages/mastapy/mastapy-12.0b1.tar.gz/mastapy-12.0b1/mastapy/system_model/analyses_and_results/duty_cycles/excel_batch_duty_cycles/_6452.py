...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6453
...
class ExcelBatchDutyCycleCreator(_0.APIBase):
    ...
    @property
    def batch_details(self) -> '_6453.ExcelBatchDutyCycleSpectraCreatorDetails':
