...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6454, _6457, _6456
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self) -> '_6454.ExcelFileDetails':
    ...
    @property
    def masta_file_details(self) -> '_6457.MASTAFileDetails':
    ...
    @property
    def working_folder(self) -> '_1559.SelectableFolder':
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6456.ExcelSheetDesignStateSelector]':
