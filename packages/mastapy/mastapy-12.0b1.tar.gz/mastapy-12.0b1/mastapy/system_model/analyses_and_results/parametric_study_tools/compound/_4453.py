...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4410
...
class PartToPartShearCouplingCompoundParametricStudyTool(_4410.CouplingCompoundParametricStudyTool):
    """PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4326.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4326.PartToPartShearCouplingParametricStudyTool]':
