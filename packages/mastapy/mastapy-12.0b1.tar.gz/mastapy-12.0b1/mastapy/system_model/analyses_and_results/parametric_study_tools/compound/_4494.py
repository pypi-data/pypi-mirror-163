...
class UnbalancedMassCompoundParametricStudyTool(_4495.VirtualComponentCompoundParametricStudyTool):
    """UnbalancedMassCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4365.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4365.UnbalancedMassParametricStudyTool]':
