...
class ConceptCouplingCompoundParametricStudyTool(_4410.CouplingCompoundParametricStudyTool):
    """ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4254.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4254.ConceptCouplingParametricStudyTool]':
