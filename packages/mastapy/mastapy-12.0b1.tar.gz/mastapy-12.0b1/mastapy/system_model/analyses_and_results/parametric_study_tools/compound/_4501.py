...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4499, _4500, _4391
...
class ZerolBevelGearSetCompoundParametricStudyTool(_4391.BevelGearSetCompoundParametricStudyTool):
    """ZerolBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4372.ZerolBevelGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4499.ZerolBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4500.ZerolBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4372.ZerolBevelGearSetParametricStudyTool]':
