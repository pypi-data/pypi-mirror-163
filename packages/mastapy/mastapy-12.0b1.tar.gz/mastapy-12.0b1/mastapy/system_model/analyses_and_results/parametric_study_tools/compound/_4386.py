...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4239
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4384, _4385, _4391
...
class BevelDifferentialGearSetCompoundParametricStudyTool(_4391.BevelGearSetCompoundParametricStudyTool):
    """BevelDifferentialGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4239.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bevel_differential_gears_compound_parametric_study_tool(self) -> 'List[_4384.BevelDifferentialGearCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_compound_parametric_study_tool(self) -> 'List[_4385.BevelDifferentialGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4239.BevelDifferentialGearSetParametricStudyTool]':
