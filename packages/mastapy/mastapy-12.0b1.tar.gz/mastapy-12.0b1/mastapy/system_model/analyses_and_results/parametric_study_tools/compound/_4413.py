...
class CVTBeltConnectionCompoundParametricStudyTool(_4382.BeltConnectionCompoundParametricStudyTool):
    """CVTBeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4266.CVTBeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4266.CVTBeltConnectionParametricStudyTool]':
