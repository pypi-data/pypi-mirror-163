...
class CycloidalAssemblyCompoundParametricStudyTool(_4471.SpecialisedAssemblyCompoundParametricStudyTool):
    """CycloidalAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4269.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4269.CycloidalAssemblyParametricStudyTool]':
