...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4296, _4295, _4232
...
class HypoidGearSetParametricStudyTool(_4232.AGMAGleasonConicalGearSetParametricStudyTool):
    """HypoidGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2698.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4296.HypoidGearParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4295.HypoidGearMeshParametricStudyTool]':
