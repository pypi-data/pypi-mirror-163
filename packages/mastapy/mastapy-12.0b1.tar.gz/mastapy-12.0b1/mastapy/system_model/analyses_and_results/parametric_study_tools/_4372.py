...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4371, _4370, _4244
...
class ZerolBevelGearSetParametricStudyTool(_4244.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4371.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4370.ZerolBevelGearMeshParametricStudyTool]':
