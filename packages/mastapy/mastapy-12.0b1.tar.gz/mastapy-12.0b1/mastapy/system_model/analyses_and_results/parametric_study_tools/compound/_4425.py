...
class ExternalCADModelCompoundParametricStudyTool(_4398.ComponentCompoundParametricStudyTool):
    """ExternalCADModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4285.ExternalCADModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4285.ExternalCADModelParametricStudyTool]':
