...
class BoltCompoundParametricStudyTool(_4398.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4246.BoltParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4246.BoltParametricStudyTool]':
