...
class ConicalGearMeshCompoundParametricStudyTool(_4432.GearMeshCompoundParametricStudyTool):
    """ConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4258.ConicalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4258.ConicalGearMeshParametricStudyTool]':
