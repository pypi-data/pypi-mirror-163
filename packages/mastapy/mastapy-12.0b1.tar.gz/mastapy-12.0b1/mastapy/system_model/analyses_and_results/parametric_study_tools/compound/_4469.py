...
class ShaftHubConnectionCompoundParametricStudyTool(_4409.ConnectorCompoundParametricStudyTool):
    """ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4339.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4339.ShaftHubConnectionParametricStudyTool]':
