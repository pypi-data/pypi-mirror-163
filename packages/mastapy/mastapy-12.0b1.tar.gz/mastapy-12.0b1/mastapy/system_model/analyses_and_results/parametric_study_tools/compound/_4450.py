...
class MountableComponentCompoundParametricStudyTool(_4398.ComponentCompoundParametricStudyTool):
    """MountableComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4311.MountableComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4311.MountableComponentParametricStudyTool]':
