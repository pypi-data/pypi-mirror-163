...
class KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool(_4439.KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4303.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4303.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
