...
class ConnectionCompoundParametricStudyTool(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4261.ConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4261.ConnectionParametricStudyTool]':
