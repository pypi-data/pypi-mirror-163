...
class CouplingCompoundParametricStudyTool(_4471.SpecialisedAssemblyCompoundParametricStudyTool):
    """CouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4265.CouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4265.CouplingParametricStudyTool]':
