...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4398.ComponentCompoundParametricStudyTool):
    """AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4227.AbstractShaftOrHousingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4227.AbstractShaftOrHousingParametricStudyTool]':
