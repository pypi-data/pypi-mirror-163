...
class BeltConnectionCompoundParametricStudyTool(_4438.InterMountableComponentConnectionCompoundParametricStudyTool):
    """BeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4235.BeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4235.BeltConnectionParametricStudyTool]':
