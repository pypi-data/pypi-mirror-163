...
class SpringDamperConnectionCompoundParametricStudyTool(_4411.CouplingConnectionCompoundParametricStudyTool):
    """SpringDamperConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4346.SpringDamperConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4346.SpringDamperConnectionParametricStudyTool]':
