...
class PointLoadCompoundParametricStudyTool(_4495.VirtualComponentCompoundParametricStudyTool):
    """PointLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4330.PointLoadParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4330.PointLoadParametricStudyTool]':
