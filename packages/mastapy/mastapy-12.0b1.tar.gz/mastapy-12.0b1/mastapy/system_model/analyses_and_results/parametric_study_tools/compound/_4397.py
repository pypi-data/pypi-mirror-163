...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4250
...
class CoaxialConnectionCompoundParametricStudyTool(_4470.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CoaxialConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4250.CoaxialConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4250.CoaxialConnectionParametricStudyTool]':
