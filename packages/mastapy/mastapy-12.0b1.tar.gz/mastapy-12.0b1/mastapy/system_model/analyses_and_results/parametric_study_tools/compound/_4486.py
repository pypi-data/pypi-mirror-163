...
class SynchroniserCompoundParametricStudyTool(_4471.SpecialisedAssemblyCompoundParametricStudyTool):
    """SynchroniserCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4358.SynchroniserParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4358.SynchroniserParametricStudyTool]':
