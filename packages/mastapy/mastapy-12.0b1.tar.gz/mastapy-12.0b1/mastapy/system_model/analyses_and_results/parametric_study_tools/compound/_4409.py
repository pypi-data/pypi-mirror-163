...
class ConnectorCompoundParametricStudyTool(_4450.MountableComponentCompoundParametricStudyTool):
    """ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4262.ConnectorParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4262.ConnectorParametricStudyTool]':
