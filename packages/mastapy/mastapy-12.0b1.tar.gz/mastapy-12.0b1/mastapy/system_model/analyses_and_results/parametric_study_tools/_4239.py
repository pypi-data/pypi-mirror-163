...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4238, _4237, _4244
...
class BevelDifferentialGearSetParametricStudyTool(_4244.BevelGearSetParametricStudyTool):
    """BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4238.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4237.BevelDifferentialGearMeshParametricStudyTool]':
