...
class ConicalGearCompoundParametricStudyTool(_4431.GearCompoundParametricStudyTool):
    """ConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4259.ConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4259.ConicalGearParametricStudyTool]':
