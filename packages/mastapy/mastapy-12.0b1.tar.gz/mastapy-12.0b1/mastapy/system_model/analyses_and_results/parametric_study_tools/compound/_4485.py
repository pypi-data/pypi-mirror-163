...
class StraightBevelSunGearCompoundParametricStudyTool(_4478.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4356.StraightBevelSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4356.StraightBevelSunGearParametricStudyTool]':
