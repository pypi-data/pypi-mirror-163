...
class OilSealCompoundParametricStudyTool(_4409.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4312.OilSealParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4312.OilSealParametricStudyTool]':
