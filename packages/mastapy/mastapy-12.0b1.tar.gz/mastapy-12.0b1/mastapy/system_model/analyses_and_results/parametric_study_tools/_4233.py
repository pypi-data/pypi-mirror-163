...
from mastapy.system_model.analyses_and_results.parametric_study_tools import (
    _4280, _4234, _4236, _4239,
    _4245, _4246, _4267, _4249,
    _4254, _4257, _4269, _4271,
    _4275, _4289, _4288, _4290,
    _4297, _4304, _4307, _4308,
    _4309, _4312, _4326, _4329,
    _4330, _4331, _4333, _4335,
    _4339, _4340, _4345, _4348,
    _4351, _4354, _4358, _4362,
    _4365, _4369, _4372, _4226
)
...
class AssemblyParametricStudyTool(_4226.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4280.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4234.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4236.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4239.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4245.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4246.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4267.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4249.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4254.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4257.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4269.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4271.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4275.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4289.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4288.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4290.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4297.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4304.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4307.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4308.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4309.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4312.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4326.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4329.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4330.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4331.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4333.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4335.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4339.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4340.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4345.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4348.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4351.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4354.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4358.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4362.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4365.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4369.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4372.ZerolBevelGearSetParametricStudyTool]':
