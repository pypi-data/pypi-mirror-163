...
class CouplingHalfCompoundParametricStudyTool(_4450.MountableComponentCompoundParametricStudyTool):
    """CouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4264.CouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4264.CouplingHalfParametricStudyTool]':
