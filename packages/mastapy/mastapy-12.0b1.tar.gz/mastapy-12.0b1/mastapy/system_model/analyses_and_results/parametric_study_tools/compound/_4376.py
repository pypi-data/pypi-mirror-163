...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4408
...
class AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool(_4408.ConnectionCompoundParametricStudyTool):
    """AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4229.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4229.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
