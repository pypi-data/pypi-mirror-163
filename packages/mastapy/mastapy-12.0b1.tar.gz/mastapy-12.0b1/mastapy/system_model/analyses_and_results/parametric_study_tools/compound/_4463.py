...
class RingPinsToDiscConnectionCompoundParametricStudyTool(_4438.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RingPinsToDiscConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4334.RingPinsToDiscConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4334.RingPinsToDiscConnectionParametricStudyTool]':
