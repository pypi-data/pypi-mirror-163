...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4378
...
class HypoidGearMeshCompoundParametricStudyTool(_4378.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """HypoidGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4295.HypoidGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4295.HypoidGearMeshParametricStudyTool]':
