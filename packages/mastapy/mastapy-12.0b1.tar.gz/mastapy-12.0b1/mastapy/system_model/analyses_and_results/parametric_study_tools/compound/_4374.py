...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4375
...
class AbstractShaftCompoundParametricStudyTool(_4375.AbstractShaftOrHousingCompoundParametricStudyTool):
    """AbstractShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4228.AbstractShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4228.AbstractShaftParametricStudyTool]':
