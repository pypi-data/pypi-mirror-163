...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4481, _4482, _4391
...
class StraightBevelGearSetCompoundParametricStudyTool(_4391.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4354.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4481.StraightBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4482.StraightBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4354.StraightBevelGearSetParametricStudyTool]':
