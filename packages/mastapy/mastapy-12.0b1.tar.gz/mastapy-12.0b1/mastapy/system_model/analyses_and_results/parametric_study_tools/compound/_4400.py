...
class ConceptCouplingConnectionCompoundParametricStudyTool(_4411.CouplingConnectionCompoundParametricStudyTool):
    """ConceptCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4252.ConceptCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4252.ConceptCouplingConnectionParametricStudyTool]':
