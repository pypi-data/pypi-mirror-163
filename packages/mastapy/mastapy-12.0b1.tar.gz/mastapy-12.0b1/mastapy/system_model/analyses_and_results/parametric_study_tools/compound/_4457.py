...
class PlanetaryGearSetCompoundParametricStudyTool(_4422.CylindricalGearSetCompoundParametricStudyTool):
    """PlanetaryGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4328.PlanetaryGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4328.PlanetaryGearSetParametricStudyTool]':
