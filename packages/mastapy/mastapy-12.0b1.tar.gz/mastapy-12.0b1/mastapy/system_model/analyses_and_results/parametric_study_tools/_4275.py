...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4274, _4273, _4293
...
class CylindricalGearSetParametricStudyTool(_4293.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2676.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4274.CylindricalGearParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4273.CylindricalGearMeshParametricStudyTool]':
