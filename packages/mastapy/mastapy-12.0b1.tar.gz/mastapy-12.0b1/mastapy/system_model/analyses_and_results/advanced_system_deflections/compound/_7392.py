...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7390, _7391, _7386
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection(_7386.KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7261.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7390.KlingelnbergCycloPalloidSpiralBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7391.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7261.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
