...
class RingPinsToDiscConnectionCompoundAdvancedSystemDeflection(_7383.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RingPinsToDiscConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7278.RingPinsToDiscConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7278.RingPinsToDiscConnectionAdvancedSystemDeflection]':
