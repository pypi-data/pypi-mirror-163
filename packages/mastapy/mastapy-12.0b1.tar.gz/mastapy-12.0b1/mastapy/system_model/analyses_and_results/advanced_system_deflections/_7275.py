...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7309, _7311
...
class PowerLoadAdvancedSystemDeflection(_7311.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2726.PowerLoadSystemDeflection]':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7309.TransmissionErrorToOtherPowerLoad]':
