...
class ClutchConnectionCompoundAdvancedSystemDeflection(_7356.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ClutchConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7207.ClutchConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7207.ClutchConnectionAdvancedSystemDeflection]':
