...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_7202.BevelGearMeshAdvancedSystemDeflection):
    """BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_544.BevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis_of_type_zerol_bevel_gear_mesh_rating(self) -> '_360.ZerolBevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_mesh_rating(self) -> '_386.StraightBevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis_of_type_spiral_bevel_gear_mesh_rating(self) -> '_393.SpiralBevelGearMeshRating':
    ...
    @property
    def connection_load_case(self) -> '_6738.BevelDifferentialGearMeshLoadCase':
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2635.BevelDifferentialGearMeshSystemDeflection]':
