...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7367
...
class PlanetaryGearSetCompoundAdvancedSystemDeflection(_7367.CylindricalGearSetCompoundAdvancedSystemDeflection):
    """PlanetaryGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7272.PlanetaryGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7272.PlanetaryGearSetAdvancedSystemDeflection]':
