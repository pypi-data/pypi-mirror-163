...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7329, _7330, _7336
...
class BevelDifferentialGearSetCompoundAdvancedSystemDeflection(_7336.BevelGearSetCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7198.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_advanced_system_deflection(self) -> 'List[_7329.BevelDifferentialGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_advanced_system_deflection(self) -> 'List[_7330.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7198.BevelDifferentialGearSetAdvancedSystemDeflection]':
