...
class RollingRingAssemblyAdvancedSystemDeflection(_7286.SpecialisedAssemblyAdvancedSystemDeflection):
    """RollingRingAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2731.RollingRingAssemblySystemDeflection]':
