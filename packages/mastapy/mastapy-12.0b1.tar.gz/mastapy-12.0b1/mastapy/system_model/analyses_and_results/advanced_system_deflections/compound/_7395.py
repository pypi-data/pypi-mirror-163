...
class MountableComponentCompoundAdvancedSystemDeflection(_7343.ComponentCompoundAdvancedSystemDeflection):
    """MountableComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7265.MountableComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7265.MountableComponentAdvancedSystemDeflection]':
