...
class RollingRingConnectionAdvancedSystemDeflection(_7252.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2732.RollingRingConnectionSystemDeflection]':
