...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7183
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7320
...
class AbstractShaftCompoundAdvancedSystemDeflection(_7320.AbstractShaftOrHousingCompoundAdvancedSystemDeflection):
    """AbstractShaftCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7183.AbstractShaftAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7183.AbstractShaftAdvancedSystemDeflection]':
