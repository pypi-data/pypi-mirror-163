...
class SynchroniserHalfAdvancedSystemDeflection(_7303.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2755.SynchroniserHalfSystemDeflection]':
