...
class ConnectionCompoundAdvancedSystemDeflection(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7220.ConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7220.ConnectionAdvancedSystemDeflection]':
