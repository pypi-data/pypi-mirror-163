...
class BoltedJointCompoundAdvancedSystemDeflection(_7416.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BoltedJointCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7205.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7205.BoltedJointAdvancedSystemDeflection]':
