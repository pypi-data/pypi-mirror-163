...
class ConnectorCompoundAdvancedSystemDeflection(_7395.MountableComponentCompoundAdvancedSystemDeflection):
    """ConnectorCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7221.ConnectorAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7221.ConnectorAdvancedSystemDeflection]':
