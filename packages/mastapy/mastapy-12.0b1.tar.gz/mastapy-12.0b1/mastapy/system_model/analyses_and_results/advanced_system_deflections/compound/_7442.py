...
class WormGearMeshCompoundAdvancedSystemDeflection(_7377.GearMeshCompoundAdvancedSystemDeflection):
    """WormGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7313.WormGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7313.WormGearMeshAdvancedSystemDeflection]':
