...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7195
...
class BeltDriveCompoundAdvancedSystemDeflection(_7416.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BeltDriveCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7195.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7195.BeltDriveAdvancedSystemDeflection]':
