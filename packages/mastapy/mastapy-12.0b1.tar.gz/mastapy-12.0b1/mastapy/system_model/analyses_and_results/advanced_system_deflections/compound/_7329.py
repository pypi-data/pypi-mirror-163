...
class BevelDifferentialGearCompoundAdvancedSystemDeflection(_7334.BevelGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7196.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7196.BevelDifferentialGearAdvancedSystemDeflection]':
