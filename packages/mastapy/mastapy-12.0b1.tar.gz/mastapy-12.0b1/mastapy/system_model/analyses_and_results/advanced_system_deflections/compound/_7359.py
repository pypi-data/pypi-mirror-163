...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7328
...
class CVTCompoundAdvancedSystemDeflection(_7328.BeltDriveCompoundAdvancedSystemDeflection):
    """CVTCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7226.CVTAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7226.CVTAdvancedSystemDeflection]':
