...
class PointLoadAdvancedSystemDeflection(_7311.VirtualComponentAdvancedSystemDeflection):
    """PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2725.PointLoadSystemDeflection]':
