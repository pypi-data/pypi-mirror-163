...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7287, _7288, _7203
...
class SpiralBevelGearSetAdvancedSystemDeflection(_7203.BevelGearSetAdvancedSystemDeflection):
    """SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2742.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7287.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7288.SpiralBevelGearMeshAdvancedSystemDeflection]':
