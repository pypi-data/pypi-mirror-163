...
class CouplingHalfCompoundAdvancedSystemDeflection(_7395.MountableComponentCompoundAdvancedSystemDeflection):
    """CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7225.CouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7225.CouplingHalfAdvancedSystemDeflection]':
