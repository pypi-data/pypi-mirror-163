...
class OilSealCompoundAdvancedSystemDeflection(_7354.ConnectorCompoundAdvancedSystemDeflection):
    """OilSealCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7266.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7266.OilSealAdvancedSystemDeflection]':
