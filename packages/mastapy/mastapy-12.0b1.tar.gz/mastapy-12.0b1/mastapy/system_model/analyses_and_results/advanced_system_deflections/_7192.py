...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import (
    _7193, _7195, _7198, _7205,
    _7204, _7226, _7206, _7211,
    _7216, _7229, _7230, _7235,
    _7243, _7242, _7244, _7251,
    _7258, _7261, _7263, _7264,
    _7266, _7268, _7273, _7274,
    _7275, _7277, _7280, _7284,
    _7283, _7289, _7290, _7295,
    _7298, _7301, _7305, _7310,
    _7314, _7317, _7182
)
...
class AssemblyAdvancedSystemDeflection(_7182.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2631.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7193.BearingAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7195.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7198.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7205.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7204.BoltAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7226.CVTAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7206.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7211.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7216.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7229.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7230.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7235.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7243.FEPartAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7242.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7244.FlexiblePinAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7251.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7258.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7261.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7263.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7264.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7266.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7268.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7273.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7274.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7275.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7277.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7280.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7284.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7283.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7289.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7290.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7295.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7298.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7301.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7305.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7310.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7314.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7317.ZerolBevelGearSetAdvancedSystemDeflection]':
