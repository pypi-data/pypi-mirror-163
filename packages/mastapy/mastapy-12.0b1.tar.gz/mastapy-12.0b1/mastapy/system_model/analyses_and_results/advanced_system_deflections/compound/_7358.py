...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7327
...
class CVTBeltConnectionCompoundAdvancedSystemDeflection(_7327.BeltConnectionCompoundAdvancedSystemDeflection):
    """CVTBeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7227.CVTBeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7227.CVTBeltConnectionAdvancedSystemDeflection]':
