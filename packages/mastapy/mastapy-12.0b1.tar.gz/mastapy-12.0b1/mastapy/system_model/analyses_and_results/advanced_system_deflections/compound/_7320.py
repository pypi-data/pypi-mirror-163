...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7184
...
class AbstractShaftOrHousingCompoundAdvancedSystemDeflection(_7343.ComponentCompoundAdvancedSystemDeflection):
    """AbstractShaftOrHousingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7184.AbstractShaftOrHousingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7184.AbstractShaftOrHousingAdvancedSystemDeflection]':
