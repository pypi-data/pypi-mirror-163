...
class ConicalGearSetCompoundAdvancedSystemDeflection(_7378.GearSetCompoundAdvancedSystemDeflection):
    """ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_531.ConicalGearSetDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_531.ConicalGearSetDutyCycleRating':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7219.ConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7219.ConicalGearSetAdvancedSystemDeflection]':
