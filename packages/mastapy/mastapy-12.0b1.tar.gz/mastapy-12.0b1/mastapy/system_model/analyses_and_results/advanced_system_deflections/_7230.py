...
class CycloidalDiscAdvancedSystemDeflection(_7183.AbstractShaftAdvancedSystemDeflection):
    """CycloidalDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2672.CycloidalDiscSystemDeflection]':
