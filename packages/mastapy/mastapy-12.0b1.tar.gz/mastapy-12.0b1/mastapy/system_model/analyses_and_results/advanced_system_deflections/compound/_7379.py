...
class GuideDxfModelCompoundAdvancedSystemDeflection(_7343.ComponentCompoundAdvancedSystemDeflection):
    """GuideDxfModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7248.GuideDxfModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7248.GuideDxfModelAdvancedSystemDeflection]':
