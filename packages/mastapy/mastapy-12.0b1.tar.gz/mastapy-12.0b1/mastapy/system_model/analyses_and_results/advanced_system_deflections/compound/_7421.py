...
class SpringDamperConnectionCompoundAdvancedSystemDeflection(_7356.CouplingConnectionCompoundAdvancedSystemDeflection):
    """SpringDamperConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7291.SpringDamperConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7291.SpringDamperConnectionAdvancedSystemDeflection]':
