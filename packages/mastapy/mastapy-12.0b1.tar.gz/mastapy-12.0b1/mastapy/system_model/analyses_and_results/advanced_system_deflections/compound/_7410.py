...
class RollingRingCompoundAdvancedSystemDeflection(_7357.CouplingHalfCompoundAdvancedSystemDeflection):
    """RollingRingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7279.RollingRingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7279.RollingRingAdvancedSystemDeflection]':
