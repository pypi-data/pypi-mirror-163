...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_7224.CouplingConnectionAdvancedSystemDeflection):
    """PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2720.PartToPartShearCouplingConnectionSystemDeflection]':
