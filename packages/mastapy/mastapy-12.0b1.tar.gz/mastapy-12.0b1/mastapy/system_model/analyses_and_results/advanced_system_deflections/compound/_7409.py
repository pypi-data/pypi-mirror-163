...
class RollingRingAssemblyCompoundAdvancedSystemDeflection(_7416.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """RollingRingAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7280.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7280.RollingRingAssemblyAdvancedSystemDeflection]':
