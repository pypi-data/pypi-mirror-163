...
class BevelGearMeshCompoundAdvancedSystemDeflection(_7323.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """BevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7202.BevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7202.BevelGearMeshAdvancedSystemDeflection]':
