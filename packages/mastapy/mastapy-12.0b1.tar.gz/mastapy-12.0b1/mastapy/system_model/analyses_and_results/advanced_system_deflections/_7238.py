...
class DatumAdvancedSystemDeflection(_7210.ComponentAdvancedSystemDeflection):
    """DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2685.DatumSystemDeflection]':
