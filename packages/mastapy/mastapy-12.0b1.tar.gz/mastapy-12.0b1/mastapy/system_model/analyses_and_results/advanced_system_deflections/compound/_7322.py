...
class AGMAGleasonConicalGearCompoundAdvancedSystemDeflection(_7350.ConicalGearCompoundAdvancedSystemDeflection):
    """AGMAGleasonConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7189.AGMAGleasonConicalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7189.AGMAGleasonConicalGearAdvancedSystemDeflection]':
