...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7315, _7316, _7203
...
class ZerolBevelGearSetAdvancedSystemDeflection(_7203.BevelGearSetAdvancedSystemDeflection):
    """ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2774.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7315.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7316.ZerolBevelGearMeshAdvancedSystemDeflection]':
