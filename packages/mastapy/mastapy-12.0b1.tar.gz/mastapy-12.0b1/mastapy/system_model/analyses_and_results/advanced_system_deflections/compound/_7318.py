...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7397.PartCompoundAdvancedSystemDeflection):
    """AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7182.AbstractAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7182.AbstractAssemblyAdvancedSystemDeflection]':
