...
class TorqueConverterConnectionAdvancedSystemDeflection(_7224.CouplingConnectionAdvancedSystemDeflection):
    """TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2762.TorqueConverterConnectionSystemDeflection]':
