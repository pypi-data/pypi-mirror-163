...
class PulleyCompoundAdvancedSystemDeflection(_7357.CouplingHalfCompoundAdvancedSystemDeflection):
    """PulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7276.PulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7276.PulleyAdvancedSystemDeflection]':
