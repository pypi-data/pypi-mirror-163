...
class BeltDriveAdvancedSystemDeflection(_7286.SpecialisedAssemblyAdvancedSystemDeflection):
    """BeltDriveAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2634.BeltDriveSystemDeflection]':
