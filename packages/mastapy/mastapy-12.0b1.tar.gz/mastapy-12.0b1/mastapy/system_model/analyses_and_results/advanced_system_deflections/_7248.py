...
class GuideDxfModelAdvancedSystemDeflection(_7210.ComponentAdvancedSystemDeflection):
    """GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2696.GuideDxfModelSystemDeflection]':
