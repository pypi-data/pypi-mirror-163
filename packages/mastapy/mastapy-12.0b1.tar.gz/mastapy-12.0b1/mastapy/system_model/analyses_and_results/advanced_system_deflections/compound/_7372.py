...
class FaceGearMeshCompoundAdvancedSystemDeflection(_7377.GearMeshCompoundAdvancedSystemDeflection):
    """FaceGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7241.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7241.FaceGearMeshAdvancedSystemDeflection]':
