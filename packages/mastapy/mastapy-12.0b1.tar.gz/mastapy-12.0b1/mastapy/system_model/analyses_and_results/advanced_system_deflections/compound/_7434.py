...
class SynchroniserSleeveCompoundAdvancedSystemDeflection(_7433.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserSleeveCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7304.SynchroniserSleeveAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7304.SynchroniserSleeveAdvancedSystemDeflection]':
