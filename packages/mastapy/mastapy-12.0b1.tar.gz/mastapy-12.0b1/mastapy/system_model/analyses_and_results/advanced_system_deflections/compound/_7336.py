...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7324
...
class BevelGearSetCompoundAdvancedSystemDeflection(_7324.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection):
    """BevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7203.BevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7203.BevelGearSetAdvancedSystemDeflection]':
