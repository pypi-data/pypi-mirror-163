...
class ConceptCouplingCompoundAdvancedSystemDeflection(_7355.CouplingCompoundAdvancedSystemDeflection):
    """ConceptCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7211.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7211.ConceptCouplingAdvancedSystemDeflection]':
