...
class SpiralBevelGearMeshAdvancedSystemDeflection(_7202.BevelGearMeshAdvancedSystemDeflection):
    """SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2741.SpiralBevelGearMeshSystemDeflection]':
