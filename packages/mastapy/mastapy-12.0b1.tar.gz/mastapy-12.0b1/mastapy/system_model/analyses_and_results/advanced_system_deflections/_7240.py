...
class FaceGearAdvancedSystemDeflection(_7245.GearAdvancedSystemDeflection):
    """FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_439.FaceGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2690.FaceGearSystemDeflection]':
