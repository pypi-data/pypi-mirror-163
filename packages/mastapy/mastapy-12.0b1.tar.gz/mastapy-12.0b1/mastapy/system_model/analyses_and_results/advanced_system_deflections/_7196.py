...
class BevelDifferentialGearAdvancedSystemDeflection(_7201.BevelGearAdvancedSystemDeflection):
    """BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2637.BevelDifferentialGearSystemDeflection]':
