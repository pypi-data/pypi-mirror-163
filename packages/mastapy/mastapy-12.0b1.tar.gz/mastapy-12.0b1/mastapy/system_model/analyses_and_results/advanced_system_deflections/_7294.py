...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_7202.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2747.StraightBevelDiffGearMeshSystemDeflection]':
