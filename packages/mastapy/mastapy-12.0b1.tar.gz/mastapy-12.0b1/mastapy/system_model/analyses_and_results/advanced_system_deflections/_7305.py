...
class TorqueConverterAdvancedSystemDeflection(_7223.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2764.TorqueConverterSystemDeflection]':
