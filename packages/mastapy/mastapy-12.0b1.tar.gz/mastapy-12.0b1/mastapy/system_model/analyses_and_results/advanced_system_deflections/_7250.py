...
class HypoidGearMeshAdvancedSystemDeflection(_7190.AGMAGleasonConicalGearMeshAdvancedSystemDeflection):
    """HypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2697.HypoidGearMeshSystemDeflection]':
