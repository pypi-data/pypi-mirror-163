...
class HypoidGearAdvancedSystemDeflection(_7189.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_430.HypoidGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2699.HypoidGearSystemDeflection]':
