...
class PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection(_7357.CouplingHalfCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7270.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7270.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
