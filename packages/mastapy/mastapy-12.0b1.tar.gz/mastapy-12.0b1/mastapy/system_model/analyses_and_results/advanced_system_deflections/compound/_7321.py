...
class AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7353.ConnectionCompoundAdvancedSystemDeflection):
    """AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7185.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7185.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection]':
