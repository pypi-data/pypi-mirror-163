...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_7185.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2671.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
