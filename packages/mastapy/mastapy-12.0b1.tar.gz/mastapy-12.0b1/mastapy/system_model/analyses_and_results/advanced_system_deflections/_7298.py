...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7296, _7297, _7203
...
class StraightBevelGearSetAdvancedSystemDeflection(_7203.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2751.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_7296.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_7297.StraightBevelGearMeshAdvancedSystemDeflection]':
