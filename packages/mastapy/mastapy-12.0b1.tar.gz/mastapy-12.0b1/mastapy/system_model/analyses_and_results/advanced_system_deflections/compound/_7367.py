...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7365, _7366, _7378
...
class CylindricalGearSetCompoundAdvancedSystemDeflection(_7378.GearSetCompoundAdvancedSystemDeflection):
    """CylindricalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_454.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_454.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7235.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gears_compound_advanced_system_deflection(self) -> 'List[_7365.CylindricalGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_advanced_system_deflection(self) -> 'List[_7366.CylindricalGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7235.CylindricalGearSetAdvancedSystemDeflection]':
