...
class ClutchAdvancedSystemDeflection(_7223.CouplingAdvancedSystemDeflection):
    """ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2647.ClutchSystemDeflection]':
