...
class PartCompoundAdvancedSystemDeflection(_7458.PartCompoundAnalysis):
    """PartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7267.PartAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7267.PartAdvancedSystemDeflection]':
