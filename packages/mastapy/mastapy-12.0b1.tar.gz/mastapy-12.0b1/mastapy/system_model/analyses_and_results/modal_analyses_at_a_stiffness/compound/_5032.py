...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_4952.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4902.TorqueConverterConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4902.TorqueConverterConnectionModalAnalysisAtAStiffness]':
