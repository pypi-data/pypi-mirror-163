...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4796, _4795, _4802
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4802.BevelGearSetModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4796.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4795.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
