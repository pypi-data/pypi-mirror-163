...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4924
...
class CVTCompoundModalAnalysisAtAStiffness(_4924.BeltDriveCompoundModalAnalysisAtAStiffness):
    """CVTCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4825.CVTModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4825.CVTModalAnalysisAtAStiffness]':
