...
class AbstractAssemblyCompoundModalAnalysisAtAStiffness(_4993.PartCompoundModalAnalysisAtAStiffness):
    """AbstractAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4784.AbstractAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4784.AbstractAssemblyModalAnalysisAtAStiffness]':
