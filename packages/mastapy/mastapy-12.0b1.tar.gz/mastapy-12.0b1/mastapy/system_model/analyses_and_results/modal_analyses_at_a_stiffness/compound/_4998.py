...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4963.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    """PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4869.PlanetaryGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4869.PlanetaryGearSetModalAnalysisAtAStiffness]':
