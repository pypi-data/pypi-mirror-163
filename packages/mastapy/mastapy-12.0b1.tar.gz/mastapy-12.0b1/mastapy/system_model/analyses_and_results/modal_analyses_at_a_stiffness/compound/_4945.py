...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4943, _4944, _4974
...
class ConceptGearSetCompoundModalAnalysisAtAStiffness(_4974.GearSetCompoundModalAnalysisAtAStiffness):
    """ConceptGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4815.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4943.ConceptGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4944.ConceptGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4815.ConceptGearSetModalAnalysisAtAStiffness]':
