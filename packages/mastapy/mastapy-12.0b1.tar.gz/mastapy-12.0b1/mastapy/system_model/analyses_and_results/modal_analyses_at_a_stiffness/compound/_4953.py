...
class CouplingHalfCompoundModalAnalysisAtAStiffness(_4991.MountableComponentCompoundModalAnalysisAtAStiffness):
    """CouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4822.CouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4822.CouplingHalfModalAnalysisAtAStiffness]':
