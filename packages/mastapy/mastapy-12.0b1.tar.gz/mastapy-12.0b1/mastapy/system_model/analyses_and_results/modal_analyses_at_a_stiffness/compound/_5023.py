...
class StraightBevelGearMeshCompoundModalAnalysisAtAStiffness(_4931.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4893.StraightBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4893.StraightBevelGearMeshModalAnalysisAtAStiffness]':
