...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4848, _4847, _4790
...
class HypoidGearSetModalAnalysisAtAStiffness(_4790.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    """HypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4848.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4847.HypoidGearMeshModalAnalysisAtAStiffness]':
