...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4939.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4837.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4837.ExternalCADModelModalAnalysisAtAStiffness]':
