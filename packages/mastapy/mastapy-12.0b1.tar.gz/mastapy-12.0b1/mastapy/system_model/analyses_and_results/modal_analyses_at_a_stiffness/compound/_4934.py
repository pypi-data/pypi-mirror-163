...
class BoltedJointCompoundModalAnalysisAtAStiffness(_5012.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BoltedJointCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4803.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4803.BoltedJointModalAnalysisAtAStiffness]':
