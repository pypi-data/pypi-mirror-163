...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4796
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4930
...
class BevelDifferentialGearCompoundModalAnalysisAtAStiffness(_4930.BevelGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4796.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4796.BevelDifferentialGearModalAnalysisAtAStiffness]':
