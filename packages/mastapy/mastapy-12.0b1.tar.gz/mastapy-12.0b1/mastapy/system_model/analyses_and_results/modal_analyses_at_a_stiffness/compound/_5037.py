...
class WormGearCompoundModalAnalysisAtAStiffness(_4972.GearCompoundModalAnalysisAtAStiffness):
    """WormGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4909.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4909.WormGearModalAnalysisAtAStiffness]':
