...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4915
...
class CycloidalDiscCompoundModalAnalysisAtAStiffness(_4915.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4829.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4829.CycloidalDiscModalAnalysisAtAStiffness]':
