...
class CVTPulleyCompoundModalAnalysisAtAStiffness(_5002.PulleyCompoundModalAnalysisAtAStiffness):
    """CVTPulleyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4826.CVTPulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4826.CVTPulleyModalAnalysisAtAStiffness]':
