...
class StraightBevelDiffGearCompoundModalAnalysisAtAStiffness(_4930.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4891.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4891.StraightBevelDiffGearModalAnalysisAtAStiffness]':
