...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4794
...
class BeltDriveCompoundModalAnalysisAtAStiffness(_5012.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BeltDriveCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4794.BeltDriveModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4794.BeltDriveModalAnalysisAtAStiffness]':
