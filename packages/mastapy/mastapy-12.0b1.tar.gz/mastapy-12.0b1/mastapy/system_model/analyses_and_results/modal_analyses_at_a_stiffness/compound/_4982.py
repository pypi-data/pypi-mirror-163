...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness(_4948.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4853.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4853.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
