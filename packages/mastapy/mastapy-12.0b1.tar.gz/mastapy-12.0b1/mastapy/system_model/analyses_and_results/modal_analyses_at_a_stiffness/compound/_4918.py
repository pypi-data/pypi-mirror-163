...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4946.ConicalGearCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4789.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4789.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
