...
class RollingRingAssemblyCompoundModalAnalysisAtAStiffness(_5012.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """RollingRingAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4876.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4876.RollingRingAssemblyModalAnalysisAtAStiffness]':
