...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(_4973.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConceptGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4813.ConceptGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4813.ConceptGearMeshModalAnalysisAtAStiffness]':
