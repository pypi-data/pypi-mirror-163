...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4918
...
class HypoidGearCompoundModalAnalysisAtAStiffness(_4918.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """HypoidGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4848.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4848.HypoidGearModalAnalysisAtAStiffness]':
