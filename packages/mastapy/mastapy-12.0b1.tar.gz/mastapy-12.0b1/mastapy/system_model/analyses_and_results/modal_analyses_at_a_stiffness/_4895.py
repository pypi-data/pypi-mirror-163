...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4894, _4893, _4802
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4802.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4894.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4893.StraightBevelGearMeshModalAnalysisAtAStiffness]':
