...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4855, _4854, _4853
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness(_4853.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4855.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4854.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
