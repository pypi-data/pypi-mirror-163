...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_4961.CylindricalGearCompoundModalAnalysisAtAStiffness):
    """CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4834.CylindricalPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4834.CylindricalPlanetGearModalAnalysisAtAStiffness]':
