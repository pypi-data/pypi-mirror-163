...
class MassDiscCompoundModalAnalysisAtAStiffness(_5036.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """MassDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4860.MassDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4860.MassDiscModalAnalysisAtAStiffness]':
