...
class VirtualComponentCompoundModalAnalysisAtAStiffness(_4991.MountableComponentCompoundModalAnalysisAtAStiffness):
    """VirtualComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4907.VirtualComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4907.VirtualComponentModalAnalysisAtAStiffness]':
