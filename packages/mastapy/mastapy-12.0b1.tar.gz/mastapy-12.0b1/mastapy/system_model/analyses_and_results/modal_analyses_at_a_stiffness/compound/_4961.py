...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_4972.GearCompoundModalAnalysisAtAStiffness):
    """CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4832.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4832.CylindricalGearModalAnalysisAtAStiffness]':
