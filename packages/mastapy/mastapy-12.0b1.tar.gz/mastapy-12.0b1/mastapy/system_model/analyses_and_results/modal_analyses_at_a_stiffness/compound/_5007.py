...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_4979.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4877.RollingRingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4877.RollingRingConnectionModalAnalysisAtAStiffness]':
