...
class CouplingConnectionCompoundModalAnalysisAtAStiffness(_4979.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4821.CouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4821.CouplingConnectionModalAnalysisAtAStiffness]':
