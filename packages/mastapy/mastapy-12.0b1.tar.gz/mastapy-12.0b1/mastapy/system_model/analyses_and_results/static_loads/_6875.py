...
from mastapy.system_model.analyses_and_results.static_loads import _6873, _6874, _6744
...
class StraightBevelDiffGearSetLoadCase(_6744.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6873.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6873.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6874.StraightBevelDiffGearMeshLoadCase]':
