...
from mastapy.system_model.analyses_and_results.static_loads import _6815, _6794
...
class HarmonicLoadDataImportFromMotorPackages(_6815.HarmonicLoadDataImportBase['T'], Generic[T]):
    """HarmonicLoadDataImportFromMotorPackages
