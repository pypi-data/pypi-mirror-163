...
from mastapy.system_model.analyses_and_results.static_loads import _6778, _6806
...
class CylindricalGearMeshLoadCase(_6806.GearMeshLoadCase):
    """CylindricalGearMeshLoadCase
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_588.ISOTR1417912001CoefficientOfFrictionConstants':
