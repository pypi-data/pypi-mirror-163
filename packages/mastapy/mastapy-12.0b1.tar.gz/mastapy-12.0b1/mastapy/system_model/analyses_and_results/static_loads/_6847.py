...
class PlanetaryGearSetLoadCase(_6779.CylindricalGearSetLoadCase):
    """PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1550.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1550.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2481.PlanetaryGearSet':
