...
from mastapy.system_model.analyses_and_results.static_loads import _6759, _6804
...
class ConicalGearLoadCase(_6804.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6759.ConicalGearManufactureError':
