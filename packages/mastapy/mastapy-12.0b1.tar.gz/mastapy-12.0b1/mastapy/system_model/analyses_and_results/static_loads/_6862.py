...
class RootAssemblyLoadCase(_6733.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1536.PIDControlSettings':
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6779.CylindricalGearSetLoadCase]':
