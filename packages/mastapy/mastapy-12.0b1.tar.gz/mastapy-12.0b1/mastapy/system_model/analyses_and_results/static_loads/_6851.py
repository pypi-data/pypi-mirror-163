...
from mastapy.math_utility import _1463, _1471
...
class PointLoadHarmonicLoadData(_1346.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1463.DegreesOfFreedom':
        """DegreesOfFreedom: 'DegreeOfFreedom' is the original name of this property."""

        temp = self.wrapped.DegreeOfFreedom
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1463.DegreesOfFreedom)(value) if value is not None else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1463.DegreesOfFreedom'):
