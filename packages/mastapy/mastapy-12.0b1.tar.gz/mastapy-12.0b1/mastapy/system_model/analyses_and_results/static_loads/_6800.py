...
from mastapy.system_model.analyses_and_results.static_loads import _6798, _6799, _6809
...
class FaceGearSetLoadCase(_6809.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6798.FaceGearLoadCase]':
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6798.FaceGearLoadCase]':
    ...
    @property
    def face_meshes_load_case(self) -> 'List[_6799.FaceGearMeshLoadCase]':
