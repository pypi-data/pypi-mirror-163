...
from mastapy.system_model.fe import _2299, _2322
...
class FEPartLoadCase(_6723.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2299.AngleSource':
        ...
        return constructor.new_from_mastapy_type(_2299.AngleSource)(value) if value is not None else None
