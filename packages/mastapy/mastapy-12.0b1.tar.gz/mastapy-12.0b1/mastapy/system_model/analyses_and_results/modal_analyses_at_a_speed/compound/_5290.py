...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_5210.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5160.TorqueConverterConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5160.TorqueConverterConnectionModalAnalysisAtASpeed]':
