...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5178
...
class BevelGearSetCompoundModalAnalysisAtASpeed(_5178.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """BevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5061.BevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5061.BevelGearSetModalAnalysisAtASpeed]':
