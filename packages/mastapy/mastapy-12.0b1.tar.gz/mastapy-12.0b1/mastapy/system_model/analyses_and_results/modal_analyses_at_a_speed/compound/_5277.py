...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_5188.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5149.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5149.StraightBevelDiffGearModalAnalysisAtASpeed]':
