...
class PlanetaryConnectionCompoundModalAnalysisAtASpeed(_5269.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """PlanetaryConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5126.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5126.PlanetaryConnectionModalAnalysisAtASpeed]':
