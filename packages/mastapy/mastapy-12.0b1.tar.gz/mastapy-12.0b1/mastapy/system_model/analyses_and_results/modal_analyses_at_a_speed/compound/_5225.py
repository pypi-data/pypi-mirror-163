...
class FaceGearCompoundModalAnalysisAtASpeed(_5230.GearCompoundModalAnalysisAtASpeed):
    """FaceGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5097.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5097.FaceGearModalAnalysisAtASpeed]':
