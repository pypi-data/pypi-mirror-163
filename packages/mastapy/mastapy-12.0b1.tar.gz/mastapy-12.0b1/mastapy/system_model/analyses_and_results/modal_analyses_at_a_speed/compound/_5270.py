...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5172
...
class SpecialisedAssemblyCompoundModalAnalysisAtASpeed(_5172.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """SpecialisedAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5141.SpecialisedAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5141.SpecialisedAssemblyModalAnalysisAtASpeed]':
