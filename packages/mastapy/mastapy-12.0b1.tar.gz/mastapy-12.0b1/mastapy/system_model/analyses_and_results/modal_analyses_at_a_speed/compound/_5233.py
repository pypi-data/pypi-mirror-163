...
class GuideDxfModelCompoundModalAnalysisAtASpeed(_5197.ComponentCompoundModalAnalysisAtASpeed):
    """GuideDxfModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5104.GuideDxfModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5104.GuideDxfModelModalAnalysisAtASpeed]':
