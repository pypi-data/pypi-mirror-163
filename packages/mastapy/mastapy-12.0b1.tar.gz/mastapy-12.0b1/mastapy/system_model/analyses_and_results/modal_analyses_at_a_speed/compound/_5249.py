...
class MountableComponentCompoundModalAnalysisAtASpeed(_5197.ComponentCompoundModalAnalysisAtASpeed):
    """MountableComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5120.MountableComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5120.MountableComponentModalAnalysisAtASpeed]':
