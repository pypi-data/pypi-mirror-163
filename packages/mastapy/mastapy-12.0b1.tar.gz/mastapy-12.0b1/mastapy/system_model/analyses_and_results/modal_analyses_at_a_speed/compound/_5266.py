...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5179
...
class RootAssemblyCompoundModalAnalysisAtASpeed(_5179.AssemblyCompoundModalAnalysisAtASpeed):
    """RootAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5137.RootAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5137.RootAssemblyModalAnalysisAtASpeed]':
