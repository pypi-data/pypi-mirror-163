...
class BearingCompoundModalAnalysisAtASpeed(_5208.ConnectorCompoundModalAnalysisAtASpeed):
    """BearingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5051.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5051.BearingModalAnalysisAtASpeed]':
