...
class SpringDamperCompoundModalAnalysisAtASpeed(_5209.CouplingCompoundModalAnalysisAtASpeed):
    """SpringDamperCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5147.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5147.SpringDamperModalAnalysisAtASpeed]':
