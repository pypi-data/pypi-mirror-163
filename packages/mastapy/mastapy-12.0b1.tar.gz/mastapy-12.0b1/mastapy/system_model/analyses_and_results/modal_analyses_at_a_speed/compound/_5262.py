...
class RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed(_5237.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5133.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5133.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
