...
class StraightBevelSunGearCompoundModalAnalysisAtASpeed(_5277.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5155.StraightBevelSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5155.StraightBevelSunGearModalAnalysisAtASpeed]':
