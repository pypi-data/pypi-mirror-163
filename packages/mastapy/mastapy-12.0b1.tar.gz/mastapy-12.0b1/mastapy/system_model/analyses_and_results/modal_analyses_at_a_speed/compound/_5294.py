...
class VirtualComponentCompoundModalAnalysisAtASpeed(_5249.MountableComponentCompoundModalAnalysisAtASpeed):
    """VirtualComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5165.VirtualComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5165.VirtualComponentModalAnalysisAtASpeed]':
