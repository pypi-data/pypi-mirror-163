...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed(_5205.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5109.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5109.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
