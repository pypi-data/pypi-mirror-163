...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5298, _5299, _5190
...
class ZerolBevelGearSetCompoundModalAnalysisAtASpeed(_5190.BevelGearSetCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5171.ZerolBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5298.ZerolBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5299.ZerolBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5171.ZerolBevelGearSetModalAnalysisAtASpeed]':
