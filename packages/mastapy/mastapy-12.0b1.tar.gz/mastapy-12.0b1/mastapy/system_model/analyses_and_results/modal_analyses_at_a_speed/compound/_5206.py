...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_5232.GearSetCompoundModalAnalysisAtASpeed):
    """ConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5077.ConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5077.ConicalGearSetModalAnalysisAtASpeed]':
