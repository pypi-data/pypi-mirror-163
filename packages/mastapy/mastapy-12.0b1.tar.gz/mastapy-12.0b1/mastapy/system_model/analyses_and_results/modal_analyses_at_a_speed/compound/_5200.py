...
class ConceptCouplingHalfCompoundModalAnalysisAtASpeed(_5211.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ConceptCouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5070.ConceptCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5070.ConceptCouplingHalfModalAnalysisAtASpeed]':
