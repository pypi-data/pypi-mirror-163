...
class WormGearCompoundModalAnalysisAtASpeed(_5230.GearCompoundModalAnalysisAtASpeed):
    """WormGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5167.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5167.WormGearModalAnalysisAtASpeed]':
