...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5060
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5176
...
class BevelGearCompoundModalAnalysisAtASpeed(_5176.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    """BevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5060.BevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5060.BevelGearModalAnalysisAtASpeed]':
