...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5225, _5226, _5232
...
class FaceGearSetCompoundModalAnalysisAtASpeed(_5232.GearSetCompoundModalAnalysisAtASpeed):
    """FaceGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5098.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5225.FaceGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5226.FaceGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5098.FaceGearSetModalAnalysisAtASpeed]':
