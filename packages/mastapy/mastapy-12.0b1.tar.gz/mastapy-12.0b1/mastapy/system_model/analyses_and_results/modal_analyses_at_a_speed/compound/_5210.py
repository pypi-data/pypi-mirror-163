...
class CouplingConnectionCompoundModalAnalysisAtASpeed(_5237.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5080.CouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5080.CouplingConnectionModalAnalysisAtASpeed]':
