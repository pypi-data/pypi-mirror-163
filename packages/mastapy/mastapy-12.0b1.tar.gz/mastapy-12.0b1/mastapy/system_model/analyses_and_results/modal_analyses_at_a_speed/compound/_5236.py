...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5234, _5235, _5178
...
class HypoidGearSetCompoundModalAnalysisAtASpeed(_5178.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """HypoidGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5107.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5234.HypoidGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5235.HypoidGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5107.HypoidGearSetModalAnalysisAtASpeed]':
