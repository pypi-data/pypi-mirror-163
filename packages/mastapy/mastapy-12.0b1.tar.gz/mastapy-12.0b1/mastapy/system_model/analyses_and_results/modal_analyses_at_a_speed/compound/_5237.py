...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5207.ConnectionCompoundModalAnalysisAtASpeed):
    """InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5108.InterMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5108.InterMountableComponentConnectionModalAnalysisAtASpeed]':
