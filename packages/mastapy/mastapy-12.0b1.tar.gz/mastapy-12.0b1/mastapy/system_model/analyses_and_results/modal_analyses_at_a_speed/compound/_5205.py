...
class ConicalGearMeshCompoundModalAnalysisAtASpeed(_5231.GearMeshCompoundModalAnalysisAtASpeed):
    """ConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5075.ConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5075.ConicalGearMeshModalAnalysisAtASpeed]':
