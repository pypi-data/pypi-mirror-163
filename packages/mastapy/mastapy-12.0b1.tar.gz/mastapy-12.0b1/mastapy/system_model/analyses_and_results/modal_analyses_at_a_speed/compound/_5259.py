...
class PowerLoadCompoundModalAnalysisAtASpeed(_5294.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PowerLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5130.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5130.PowerLoadModalAnalysisAtASpeed]':
