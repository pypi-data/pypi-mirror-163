...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed(_5196.CoaxialConnectionCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5087.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5087.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
