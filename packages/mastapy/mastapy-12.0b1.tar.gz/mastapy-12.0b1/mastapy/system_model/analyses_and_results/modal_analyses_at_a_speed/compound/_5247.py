...
class MassDiscCompoundModalAnalysisAtASpeed(_5294.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MassDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5118.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5118.MassDiscModalAnalysisAtASpeed]':
