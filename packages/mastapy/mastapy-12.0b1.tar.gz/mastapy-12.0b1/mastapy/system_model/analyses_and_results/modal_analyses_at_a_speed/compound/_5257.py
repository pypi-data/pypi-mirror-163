...
class PlanetCarrierCompoundModalAnalysisAtASpeed(_5249.MountableComponentCompoundModalAnalysisAtASpeed):
    """PlanetCarrierCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5128.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5128.PlanetCarrierModalAnalysisAtASpeed]':
