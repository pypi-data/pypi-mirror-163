...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5182
...
class CVTCompoundModalAnalysisAtASpeed(_5182.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5084.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5084.CVTModalAnalysisAtASpeed]':
