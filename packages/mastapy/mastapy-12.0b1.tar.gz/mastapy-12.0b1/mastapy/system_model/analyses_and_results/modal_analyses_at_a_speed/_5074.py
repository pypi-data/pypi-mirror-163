...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5073, _5072, _5103
...
class ConceptGearSetModalAnalysisAtASpeed(_5103.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_5073.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_5072.ConceptGearMeshModalAnalysisAtASpeed]':
