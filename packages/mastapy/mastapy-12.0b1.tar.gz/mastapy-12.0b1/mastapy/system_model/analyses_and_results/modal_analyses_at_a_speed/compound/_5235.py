...
class HypoidGearMeshCompoundModalAnalysisAtASpeed(_5177.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    """HypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5105.HypoidGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5105.HypoidGearMeshModalAnalysisAtASpeed]':
