...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5044
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5174
...
class AbstractShaftCompoundModalAnalysisAtASpeed(_5174.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5044.AbstractShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5044.AbstractShaftModalAnalysisAtASpeed]':
