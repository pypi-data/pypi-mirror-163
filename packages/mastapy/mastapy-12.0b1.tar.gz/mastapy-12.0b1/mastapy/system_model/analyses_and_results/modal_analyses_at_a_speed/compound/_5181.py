...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5052
...
class BeltConnectionCompoundModalAnalysisAtASpeed(_5237.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """BeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5052.BeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5052.BeltConnectionModalAnalysisAtASpeed]':
