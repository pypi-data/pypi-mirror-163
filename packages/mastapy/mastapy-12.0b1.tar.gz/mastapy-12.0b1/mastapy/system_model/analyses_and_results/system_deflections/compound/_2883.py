...
class ShaftHubConnectionCompoundSystemDeflection(_2821.ConnectorCompoundSystemDeflection):
    """ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2735.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2735.ShaftHubConnectionSystemDeflection]':
