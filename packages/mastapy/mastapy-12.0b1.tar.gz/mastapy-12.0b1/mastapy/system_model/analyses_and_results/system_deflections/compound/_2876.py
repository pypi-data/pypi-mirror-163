...
class RingPinsToDiscConnectionCompoundSystemDeflection(_2851.InterMountableComponentConnectionCompoundSystemDeflection):
    """RingPinsToDiscConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2729.RingPinsToDiscConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2729.RingPinsToDiscConnectionSystemDeflection]':
