...
from mastapy.system_model.drawing import _2184
...
class ConcentricPartGroupCombinationSystemDeflectionResults(_0.APIBase):
    ...
    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_2184.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
