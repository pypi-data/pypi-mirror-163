...
class ConnectionCompoundSystemDeflection(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2661.ConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2661.ConnectionSystemDeflection]':
