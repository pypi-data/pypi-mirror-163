...
class RigidlyConnectedComponentGroupSystemDeflection(_2591.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1476.MassProperties':
    ...
    @property
    def components(self) -> 'List[_2649.ComponentSystemDeflection]':
