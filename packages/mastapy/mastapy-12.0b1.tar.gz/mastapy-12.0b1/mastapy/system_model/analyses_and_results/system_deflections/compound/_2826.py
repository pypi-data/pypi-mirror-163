...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2795
...
class CVTCompoundSystemDeflection(_2795.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2668.CVTSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2668.CVTSystemDeflection]':
