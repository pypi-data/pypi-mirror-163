...
class InterMountableComponentConnectionCompoundSystemDeflection(_2820.ConnectionCompoundSystemDeflection):
    """InterMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2701.InterMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2701.InterMountableComponentConnectionSystemDeflection]':
