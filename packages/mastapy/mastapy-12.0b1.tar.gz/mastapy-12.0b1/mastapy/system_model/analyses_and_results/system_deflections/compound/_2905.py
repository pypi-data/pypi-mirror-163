...
class TorqueConverterConnectionCompoundSystemDeflection(_2823.CouplingConnectionCompoundSystemDeflection):
    """TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2762.TorqueConverterConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2762.TorqueConverterConnectionSystemDeflection]':
