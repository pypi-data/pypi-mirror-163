...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2839, _2840, _2846
...
class FaceGearSetCompoundSystemDeflection(_2846.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2689.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2839.FaceGearCompoundSystemDeflection]':
    ...
    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2840.FaceGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2689.FaceGearSetSystemDeflection]':
