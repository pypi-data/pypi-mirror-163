...
class CylindricalGearMeshCompoundSystemDeflection(_2845.GearMeshCompoundSystemDeflection):
    """CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def cylindrical_mesh_rating(self) -> '_457.CylindricalMeshDutyCycleRating':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2675.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2675.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
