...
class AbstractShaftOrHousingCompoundSystemDeflection(_2810.ComponentCompoundSystemDeflection):
    """AbstractShaftOrHousingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2625.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2625.AbstractShaftOrHousingSystemDeflection]':
