...
from mastapy.system_model.analyses_and_results.system_deflections import _2637, _2635, _2641
...
class BevelDifferentialGearSetSystemDeflection(_2641.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3977.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2637.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2635.BevelDifferentialGearMeshSystemDeflection]':
