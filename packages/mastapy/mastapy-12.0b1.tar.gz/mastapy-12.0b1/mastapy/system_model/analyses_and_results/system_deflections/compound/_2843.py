...
class FlexiblePinAssemblyCompoundSystemDeflection(_2885.SpecialisedAssemblyCompoundSystemDeflection):
    """FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2692.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2692.FlexiblePinAssemblySystemDeflection]':
