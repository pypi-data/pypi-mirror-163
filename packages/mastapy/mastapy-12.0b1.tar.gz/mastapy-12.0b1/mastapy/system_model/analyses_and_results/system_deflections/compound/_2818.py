...
class ConicalGearMeshCompoundSystemDeflection(_2845.GearMeshCompoundSystemDeflection):
    """ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2658.ConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2658.ConicalGearMeshSystemDeflection]':
