...
class StraightBevelGearMeshSystemDeflection(_2640.BevelGearMeshSystemDeflection):
    """StraightBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_386.StraightBevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_386.StraightBevelGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4075.StraightBevelGearMeshPowerFlow':
