...
class StraightBevelGearCompoundSystemDeflection(_2801.BevelGearCompoundSystemDeflection):
    """StraightBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2752.StraightBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2752.StraightBevelGearSystemDeflection]':
