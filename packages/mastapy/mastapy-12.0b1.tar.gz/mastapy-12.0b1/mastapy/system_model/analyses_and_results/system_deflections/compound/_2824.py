...
class CouplingHalfCompoundSystemDeflection(_2863.MountableComponentCompoundSystemDeflection):
    """CouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2664.CouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2664.CouplingHalfSystemDeflection]':
