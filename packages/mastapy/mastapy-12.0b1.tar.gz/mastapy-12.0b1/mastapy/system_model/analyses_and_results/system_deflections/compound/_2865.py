...
class PartCompoundSystemDeflection(_7458.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2719.PartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2719.PartSystemDeflection]':
