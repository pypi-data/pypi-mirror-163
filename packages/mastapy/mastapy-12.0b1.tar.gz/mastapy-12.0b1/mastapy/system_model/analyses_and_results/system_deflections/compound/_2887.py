...
class SpiralBevelGearMeshCompoundSystemDeflection(_2802.BevelGearMeshCompoundSystemDeflection):
    """SpiralBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2741.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2741.SpiralBevelGearMeshSystemDeflection]':
