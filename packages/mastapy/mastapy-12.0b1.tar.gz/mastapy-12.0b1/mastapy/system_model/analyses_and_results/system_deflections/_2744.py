...
class SpringDamperConnectionSystemDeflection(_2663.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4069.SpringDamperConnectionPowerFlow':
