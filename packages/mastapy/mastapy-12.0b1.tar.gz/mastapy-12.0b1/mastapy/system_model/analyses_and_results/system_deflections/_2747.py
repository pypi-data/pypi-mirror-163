...
class StraightBevelDiffGearMeshSystemDeflection(_2640.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_389.StraightBevelDiffGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_389.StraightBevelDiffGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4072.StraightBevelDiffGearMeshPowerFlow':
