...
from mastapy.system_model.analyses_and_results.power_flows import _3988, _4008
...
class CoaxialConnectionSystemDeflection(_2739.ShaftToMountableComponentConnectionSystemDeflection):
    """CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3988.CoaxialConnectionPowerFlow':
