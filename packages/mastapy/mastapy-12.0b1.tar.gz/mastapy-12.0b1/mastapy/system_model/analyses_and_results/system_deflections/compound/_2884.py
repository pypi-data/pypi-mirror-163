...
class ShaftToMountableComponentConnectionCompoundSystemDeflection(_2788.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    """ShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2739.ShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2739.ShaftToMountableComponentConnectionSystemDeflection]':
