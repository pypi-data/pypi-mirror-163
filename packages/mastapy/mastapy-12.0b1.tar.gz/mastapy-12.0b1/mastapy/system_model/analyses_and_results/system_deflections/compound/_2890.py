...
class SpringDamperConnectionCompoundSystemDeflection(_2823.CouplingConnectionCompoundSystemDeflection):
    """SpringDamperConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2744.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2744.SpringDamperConnectionSystemDeflection]':
