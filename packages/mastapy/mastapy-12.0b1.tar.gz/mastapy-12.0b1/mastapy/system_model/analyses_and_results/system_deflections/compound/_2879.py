...
class RollingRingConnectionCompoundSystemDeflection(_2851.InterMountableComponentConnectionCompoundSystemDeflection):
    """RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2732.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2732.RollingRingConnectionSystemDeflection]':
