...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2796.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2638.BevelDifferentialPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2638.BevelDifferentialPlanetGearSystemDeflection]':
