...
class CoaxialConnectionCompoundSystemDeflection(_2884.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    """CoaxialConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2648.CoaxialConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2648.CoaxialConnectionSystemDeflection]':
