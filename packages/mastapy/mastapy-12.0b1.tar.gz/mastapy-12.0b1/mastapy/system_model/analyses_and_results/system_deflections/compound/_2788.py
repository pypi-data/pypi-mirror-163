...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2820
...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(_2820.ConnectionCompoundSystemDeflection):
    """AbstractShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2627.AbstractShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2627.AbstractShaftToMountableComponentConnectionSystemDeflection]':
