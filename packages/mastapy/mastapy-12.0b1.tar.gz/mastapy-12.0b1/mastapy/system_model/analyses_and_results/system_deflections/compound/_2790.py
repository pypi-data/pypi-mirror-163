...
class AGMAGleasonConicalGearMeshCompoundSystemDeflection(_2818.ConicalGearMeshCompoundSystemDeflection):
    """AGMAGleasonConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2628.AGMAGleasonConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2628.AGMAGleasonConicalGearMeshSystemDeflection]':
