...
class RingPinsCompoundSystemDeflection(_2863.MountableComponentCompoundSystemDeflection):
    """RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2728.RingPinsSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2728.RingPinsSystemDeflection]':
