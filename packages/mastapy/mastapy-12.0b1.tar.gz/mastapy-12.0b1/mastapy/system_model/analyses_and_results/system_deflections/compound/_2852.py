...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2817
...
class KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection(_2817.ConicalGearCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2704.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2704.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
