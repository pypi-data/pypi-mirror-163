...
class SpiralBevelGearCompoundSystemDeflection(_2801.BevelGearCompoundSystemDeflection):
    """SpiralBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2743.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2743.SpiralBevelGearSystemDeflection]':
