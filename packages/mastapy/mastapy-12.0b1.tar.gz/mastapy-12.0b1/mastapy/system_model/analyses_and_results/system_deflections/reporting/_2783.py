...
from mastapy.utility.enums import _1776
...
class ShaftSystemDeflectionSectionsReport(_1714.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1776.TableAndChartOptions':
        """TableAndChartOptions: 'Display' is the original name of this property."""

        temp = self.wrapped.Display
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1776.TableAndChartOptions)(value) if value is not None else None

    @display.setter
    def display(self, value: '_1776.TableAndChartOptions'):
