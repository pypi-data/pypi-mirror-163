...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2858, _2859, _2854
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection(_2854.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2709.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2858.KlingelnbergCycloPalloidSpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2859.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2709.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
