...
class ConceptCouplingConnectionCompoundSystemDeflection(_2823.CouplingConnectionCompoundSystemDeflection):
    """ConceptCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2651.ConceptCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2651.ConceptCouplingConnectionSystemDeflection]':
