...
class TorqueConverterPumpCompoundSystemDeflection(_2824.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2763.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2763.TorqueConverterPumpSystemDeflection]':
