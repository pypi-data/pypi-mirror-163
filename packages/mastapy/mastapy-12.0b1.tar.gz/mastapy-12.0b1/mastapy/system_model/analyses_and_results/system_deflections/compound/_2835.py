...
class CylindricalPlanetGearCompoundSystemDeflection(_2832.CylindricalGearCompoundSystemDeflection):
    """CylindricalPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2684.CylindricalPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2684.CylindricalPlanetGearSystemDeflection]':
