...
class BoltCompoundSystemDeflection(_2810.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2644.BoltSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2644.BoltSystemDeflection]':
