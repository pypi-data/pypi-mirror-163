...
class SpringDamperCompoundSystemDeflection(_2822.CouplingCompoundSystemDeflection):
    """SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2746.SpringDamperSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2746.SpringDamperSystemDeflection]':
