...
class StraightBevelSunGearCompoundSystemDeflection(_2892.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2754.StraightBevelSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2754.StraightBevelSunGearSystemDeflection]':
