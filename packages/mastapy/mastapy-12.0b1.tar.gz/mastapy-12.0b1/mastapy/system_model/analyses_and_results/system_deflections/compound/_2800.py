...
class BevelDifferentialSunGearCompoundSystemDeflection(_2796.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2639.BevelDifferentialSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2639.BevelDifferentialSunGearSystemDeflection]':
