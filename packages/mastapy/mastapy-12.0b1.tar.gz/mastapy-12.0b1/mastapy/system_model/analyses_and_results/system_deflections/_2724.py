...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2780
...
class PlanetCarrierSystemDeflection(_2716.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6849.PlanetCarrierLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4050.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2780.PlanetCarrierWindup]':
