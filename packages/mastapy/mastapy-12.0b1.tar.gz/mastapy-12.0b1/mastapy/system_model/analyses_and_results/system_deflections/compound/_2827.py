...
class CVTPulleyCompoundSystemDeflection(_2874.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2667.CVTPulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2667.CVTPulleySystemDeflection]':
