...
class SynchroniserSleeveCompoundSystemDeflection(_2902.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserSleeveCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2757.SynchroniserSleeveSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2757.SynchroniserSleeveSystemDeflection]':
