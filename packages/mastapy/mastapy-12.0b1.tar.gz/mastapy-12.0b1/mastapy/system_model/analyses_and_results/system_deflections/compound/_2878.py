...
class RollingRingCompoundSystemDeflection(_2824.CouplingHalfCompoundSystemDeflection):
    """RollingRingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2733.RollingRingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2733.RollingRingSystemDeflection]':
