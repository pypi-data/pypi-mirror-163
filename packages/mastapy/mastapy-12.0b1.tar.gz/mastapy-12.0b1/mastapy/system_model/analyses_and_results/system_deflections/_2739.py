...
class ShaftToMountableComponentConnectionSystemDeflection(_2627.AbstractShaftToMountableComponentConnectionSystemDeflection):
    """ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4064.ShaftToMountableComponentConnectionPowerFlow':
