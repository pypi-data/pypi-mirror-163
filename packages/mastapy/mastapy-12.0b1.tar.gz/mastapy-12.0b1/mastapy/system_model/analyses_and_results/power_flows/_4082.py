...
from mastapy.system_model.analyses_and_results.power_flows import _4080, _4065
...
class SynchroniserPowerFlow(_4065.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4080.SynchroniserHalfPowerFlow]':
