...
class ConceptCouplingConnectionCompoundPowerFlow(_4135.CouplingConnectionCompoundPowerFlow):
    """ConceptCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3990.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3990.ConceptCouplingConnectionPowerFlow]':
