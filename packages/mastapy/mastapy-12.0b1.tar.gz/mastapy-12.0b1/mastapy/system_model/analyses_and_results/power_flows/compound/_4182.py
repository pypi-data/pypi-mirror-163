...
class PlanetCarrierCompoundPowerFlow(_4174.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4050.PlanetCarrierPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4050.PlanetCarrierPowerFlow]':
