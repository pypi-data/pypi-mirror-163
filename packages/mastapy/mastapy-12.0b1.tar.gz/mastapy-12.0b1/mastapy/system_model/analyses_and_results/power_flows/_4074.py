...
from mastapy.system_model.analyses_and_results.power_flows import _4073, _4072, _3982
...
class StraightBevelDiffGearSetPowerFlow(_3982.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4073.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_4073.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4072.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_4072.StraightBevelDiffGearMeshPowerFlow]':
