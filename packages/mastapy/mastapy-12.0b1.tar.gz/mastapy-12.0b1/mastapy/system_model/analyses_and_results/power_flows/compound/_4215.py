...
class TorqueConverterConnectionCompoundPowerFlow(_4135.CouplingConnectionCompoundPowerFlow):
    """TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4085.TorqueConverterConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4085.TorqueConverterConnectionPowerFlow]':
