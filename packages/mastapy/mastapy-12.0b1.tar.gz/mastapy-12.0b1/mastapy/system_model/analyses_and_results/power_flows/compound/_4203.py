...
class StraightBevelDiffGearMeshCompoundPowerFlow(_4114.BevelGearMeshCompoundPowerFlow):
    """StraightBevelDiffGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4072.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4072.StraightBevelDiffGearMeshPowerFlow]':
