...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_4130.ConicalGearMeshCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4031.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4031.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
