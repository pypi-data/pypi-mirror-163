...
class RollingRingConnectionCompoundPowerFlow(_4162.InterMountableComponentConnectionCompoundPowerFlow):
    """RollingRingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4059.RollingRingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4059.RollingRingConnectionPowerFlow]':
