...
class GearCompoundPowerFlow(_4174.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4024.GearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4024.GearPowerFlow]':
