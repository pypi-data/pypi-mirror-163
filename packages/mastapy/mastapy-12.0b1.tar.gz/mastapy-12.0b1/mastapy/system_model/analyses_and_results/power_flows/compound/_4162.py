...
class InterMountableComponentConnectionCompoundPowerFlow(_4132.ConnectionCompoundPowerFlow):
    """InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4030.InterMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4030.InterMountableComponentConnectionPowerFlow]':
