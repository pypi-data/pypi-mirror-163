...
class ExternalCADModelCompoundPowerFlow(_4122.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4017.ExternalCADModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4017.ExternalCADModelPowerFlow]':
