...
class BeltConnectionCompoundPowerFlow(_4162.InterMountableComponentConnectionCompoundPowerFlow):
    """BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3973.BeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3973.BeltConnectionPowerFlow]':
