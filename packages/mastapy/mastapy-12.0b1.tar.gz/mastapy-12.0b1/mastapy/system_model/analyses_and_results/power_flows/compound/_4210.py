...
class SynchroniserCompoundPowerFlow(_4195.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4082.SynchroniserPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4082.SynchroniserPowerFlow]':
