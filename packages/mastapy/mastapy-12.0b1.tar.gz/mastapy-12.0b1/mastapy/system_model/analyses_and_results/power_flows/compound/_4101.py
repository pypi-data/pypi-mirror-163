...
class AGMAGleasonConicalGearCompoundPowerFlow(_4129.ConicalGearCompoundPowerFlow):
    """AGMAGleasonConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3969.AGMAGleasonConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3969.AGMAGleasonConicalGearPowerFlow]':
