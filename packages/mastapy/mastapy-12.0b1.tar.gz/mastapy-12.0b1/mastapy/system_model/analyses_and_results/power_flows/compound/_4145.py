...
class CylindricalGearMeshCompoundPowerFlow(_4156.GearMeshCompoundPowerFlow):
    """CylindricalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4012.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4012.CylindricalGearMeshPowerFlow]':
