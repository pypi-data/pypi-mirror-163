...
from mastapy.system_model.analyses_and_results.power_flows import _4019, _4018, _4025
...
class FaceGearSetPowerFlow(_4025.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4019.FaceGearPowerFlow]':
    ...
    @property
    def face_gears_power_flow(self) -> 'List[_4019.FaceGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4018.FaceGearMeshPowerFlow]':
    ...
    @property
    def face_meshes_power_flow(self) -> 'List[_4018.FaceGearMeshPowerFlow]':
