...
class CouplingCompoundPowerFlow(_4195.SpecialisedAssemblyCompoundPowerFlow):
    """CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4003.CouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4003.CouplingPowerFlow]':
