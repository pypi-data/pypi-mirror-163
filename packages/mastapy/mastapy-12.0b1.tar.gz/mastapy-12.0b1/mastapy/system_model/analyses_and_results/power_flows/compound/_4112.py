...
class BevelDifferentialSunGearCompoundPowerFlow(_4108.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3979.BevelDifferentialSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3979.BevelDifferentialSunGearPowerFlow]':
