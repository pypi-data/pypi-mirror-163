...
class ZerolBevelGearMeshCompoundPowerFlow(_4114.BevelGearMeshCompoundPowerFlow):
    """ZerolBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4094.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4094.ZerolBevelGearMeshPowerFlow]':
