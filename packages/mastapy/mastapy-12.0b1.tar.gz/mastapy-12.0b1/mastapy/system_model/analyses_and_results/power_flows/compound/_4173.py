...
class MeasurementComponentCompoundPowerFlow(_4219.VirtualComponentCompoundPowerFlow):
    """MeasurementComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4041.MeasurementComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4041.MeasurementComponentPowerFlow]':
