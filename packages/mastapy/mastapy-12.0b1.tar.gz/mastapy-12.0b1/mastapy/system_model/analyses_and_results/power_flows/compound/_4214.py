...
class TorqueConverterCompoundPowerFlow(_4134.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4086.TorqueConverterPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4086.TorqueConverterPowerFlow]':
