...
class CycloidalAssemblyCompoundPowerFlow(_4195.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4007.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4007.CycloidalAssemblyPowerFlow]':
