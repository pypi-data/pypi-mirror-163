...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4106
...
class CVTBeltConnectionCompoundPowerFlow(_4106.BeltConnectionCompoundPowerFlow):
    """CVTBeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4004.CVTBeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4004.CVTBeltConnectionPowerFlow]':
