...
class PlanetaryGearSetCompoundPowerFlow(_4146.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4049.PlanetaryGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4049.PlanetaryGearSetPowerFlow]':
