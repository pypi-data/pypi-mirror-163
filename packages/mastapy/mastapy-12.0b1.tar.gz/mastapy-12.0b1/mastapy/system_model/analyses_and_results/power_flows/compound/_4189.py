...
class RollingRingCompoundPowerFlow(_4136.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4060.RollingRingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4060.RollingRingPowerFlow]':
