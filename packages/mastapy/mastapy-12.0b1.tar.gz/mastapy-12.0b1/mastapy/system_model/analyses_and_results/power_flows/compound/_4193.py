...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4133
...
class ShaftHubConnectionCompoundPowerFlow(_4133.ConnectorCompoundPowerFlow):
    """ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4062.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4062.ShaftHubConnectionPowerFlow]':
