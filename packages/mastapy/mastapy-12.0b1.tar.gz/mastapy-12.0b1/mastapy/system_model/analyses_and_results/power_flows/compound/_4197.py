...
class SpiralBevelGearMeshCompoundPowerFlow(_4114.BevelGearMeshCompoundPowerFlow):
    """SpiralBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4066.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4066.SpiralBevelGearMeshPowerFlow]':
