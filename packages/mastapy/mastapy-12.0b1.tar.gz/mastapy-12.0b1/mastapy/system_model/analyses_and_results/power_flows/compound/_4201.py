...
class SpringDamperHalfCompoundPowerFlow(_4136.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4070.SpringDamperHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4070.SpringDamperHalfPowerFlow]':
