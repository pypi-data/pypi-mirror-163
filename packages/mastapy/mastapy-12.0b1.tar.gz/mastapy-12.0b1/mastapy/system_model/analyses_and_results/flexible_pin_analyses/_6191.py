...
class FlexiblePinAnalysisStopStartAnalysis(_6185.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self) -> '_2738.ShaftSystemDeflection':
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2738.ShaftSystemDeflection':
