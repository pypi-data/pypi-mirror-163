...
from mastapy.system_model.analyses_and_results.load_case_groups import _5588
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6184
...
class WindTurbineCertificationReport(_6184.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2414.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2734.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2880.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2734.RootAssemblySystemDeflection':
