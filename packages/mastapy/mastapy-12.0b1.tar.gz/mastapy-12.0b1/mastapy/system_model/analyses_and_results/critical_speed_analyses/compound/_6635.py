...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6592
...
class CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis(_6592.AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6506.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6506.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
