...
class BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis(_6600.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6472.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6472.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
