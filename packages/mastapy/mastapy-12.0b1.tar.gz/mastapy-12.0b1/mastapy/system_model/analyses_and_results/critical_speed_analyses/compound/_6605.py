...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6474
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6593
...
class BevelGearCompoundCriticalSpeedAnalysis(_6593.AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis):
    """BevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6474.BevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6474.BevelGearCriticalSpeedAnalysis]':
