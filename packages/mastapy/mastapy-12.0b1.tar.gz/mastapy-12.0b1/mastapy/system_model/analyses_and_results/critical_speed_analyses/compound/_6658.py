...
class KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis(_6655.KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6529.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6529.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
