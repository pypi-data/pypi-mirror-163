...
class AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6624.ConnectionCompoundCriticalSpeedAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6461.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6461.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
