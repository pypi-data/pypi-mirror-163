...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6462
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6621
...
class AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis(_6621.ConicalGearCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6462.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6462.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
