...
class CouplingHalfCompoundCriticalSpeedAnalysis(_6666.MountableComponentCompoundCriticalSpeedAnalysis):
    """CouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6497.CouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6497.CouplingHalfCriticalSpeedAnalysis]':
