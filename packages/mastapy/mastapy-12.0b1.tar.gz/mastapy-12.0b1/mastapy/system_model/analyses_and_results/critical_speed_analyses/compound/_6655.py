...
class KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis(_6621.ConicalGearCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6526.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6526.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
