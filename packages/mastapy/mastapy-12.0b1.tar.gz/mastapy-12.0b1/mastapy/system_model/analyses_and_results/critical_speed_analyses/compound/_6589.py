...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6668.PartCompoundCriticalSpeedAnalysis):
    """AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6458.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6458.AbstractAssemblyCriticalSpeedAnalysis]':
