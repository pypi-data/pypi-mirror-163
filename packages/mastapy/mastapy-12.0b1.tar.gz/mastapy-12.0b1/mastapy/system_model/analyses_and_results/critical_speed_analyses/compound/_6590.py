...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6591
...
class AbstractShaftCompoundCriticalSpeedAnalysis(_6591.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """AbstractShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6459.AbstractShaftCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6459.AbstractShaftCriticalSpeedAnalysis]':
