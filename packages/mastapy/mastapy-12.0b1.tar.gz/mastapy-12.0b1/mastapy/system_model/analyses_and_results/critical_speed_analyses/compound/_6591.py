...
class AbstractShaftOrHousingCompoundCriticalSpeedAnalysis(_6614.ComponentCompoundCriticalSpeedAnalysis):
    """AbstractShaftOrHousingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6460.AbstractShaftOrHousingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6460.AbstractShaftOrHousingCriticalSpeedAnalysis]':
