...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6507, _6508, _6520
...
class CylindricalGearSetCriticalSpeedAnalysis(_6520.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    @property
    def cylindrical_gears_critical_speed_analysis(self) -> 'List[_6507.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_critical_speed_analysis(self) -> 'List[_6508.CylindricalGearMeshCriticalSpeedAnalysis]':
