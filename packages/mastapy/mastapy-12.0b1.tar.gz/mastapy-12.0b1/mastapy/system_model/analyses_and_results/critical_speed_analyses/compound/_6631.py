...
class CVTPulleyCompoundCriticalSpeedAnalysis(_6677.PulleyCompoundCriticalSpeedAnalysis):
    """CVTPulleyCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6502.CVTPulleyCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6502.CVTPulleyCriticalSpeedAnalysis]':
