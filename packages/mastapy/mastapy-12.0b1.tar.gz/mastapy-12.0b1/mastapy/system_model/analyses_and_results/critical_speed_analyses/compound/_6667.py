...
class OilSealCompoundCriticalSpeedAnalysis(_6625.ConnectorCompoundCriticalSpeedAnalysis):
    """OilSealCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6538.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6538.OilSealCriticalSpeedAnalysis]':
