...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6624.ConnectionCompoundCriticalSpeedAnalysis):
    """InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6525.InterMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6525.InterMountableComponentConnectionCriticalSpeedAnalysis]':
