...
class HypoidGearMeshCompoundCriticalSpeedAnalysis(_6594.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """HypoidGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6523.HypoidGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6523.HypoidGearMeshCriticalSpeedAnalysis]':
