...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6628
...
class ConceptCouplingHalfCompoundCriticalSpeedAnalysis(_6628.CouplingHalfCompoundCriticalSpeedAnalysis):
    """ConceptCouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6486.ConceptCouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6486.ConceptCouplingHalfCriticalSpeedAnalysis]':
