...
class TorqueConverterConnectionCompoundCriticalSpeedAnalysis(_6627.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """TorqueConverterConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6577.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6577.TorqueConverterConnectionCriticalSpeedAnalysis]':
