...
class WormGearMeshCompoundCriticalSpeedAnalysis(_6648.GearMeshCompoundCriticalSpeedAnalysis):
    """WormGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6584.WormGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6584.WormGearMeshCriticalSpeedAnalysis]':
