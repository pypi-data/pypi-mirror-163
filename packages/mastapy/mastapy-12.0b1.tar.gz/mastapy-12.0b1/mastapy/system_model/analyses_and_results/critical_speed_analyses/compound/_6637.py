...
class CylindricalGearMeshCompoundCriticalSpeedAnalysis(_6648.GearMeshCompoundCriticalSpeedAnalysis):
    """CylindricalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6508.CylindricalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6508.CylindricalGearMeshCriticalSpeedAnalysis]':
