...
class WormGearCompoundCriticalSpeedAnalysis(_6647.GearCompoundCriticalSpeedAnalysis):
    """WormGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6583.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6583.WormGearCriticalSpeedAnalysis]':
