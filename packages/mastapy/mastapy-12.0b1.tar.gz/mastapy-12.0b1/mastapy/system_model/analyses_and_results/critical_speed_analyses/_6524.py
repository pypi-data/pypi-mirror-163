...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6522, _6523, _6464
...
class HypoidGearSetCriticalSpeedAnalysis(_6464.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    """HypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def hypoid_gears_critical_speed_analysis(self) -> 'List[_6522.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_critical_speed_analysis(self) -> 'List[_6523.HypoidGearMeshCriticalSpeedAnalysis]':
