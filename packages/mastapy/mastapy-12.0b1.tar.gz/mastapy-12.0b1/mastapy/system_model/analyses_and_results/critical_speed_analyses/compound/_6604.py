...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6473
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6600
...
class BevelDifferentialSunGearCompoundCriticalSpeedAnalysis(_6600.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6473.BevelDifferentialSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6473.BevelDifferentialSunGearCriticalSpeedAnalysis]':
