...
class FaceGearCompoundCriticalSpeedAnalysis(_6647.GearCompoundCriticalSpeedAnalysis):
    """FaceGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6513.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6513.FaceGearCriticalSpeedAnalysis]':
