...
class CycloidalDiscCompoundCriticalSpeedAnalysis(_6590.AbstractShaftCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6505.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6505.CycloidalDiscCriticalSpeedAnalysis]':
