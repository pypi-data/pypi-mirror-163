...
class ClutchCompoundCriticalSpeedAnalysis(_6626.CouplingCompoundCriticalSpeedAnalysis):
    """ClutchCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6480.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6480.ClutchCriticalSpeedAnalysis]':
