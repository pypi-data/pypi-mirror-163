...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6586, _6587, _6476
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6476.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6586.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6587.ZerolBevelGearMeshCriticalSpeedAnalysis]':
