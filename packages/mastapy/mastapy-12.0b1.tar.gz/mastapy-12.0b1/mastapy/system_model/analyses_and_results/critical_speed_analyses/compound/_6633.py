...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6613.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6504.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6504.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
