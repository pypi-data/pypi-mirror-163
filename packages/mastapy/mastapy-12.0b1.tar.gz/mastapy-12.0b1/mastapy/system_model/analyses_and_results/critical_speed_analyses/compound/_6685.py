...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6625
...
class ShaftHubConnectionCompoundCriticalSpeedAnalysis(_6625.ConnectorCompoundCriticalSpeedAnalysis):
    """ShaftHubConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6556.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6556.ShaftHubConnectionCriticalSpeedAnalysis]':
