...
class ConceptGearCompoundCriticalSpeedAnalysis(_6647.GearCompoundCriticalSpeedAnalysis):
    """ConceptGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6487.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6487.ConceptGearCriticalSpeedAnalysis]':
