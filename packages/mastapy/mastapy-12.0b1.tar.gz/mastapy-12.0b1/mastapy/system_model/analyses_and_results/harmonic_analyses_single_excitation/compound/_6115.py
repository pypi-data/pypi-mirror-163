...
class GearSetCompoundHarmonicAnalysisOfSingleExcitation(_6153.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """GearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5985.GearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5985.GearSetHarmonicAnalysisOfSingleExcitation]':
