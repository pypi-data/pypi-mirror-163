...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6055
...
class SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6055.AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6024.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6024.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation]':
