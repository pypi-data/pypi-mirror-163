...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5926
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6057
...
class AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation(_6057.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5926.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5926.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
