...
class PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation(_6132.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6011.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6011.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
