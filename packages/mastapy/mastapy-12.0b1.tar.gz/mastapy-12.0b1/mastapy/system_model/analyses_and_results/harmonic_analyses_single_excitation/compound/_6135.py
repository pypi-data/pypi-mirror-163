...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6092
...
class PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation(_6092.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6008.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6008.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
