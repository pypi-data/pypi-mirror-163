...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6052, _6053, _5943
...
class ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation(_5943.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6052.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6053.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
