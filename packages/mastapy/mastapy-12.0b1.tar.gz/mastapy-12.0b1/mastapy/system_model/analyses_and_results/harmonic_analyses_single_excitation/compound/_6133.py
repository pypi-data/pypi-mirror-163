...
class OilSealCompoundHarmonicAnalysisOfSingleExcitation(_6091.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """OilSealCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6004.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6004.OilSealHarmonicAnalysisOfSingleExcitation]':
