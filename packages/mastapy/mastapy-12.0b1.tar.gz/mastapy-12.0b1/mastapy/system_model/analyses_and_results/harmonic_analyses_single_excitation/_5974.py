...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5972, _5973, _5985
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_5985.GearSetHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5972.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5973.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
