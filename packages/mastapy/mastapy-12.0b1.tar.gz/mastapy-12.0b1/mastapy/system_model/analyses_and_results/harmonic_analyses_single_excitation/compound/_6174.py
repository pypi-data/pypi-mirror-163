...
class TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation(_6094.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6045.TorqueConverterPumpHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6045.TorqueConverterPumpHarmonicAnalysisOfSingleExcitation]':
