...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import (
    _5933, _5935, _5938, _5944,
    _5945, _5966, _5948, _5953,
    _5956, _5968, _5970, _5974,
    _5981, _5980, _5982, _5990,
    _5997, _6000, _6001, _6002,
    _6004, _6008, _6011, _6012,
    _6013, _6015, _6017, _6022,
    _6021, _6027, _6030, _6033,
    _6036, _6040, _6044, _6047,
    _6051, _6054, _5925
)
...
class AssemblyHarmonicAnalysisOfSingleExcitation(_5925.AbstractAssemblyHarmonicAnalysisOfSingleExcitation):
    """AssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def bearings(self) -> 'List[_5933.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def belt_drives(self) -> 'List[_5935.BeltDriveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5938.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5944.BoltedJointHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolts(self) -> 'List[_5945.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cv_ts(self) -> 'List[_5966.CVTHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def clutches(self) -> 'List[_5948.ClutchHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5953.ConceptCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5956.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5968.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5970.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5974.CylindricalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def fe_parts(self) -> 'List[_5981.FEPartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5980.FaceGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5982.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5990.HypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5997.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6000.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def mass_discs(self) -> 'List[_6001.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def measurement_components(self) -> 'List[_6002.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def oil_seals(self) -> 'List[_6004.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6008.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6011.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def point_loads(self) -> 'List[_6012.PointLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def power_loads(self) -> 'List[_6013.PowerLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def ring_pins(self) -> 'List[_6015.RingPinsHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6017.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6022.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shafts(self) -> 'List[_6021.ShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6027.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6030.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6033.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6036.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def synchronisers(self) -> 'List[_6040.SynchroniserHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def torque_converters(self) -> 'List[_6044.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6047.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6051.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6054.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]':
