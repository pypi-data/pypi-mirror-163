...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6034, _6035, _5943
...
class StraightBevelGearSetHarmonicAnalysisOfSingleExcitation(_5943.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6034.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6035.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
