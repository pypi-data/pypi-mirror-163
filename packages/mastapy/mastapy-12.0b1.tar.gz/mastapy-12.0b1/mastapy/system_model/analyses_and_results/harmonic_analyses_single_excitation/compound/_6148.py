...
class RollingRingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6120.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """RollingRingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6018.RollingRingConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6018.RollingRingConnectionHarmonicAnalysisOfSingleExcitation]':
