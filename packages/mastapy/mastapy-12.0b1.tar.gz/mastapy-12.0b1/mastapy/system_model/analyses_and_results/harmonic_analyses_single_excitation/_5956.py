...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5954, _5955, _5985
...
class ConceptGearSetHarmonicAnalysisOfSingleExcitation(_5985.GearSetHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def concept_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5954.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5955.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
