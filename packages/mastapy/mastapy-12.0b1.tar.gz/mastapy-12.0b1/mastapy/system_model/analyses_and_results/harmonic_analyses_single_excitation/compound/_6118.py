...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6060
...
class HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6060.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5989.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5989.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
