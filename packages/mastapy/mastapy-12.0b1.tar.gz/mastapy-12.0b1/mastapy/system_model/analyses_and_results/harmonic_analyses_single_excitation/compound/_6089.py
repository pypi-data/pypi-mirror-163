...
class ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6115.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5959.ConicalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5959.ConicalGearSetHarmonicAnalysisOfSingleExcitation]':
