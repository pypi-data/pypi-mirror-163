...
class GearCompoundHarmonicAnalysisOfSingleExcitation(_6132.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """GearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5983.GearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5983.GearHarmonicAnalysisOfSingleExcitation]':
