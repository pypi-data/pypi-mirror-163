...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6025, _6026, _5943
...
class SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation(_5943.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6025.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6026.SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
