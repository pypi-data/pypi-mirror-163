...
class StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6072.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_design(self) -> '_2267.StraightBevelGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6035.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6035.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
