...
class DatumCompoundHarmonicAnalysisOfSingleExcitation(_6080.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """DatumCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5976.DatumHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5976.DatumHarmonicAnalysisOfSingleExcitation]':
