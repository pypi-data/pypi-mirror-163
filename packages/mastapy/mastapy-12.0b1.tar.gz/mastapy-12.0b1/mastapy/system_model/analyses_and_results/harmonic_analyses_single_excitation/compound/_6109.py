...
class FaceGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6114.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5979.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5979.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
