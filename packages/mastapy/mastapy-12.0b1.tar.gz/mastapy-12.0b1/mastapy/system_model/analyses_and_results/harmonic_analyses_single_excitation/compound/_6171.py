...
class SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation(_6170.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6042.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6042.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
