...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5940
...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_6066.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5940.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5940.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
