...
class PulleyCompoundHarmonicAnalysisOfSingleExcitation(_6094.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """PulleyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6014.PulleyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6014.PulleyHarmonicAnalysisOfSingleExcitation]':
