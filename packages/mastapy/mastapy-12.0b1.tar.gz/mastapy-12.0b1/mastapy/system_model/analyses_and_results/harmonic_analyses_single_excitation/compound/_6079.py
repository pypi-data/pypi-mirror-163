...
class CoaxialConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6152.ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """CoaxialConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5949.CoaxialConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5949.CoaxialConnectionHarmonicAnalysisOfSingleExcitation]':
