...
class BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6060.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5942.BevelGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5942.BevelGearMeshHarmonicAnalysisOfSingleExcitation]':
