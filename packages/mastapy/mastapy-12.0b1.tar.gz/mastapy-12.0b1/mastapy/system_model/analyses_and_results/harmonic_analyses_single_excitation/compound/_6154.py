...
class SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation(_6071.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6025.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6025.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
