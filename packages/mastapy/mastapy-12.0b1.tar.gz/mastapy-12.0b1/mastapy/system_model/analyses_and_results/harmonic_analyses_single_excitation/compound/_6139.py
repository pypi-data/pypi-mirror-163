...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6104
...
class PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6104.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6010.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6010.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
