...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6061.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5943.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5943.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
