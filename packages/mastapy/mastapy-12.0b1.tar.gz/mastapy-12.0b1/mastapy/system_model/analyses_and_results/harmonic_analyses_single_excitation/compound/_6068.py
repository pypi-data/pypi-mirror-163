...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5938
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6066, _6067, _6073
...
class BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6073.BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5938.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6066.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6067.BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5938.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
