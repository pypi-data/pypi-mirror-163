...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6178, _6179, _6115
...
class WormGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6115.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """WormGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6051.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6178.WormGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6179.WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6051.WormGearSetHarmonicAnalysisOfSingleExcitation]':
