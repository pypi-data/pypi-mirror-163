...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5799.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """ShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5726.ShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5726.ShaftToMountableComponentConnectionHarmonicAnalysis]':
