...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5834
...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(_5834.CouplingConnectionCompoundHarmonicAnalysis):
    """PartToPartShearCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5707.PartToPartShearCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5707.PartToPartShearCouplingConnectionHarmonicAnalysis]':
