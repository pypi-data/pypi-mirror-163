...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5835.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5750.TorqueConverterPumpHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5750.TorqueConverterPumpHarmonicAnalysis]':
