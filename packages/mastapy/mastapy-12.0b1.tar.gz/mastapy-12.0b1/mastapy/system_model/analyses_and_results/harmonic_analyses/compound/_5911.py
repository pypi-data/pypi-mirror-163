...
class SynchroniserPartCompoundHarmonicAnalysis(_5835.CouplingHalfCompoundHarmonicAnalysis):
    """SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5746.SynchroniserPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5746.SynchroniserPartHarmonicAnalysis]':
