...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5821.ComponentCompoundHarmonicAnalysis):
    """AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5605.AbstractShaftOrHousingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5605.AbstractShaftOrHousingHarmonicAnalysis]':
