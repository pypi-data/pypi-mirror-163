...
class SynchroniserCompoundHarmonicAnalysis(_5894.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """SynchroniserCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5745.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5745.SynchroniserHarmonicAnalysis]':
