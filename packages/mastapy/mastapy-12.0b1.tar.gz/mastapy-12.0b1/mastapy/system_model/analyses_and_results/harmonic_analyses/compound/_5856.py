...
class GearSetCompoundHarmonicAnalysis(_5894.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """GearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5680.GearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5680.GearSetHarmonicAnalysis]':
