...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5780, _5786
...
class ResultsForOrderIncludingNodes(_5786.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    @property
    def node_results_global_coordinate_system(self) -> 'List[_5780.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
    ...
    @property
    def node_results_local_coordinate_system(self) -> 'List[_5780.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
