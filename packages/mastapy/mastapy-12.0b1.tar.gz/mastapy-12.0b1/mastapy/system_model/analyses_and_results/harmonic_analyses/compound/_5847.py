...
class DatumCompoundHarmonicAnalysis(_5821.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5655.DatumHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5655.DatumHarmonicAnalysis]':
