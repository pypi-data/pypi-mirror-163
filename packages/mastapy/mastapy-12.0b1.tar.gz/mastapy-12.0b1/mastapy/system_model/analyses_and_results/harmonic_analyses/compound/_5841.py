...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5797
...
class CycloidalDiscCompoundHarmonicAnalysis(_5797.AbstractShaftCompoundHarmonicAnalysis):
    """CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5649.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5649.CycloidalDiscHarmonicAnalysis]':
