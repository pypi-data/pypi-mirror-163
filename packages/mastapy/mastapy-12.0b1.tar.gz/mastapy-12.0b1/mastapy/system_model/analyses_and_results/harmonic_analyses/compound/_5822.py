...
class ConceptCouplingCompoundHarmonicAnalysis(_5833.CouplingCompoundHarmonicAnalysis):
    """ConceptCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5632.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5632.ConceptCouplingHarmonicAnalysis]':
