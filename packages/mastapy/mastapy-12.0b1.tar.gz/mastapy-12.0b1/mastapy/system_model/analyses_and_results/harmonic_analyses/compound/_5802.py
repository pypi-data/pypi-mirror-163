...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysis(_5830.ConicalGearSetCompoundHarmonicAnalysis):
    """AGMAGleasonConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5609.AGMAGleasonConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5609.AGMAGleasonConicalGearSetHarmonicAnalysis]':
