...
class BeltDriveCompoundHarmonicAnalysis(_5894.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5613.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5613.BeltDriveHarmonicAnalysis]':
