...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5669, _5670, _5680
...
class FaceGearSetHarmonicAnalysis(_5680.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5669.FaceGearHarmonicAnalysis]':
    ...
    @property
    def face_gears_harmonic_analysis(self) -> 'List[_5669.FaceGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5670.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def face_meshes_harmonic_analysis(self) -> 'List[_5670.FaceGearMeshHarmonicAnalysis]':
