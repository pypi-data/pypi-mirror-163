...
class ShaftCompoundHarmonicAnalysis(_5797.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5724.ShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5724.ShaftHarmonicAnalysis]':
