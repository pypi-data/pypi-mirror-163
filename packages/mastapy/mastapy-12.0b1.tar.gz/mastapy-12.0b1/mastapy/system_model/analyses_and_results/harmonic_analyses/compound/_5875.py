...
class PartCompoundHarmonicAnalysis(_7458.PartCompoundAnalysis):
    """PartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5706.PartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5706.PartHarmonicAnalysis]':
