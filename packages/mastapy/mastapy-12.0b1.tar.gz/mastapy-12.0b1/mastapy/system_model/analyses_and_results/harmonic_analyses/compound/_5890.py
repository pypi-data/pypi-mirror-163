...
class RootAssemblyCompoundHarmonicAnalysis(_5803.AssemblyCompoundHarmonicAnalysis):
    """RootAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5723.RootAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5723.RootAssemblyHarmonicAnalysis]':
