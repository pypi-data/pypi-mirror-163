...
class AbstractShaftToMountableComponentConnectionHarmonicAnalysis(_5639.ConnectionHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2627.AbstractShaftToMountableComponentConnectionSystemDeflection':
