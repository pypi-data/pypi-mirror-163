...
class SpringDamperHalfCompoundHarmonicAnalysis(_5835.CouplingHalfCompoundHarmonicAnalysis):
    """SpringDamperHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5734.SpringDamperHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5734.SpringDamperHalfHarmonicAnalysis]':
