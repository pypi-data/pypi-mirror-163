...
class SynchroniserHalfCompoundHarmonicAnalysis(_5911.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5744.SynchroniserHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5744.SynchroniserHalfHarmonicAnalysis]':
