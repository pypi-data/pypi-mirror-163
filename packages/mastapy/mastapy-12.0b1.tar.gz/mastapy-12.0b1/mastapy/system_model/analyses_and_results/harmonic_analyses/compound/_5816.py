...
class BoltedJointCompoundHarmonicAnalysis(_5894.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BoltedJointCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5622.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5622.BoltedJointHarmonicAnalysis]':
