...
class PlanetCarrierCompoundHarmonicAnalysis(_5873.MountableComponentCompoundHarmonicAnalysis):
    """PlanetCarrierCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5713.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5713.PlanetCarrierHarmonicAnalysis]':
