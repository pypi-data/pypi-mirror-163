...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5788, _5771
...
class SingleWhineAnalysisResultsPropertyAccessor(_5771.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5788.ResultsForOrderIncludingNodes]':
