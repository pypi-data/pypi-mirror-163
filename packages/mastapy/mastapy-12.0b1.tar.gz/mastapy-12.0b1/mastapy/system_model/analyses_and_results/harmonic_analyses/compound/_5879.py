...
class PlanetaryConnectionCompoundHarmonicAnalysis(_5893.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """PlanetaryConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5711.PlanetaryConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5711.PlanetaryConnectionHarmonicAnalysis]':
