...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5787, _5771
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5771.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5787.ResultsForOrderIncludingGroups]':
