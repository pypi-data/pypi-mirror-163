...
class StraightBevelGearCompoundHarmonicAnalysis(_5812.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5739.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5739.StraightBevelGearHarmonicAnalysis]':
