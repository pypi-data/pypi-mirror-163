...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis(_5863.KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5697.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5697.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
