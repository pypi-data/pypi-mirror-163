...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5813.BevelGearMeshCompoundHarmonicAnalysis):
    """SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5731.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5731.SpiralBevelGearMeshHarmonicAnalysis]':
