...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5904, _5905, _5814
...
class StraightBevelGearSetCompoundHarmonicAnalysis(_5814.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5741.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5904.StraightBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5905.StraightBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5741.StraightBevelGearSetHarmonicAnalysis]':
