...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5807.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5618.BevelDifferentialSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5618.BevelDifferentialSunGearHarmonicAnalysis]':
