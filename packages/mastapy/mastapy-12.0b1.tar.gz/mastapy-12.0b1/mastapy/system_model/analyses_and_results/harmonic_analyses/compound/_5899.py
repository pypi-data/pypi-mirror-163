...
class SpringDamperConnectionCompoundHarmonicAnalysis(_5834.CouplingConnectionCompoundHarmonicAnalysis):
    """SpringDamperConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5733.SpringDamperConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5733.SpringDamperConnectionHarmonicAnalysis]':
