...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5828
...
class KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis(_5828.ConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5693.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5693.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
