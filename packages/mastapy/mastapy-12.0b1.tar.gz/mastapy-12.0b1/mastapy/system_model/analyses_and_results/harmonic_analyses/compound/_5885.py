...
class RingPinsCompoundHarmonicAnalysis(_5873.MountableComponentCompoundHarmonicAnalysis):
    """RingPinsCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5718.RingPinsHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5718.RingPinsHarmonicAnalysis]':
