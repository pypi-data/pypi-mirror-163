...
class CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis(_5820.CoaxialConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5648.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5648.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
