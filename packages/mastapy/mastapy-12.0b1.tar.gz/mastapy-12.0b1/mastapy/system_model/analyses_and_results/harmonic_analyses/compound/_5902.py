...
class StraightBevelDiffGearMeshCompoundHarmonicAnalysis(_5813.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelDiffGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5737.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5737.StraightBevelDiffGearMeshHarmonicAnalysis]':
