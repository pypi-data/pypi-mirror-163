...
class ClutchConnectionCompoundHarmonicAnalysis(_5834.CouplingConnectionCompoundHarmonicAnalysis):
    """ClutchConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5624.ClutchConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5624.ClutchConnectionHarmonicAnalysis]':
