...
class BoltCompoundHarmonicAnalysis(_5821.ComponentCompoundHarmonicAnalysis):
    """BoltCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5623.BoltHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5623.BoltHarmonicAnalysis]':
