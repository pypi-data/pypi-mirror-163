...
class CycloidalAssemblyCompoundHarmonicAnalysis(_5894.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """CycloidalAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5647.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5647.CycloidalAssemblyHarmonicAnalysis]':
