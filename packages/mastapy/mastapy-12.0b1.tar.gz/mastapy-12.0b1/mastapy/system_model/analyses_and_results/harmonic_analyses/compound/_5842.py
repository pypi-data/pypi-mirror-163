...
class CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis(_5799.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5650.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5650.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
