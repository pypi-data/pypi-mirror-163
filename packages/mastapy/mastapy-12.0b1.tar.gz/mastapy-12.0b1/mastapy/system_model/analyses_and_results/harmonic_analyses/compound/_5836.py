...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5805
...
class CVTBeltConnectionCompoundHarmonicAnalysis(_5805.BeltConnectionCompoundHarmonicAnalysis):
    """CVTBeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5644.CVTBeltConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5644.CVTBeltConnectionHarmonicAnalysis]':
