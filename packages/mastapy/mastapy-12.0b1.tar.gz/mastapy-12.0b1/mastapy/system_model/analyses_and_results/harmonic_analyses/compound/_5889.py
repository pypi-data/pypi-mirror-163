...
class RollingRingConnectionCompoundHarmonicAnalysis(_5861.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RollingRingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5721.RollingRingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5721.RollingRingConnectionHarmonicAnalysis]':
