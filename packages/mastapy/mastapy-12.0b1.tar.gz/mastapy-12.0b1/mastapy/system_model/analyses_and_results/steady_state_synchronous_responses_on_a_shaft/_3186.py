...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import (
    _3187, _3189, _3191, _3198,
    _3199, _3221, _3202, _3207,
    _3209, _3222, _3225, _3227,
    _3235, _3233, _3236, _3242,
    _3249, _3252, _3254, _3255,
    _3257, _3261, _3264, _3265,
    _3266, _3268, _3270, _3274,
    _3275, _3279, _3283, _3286,
    _3289, _3296, _3299, _3301,
    _3304, _3307, _3179
)
...
class AssemblySteadyStateSynchronousResponseOnAShaft(_3179.AbstractAssemblySteadyStateSynchronousResponseOnAShaft):
    """AssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def bearings(self) -> 'List[_3187.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def belt_drives(self) -> 'List[_3189.BeltDriveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3191.BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3198.BoltedJointSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolts(self) -> 'List[_3199.BoltSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cv_ts(self) -> 'List[_3221.CVTSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def clutches(self) -> 'List[_3202.ClutchSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3207.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3209.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3222.CycloidalAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3225.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3227.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def fe_parts(self) -> 'List[_3235.FEPartSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3233.FaceGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3236.FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3242.HypoidGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3249.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3252.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def mass_discs(self) -> 'List[_3254.MassDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def measurement_components(self) -> 'List[_3255.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def oil_seals(self) -> 'List[_3257.OilSealSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3261.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3264.PlanetCarrierSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def point_loads(self) -> 'List[_3265.PointLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def power_loads(self) -> 'List[_3266.PowerLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def ring_pins(self) -> 'List[_3268.RingPinsSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3270.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3274.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shafts(self) -> 'List[_3275.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3279.SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3283.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3286.StraightBevelDiffGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3289.StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def synchronisers(self) -> 'List[_3296.SynchroniserSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def torque_converters(self) -> 'List[_3299.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3301.UnbalancedMassSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3304.WormGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3307.ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
