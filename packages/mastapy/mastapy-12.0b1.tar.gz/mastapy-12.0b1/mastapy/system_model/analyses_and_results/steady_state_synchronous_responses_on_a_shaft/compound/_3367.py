...
class GearCompoundSteadyStateSynchronousResponseOnAShaft(_3386.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3239.GearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3239.GearSteadyStateSynchronousResponseOnAShaft]':
