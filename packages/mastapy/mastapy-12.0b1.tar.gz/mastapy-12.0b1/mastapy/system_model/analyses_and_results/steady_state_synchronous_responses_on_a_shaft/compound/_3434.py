...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3432, _3433, _3369
...
class WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3369.GearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3304.WormGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3432.WormGearCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3433.WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3304.WormGearSetSteadyStateSynchronousResponseOnAShaft]':
