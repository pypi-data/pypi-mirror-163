...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3187
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3345
...
class BearingCompoundSteadyStateSynchronousResponseOnAShaft(_3345.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """BearingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3187.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3187.BearingSteadyStateSynchronousResponseOnAShaft]':
