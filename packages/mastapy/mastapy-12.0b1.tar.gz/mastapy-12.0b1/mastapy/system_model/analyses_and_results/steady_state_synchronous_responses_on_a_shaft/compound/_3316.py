...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3186
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import (
    _3317, _3319, _3322, _3329,
    _3328, _3350, _3330, _3335,
    _3340, _3352, _3354, _3358,
    _3365, _3364, _3366, _3373,
    _3380, _3383, _3384, _3385,
    _3387, _3389, _3394, _3395,
    _3396, _3398, _3400, _3405,
    _3404, _3410, _3411, _3416,
    _3419, _3422, _3426, _3430,
    _3434, _3437, _3309
)
...
class AssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3309.AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """AssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3186.AssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bearings(self) -> 'List[_3317.BearingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def belt_drives(self) -> 'List[_3319.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3322.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3329.BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolts(self) -> 'List[_3328.BoltCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cv_ts(self) -> 'List[_3350.CVTCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def clutches(self) -> 'List[_3330.ClutchCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3335.ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3340.ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3352.CycloidalAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3354.CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3358.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def fe_parts(self) -> 'List[_3365.FEPartCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3364.FaceGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3366.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3373.HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3380.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3383.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def mass_discs(self) -> 'List[_3384.MassDiscCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def measurement_components(self) -> 'List[_3385.MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def oil_seals(self) -> 'List[_3387.OilSealCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3389.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3394.PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def point_loads(self) -> 'List[_3395.PointLoadCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def power_loads(self) -> 'List[_3396.PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def ring_pins(self) -> 'List[_3398.RingPinsCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3400.RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3405.ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shafts(self) -> 'List[_3404.ShaftCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3410.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3411.SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3416.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3419.StraightBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def synchronisers(self) -> 'List[_3422.SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def torque_converters(self) -> 'List[_3426.TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3430.UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3434.WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3437.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3186.AssemblySteadyStateSynchronousResponseOnAShaft]':
