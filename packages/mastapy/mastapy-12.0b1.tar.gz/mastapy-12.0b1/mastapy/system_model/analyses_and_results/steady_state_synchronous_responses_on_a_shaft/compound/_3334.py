...
class ComponentCompoundSteadyStateSynchronousResponseOnAShaft(_3388.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    """ComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3204.ComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3204.ComponentSteadyStateSynchronousResponseOnAShaft]':
