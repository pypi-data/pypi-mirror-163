...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_3414.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3291.StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3291.StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft]':
