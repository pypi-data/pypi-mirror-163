...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_3356.CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """CylindricalPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3229.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3229.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft]':
