...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3310
...
class CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft(_3310.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3225.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3225.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
