...
class RingPinsCompoundSteadyStateSynchronousResponseOnAShaft(_3386.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """RingPinsCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3268.RingPinsSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3268.RingPinsSteadyStateSynchronousResponseOnAShaft]':
