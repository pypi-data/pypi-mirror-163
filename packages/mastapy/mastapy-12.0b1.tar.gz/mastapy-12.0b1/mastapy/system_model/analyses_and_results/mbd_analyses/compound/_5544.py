...
class RollingRingAssemblyCompoundMultibodyDynamicsAnalysis(_5551.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """RollingRingAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5403.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5403.RollingRingAssemblyMultibodyDynamicsAnalysis]':
