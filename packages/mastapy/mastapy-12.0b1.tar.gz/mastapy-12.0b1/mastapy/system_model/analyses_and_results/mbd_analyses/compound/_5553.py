...
class SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5470.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5414.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5414.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
