...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5303
...
class AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis(_5478.ComponentCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5303.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5303.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
