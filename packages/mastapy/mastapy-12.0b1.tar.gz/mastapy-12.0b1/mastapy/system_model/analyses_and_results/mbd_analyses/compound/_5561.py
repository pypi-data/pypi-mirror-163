...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(_5469.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5424.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5424.StraightBevelGearMultibodyDynamicsAnalysis]':
