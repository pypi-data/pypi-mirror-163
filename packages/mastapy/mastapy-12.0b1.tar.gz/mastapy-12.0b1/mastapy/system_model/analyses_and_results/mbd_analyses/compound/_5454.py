...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5302
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5455
...
class AbstractShaftCompoundMultibodyDynamicsAnalysis(_5455.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5302.AbstractShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5302.AbstractShaftMultibodyDynamicsAnalysis]':
