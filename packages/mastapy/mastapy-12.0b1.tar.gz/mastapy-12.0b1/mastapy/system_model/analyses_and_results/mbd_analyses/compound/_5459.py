...
class AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis(_5487.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5307.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5307.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
