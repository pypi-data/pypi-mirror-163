...
class CVTBeltConnectionCompoundMultibodyDynamicsAnalysis(_5462.BeltConnectionCompoundMultibodyDynamicsAnalysis):
    """CVTBeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5344.CVTBeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5344.CVTBeltConnectionMultibodyDynamicsAnalysis]':
