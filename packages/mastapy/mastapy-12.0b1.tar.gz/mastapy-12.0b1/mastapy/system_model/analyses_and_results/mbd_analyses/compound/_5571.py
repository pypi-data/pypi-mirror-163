...
class TorqueConverterConnectionCompoundMultibodyDynamicsAnalysis(_5491.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5432.TorqueConverterConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5432.TorqueConverterConnectionMultibodyDynamicsAnalysis]':
