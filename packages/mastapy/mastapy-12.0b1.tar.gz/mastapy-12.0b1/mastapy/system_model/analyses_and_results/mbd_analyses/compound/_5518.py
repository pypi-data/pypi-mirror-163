...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5488.ConnectionCompoundMultibodyDynamicsAnalysis):
    """InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5374.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5374.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
