...
class CylindricalGearCompoundMultibodyDynamicsAnalysis(_5511.GearCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5352.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5352.CylindricalGearMultibodyDynamicsAnalysis]':
