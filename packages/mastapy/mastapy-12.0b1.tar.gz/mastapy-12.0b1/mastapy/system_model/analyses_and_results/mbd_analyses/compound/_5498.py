...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5454
...
class CycloidalDiscCompoundMultibodyDynamicsAnalysis(_5454.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5349.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5349.CycloidalDiscMultibodyDynamicsAnalysis]':
