...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5313
...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5551.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5313.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5313.BeltDriveMultibodyDynamicsAnalysis]':
