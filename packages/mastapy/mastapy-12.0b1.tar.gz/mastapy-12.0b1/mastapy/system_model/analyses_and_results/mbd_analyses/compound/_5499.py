...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5456
...
class CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis(_5456.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5350.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5350.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
