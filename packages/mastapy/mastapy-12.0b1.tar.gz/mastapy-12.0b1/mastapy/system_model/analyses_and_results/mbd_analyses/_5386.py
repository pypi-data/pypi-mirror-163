...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5452
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5308.AnalysisTypes':
        """AnalysisTypes: 'AnalysisType' is the original name of this property."""

        temp = self.wrapped.AnalysisType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5308.AnalysisTypes)(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_5308.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5370.InertiaAdjustedLoadCasePeriodMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5370.InertiaAdjustedLoadCasePeriodMethod)(value) if value is not None else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5370.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5371.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5371.InertiaAdjustedLoadCaseResultsToCreate)(value) if value is not None else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5371.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_interface_options(self) -> '_5452.DynamicExternalInterfaceOptions':
    ...
    @property
    def frequency_response_options(self) -> '_4563.FrequencyResponseAnalysisOptions':
    ...
    @property
    def run_up_analysis_options(self) -> '_5387.MBDRunUpAnalysisOptions':
