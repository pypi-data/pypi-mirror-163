...
class GuideDxfModelCompoundMultibodyDynamicsAnalysis(_5478.ComponentCompoundMultibodyDynamicsAnalysis):
    """GuideDxfModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5366.GuideDxfModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5366.GuideDxfModelMultibodyDynamicsAnalysis]':
