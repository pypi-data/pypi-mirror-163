...
class SynchroniserHalfCompoundMultibodyDynamicsAnalysis(_5568.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5428.SynchroniserHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5428.SynchroniserHalfMultibodyDynamicsAnalysis]':
