...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5449, _5451
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5340.ConnectorMultibodyDynamicsAnalysis):
    """ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5449.DynamicForceVector3DResult':
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5451.DynamicTorqueVector3DResult':
