...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5315, _5314, _5321
...
class BevelDifferentialGearSetMultibodyDynamicsAnalysis(_5321.BevelGearSetMultibodyDynamicsAnalysis):
    """BevelDifferentialGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5315.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gears_multibody_dynamics_analysis(self) -> 'List[_5315.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_meshes_multibody_dynamics_analysis(self) -> 'List[_5314.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
