...
class GearMeshCompoundMultibodyDynamicsAnalysis(_5518.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """GearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5362.GearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5362.GearMeshMultibodyDynamicsAnalysis]':
