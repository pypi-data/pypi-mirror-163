...
class ConceptGearMeshCompoundMultibodyDynamicsAnalysis(_5512.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConceptGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5333.ConceptGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5333.ConceptGearMeshMultibodyDynamicsAnalysis]':
