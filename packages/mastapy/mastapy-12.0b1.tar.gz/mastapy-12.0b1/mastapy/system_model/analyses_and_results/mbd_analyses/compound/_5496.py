...
class CycloidalAssemblyCompoundMultibodyDynamicsAnalysis(_5551.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """CycloidalAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5347.CycloidalAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5347.CycloidalAssemblyMultibodyDynamicsAnalysis]':
