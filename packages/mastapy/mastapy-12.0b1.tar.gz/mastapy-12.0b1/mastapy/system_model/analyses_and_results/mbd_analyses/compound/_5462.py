...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5312
...
class BeltConnectionCompoundMultibodyDynamicsAnalysis(_5518.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """BeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5312.BeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5312.BeltConnectionMultibodyDynamicsAnalysis]':
