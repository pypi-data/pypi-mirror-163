...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5576, _5577, _5513
...
class WormGearSetCompoundMultibodyDynamicsAnalysis(_5513.GearSetCompoundMultibodyDynamicsAnalysis):
    """WormGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5443.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5576.WormGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5577.WormGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5443.WormGearSetMultibodyDynamicsAnalysis]':
