...
class ClutchConnectionCompoundMultibodyDynamicsAnalysis(_5491.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """ClutchConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5324.ClutchConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5324.ClutchConnectionMultibodyDynamicsAnalysis]':
