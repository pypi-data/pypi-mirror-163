...
class TorqueConverterCompoundMultibodyDynamicsAnalysis(_5490.CouplingCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5434.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5434.TorqueConverterMultibodyDynamicsAnalysis]':
