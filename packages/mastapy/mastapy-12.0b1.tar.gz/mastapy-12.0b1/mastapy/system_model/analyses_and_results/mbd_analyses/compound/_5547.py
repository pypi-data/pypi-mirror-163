...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5460
...
class RootAssemblyCompoundMultibodyDynamicsAnalysis(_5460.AssemblyCompoundMultibodyDynamicsAnalysis):
    """RootAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5406.RootAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5406.RootAssemblyMultibodyDynamicsAnalysis]':
