...
class PartCompoundMultibodyDynamicsAnalysis(_7458.PartCompoundAnalysis):
    """PartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5391.PartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5391.PartMultibodyDynamicsAnalysis]':
