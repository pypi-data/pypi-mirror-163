...
class SynchroniserCompoundMultibodyDynamicsAnalysis(_5551.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """SynchroniserCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5429.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5429.SynchroniserMultibodyDynamicsAnalysis]':
