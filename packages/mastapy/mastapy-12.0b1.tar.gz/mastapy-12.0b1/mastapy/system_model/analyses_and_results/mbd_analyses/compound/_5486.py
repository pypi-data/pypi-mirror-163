...
class ConicalGearMeshCompoundMultibodyDynamicsAnalysis(_5512.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConicalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5336.ConicalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5336.ConicalGearMeshMultibodyDynamicsAnalysis]':
