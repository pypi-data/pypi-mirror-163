...
class BevelGearMeshCompoundMultibodyDynamicsAnalysis(_5458.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    """BevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5319.BevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5319.BevelGearMeshMultibodyDynamicsAnalysis]':
