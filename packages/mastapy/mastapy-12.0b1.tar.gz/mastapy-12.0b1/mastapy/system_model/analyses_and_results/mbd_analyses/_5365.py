...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5364, _5362, _5413
...
class GearSetMultibodyDynamicsAnalysis(_5413.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5364.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5362.GearMeshMultibodyDynamicsAnalysis]':
