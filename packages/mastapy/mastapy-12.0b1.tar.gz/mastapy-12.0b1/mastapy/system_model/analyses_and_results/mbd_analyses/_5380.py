...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5379, _5378, _5377
...
class KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis(_5377.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5379.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5379.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5378.KlingelnbergCycloPalloidHypoidGearMeshMultibodyDynamicsAnalysis]':
