...
class ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5470.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5444.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5444.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
