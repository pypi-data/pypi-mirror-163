...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5490
...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5490.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5394.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5394.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
