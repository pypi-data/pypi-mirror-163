...
class ZerolBevelGearCompoundModalAnalysis(_4671.BevelGearCompoundModalAnalysis):
    """ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4641.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4641.ZerolBevelGearModalAnalysis]':
