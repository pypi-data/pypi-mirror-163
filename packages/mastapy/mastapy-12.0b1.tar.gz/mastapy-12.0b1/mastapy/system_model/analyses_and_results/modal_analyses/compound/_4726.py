...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4724, _4725, _4723
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4723.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4577.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(self) -> 'List[_4724.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(self) -> 'List[_4725.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4577.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
