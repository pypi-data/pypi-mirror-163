...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4661
...
class BevelGearSetCompoundModalAnalysis(_4661.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """BevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4520.BevelGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4520.BevelGearSetModalAnalysis]':
