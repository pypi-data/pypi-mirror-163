...
class GuideDxfModelCompoundModalAnalysis(_4680.ComponentCompoundModalAnalysis):
    """GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4567.GuideDxfModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4567.GuideDxfModelModalAnalysis]':
