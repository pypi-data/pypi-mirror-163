...
from mastapy.system_model.analyses_and_results.modal_analyses import _4641, _4640, _4520
...
class ZerolBevelGearSetModalAnalysis(_4520.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4641.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4640.ZerolBevelGearMeshModalAnalysis]':
