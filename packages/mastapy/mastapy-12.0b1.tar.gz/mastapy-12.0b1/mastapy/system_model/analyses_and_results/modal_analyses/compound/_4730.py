...
class MassDiscCompoundModalAnalysis(_4777.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4581.MassDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4581.MassDiscModalAnalysis]':
