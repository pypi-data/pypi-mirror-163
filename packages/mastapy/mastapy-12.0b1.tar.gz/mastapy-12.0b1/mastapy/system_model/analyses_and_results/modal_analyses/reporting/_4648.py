...
class PerModeResultsReport(_1714.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1776.TableAndChartOptions':
    ...
    def display_option(self, value: '_1776.TableAndChartOptions'):
