...
class StraightBevelDiffGearMeshModalAnalysis(_4518.BevelGearMeshModalAnalysis):
    """StraightBevelDiffGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2747.StraightBevelDiffGearMeshSystemDeflection':
