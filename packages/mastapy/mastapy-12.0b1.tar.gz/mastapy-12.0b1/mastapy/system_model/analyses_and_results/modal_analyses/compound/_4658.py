...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(_4690.ConnectionCompoundModalAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4505.AbstractShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4505.AbstractShaftToMountableComponentConnectionModalAnalysis]':
