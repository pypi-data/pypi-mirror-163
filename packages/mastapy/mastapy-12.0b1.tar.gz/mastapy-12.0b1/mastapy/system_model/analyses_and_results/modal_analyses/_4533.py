...
from mastapy.system_model.analyses_and_results.modal_analyses import _4532, _4531, _4566
...
class ConceptGearSetModalAnalysis(_4566.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4532.ConceptGearModalAnalysis]':
    ...
    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4531.ConceptGearMeshModalAnalysis]':
