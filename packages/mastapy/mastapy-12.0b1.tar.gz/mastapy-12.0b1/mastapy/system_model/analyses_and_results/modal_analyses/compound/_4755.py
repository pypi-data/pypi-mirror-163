...
class SpiralBevelGearMeshCompoundModalAnalysis(_4672.BevelGearMeshCompoundModalAnalysis):
    """SpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4610.SpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4610.SpiralBevelGearMeshModalAnalysis]':
