...
class BoltedJointCompoundModalAnalysis(_4753.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4521.BoltedJointModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4521.BoltedJointModalAnalysis]':
