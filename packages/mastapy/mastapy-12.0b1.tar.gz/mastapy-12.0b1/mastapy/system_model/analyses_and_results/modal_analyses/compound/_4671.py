...
class BevelGearCompoundModalAnalysis(_4659.AGMAGleasonConicalGearCompoundModalAnalysis):
    """BevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4519.BevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4519.BevelGearModalAnalysis]':
