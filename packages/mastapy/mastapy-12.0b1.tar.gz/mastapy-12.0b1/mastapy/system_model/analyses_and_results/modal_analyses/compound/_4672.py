...
from mastapy.system_model.analyses_and_results.modal_analyses import _4518
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4660
...
class BevelGearMeshCompoundModalAnalysis(_4660.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """BevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4518.BevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4518.BevelGearMeshModalAnalysis]':
