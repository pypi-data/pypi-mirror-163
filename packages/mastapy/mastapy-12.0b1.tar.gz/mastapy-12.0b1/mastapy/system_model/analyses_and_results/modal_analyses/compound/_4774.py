...
class TorqueConverterPumpCompoundModalAnalysis(_4694.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4630.TorqueConverterPumpModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4630.TorqueConverterPumpModalAnalysis]':
