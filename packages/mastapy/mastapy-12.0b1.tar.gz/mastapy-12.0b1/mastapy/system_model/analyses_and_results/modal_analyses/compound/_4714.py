...
class GearMeshCompoundModalAnalysis(_4720.InterMountableComponentConnectionCompoundModalAnalysis):
    """GearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4564.GearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4564.GearMeshModalAnalysis]':
