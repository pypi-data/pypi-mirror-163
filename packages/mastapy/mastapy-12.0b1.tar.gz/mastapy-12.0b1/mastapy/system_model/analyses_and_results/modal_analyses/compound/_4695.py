...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4664
...
class CVTBeltConnectionCompoundModalAnalysis(_4664.BeltConnectionCompoundModalAnalysis):
    """CVTBeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4543.CVTBeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4543.CVTBeltConnectionModalAnalysis]':
