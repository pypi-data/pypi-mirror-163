...
from mastapy.system_model.analyses_and_results.modal_analyses import _4503
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4657
...
class AbstractShaftCompoundModalAnalysis(_4657.AbstractShaftOrHousingCompoundModalAnalysis):
    """AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4503.AbstractShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4503.AbstractShaftModalAnalysis]':
