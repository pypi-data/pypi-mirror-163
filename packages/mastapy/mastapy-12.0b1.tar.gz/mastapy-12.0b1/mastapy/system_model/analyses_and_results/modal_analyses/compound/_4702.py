...
class CylindricalGearCompoundModalAnalysis(_4713.GearCompoundModalAnalysis):
    """CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4551.CylindricalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4551.CylindricalGearModalAnalysis]':
