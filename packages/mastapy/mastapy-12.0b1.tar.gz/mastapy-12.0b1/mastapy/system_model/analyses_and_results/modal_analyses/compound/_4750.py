...
class ShaftCompoundModalAnalysis(_4656.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4606.ShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4606.ShaftModalAnalysis]':
