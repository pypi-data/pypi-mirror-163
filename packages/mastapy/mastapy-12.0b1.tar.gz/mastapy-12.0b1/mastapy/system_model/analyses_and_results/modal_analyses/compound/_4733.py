...
class OilSealCompoundModalAnalysis(_4691.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4587.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4587.OilSealModalAnalysis]':
