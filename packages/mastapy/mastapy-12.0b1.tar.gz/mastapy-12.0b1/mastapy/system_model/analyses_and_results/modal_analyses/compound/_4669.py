...
from mastapy.system_model.analyses_and_results.modal_analyses import _4516
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4666
...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4666.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4516.BevelDifferentialPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4516.BevelDifferentialPlanetGearModalAnalysis]':
