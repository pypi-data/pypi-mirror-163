...
class SynchroniserCompoundModalAnalysis(_4753.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4625.SynchroniserModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4625.SynchroniserModalAnalysis]':
