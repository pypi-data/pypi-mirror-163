...
class TorqueConverterTurbineCompoundModalAnalysis(_4694.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4631.TorqueConverterTurbineModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4631.TorqueConverterTurbineModalAnalysis]':
