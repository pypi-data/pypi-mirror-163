...
class SpiralBevelGearCompoundModalAnalysis(_4671.BevelGearCompoundModalAnalysis):
    """SpiralBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4611.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4611.SpiralBevelGearModalAnalysis]':
