...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4693
...
class PartToPartShearCouplingConnectionCompoundModalAnalysis(_4693.CouplingConnectionCompoundModalAnalysis):
    """PartToPartShearCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4590.PartToPartShearCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4590.PartToPartShearCouplingConnectionModalAnalysis]':
