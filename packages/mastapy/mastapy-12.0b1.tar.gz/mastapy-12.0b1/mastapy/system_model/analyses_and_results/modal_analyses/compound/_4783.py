...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4781, _4782, _4673
...
class ZerolBevelGearSetCompoundModalAnalysis(_4673.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4642.ZerolBevelGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis(self) -> 'List[_4781.ZerolBevelGearCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis(self) -> 'List[_4782.ZerolBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4642.ZerolBevelGearSetModalAnalysis]':
