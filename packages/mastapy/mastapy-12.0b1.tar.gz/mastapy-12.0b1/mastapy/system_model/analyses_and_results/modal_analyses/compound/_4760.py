...
class StraightBevelDiffGearCompoundModalAnalysis(_4671.BevelGearCompoundModalAnalysis):
    """StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4617.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4617.StraightBevelDiffGearModalAnalysis]':
