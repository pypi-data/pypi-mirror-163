...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4691
...
class ShaftHubConnectionCompoundModalAnalysis(_4691.ConnectorCompoundModalAnalysis):
    """ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4605.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4605.ShaftHubConnectionModalAnalysis]':
