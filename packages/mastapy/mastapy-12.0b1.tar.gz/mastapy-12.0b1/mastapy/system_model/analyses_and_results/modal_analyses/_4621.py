...
from mastapy.system_model.analyses_and_results.modal_analyses import _4620, _4619, _4520
...
class StraightBevelGearSetModalAnalysis(_4520.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4620.StraightBevelGearModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4619.StraightBevelGearMeshModalAnalysis]':
