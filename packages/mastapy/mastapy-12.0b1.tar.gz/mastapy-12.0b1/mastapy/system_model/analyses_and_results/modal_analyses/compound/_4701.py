...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4658
...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis(_4658.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4549.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4549.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
