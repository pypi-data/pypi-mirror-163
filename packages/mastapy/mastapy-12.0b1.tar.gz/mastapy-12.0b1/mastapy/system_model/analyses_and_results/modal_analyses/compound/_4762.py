...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4760, _4761, _4673
...
class StraightBevelDiffGearSetCompoundModalAnalysis(_4673.BevelGearSetCompoundModalAnalysis):
    """StraightBevelDiffGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4618.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis(self) -> 'List[_4760.StraightBevelDiffGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis(self) -> 'List[_4761.StraightBevelDiffGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4618.StraightBevelDiffGearSetModalAnalysis]':
