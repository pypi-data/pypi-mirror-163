...
class TorqueConverterCompoundModalAnalysis(_4692.CouplingCompoundModalAnalysis):
    """TorqueConverterCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4629.TorqueConverterModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4629.TorqueConverterModalAnalysis]':
