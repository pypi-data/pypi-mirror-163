...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4665
...
class CVTCompoundModalAnalysis(_4665.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4544.CVTModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4544.CVTModalAnalysis]':
