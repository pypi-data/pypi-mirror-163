...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis(_4689.ConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4574.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4574.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
