...
class StraightBevelGearCompoundModalAnalysis(_4671.BevelGearCompoundModalAnalysis):
    """StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4620.StraightBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4620.StraightBevelGearModalAnalysis]':
