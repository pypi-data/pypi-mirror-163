...
class WormGearMeshCompoundModalAnalysis(_4714.GearMeshCompoundModalAnalysis):
    """WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4637.WormGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4637.WormGearMeshModalAnalysis]':
