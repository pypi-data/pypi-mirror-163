...
class PartCompoundModalAnalysis(_7458.PartCompoundAnalysis):
    """PartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4589.PartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4589.PartModalAnalysis]':
