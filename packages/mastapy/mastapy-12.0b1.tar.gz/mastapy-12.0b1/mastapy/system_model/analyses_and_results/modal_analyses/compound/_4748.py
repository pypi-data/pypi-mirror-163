...
class RollingRingConnectionCompoundModalAnalysis(_4720.InterMountableComponentConnectionCompoundModalAnalysis):
    """RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4602.RollingRingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4602.RollingRingConnectionModalAnalysis]':
