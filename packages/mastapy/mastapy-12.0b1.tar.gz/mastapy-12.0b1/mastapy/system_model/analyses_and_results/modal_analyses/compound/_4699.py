...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysis(_4679.CoaxialConnectionCompoundModalAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4547.CycloidalDiscCentralBearingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4547.CycloidalDiscCentralBearingConnectionModalAnalysis]':
