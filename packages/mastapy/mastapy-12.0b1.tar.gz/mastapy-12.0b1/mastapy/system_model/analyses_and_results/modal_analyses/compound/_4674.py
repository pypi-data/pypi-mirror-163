...
class BoltCompoundModalAnalysis(_4680.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4522.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4522.BoltModalAnalysis]':
