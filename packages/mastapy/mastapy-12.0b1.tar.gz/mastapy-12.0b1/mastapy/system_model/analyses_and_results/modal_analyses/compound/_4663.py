...
class BearingCompoundModalAnalysis(_4691.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4510.BearingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4510.BearingModalAnalysis]':
