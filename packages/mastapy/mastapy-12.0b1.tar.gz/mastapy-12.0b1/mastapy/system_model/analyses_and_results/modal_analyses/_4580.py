...
from mastapy.system_model.analyses_and_results.modal_analyses import _4579, _4578, _4574
...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis(_4574.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_modal_analysis(self) -> 'List[_4579.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_modal_analysis(self) -> 'List[_4578.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
