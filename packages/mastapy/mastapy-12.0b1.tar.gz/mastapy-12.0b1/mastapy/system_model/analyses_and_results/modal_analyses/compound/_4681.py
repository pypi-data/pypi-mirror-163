...
class ConceptCouplingCompoundModalAnalysis(_4692.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4530.ConceptCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4530.ConceptCouplingModalAnalysis]':
