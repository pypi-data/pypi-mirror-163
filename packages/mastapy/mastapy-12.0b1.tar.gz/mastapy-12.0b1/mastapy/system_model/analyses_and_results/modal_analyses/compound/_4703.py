...
class CylindricalGearMeshCompoundModalAnalysis(_4714.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4550.CylindricalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4550.CylindricalGearMeshModalAnalysis]':
