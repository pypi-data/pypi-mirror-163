...
class PowerLoadCompoundModalAnalysis(_4777.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4597.PowerLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4597.PowerLoadModalAnalysis]':
