...
class ConnectorCompoundModalAnalysis(_4732.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4538.ConnectorModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4538.ConnectorModalAnalysis]':
