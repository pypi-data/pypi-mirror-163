...
class AbstractAssemblyCompoundModalAnalysis(_4734.PartCompoundModalAnalysis):
    """AbstractAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4502.AbstractAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4502.AbstractAssemblyModalAnalysis]':
