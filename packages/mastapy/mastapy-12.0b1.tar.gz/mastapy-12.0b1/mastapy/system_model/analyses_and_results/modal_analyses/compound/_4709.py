...
class FaceGearMeshCompoundModalAnalysis(_4714.GearMeshCompoundModalAnalysis):
    """FaceGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4558.FaceGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4558.FaceGearMeshModalAnalysis]':
