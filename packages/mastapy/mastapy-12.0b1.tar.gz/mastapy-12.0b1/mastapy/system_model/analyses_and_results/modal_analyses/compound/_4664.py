...
from mastapy.system_model.analyses_and_results.modal_analyses import _4511
...
class BeltConnectionCompoundModalAnalysis(_4720.InterMountableComponentConnectionCompoundModalAnalysis):
    """BeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4511.BeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4511.BeltConnectionModalAnalysis]':
