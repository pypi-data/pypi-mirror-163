...
from mastapy.system_model.analyses_and_results.modal_analyses import _4514
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4671
...
class BevelDifferentialGearCompoundModalAnalysis(_4671.BevelGearCompoundModalAnalysis):
    """BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4514.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4514.BevelDifferentialGearModalAnalysis]':
