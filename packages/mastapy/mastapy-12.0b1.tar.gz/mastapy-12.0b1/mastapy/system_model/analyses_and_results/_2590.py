...
from mastapy.utility.report import _1712
...
from mastapy.utility.model_validation import _1752, _1751
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1712.CustomReport':
    ...
    @property
    def component_design(self) -> '_2147.DesignEntity':
    ...
    @property
    def component_design_of_type_connection(self) -> '_2212.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2408.Part':
    ...
    @property
    def safety_factors(self) -> '_270.SafetyFactorGroup':
    ...
    @property
    def all_status_errors(self) -> 'List[_1752.StatusItem]':
