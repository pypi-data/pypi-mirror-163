...
class ZerolBevelGearMeshCompoundDynamicAnalysis(_6340.BevelGearMeshCompoundDynamicAnalysis):
    """ZerolBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6321.ZerolBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6321.ZerolBevelGearMeshDynamicAnalysis]':
