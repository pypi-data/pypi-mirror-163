...
class CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis(_6347.CoaxialConnectionCompoundDynamicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6237.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6237.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
