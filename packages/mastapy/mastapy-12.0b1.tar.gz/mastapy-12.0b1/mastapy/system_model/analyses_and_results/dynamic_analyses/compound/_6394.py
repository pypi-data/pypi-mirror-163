...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6392, _6393, _6391
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis(_6391.KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6265.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6392.KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6393.KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6265.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
