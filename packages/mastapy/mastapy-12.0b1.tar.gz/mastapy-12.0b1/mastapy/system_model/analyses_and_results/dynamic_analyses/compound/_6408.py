...
class PlanetCarrierCompoundDynamicAnalysis(_6400.MountableComponentCompoundDynamicAnalysis):
    """PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6279.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6279.PlanetCarrierDynamicAnalysis]':
