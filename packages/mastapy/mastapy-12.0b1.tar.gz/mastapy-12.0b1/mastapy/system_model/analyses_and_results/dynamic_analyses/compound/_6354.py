...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6352, _6353, _6383
...
class ConceptGearSetCompoundDynamicAnalysis(_6383.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6224.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6352.ConceptGearCompoundDynamicAnalysis]':
    ...
    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6353.ConceptGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6224.ConceptGearSetDynamicAnalysis]':
