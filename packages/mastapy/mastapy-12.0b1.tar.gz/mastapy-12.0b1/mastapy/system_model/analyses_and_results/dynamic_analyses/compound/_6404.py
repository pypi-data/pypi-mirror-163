...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6361
...
class PartToPartShearCouplingConnectionCompoundDynamicAnalysis(_6361.CouplingConnectionCompoundDynamicAnalysis):
    """PartToPartShearCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6274.PartToPartShearCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6274.PartToPartShearCouplingConnectionDynamicAnalysis]':
