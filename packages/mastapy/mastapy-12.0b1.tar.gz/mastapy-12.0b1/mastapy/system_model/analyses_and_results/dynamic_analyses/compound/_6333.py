...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6203
...
class BeltDriveCompoundDynamicAnalysis(_6421.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6203.BeltDriveDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6203.BeltDriveDynamicAnalysis]':
