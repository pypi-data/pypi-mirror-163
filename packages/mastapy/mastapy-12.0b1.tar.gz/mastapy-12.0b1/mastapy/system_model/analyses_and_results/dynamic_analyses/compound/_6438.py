...
class SynchroniserPartCompoundDynamicAnalysis(_6362.CouplingHalfCompoundDynamicAnalysis):
    """SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6309.SynchroniserPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6309.SynchroniserPartDynamicAnalysis]':
