...
class ConceptGearCompoundDynamicAnalysis(_6381.GearCompoundDynamicAnalysis):
    """ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6222.ConceptGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6222.ConceptGearDynamicAnalysis]':
