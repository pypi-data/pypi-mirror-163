...
class CouplingConnectionCompoundDynamicAnalysis(_6388.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """CouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6230.CouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6230.CouplingConnectionDynamicAnalysis]':
