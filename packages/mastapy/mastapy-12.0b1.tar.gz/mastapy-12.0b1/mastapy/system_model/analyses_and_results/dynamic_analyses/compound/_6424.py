...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6422, _6423, _6341
...
class SpiralBevelGearSetCompoundDynamicAnalysis(_6341.BevelGearSetCompoundDynamicAnalysis):
    """SpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6295.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6422.SpiralBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6423.SpiralBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6295.SpiralBevelGearSetDynamicAnalysis]':
