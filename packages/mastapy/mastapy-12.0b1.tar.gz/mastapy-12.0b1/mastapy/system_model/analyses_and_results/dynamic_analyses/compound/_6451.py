...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6449, _6450, _6341
...
class ZerolBevelGearSetCompoundDynamicAnalysis(_6341.BevelGearSetCompoundDynamicAnalysis):
    """ZerolBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6322.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6449.ZerolBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6450.ZerolBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6322.ZerolBevelGearSetDynamicAnalysis]':
