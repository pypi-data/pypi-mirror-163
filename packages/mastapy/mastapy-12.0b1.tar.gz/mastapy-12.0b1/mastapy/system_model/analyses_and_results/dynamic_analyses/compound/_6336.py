...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6334, _6335, _6341
...
class BevelDifferentialGearSetCompoundDynamicAnalysis(_6341.BevelGearSetCompoundDynamicAnalysis):
    """BevelDifferentialGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6206.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_dynamic_analysis(self) -> 'List[_6334.BevelDifferentialGearCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_dynamic_analysis(self) -> 'List[_6335.BevelDifferentialGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6206.BevelDifferentialGearSetDynamicAnalysis]':
