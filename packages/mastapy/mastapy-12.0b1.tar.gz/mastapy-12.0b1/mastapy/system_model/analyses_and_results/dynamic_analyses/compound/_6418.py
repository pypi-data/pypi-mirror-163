...
class ShaftCompoundDynamicAnalysis(_6324.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6289.ShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6289.ShaftDynamicAnalysis]':
