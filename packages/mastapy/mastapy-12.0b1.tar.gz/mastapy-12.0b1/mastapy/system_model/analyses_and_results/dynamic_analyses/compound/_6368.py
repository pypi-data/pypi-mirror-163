...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6324
...
class CycloidalDiscCompoundDynamicAnalysis(_6324.AbstractShaftCompoundDynamicAnalysis):
    """CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6238.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6238.CycloidalDiscDynamicAnalysis]':
