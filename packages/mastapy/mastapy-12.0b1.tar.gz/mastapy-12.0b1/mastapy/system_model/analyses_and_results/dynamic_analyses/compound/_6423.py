...
class SpiralBevelGearMeshCompoundDynamicAnalysis(_6340.BevelGearMeshCompoundDynamicAnalysis):
    """SpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6294.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6294.SpiralBevelGearMeshDynamicAnalysis]':
