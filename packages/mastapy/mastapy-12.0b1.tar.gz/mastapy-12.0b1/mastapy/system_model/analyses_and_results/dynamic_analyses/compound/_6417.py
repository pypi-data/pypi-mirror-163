...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6330
...
class RootAssemblyCompoundDynamicAnalysis(_6330.AssemblyCompoundDynamicAnalysis):
    """RootAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6288.RootAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6288.RootAssemblyDynamicAnalysis]':
