...
class BeltConnectionCompoundDynamicAnalysis(_6388.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """BeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6202.BeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6202.BeltConnectionDynamicAnalysis]':
