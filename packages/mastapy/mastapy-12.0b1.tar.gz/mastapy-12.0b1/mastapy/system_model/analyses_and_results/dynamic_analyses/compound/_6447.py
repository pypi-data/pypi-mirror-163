...
class WormGearMeshCompoundDynamicAnalysis(_6382.GearMeshCompoundDynamicAnalysis):
    """WormGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6318.WormGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6318.WormGearMeshDynamicAnalysis]':
