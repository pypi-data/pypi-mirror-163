...
class FaceGearMeshCompoundDynamicAnalysis(_6382.GearMeshCompoundDynamicAnalysis):
    """FaceGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6248.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6248.FaceGearMeshDynamicAnalysis]':
