...
class TorqueConverterConnectionCompoundDynamicAnalysis(_6361.CouplingConnectionCompoundDynamicAnalysis):
    """TorqueConverterConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6311.TorqueConverterConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6311.TorqueConverterConnectionDynamicAnalysis]':
