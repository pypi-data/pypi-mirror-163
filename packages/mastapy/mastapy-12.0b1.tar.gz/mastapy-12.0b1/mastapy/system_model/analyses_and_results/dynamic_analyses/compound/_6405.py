...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6362.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6276.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6276.PartToPartShearCouplingHalfDynamicAnalysis]':
