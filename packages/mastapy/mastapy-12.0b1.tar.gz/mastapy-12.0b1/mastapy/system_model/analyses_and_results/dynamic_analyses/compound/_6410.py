...
class PowerLoadCompoundDynamicAnalysis(_6445.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6281.PowerLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6281.PowerLoadDynamicAnalysis]':
