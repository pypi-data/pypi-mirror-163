...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6428, _6429, _6341
...
class StraightBevelDiffGearSetCompoundDynamicAnalysis(_6341.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelDiffGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6301.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_dynamic_analysis(self) -> 'List[_6428.StraightBevelDiffGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_dynamic_analysis(self) -> 'List[_6429.StraightBevelDiffGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6301.StraightBevelDiffGearSetDynamicAnalysis]':
