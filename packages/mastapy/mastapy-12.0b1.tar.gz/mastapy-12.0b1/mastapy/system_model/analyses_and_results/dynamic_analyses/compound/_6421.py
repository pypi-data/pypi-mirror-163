...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6323
...
class SpecialisedAssemblyCompoundDynamicAnalysis(_6323.AbstractAssemblyCompoundDynamicAnalysis):
    """SpecialisedAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6292.SpecialisedAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6292.SpecialisedAssemblyDynamicAnalysis]':
