...
class ConnectionCompoundDynamicAnalysis(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6228.ConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6228.ConnectionDynamicAnalysis]':
