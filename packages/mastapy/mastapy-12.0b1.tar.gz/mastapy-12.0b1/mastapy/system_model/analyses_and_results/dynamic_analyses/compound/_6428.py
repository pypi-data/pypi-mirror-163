...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6339.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6299.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6299.StraightBevelDiffGearDynamicAnalysis]':
