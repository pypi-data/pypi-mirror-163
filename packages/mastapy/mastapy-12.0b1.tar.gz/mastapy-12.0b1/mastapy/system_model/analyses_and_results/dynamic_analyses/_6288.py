...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2565, _6200
...
from mastapy.system_model.analyses_and_results.modal_analyses import _2568
...
class RootAssemblyDynamicAnalysis(_6200.AssemblyDynamicAnalysis):
    """RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2565.DynamicAnalysis':
