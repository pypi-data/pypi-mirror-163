...
class WormGearCompoundDynamicAnalysis(_6381.GearCompoundDynamicAnalysis):
    """WormGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6317.WormGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6317.WormGearDynamicAnalysis]':
