...
class HypoidGearMeshCompoundDynamicAnalysis(_6328.AGMAGleasonConicalGearMeshCompoundDynamicAnalysis):
    """HypoidGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6257.HypoidGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6257.HypoidGearMeshDynamicAnalysis]':
