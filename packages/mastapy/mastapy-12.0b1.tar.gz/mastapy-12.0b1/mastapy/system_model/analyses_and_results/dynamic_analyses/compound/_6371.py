...
class CylindricalGearMeshCompoundDynamicAnalysis(_6382.GearMeshCompoundDynamicAnalysis):
    """CylindricalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6241.CylindricalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6241.CylindricalGearMeshDynamicAnalysis]':
