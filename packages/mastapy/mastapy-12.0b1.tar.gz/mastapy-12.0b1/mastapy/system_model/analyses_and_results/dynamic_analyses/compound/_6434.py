...
class StraightBevelPlanetGearCompoundDynamicAnalysis(_6428.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6305.StraightBevelPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6305.StraightBevelPlanetGearDynamicAnalysis]':
