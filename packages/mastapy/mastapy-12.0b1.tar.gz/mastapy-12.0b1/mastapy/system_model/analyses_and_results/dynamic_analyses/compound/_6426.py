...
class SpringDamperConnectionCompoundDynamicAnalysis(_6361.CouplingConnectionCompoundDynamicAnalysis):
    """SpringDamperConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6296.SpringDamperConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6296.SpringDamperConnectionDynamicAnalysis]':
