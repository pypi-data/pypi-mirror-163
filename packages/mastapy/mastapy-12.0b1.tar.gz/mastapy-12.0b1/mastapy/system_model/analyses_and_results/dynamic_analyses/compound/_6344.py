...
class ClutchCompoundDynamicAnalysis(_6360.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6215.ClutchDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6215.ClutchDynamicAnalysis]':
