...
TReal = TypeVar('TReal', bound='_2384.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6751.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5601.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    """ComponentStaticLoadCaseGroup
