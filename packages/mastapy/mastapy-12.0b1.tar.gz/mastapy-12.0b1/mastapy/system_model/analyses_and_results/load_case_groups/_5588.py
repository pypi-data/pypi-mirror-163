...
from mastapy.system_model.analyses_and_results.load_case_groups import _5591, _5584
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6915
...
class DutyCycle(_5584.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5591.SubGroupInSingleDesignState]':
    ...
    @property
    def time_series_importer(self) -> '_6915.TimeSeriesImporter':
    ...
    def add_static_load(self, static_load: '_6719.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5591.SubGroupInSingleDesignState'):
    ...
    def remove_static_load(self, static_load: '_6719.StaticLoadCase'):
