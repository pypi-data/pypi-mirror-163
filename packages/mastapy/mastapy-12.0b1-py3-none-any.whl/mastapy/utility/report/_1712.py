...
class CustomReport(_1722.CustomReportItemContainer):
    """CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1705.CadTableBorderType':
        """CadTableBorderType: 'CADTableBorderStyle' is the original name of this property."""

        temp = self.wrapped.CADTableBorderStyle
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1705.CadTableBorderType)(value) if value is not None else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1705.CadTableBorderType'):
    ...
    @property
    def include_report_check(self) -> '_1739.DefinitionBooleanCheckOptions':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1739.DefinitionBooleanCheckOptions)(value) if value is not None else None

    @include_report_check.setter
    def include_report_check(self, value: '_1739.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def page_size_for_cad_export(self) -> '_1704.CadPageSize':
        """CadPageSize: 'PageSizeForCADExport' is the original name of this property."""

        temp = self.wrapped.PageSizeForCADExport
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1704.CadPageSize)(value) if value is not None else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1704.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
