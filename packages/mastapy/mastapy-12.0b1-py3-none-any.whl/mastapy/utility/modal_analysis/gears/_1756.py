...
from mastapy.utility.modal_analysis.gears import _1757, _1760, _1762
...
class GearOrderForTE(_1762.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self) -> '_1757.GearPositions':
        ...
        return constructor.new_from_mastapy_type(_1757.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1760.OrderForTE]':
