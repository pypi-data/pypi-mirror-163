...
class BoltGeometry(_1785.NamedDatabaseItem):
    """BoltGeometry
    ...
    @property
    def bolt_sections(self) -> 'List[_1431.BoltSection]':
    ...
    def bolt_sections(self, value: 'List[_1431.BoltSection]'):
        value = value if value else None
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self) -> '_1432.BoltShankType':
        """BoltShankType: 'BoltShankType' is the original name of this property."""

        temp = self.wrapped.BoltShankType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1432.BoltShankType)(value) if value is not None else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1432.BoltShankType'):
        value = value if value else None
    ...
    @property
    def standard_size(self) -> '_1443.StandardSizes':
        """StandardSizes: 'StandardSize' is the original name of this property."""

        temp = self.wrapped.StandardSize
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1443.StandardSizes)(value) if value is not None else None

    @standard_size.setter
    def standard_size(self, value: '_1443.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_bolted_joint(self) -> '_1433.BoltTypes':
        """BoltTypes: 'TypeOfBoltedJoint' is the original name of this property."""

        temp = self.wrapped.TypeOfBoltedJoint
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1433.BoltTypes)(value) if value is not None else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1433.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self) -> '_1438.HeadCapTypes':
        """HeadCapTypes: 'TypeOfHeadCap' is the original name of this property."""

        temp = self.wrapped.TypeOfHeadCap
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1438.HeadCapTypes)(value) if value is not None else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1438.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1445.ThreadTypes':
        """ThreadTypes: 'TypeOfThread' is the original name of this property."""

        temp = self.wrapped.TypeOfThread
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1445.ThreadTypes)(value) if value is not None else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1445.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
