...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self) -> 'List[_1434.ClampedSection]':
    ...
    def clamped_parts(self, value: 'List[_1434.ClampedSection]'):
    ...
    @property
    def joint_geometry(self) -> '_1439.JointGeometries':
        """JointGeometries: 'JointGeometry' is the original name of this property."""

        temp = self.wrapped.JointGeometry
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1439.JointGeometries)(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1439.JointGeometries'):
        value = value if value else None
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1442.RolledBeforeOrAfterHeatTreament':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1442.RolledBeforeOrAfterHeatTreament)(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1442.RolledBeforeOrAfterHeatTreament'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bolt_geometry(self) -> '_1427.BoltGeometry':
    ...
    @property
    def material_of_bolt(self) -> '_1429.BoltMaterial':
    ...
    @property
    def material_of_nut(self) -> '_1425.BoltedJointMaterial':
        ...
        if _1425.BoltedJointMaterial.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def material_of_tapped_thread(self) -> '_1425.BoltedJointMaterial':
    ...
    @property
    def clamped_sections(self) -> 'List[_1434.ClampedSection]':
