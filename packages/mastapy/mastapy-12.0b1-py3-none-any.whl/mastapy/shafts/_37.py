...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    def sn_curve(self) -> '_272.SNCurve':
    ...
    @property
    def sn_curve_axial(self) -> '_272.SNCurve':
    ...
    @property
    def sn_curve_bending_x(self) -> '_272.SNCurve':
    ...
    @property
    def sn_curve_bending_y(self) -> '_272.SNCurve':
    ...
    @property
    def sn_curve_torsional(self) -> '_272.SNCurve':
