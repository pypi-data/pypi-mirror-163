...
from mastapy.system_model.fe import _2297, _2304
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2297.AlignmentMethodForRaceBearing':
        ...
        return constructor.new_from_mastapy_type(_2297.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2297.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2304.BearingRaceNodeLink]':
