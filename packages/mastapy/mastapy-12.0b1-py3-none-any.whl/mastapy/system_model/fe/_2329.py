...
class FESubstructureWithSelection(_2300.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2322.FESubstructure':
    ...
    @property
    def element_face_groups(self) -> 'List[_2315.ElementFaceGroupWithSelection]':
    ...
    @property
    def node_groups(self) -> 'List[_2340.NodeGroupWithSelection]':
