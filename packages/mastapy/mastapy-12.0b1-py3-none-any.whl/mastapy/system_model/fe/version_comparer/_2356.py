...
from mastapy.math_utility.measured_vectors import _1523, _1521
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1523.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1521.NodeResults':
    ...
    @property
    def original_result(self) -> '_1521.NodeResults':
