...
from mastapy.system_model.fe.version_comparer import _2355, _2351
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2355.LoadCasesToRun':
        """LoadCasesToRun: 'LoadCasesToRun' is the original name of this property."""

        temp = self.wrapped.LoadCasesToRun
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2355.LoadCasesToRun)(value) if value is not None else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2355.LoadCasesToRun'):
    ...
    @property
    def design_results(self) -> 'List[_2351.DesignResults]':
