...
from mastapy.utility.enums import _1777
...
from mastapy.system_model.fe import _2339, _2329
...
class FESubstructureWithSelectionForStaticAnalysis(_2329.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def full_fe_results(self) -> '_226.StaticCMSResults':
    ...
    @property
    def static_draw_style(self) -> '_183.FEModelStaticAnalysisDrawStyle':
    ...
    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2339.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2339.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def displacement_results(self) -> 'List[_1523.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def force_results(self) -> 'List[_1523.VectorWithLinearAndAngularComponents]':
