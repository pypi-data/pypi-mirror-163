...
from mastapy.system_model.fe import (
    _2296, _2302, _2350, _2327,
    _2298, _2323, _2334, _2320,
    _2335, _2324, _2348, _2330,
    _2331, _2332, _2333
)
from mastapy._internal.implicit import list_with_selected_item, overridable, enum_with_selected_value
from mastapy.system_model.part_model import _2384, _2388, _2393
...
from mastapy.materials import _228, _274
...
from mastapy.system_model.fe.links import _2357
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self) -> '_2296.AlignmentMethod':
        """AlignmentMethod: 'AlignmentMethod' is the original name of this property."""

        temp = self.wrapped.AlignmentMethod
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2296.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2296.AlignmentMethod'):
    ...
    @property
    def bearing_node_alignment(self) -> '_2302.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2302.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2302.BearingNodeAlignmentOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2298.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2163.RelativeComponentAlignment[_2384.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2384.Component](temp) if temp is not None else None

    @property
    def cms_model(self) -> '_218.CMSModel':
    ...
    @property
    def coordinate_system(self) -> '_1458.CoordinateSystem3D':
    ...
    @property
    def export(self) -> '_2323.FESubstructureExportOptions':
    ...
    @property
    def sound_pressure_enclosure(self) -> '_274.SoundPressureEnclosure':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2334.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2320.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2335.IndependentMastaCreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2357.FELink]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2422.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2348.ReplacedShaftSelectionHelper]':
    ...
    @property
    def thermal_expansion_displacements(self) -> 'List[_1523.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1523.VectorWithLinearAndAngularComponents]':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2330.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2331.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2332.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2333.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_165.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7471.TaskProgress'] = None):
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1570.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1570.Unit', force_unit: '_1570.Unit'):
    ...
    def links_for(self, node: '_2324.FESubstructureNode') -> 'List[_2357.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7471.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1570.Unit', file_name: 'str'):
