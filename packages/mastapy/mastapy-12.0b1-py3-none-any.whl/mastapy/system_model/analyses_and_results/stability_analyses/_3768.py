...
from mastapy.system_model.analyses_and_results.stability_analyses import _3769, _3767, _3765
...
class KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis(_3765.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_stability_analysis(self) -> 'List[_3769.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_stability_analysis(self) -> 'List[_3767.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
