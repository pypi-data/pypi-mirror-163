...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3882, _3883, _3889
...
class FaceGearSetCompoundStabilityAnalysis(_3889.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3752.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3882.FaceGearCompoundStabilityAnalysis]':
    ...
    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3883.FaceGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3752.FaceGearSetStabilityAnalysis]':
