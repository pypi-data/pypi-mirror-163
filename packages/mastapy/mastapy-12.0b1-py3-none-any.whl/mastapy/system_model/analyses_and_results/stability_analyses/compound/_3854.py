...
class ComponentCompoundStabilityAnalysis(_3908.PartCompoundStabilityAnalysis):
    """ComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3722.ComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3722.ComponentStabilityAnalysis]':
