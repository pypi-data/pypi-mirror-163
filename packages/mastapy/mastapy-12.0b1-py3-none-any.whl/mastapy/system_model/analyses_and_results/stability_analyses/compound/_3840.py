...
class BevelDifferentialGearCompoundStabilityAnalysis(_3845.BevelGearCompoundStabilityAnalysis):
    """BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3710.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3710.BevelDifferentialGearStabilityAnalysis]':
