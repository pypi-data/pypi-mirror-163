...
class ClutchCompoundStabilityAnalysis(_3866.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3720.ClutchStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3720.ClutchStabilityAnalysis]':
