...
class CouplingHalfCompoundStabilityAnalysis(_3906.MountableComponentCompoundStabilityAnalysis):
    """CouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3735.CouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3735.CouplingHalfStabilityAnalysis]':
