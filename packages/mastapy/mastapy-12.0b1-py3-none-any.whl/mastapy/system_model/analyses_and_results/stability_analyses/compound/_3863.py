...
class ConicalGearSetCompoundStabilityAnalysis(_3889.GearSetCompoundStabilityAnalysis):
    """ConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3730.ConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3730.ConicalGearSetStabilityAnalysis]':
