...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3829
...
class SpecialisedAssemblyCompoundStabilityAnalysis(_3829.AbstractAssemblyCompoundStabilityAnalysis):
    """SpecialisedAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3796.SpecialisedAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3796.SpecialisedAssemblyStabilityAnalysis]':
