...
class CVTPulleyCompoundStabilityAnalysis(_3917.PulleyCompoundStabilityAnalysis):
    """CVTPulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3739.CVTPulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3739.CVTPulleyStabilityAnalysis]':
