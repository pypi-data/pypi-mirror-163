...
class PartToPartShearCouplingCompoundStabilityAnalysis(_3866.CouplingCompoundStabilityAnalysis):
    """PartToPartShearCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3780.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3780.PartToPartShearCouplingStabilityAnalysis]':
