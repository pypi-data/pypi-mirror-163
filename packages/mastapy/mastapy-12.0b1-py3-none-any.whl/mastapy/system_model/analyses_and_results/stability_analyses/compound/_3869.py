...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3838
...
class CVTBeltConnectionCompoundStabilityAnalysis(_3838.BeltConnectionCompoundStabilityAnalysis):
    """CVTBeltConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3738.CVTBeltConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3738.CVTBeltConnectionStabilityAnalysis]':
