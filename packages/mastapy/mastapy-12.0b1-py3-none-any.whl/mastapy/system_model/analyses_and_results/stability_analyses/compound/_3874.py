...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3830
...
class CycloidalDiscCompoundStabilityAnalysis(_3830.AbstractShaftCompoundStabilityAnalysis):
    """CycloidalDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3744.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3744.CycloidalDiscStabilityAnalysis]':
