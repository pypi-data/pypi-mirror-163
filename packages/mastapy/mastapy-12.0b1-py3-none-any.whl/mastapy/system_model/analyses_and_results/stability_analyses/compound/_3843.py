...
from mastapy.system_model.analyses_and_results.stability_analyses import _3711
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3840
...
class BevelDifferentialPlanetGearCompoundStabilityAnalysis(_3840.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3711.BevelDifferentialPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3711.BevelDifferentialPlanetGearStabilityAnalysis]':
