...
class ConceptGearMeshCompoundStabilityAnalysis(_3888.GearMeshCompoundStabilityAnalysis):
    """ConceptGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3726.ConceptGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3726.ConceptGearMeshStabilityAnalysis]':
