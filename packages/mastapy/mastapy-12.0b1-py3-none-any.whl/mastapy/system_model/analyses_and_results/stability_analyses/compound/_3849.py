...
class BoltedJointCompoundStabilityAnalysis(_3927.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BoltedJointCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3716.BoltedJointStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3716.BoltedJointStabilityAnalysis]':
