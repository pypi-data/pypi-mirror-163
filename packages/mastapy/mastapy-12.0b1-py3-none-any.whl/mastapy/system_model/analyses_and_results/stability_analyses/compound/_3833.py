...
from mastapy.system_model.analyses_and_results.stability_analyses import _3703
...
class AGMAGleasonConicalGearCompoundStabilityAnalysis(_3861.ConicalGearCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3703.AGMAGleasonConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3703.AGMAGleasonConicalGearStabilityAnalysis]':
