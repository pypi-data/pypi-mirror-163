...
class OilSealCompoundStabilityAnalysis(_3865.ConnectorCompoundStabilityAnalysis):
    """OilSealCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3776.OilSealStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3776.OilSealStabilityAnalysis]':
