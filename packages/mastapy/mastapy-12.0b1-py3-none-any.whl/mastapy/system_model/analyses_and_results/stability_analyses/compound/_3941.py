...
class StraightBevelSunGearCompoundStabilityAnalysis(_3934.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3812.StraightBevelSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3812.StraightBevelSunGearStabilityAnalysis]':
