...
class StraightBevelDiffGearMeshCompoundStabilityAnalysis(_3846.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelDiffGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3805.StraightBevelDiffGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3805.StraightBevelDiffGearMeshStabilityAnalysis]':
