...
class KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis(_3863.ConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3765.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3765.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
