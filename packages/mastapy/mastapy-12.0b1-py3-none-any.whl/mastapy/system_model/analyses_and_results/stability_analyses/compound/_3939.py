...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3937, _3938, _3847
...
class StraightBevelGearSetCompoundStabilityAnalysis(_3847.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3809.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_stability_analysis(self) -> 'List[_3937.StraightBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_stability_analysis(self) -> 'List[_3938.StraightBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3809.StraightBevelGearSetStabilityAnalysis]':
