...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3867.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3723.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3723.ConceptCouplingConnectionStabilityAnalysis]':
