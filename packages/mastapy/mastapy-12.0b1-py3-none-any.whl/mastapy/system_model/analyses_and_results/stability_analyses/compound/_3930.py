...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3928, _3929, _3847
...
class SpiralBevelGearSetCompoundStabilityAnalysis(_3847.BevelGearSetCompoundStabilityAnalysis):
    """SpiralBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3798.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_stability_analysis(self) -> 'List[_3928.SpiralBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_stability_analysis(self) -> 'List[_3929.SpiralBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3798.SpiralBevelGearSetStabilityAnalysis]':
