...
class BevelDifferentialGearMeshCompoundStabilityAnalysis(_3846.BevelGearMeshCompoundStabilityAnalysis):
    """BevelDifferentialGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3708.BevelDifferentialGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3708.BevelDifferentialGearMeshStabilityAnalysis]':
