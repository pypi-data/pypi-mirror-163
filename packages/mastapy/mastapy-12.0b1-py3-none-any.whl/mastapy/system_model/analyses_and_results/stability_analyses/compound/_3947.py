...
class TorqueConverterConnectionCompoundStabilityAnalysis(_3867.CouplingConnectionCompoundStabilityAnalysis):
    """TorqueConverterConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3817.TorqueConverterConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3817.TorqueConverterConnectionStabilityAnalysis]':
