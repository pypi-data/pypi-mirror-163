...
class TorqueConverterCompoundStabilityAnalysis(_3866.CouplingCompoundStabilityAnalysis):
    """TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3819.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3819.TorqueConverterStabilityAnalysis]':
