...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis(_3896.KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3767.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3767.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
