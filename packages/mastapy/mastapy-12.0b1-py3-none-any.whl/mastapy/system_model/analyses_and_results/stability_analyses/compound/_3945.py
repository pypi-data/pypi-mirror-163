...
class SynchroniserSleeveCompoundStabilityAnalysis(_3944.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserSleeveCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3815.SynchroniserSleeveStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3815.SynchroniserSleeveStabilityAnalysis]':
