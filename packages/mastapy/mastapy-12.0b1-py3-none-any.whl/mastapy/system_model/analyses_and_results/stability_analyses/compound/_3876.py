...
class CylindricalGearCompoundStabilityAnalysis(_3887.GearCompoundStabilityAnalysis):
    """CylindricalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3747.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3747.CylindricalGearStabilityAnalysis]':
