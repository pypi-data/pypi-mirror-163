...
class PartCompoundStabilityAnalysis(_7458.PartCompoundAnalysis):
    """PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3777.PartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3777.PartStabilityAnalysis]':
