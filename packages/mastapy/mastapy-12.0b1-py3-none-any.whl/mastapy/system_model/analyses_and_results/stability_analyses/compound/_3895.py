...
class KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(_3861.ConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3766.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3766.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
