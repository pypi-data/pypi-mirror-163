...
class ZerolBevelGearCompoundStabilityAnalysis(_3845.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3828.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3828.ZerolBevelGearStabilityAnalysis]':
