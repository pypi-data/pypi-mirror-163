...
class AbstractAssemblyCompoundStabilityAnalysis(_3908.PartCompoundStabilityAnalysis):
    """AbstractAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3697.AbstractAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3697.AbstractAssemblyStabilityAnalysis]':
