...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3840.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3712.BevelDifferentialSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3712.BevelDifferentialSunGearStabilityAnalysis]':
