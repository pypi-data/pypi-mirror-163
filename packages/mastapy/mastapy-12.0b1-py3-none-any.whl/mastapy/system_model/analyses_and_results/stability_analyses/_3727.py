...
from mastapy.system_model.analyses_and_results.stability_analyses import _3728, _3726, _3757
...
class ConceptGearSetStabilityAnalysis(_3757.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3728.ConceptGearStabilityAnalysis]':
    ...
    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3726.ConceptGearMeshStabilityAnalysis]':
