...
from mastapy.system_model.analyses_and_results.stability_analyses import (
    _3705, _3707, _3709, _3716,
    _3717, _3740, _3720, _3725,
    _3727, _3741, _3744, _3746,
    _3754, _3752, _3755, _3761,
    _3768, _3771, _3773, _3774,
    _3776, _3780, _3783, _3784,
    _3785, _3787, _3789, _3793,
    _3794, _3798, _3802, _3806,
    _3809, _3816, _3819, _3821,
    _3824, _3827, _3697
)
...
class AssemblyStabilityAnalysis(_3697.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self) -> 'List[_3705.BearingStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3707.BeltDriveStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3709.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3716.BoltedJointStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3717.BoltStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3740.CVTStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3720.ClutchStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3725.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3727.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3741.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3744.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3746.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3754.FEPartStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3752.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3755.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3761.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3768.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3771.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3773.MassDiscStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3774.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3776.OilSealStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3780.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3783.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3784.PointLoadStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3785.PowerLoadStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3787.RingPinsStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3789.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3793.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3794.ShaftStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3798.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3802.SpringDamperStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3806.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3809.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3816.SynchroniserStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3819.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3821.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3824.WormGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3827.ZerolBevelGearSetStabilityAnalysis]':
