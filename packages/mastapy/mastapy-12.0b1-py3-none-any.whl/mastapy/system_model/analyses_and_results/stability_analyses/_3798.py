...
from mastapy.system_model.analyses_and_results.stability_analyses import _3799, _3797, _3714
...
class SpiralBevelGearSetStabilityAnalysis(_3714.BevelGearSetStabilityAnalysis):
    """SpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def spiral_bevel_gears_stability_analysis(self) -> 'List[_3799.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_stability_analysis(self) -> 'List[_3797.SpiralBevelGearMeshStabilityAnalysis]':
