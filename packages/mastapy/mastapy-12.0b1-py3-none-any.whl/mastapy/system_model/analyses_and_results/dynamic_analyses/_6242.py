...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6240, _6241, _6254
...
class CylindricalGearSetDynamicAnalysis(_6254.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_6240.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_6241.CylindricalGearMeshDynamicAnalysis]':
