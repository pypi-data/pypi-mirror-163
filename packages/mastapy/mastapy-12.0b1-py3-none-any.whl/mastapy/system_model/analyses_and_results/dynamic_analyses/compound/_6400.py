...
class MountableComponentCompoundDynamicAnalysis(_6348.ComponentCompoundDynamicAnalysis):
    """MountableComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6271.MountableComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6271.MountableComponentDynamicAnalysis]':
