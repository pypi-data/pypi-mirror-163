...
class CylindricalGearCompoundDynamicAnalysis(_6381.GearCompoundDynamicAnalysis):
    """CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6240.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6240.CylindricalGearDynamicAnalysis]':
