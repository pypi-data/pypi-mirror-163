...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6327
...
class HypoidGearCompoundDynamicAnalysis(_6327.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6256.HypoidGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6256.HypoidGearDynamicAnalysis]':
