...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6325
...
class AbstractShaftCompoundDynamicAnalysis(_6325.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6194.AbstractShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6194.AbstractShaftDynamicAnalysis]':
