...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6361.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6219.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6219.ConceptCouplingConnectionDynamicAnalysis]':
