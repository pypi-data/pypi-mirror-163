...
class FEPartCompoundDynamicAnalysis(_6325.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """FEPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6250.FEPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6250.FEPartDynamicAnalysis]':
