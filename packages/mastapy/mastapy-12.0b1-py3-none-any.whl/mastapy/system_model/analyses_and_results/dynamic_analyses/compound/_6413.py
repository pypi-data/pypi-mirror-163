...
class RingPinsToDiscConnectionCompoundDynamicAnalysis(_6388.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RingPinsToDiscConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6284.RingPinsToDiscConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6284.RingPinsToDiscConnectionDynamicAnalysis]':
