...
class CouplingHalfCompoundDynamicAnalysis(_6400.MountableComponentCompoundDynamicAnalysis):
    """CouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6232.CouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6232.CouplingHalfDynamicAnalysis]':
