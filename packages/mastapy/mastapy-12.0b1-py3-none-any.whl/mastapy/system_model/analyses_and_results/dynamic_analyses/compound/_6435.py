...
class StraightBevelSunGearCompoundDynamicAnalysis(_6428.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6306.StraightBevelSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6306.StraightBevelSunGearDynamicAnalysis]':
