...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6210
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6328
...
class BevelGearMeshCompoundDynamicAnalysis(_6328.AGMAGleasonConicalGearMeshCompoundDynamicAnalysis):
    """BevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6210.BevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6210.BevelGearMeshDynamicAnalysis]':
