...
class GuideDxfModelCompoundDynamicAnalysis(_6348.ComponentCompoundDynamicAnalysis):
    """GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6255.GuideDxfModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6255.GuideDxfModelDynamicAnalysis]':
