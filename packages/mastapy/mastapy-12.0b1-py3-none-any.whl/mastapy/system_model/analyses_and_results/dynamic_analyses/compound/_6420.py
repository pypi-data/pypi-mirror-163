...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6326.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6291.ShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6291.ShaftToMountableComponentConnectionDynamicAnalysis]':
