...
class PulleyCompoundDynamicAnalysis(_6362.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6282.PulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6282.PulleyDynamicAnalysis]':
