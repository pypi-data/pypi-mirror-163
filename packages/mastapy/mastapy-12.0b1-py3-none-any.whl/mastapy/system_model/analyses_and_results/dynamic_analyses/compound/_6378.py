...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6376, _6377, _6383
...
class FaceGearSetCompoundDynamicAnalysis(_6383.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6249.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_6376.FaceGearCompoundDynamicAnalysis]':
    ...
    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_6377.FaceGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6249.FaceGearSetDynamicAnalysis]':
