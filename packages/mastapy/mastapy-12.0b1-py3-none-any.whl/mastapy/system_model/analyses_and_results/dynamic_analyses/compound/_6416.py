...
class RollingRingConnectionCompoundDynamicAnalysis(_6388.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RollingRingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6286.RollingRingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6286.RollingRingConnectionDynamicAnalysis]':
