...
class AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6358.ConnectionCompoundDynamicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6196.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6196.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
