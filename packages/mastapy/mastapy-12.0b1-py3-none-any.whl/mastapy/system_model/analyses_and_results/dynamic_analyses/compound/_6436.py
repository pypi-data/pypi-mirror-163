...
class SynchroniserCompoundDynamicAnalysis(_6421.SpecialisedAssemblyCompoundDynamicAnalysis):
    """SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6307.SynchroniserDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6307.SynchroniserDynamicAnalysis]':
