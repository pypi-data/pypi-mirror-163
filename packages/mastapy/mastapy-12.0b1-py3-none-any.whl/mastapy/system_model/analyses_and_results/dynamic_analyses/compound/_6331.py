...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6201
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6359
...
class BearingCompoundDynamicAnalysis(_6359.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6201.BearingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6201.BearingDynamicAnalysis]':
