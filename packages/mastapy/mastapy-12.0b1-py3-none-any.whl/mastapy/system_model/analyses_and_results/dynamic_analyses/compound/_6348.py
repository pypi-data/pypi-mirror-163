...
class ComponentCompoundDynamicAnalysis(_6402.PartCompoundDynamicAnalysis):
    """ComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6218.ComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6218.ComponentDynamicAnalysis]':
