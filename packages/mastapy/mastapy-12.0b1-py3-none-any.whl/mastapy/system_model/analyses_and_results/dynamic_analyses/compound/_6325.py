...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6348.ComponentCompoundDynamicAnalysis):
    """AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6195.AbstractShaftOrHousingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6195.AbstractShaftOrHousingDynamicAnalysis]':
