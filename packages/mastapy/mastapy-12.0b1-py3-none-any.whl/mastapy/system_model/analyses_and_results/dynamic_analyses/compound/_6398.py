...
class MassDiscCompoundDynamicAnalysis(_6445.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6269.MassDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6269.MassDiscDynamicAnalysis]':
