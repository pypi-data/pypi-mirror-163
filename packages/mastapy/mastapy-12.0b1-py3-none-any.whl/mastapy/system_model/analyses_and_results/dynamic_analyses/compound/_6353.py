...
class ConceptGearMeshCompoundDynamicAnalysis(_6382.GearMeshCompoundDynamicAnalysis):
    """ConceptGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6223.ConceptGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6223.ConceptGearMeshDynamicAnalysis]':
