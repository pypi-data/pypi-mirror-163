...
class ConceptCouplingCompoundDynamicAnalysis(_6360.CouplingCompoundDynamicAnalysis):
    """ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6220.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6220.ConceptCouplingDynamicAnalysis]':
