...
class ExternalCADModelCompoundDynamicAnalysis(_6348.ComponentCompoundDynamicAnalysis):
    """ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6246.ExternalCADModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6246.ExternalCADModelDynamicAnalysis]':
