...
class TorqueConverterPumpCompoundDynamicAnalysis(_6362.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6313.TorqueConverterPumpDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6313.TorqueConverterPumpDynamicAnalysis]':
