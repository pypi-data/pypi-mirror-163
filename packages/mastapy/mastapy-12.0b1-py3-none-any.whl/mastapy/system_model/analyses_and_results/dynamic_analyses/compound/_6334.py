...
class BevelDifferentialGearCompoundDynamicAnalysis(_6339.BevelGearCompoundDynamicAnalysis):
    """BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6204.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6204.BevelDifferentialGearDynamicAnalysis]':
