...
class MeasurementComponentCompoundDynamicAnalysis(_6445.VirtualComponentCompoundDynamicAnalysis):
    """MeasurementComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6270.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6270.MeasurementComponentDynamicAnalysis]':
