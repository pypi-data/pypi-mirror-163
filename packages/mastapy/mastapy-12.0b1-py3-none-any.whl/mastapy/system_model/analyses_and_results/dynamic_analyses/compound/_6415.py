...
class RollingRingCompoundDynamicAnalysis(_6362.CouplingHalfCompoundDynamicAnalysis):
    """RollingRingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6287.RollingRingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6287.RollingRingDynamicAnalysis]':
