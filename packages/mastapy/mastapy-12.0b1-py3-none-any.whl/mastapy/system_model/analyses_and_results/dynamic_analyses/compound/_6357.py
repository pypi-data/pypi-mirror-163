...
class ConicalGearSetCompoundDynamicAnalysis(_6383.GearSetCompoundDynamicAnalysis):
    """ConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6227.ConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6227.ConicalGearSetDynamicAnalysis]':
