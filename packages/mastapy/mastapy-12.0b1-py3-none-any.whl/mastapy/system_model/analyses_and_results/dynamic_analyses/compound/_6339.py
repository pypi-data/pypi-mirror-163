...
class BevelGearCompoundDynamicAnalysis(_6327.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """BevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6209.BevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6209.BevelGearDynamicAnalysis]':
