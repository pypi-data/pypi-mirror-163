...
class PlanetaryConnectionCompoundDynamicAnalysis(_6420.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """PlanetaryConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6277.PlanetaryConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6277.PlanetaryConnectionDynamicAnalysis]':
