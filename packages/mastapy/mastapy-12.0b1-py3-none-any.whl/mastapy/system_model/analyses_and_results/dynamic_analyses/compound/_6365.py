...
class CVTPulleyCompoundDynamicAnalysis(_6411.PulleyCompoundDynamicAnalysis):
    """CVTPulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6235.CVTPulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6235.CVTPulleyDynamicAnalysis]':
