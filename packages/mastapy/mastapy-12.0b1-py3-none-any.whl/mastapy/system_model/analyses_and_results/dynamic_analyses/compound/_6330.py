...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6200
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import (
    _6331, _6333, _6336, _6343,
    _6342, _6364, _6344, _6349,
    _6354, _6366, _6368, _6372,
    _6379, _6378, _6380, _6387,
    _6394, _6397, _6398, _6399,
    _6401, _6403, _6408, _6409,
    _6410, _6412, _6414, _6419,
    _6418, _6424, _6425, _6430,
    _6433, _6436, _6440, _6444,
    _6448, _6451, _6323
)
...
class AssemblyCompoundDynamicAnalysis(_6323.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6200.AssemblyDynamicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6331.BearingCompoundDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6333.BeltDriveCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6336.BevelDifferentialGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6343.BoltedJointCompoundDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6342.BoltCompoundDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6364.CVTCompoundDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6344.ClutchCompoundDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6349.ConceptCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6354.ConceptGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6366.CycloidalAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6368.CycloidalDiscCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6372.CylindricalGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6379.FEPartCompoundDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6378.FaceGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6380.FlexiblePinAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6387.HypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6394.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6397.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6398.MassDiscCompoundDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6399.MeasurementComponentCompoundDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6401.OilSealCompoundDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6403.PartToPartShearCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6408.PlanetCarrierCompoundDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6409.PointLoadCompoundDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6410.PowerLoadCompoundDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6412.RingPinsCompoundDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6414.RollingRingAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6419.ShaftHubConnectionCompoundDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6418.ShaftCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6424.SpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6425.SpringDamperCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6430.StraightBevelDiffGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6433.StraightBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6436.SynchroniserCompoundDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6440.TorqueConverterCompoundDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6444.UnbalancedMassCompoundDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6448.WormGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6451.ZerolBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6200.AssemblyDynamicAnalysis]':
