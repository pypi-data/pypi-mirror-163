...
class StraightBevelGearMeshCompoundDynamicAnalysis(_6340.BevelGearMeshCompoundDynamicAnalysis):
    """StraightBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6303.StraightBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6303.StraightBevelGearMeshDynamicAnalysis]':
