...
class SpringDamperCompoundDynamicAnalysis(_6360.CouplingCompoundDynamicAnalysis):
    """SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6297.SpringDamperDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6297.SpringDamperDynamicAnalysis]':
