...
class UnbalancedMassCompoundDynamicAnalysis(_6445.VirtualComponentCompoundDynamicAnalysis):
    """UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6315.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6315.UnbalancedMassDynamicAnalysis]':
