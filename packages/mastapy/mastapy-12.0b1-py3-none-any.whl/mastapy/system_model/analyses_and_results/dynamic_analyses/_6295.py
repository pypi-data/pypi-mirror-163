...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6293, _6294, _6211
...
class SpiralBevelGearSetDynamicAnalysis(_6211.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6293.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6294.SpiralBevelGearMeshDynamicAnalysis]':
