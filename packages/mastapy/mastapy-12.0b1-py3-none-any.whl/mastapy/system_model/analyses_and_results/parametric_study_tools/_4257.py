...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4256, _4255, _4293
...
class ConceptGearSetParametricStudyTool(_4293.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4256.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4255.ConceptGearMeshParametricStudyTool]':
