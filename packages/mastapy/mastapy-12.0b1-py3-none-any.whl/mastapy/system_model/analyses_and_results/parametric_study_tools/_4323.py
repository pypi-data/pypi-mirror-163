...
from mastapy.utility_gui import _1804
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4318
from mastapy.system_model.analyses_and_results.analysis_cases import _7457
...
class PartParametricStudyTool(_7457.PartAnalysisCase):
    """PartParametricStudyTool
    ...
    @property
    def design_of_experiments_chart(self) -> '_1809.NDChartDefinition':
        ...
        if _1809.NDChartDefinition.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def design_of_experiments_chart_of_type_bubble_chart_definition(self) -> '_1805.BubbleChartDefinition':
        ...
        temp = self.wrapped.DesignOfExperimentsChart
        if _1805.BubbleChartDefinition.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def design_of_experiments_chart_of_type_parallel_coordinates_chart_definition(self) -> '_1810.ParallelCoordinatesChartDefinition':
        ...
        temp = self.wrapped.DesignOfExperimentsChart
        if _1810.ParallelCoordinatesChartDefinition.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def design_of_experiments_chart_of_type_scatter_chart_definition(self) -> '_1812.ScatterChartDefinition':
        ...
        temp = self.wrapped.DesignOfExperimentsChart
        if _1812.ScatterChartDefinition.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def design_of_experiments_chart_of_type_three_d_chart_definition(self) -> '_1813.ThreeDChartDefinition':
        ...
        temp = self.wrapped.DesignOfExperimentsChart
        if _1813.ThreeDChartDefinition.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def design_of_experiments_chart_of_type_three_d_vector_chart_definition(self) -> '_1814.ThreeDVectorChartDefinition':
        ...
        temp = self.wrapped.DesignOfExperimentsChart
        if _1814.ThreeDVectorChartDefinition.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def design_of_experiments_chart_of_type_two_d_chart_definition(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def linear_sweep_chart_2d(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def linear_sweep_chart_3d(self) -> '_1813.ThreeDChartDefinition':
    ...
    @property
    def data_logger(self) -> '_1804.DataLoggerWithCharts':
    ...
    @property
    def parametric_study_tool(self) -> '_4318.ParametricStudyTool':
