...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4350, _4349, _4244
...
class StraightBevelDiffGearSetParametricStudyTool(_4244.BevelGearSetParametricStudyTool):
    """StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_4350.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_4349.StraightBevelDiffGearMeshParametricStudyTool]':
