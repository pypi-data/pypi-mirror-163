...
class CylindricalGearMeshParametricStudyTool(_4291.GearMeshParametricStudyTool):
    """CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2673.CylindricalGearMeshSystemDeflection]':
