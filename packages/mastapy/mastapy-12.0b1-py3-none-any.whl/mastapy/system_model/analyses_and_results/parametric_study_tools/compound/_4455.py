...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4412.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4325.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4325.PartToPartShearCouplingHalfParametricStudyTool]':
