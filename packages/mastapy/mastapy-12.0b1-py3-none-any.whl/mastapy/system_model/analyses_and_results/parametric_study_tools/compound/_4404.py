...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4402, _4403, _4433
...
class ConceptGearSetCompoundParametricStudyTool(_4433.GearSetCompoundParametricStudyTool):
    """ConceptGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4257.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def concept_gears_compound_parametric_study_tool(self) -> 'List[_4402.ConceptGearCompoundParametricStudyTool]':
    ...
    @property
    def concept_meshes_compound_parametric_study_tool(self) -> 'List[_4403.ConceptGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4257.ConceptGearSetParametricStudyTool]':
