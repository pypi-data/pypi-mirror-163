...
class MassDiscCompoundParametricStudyTool(_4495.VirtualComponentCompoundParametricStudyTool):
    """MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4308.MassDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4308.MassDiscParametricStudyTool]':
