...
class InterMountableComponentConnectionCompoundParametricStudyTool(_4408.ConnectionCompoundParametricStudyTool):
    """InterMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4298.InterMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4298.InterMountableComponentConnectionParametricStudyTool]':
