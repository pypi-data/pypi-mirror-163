...
class ConicalGearSetCompoundParametricStudyTool(_4433.GearSetCompoundParametricStudyTool):
    """ConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4260.ConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4260.ConicalGearSetParametricStudyTool]':
