...
class TorqueConverterConnectionCompoundParametricStudyTool(_4411.CouplingConnectionCompoundParametricStudyTool):
    """TorqueConverterConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4361.TorqueConverterConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4361.TorqueConverterConnectionParametricStudyTool]':
