...
class VirtualComponentCompoundParametricStudyTool(_4450.MountableComponentCompoundParametricStudyTool):
    """VirtualComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4366.VirtualComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4366.VirtualComponentParametricStudyTool]':
