...
class AbstractAssemblyCompoundParametricStudyTool(_4452.PartCompoundParametricStudyTool):
    """AbstractAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4226.AbstractAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4226.AbstractAssemblyParametricStudyTool]':
