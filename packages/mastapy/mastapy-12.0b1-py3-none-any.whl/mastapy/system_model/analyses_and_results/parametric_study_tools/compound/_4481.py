...
class StraightBevelGearCompoundParametricStudyTool(_4389.BevelGearCompoundParametricStudyTool):
    """StraightBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4353.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4353.StraightBevelGearParametricStudyTool]':
