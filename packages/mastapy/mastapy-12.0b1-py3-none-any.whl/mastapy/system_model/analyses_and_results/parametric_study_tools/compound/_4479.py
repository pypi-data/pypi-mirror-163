...
class StraightBevelDiffGearMeshCompoundParametricStudyTool(_4390.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelDiffGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4349.StraightBevelDiffGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4349.StraightBevelDiffGearMeshParametricStudyTool]':
