...
class BoltedJointCompoundParametricStudyTool(_4471.SpecialisedAssemblyCompoundParametricStudyTool):
    """BoltedJointCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4245.BoltedJointParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4245.BoltedJointParametricStudyTool]':
