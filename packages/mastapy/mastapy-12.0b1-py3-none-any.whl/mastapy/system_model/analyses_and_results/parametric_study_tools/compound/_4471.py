...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4373
...
class SpecialisedAssemblyCompoundParametricStudyTool(_4373.AbstractAssemblyCompoundParametricStudyTool):
    """SpecialisedAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4342.SpecialisedAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4342.SpecialisedAssemblyParametricStudyTool]':
