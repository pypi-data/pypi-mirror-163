...
class TorqueConverterCompoundParametricStudyTool(_4410.CouplingCompoundParametricStudyTool):
    """TorqueConverterCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4362.TorqueConverterParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4362.TorqueConverterParametricStudyTool]':
