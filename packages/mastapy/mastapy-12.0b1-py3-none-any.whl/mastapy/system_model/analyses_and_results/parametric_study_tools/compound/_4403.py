...
class ConceptGearMeshCompoundParametricStudyTool(_4432.GearMeshCompoundParametricStudyTool):
    """ConceptGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4255.ConceptGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4255.ConceptGearMeshParametricStudyTool]':
