...
class BevelGearCompoundParametricStudyTool(_4377.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """BevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4243.BevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4243.BevelGearParametricStudyTool]':
