...
class ShaftToMountableComponentConnectionCompoundParametricStudyTool(_4376.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """ShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4341.ShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4341.ShaftToMountableComponentConnectionParametricStudyTool]':
