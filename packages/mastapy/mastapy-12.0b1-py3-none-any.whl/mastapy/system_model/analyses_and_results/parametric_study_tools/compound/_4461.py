...
class PulleyCompoundParametricStudyTool(_4412.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4332.PulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4332.PulleyParametricStudyTool]':
