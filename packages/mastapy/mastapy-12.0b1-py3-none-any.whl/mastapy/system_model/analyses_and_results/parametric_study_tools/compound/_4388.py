...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4241
...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4384.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4241.BevelDifferentialSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4241.BevelDifferentialSunGearParametricStudyTool]':
