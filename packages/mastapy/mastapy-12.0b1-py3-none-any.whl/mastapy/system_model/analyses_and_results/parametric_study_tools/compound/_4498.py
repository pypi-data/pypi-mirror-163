...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4496, _4497, _4433
...
class WormGearSetCompoundParametricStudyTool(_4433.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4369.WormGearSetParametricStudyTool]':
    ...
    @property
    def worm_gears_compound_parametric_study_tool(self) -> 'List[_4496.WormGearCompoundParametricStudyTool]':
    ...
    @property
    def worm_meshes_compound_parametric_study_tool(self) -> 'List[_4497.WormGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4369.WormGearSetParametricStudyTool]':
