...
class ZerolBevelGearCompoundParametricStudyTool(_4389.BevelGearCompoundParametricStudyTool):
    """ZerolBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4371.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4371.ZerolBevelGearParametricStudyTool]':
