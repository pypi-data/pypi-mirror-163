...
class StraightBevelDiffGearCompoundParametricStudyTool(_4389.BevelGearCompoundParametricStudyTool):
    """StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4350.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4350.StraightBevelDiffGearParametricStudyTool]':
