...
class PlanetaryConnectionCompoundParametricStudyTool(_4470.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """PlanetaryConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4327.PlanetaryConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4327.PlanetaryConnectionParametricStudyTool]':
