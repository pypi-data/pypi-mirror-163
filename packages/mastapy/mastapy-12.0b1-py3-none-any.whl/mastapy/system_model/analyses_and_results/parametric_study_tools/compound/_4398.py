...
class ComponentCompoundParametricStudyTool(_4452.PartCompoundParametricStudyTool):
    """ComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4251.ComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4251.ComponentParametricStudyTool]':
