...
class FaceGearMeshCompoundParametricStudyTool(_4432.GearMeshCompoundParametricStudyTool):
    """FaceGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4286.FaceGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4286.FaceGearMeshParametricStudyTool]':
