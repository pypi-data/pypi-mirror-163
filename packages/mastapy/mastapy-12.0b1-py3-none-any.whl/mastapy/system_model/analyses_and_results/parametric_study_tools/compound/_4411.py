...
class CouplingConnectionCompoundParametricStudyTool(_4438.InterMountableComponentConnectionCompoundParametricStudyTool):
    """CouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4263.CouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4263.CouplingConnectionParametricStudyTool]':
