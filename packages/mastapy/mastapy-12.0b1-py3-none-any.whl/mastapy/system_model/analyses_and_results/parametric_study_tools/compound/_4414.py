...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4383
...
class CVTCompoundParametricStudyTool(_4383.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4267.CVTParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4267.CVTParametricStudyTool]':
