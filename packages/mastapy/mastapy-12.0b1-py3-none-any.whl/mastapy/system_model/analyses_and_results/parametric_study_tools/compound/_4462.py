...
class RingPinsCompoundParametricStudyTool(_4450.MountableComponentCompoundParametricStudyTool):
    """RingPinsCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4333.RingPinsParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4333.RingPinsParametricStudyTool]':
