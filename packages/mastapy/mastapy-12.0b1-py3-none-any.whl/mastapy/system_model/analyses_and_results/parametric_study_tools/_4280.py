...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self) -> '_4281.DutyCycleResultsForAllGearSets':
    ...
    @property
    def results_for_root_assembly(self) -> '_4282.DutyCycleResultsForRootAssembly':
    ...
    @property
    def results_for_all_bearings(self) -> 'List[_4283.DutyCycleResultsForSingleBearing]':
    ...
    @property
    def results_for_all_shafts(self) -> 'List[_4284.DutyCycleResultsForSingleShaft]':
