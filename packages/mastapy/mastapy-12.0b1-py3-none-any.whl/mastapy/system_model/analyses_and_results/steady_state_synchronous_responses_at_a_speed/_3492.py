...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3493, _3491, _3497
...
class FaceGearSetSteadyStateSynchronousResponseAtASpeed(_3497.GearSetSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def face_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3493.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3491.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
