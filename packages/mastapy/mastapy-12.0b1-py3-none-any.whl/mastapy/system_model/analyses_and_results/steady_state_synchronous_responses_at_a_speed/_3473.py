...
class ConnectionSteadyStateSynchronousResponseAtASpeed(_7453.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed(self) -> '_3543.SteadyStateSynchronousResponseAtASpeed':
