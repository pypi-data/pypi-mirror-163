...
class ConnectorCompoundSteadyStateSynchronousResponseAtASpeed(_3645.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConnectorCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3474.ConnectorSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3474.ConnectorSteadyStateSynchronousResponseAtASpeed]':
