...
class SpiralBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3584.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3539.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3539.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
