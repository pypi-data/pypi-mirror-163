...
class PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3690.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3525.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3525.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
