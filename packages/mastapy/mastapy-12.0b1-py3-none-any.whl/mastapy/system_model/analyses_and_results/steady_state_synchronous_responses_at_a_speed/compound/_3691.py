...
class WormGearCompoundSteadyStateSynchronousResponseAtASpeed(_3626.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3564.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3564.WormGearSteadyStateSynchronousResponseAtASpeed]':
