...
class ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed(_3593.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3490.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3490.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
