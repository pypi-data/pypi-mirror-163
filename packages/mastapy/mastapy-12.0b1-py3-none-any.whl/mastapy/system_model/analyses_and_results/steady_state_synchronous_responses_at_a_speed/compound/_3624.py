...
class FEPartCompoundSteadyStateSynchronousResponseAtASpeed(_3570.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    """FEPartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3494.FEPartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3494.FEPartSteadyStateSynchronousResponseAtASpeed]':
