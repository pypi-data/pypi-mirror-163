...
class CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3656.PulleyCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3479.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3479.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
