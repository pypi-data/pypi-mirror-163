...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3574
...
class BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3574.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3455.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3455.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
