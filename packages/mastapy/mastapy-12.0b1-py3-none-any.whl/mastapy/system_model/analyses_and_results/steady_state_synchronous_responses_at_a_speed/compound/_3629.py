...
class GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed(_3593.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3499.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3499.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
