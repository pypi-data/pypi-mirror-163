...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6532, _6533, _6528
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis(_6528.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6532.KlingelnbergCycloPalloidSpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6533.KlingelnbergCycloPalloidSpiralBevelGearMeshCriticalSpeedAnalysis]':
