...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6565, _6566, _6476
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6476.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6565.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6566.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
