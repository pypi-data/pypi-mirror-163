...
class StraightBevelSunGearCompoundCriticalSpeedAnalysis(_6694.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6572.StraightBevelSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6572.StraightBevelSunGearCriticalSpeedAnalysis]':
