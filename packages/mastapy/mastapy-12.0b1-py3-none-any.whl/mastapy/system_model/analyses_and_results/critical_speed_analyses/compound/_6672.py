...
class PlanetaryConnectionCompoundCriticalSpeedAnalysis(_6686.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """PlanetaryConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6543.PlanetaryConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6543.PlanetaryConnectionCriticalSpeedAnalysis]':
