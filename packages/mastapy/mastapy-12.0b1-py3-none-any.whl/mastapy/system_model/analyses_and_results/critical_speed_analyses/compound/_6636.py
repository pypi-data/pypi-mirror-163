...
class CylindricalGearCompoundCriticalSpeedAnalysis(_6647.GearCompoundCriticalSpeedAnalysis):
    """CylindricalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6507.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6507.CylindricalGearCriticalSpeedAnalysis]':
