...
class FaceGearMeshCompoundCriticalSpeedAnalysis(_6648.GearMeshCompoundCriticalSpeedAnalysis):
    """FaceGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6514.FaceGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6514.FaceGearMeshCriticalSpeedAnalysis]':
