...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6595
...
class BevelGearSetCompoundCriticalSpeedAnalysis(_6595.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """BevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6476.BevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6476.BevelGearSetCriticalSpeedAnalysis]':
