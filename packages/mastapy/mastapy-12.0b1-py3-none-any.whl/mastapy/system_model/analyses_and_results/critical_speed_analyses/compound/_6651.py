...
class HypoidGearCompoundCriticalSpeedAnalysis(_6593.AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis):
    """HypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6522.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6522.HypoidGearCriticalSpeedAnalysis]':
