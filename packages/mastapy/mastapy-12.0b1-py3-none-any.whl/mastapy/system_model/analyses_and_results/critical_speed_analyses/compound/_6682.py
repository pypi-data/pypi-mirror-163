...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(_6654.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """RollingRingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6552.RollingRingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6552.RollingRingConnectionCriticalSpeedAnalysis]':
