...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6638
...
class PlanetaryGearSetCompoundCriticalSpeedAnalysis(_6638.CylindricalGearSetCompoundCriticalSpeedAnalysis):
    """PlanetaryGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6544.PlanetaryGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6544.PlanetaryGearSetCriticalSpeedAnalysis]':
