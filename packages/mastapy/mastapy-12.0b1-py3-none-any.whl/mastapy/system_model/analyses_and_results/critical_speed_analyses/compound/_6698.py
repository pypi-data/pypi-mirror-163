...
class StraightBevelGearMeshCompoundCriticalSpeedAnalysis(_6606.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6569.StraightBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6569.StraightBevelGearMeshCriticalSpeedAnalysis]':
