...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6636, _6637, _6649
...
class CylindricalGearSetCompoundCriticalSpeedAnalysis(_6649.GearSetCompoundCriticalSpeedAnalysis):
    """CylindricalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6509.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_critical_speed_analysis(self) -> 'List[_6636.CylindricalGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_critical_speed_analysis(self) -> 'List[_6637.CylindricalGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6509.CylindricalGearSetCriticalSpeedAnalysis]':
