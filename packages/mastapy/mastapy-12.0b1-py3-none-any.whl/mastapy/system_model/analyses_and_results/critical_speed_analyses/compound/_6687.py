...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6589
...
class SpecialisedAssemblyCompoundCriticalSpeedAnalysis(_6589.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """SpecialisedAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6558.SpecialisedAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6558.SpecialisedAssemblyCriticalSpeedAnalysis]':
