...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6475
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6594
...
class BevelGearMeshCompoundCriticalSpeedAnalysis(_6594.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """BevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6475.BevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6475.BevelGearMeshCriticalSpeedAnalysis]':
