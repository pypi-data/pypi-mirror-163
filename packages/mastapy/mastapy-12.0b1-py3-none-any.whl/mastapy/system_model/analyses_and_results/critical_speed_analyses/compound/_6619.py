...
class ConceptGearMeshCompoundCriticalSpeedAnalysis(_6648.GearMeshCompoundCriticalSpeedAnalysis):
    """ConceptGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6488.ConceptGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6488.ConceptGearMeshCriticalSpeedAnalysis]':
