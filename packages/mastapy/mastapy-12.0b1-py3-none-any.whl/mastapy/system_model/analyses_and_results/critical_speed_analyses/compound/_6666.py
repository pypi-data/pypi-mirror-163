...
class MountableComponentCompoundCriticalSpeedAnalysis(_6614.ComponentCompoundCriticalSpeedAnalysis):
    """MountableComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6537.MountableComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6537.MountableComponentCriticalSpeedAnalysis]':
