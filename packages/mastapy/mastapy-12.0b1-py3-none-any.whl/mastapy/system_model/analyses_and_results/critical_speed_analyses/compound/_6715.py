...
class ZerolBevelGearCompoundCriticalSpeedAnalysis(_6605.BevelGearCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6586.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6586.ZerolBevelGearCriticalSpeedAnalysis]':
