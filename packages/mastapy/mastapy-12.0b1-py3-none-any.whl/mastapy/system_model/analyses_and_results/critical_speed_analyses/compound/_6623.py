...
class ConicalGearSetCompoundCriticalSpeedAnalysis(_6649.GearSetCompoundCriticalSpeedAnalysis):
    """ConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6492.ConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6492.ConicalGearSetCriticalSpeedAnalysis]':
