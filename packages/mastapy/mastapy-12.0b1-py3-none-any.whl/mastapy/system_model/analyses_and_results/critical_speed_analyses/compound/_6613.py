...
class CoaxialConnectionCompoundCriticalSpeedAnalysis(_6686.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CoaxialConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6482.CoaxialConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6482.CoaxialConnectionCriticalSpeedAnalysis]':
