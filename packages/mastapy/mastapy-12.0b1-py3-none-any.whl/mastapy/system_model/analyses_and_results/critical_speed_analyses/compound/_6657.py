...
class KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis(_6623.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6528.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6528.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
