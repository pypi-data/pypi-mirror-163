...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6694.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6571.StraightBevelPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6571.StraightBevelPlanetGearCriticalSpeedAnalysis]':
