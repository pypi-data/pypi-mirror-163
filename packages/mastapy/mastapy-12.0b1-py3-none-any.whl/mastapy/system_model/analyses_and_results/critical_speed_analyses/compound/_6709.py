...
class TorqueConverterTurbineCompoundCriticalSpeedAnalysis(_6628.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterTurbineCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6580.TorqueConverterTurbineCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6580.TorqueConverterTurbineCriticalSpeedAnalysis]':
