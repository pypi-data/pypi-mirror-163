...
class ConceptCouplingCompoundCriticalSpeedAnalysis(_6626.CouplingCompoundCriticalSpeedAnalysis):
    """ConceptCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6485.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6485.ConceptCouplingCriticalSpeedAnalysis]':
