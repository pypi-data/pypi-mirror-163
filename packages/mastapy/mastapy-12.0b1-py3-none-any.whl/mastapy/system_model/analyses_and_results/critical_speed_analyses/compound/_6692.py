...
class SpringDamperConnectionCompoundCriticalSpeedAnalysis(_6627.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """SpringDamperConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6562.SpringDamperConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6562.SpringDamperConnectionCriticalSpeedAnalysis]':
