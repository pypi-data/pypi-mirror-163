...
class PointLoadCompoundCriticalSpeedAnalysis(_6711.VirtualComponentCompoundCriticalSpeedAnalysis):
    """PointLoadCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6546.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6546.PointLoadCriticalSpeedAnalysis]':
