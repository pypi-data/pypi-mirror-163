...
class ConicalGearMeshCompoundCriticalSpeedAnalysis(_6648.GearMeshCompoundCriticalSpeedAnalysis):
    """ConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6491.ConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6491.ConicalGearMeshCriticalSpeedAnalysis]':
