...
class BoltedJointCompoundCriticalSpeedAnalysis(_6687.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BoltedJointCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6478.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6478.BoltedJointCriticalSpeedAnalysis]':
