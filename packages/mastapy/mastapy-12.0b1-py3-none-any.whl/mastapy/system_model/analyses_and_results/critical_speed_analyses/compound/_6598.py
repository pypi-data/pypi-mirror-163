...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6467
...
class BeltConnectionCompoundCriticalSpeedAnalysis(_6654.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """BeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6467.BeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6467.BeltConnectionCriticalSpeedAnalysis]':
