...
class VirtualComponentCompoundCriticalSpeedAnalysis(_6666.MountableComponentCompoundCriticalSpeedAnalysis):
    """VirtualComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6582.VirtualComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6582.VirtualComponentCriticalSpeedAnalysis]':
