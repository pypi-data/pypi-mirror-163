...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6622
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis(_6622.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6527.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6527.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
