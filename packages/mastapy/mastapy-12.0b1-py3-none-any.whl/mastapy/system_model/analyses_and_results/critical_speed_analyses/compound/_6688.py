...
class SpiralBevelGearCompoundCriticalSpeedAnalysis(_6605.BevelGearCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6559.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6559.SpiralBevelGearCriticalSpeedAnalysis]':
