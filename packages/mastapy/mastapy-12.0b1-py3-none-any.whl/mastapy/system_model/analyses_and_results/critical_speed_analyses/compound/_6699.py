...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6697, _6698, _6607
...
class StraightBevelGearSetCompoundCriticalSpeedAnalysis(_6607.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6570.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6697.StraightBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6698.StraightBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6570.StraightBevelGearSetCriticalSpeedAnalysis]':
