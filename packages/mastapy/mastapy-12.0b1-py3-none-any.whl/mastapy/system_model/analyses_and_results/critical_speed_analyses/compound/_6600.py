...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6469
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6605
...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6605.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6469.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6469.BevelDifferentialGearCriticalSpeedAnalysis]':
