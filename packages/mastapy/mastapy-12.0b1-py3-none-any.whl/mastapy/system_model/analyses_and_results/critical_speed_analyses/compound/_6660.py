...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6658, _6659, _6657
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis(_6657.KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6531.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6658.KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6659.KlingelnbergCycloPalloidHypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6531.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
