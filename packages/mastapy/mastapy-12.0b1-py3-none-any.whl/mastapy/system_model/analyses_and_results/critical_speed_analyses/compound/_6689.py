...
class SpiralBevelGearMeshCompoundCriticalSpeedAnalysis(_6606.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6560.SpiralBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6560.SpiralBevelGearMeshCriticalSpeedAnalysis]':
