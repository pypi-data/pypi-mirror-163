...
class BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis(_6606.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6470.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6470.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
