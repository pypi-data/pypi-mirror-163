...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6487, _6488, _6520
...
class ConceptGearSetCriticalSpeedAnalysis(_6520.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6487.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6488.ConceptGearMeshCriticalSpeedAnalysis]':
