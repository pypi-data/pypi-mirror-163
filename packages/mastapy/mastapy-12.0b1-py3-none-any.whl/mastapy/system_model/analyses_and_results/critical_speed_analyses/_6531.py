...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6529, _6530, _6528
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6528.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6529.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6530.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
