...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6513, _6514, _6520
...
class FaceGearSetCriticalSpeedAnalysis(_6520.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6513.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6514.FaceGearMeshCriticalSpeedAnalysis]':
