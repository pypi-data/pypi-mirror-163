...
class FaceGearCompoundHarmonicAnalysisOfSingleExcitation(_6113.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5978.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5978.FaceGearHarmonicAnalysisOfSingleExcitation]':
