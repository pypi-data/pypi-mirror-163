...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6056
...
class CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation(_6056.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5970.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5970.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
