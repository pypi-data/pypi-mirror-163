...
class CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation(_6113.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5972.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5972.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
