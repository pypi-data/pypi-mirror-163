...
class MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation(_6177.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6002.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6002.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
