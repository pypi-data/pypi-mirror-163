...
class CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation(_6143.PulleyCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5967.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5967.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
