...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6064
...
class CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6064.BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5965.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5965.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
