...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5936
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6071
...
class BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation(_6071.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5936.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5936.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
