...
class CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_6132.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5963.CouplingHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5963.CouplingHalfHarmonicAnalysisOfSingleExcitation]':
