...
from mastapy.system_model.analyses_and_results.power_flows import _4076, _4075, _3982
...
class StraightBevelGearSetPowerFlow(_3982.BevelGearSetPowerFlow):
    """StraightBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4076.StraightBevelGearPowerFlow]':
    ...
    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_4076.StraightBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4075.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_4075.StraightBevelGearMeshPowerFlow]':
