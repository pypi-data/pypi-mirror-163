...
from mastapy.system_model.analyses_and_results.power_flows import _3976, _3975, _3982
...
class BevelDifferentialGearSetPowerFlow(_3982.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3976.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_3976.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3975.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_3975.BevelDifferentialGearMeshPowerFlow]':
