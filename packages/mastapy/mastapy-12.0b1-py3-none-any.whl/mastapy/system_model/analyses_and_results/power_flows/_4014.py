...
from mastapy.system_model.analyses_and_results.power_flows import _4013, _4012, _4025
...
class CylindricalGearSetPowerFlow(_4025.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4013.CylindricalGearPowerFlow]':
    ...
    @property
    def cylindrical_gears_power_flow(self) -> 'List[_4013.CylindricalGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4012.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def cylindrical_meshes_power_flow(self) -> 'List[_4012.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def ratings_for_all_designs(self) -> 'List[_455.CylindricalGearSetRating]':
