...
class RingPinsToDiscConnectionCompoundPowerFlow(_4162.InterMountableComponentConnectionCompoundPowerFlow):
    """RingPinsToDiscConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4057.RingPinsToDiscConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4057.RingPinsToDiscConnectionPowerFlow]':
