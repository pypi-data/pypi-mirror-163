...
class ConicalGearMeshCompoundPowerFlow(_4156.GearMeshCompoundPowerFlow):
    """ConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3996.ConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3996.ConicalGearMeshPowerFlow]':
