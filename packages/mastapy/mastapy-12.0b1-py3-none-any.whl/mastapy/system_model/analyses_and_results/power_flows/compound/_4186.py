...
class RingPinsCompoundPowerFlow(_4174.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4056.RingPinsPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4056.RingPinsPowerFlow]':
