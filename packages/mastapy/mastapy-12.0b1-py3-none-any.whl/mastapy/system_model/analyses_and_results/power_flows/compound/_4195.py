...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4097
...
class SpecialisedAssemblyCompoundPowerFlow(_4097.AbstractAssemblyCompoundPowerFlow):
    """SpecialisedAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4065.SpecialisedAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4065.SpecialisedAssemblyPowerFlow]':
