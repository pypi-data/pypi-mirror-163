...
class DatumCompoundPowerFlow(_4122.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4016.DatumPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4016.DatumPowerFlow]':
