...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4132
...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_4132.ConnectionCompoundPowerFlow):
    """AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3967.AbstractShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3967.AbstractShaftToMountableComponentConnectionPowerFlow]':
