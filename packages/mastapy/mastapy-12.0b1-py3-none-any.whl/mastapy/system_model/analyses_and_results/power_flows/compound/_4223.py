...
class ZerolBevelGearCompoundPowerFlow(_4113.BevelGearCompoundPowerFlow):
    """ZerolBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4095.ZerolBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4095.ZerolBevelGearPowerFlow]':
