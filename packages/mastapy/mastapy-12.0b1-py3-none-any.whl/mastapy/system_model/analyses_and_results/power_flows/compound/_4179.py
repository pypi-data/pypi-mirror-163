...
class PartToPartShearCouplingHalfCompoundPowerFlow(_4136.CouplingHalfCompoundPowerFlow):
    """PartToPartShearCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4046.PartToPartShearCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4046.PartToPartShearCouplingHalfPowerFlow]':
