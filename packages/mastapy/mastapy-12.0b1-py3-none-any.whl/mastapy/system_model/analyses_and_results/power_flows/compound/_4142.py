...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4098
...
class CycloidalDiscCompoundPowerFlow(_4098.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4010.CycloidalDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4010.CycloidalDiscPowerFlow]':
