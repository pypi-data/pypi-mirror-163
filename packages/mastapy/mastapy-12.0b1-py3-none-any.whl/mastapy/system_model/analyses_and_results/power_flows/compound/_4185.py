...
class PulleyCompoundPowerFlow(_4136.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4055.PulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4055.PulleyPowerFlow]':
