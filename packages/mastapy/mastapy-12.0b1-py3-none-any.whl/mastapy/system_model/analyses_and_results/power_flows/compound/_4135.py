...
class CouplingConnectionCompoundPowerFlow(_4162.InterMountableComponentConnectionCompoundPowerFlow):
    """CouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4001.CouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4001.CouplingConnectionPowerFlow]':
