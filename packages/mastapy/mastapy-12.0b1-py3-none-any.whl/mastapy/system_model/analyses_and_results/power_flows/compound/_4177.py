...
class PartToPartShearCouplingCompoundPowerFlow(_4134.CouplingCompoundPowerFlow):
    """PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4047.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4047.PartToPartShearCouplingPowerFlow]':
