...
class PowerLoadCompoundPowerFlow(_4219.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4054.PowerLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4054.PowerLoadPowerFlow]':
