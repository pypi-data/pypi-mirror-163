...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_4121.CoaxialConnectionCompoundPowerFlow):
    """CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4008.CycloidalDiscCentralBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4008.CycloidalDiscCentralBearingConnectionPowerFlow]':
