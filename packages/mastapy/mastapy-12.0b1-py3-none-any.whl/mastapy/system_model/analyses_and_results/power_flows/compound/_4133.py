...
class ConnectorCompoundPowerFlow(_4174.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4000.ConnectorPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4000.ConnectorPowerFlow]':
