...
class StraightBevelDiffGearCompoundPowerFlow(_4113.BevelGearCompoundPowerFlow):
    """StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4073.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4073.StraightBevelDiffGearPowerFlow]':
