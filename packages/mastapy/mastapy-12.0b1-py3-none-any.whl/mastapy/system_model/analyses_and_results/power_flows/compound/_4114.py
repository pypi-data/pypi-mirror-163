...
class BevelGearMeshCompoundPowerFlow(_4102.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """BevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3980.BevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3980.BevelGearMeshPowerFlow]':
