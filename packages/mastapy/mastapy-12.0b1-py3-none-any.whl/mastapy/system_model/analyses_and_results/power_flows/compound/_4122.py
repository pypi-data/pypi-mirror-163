...
class ComponentCompoundPowerFlow(_4176.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3989.ComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3989.ComponentPowerFlow]':
