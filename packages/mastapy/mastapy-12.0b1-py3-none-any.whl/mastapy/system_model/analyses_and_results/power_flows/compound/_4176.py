...
class PartCompoundPowerFlow(_7458.PartCompoundAnalysis):
    """PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4044.PartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4044.PartPowerFlow]':
