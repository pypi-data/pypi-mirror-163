...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4205, _4206, _4115
...
class StraightBevelGearSetCompoundPowerFlow(_4115.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4077.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gears_compound_power_flow(self) -> 'List[_4205.StraightBevelGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_compound_power_flow(self) -> 'List[_4206.StraightBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4077.StraightBevelGearSetPowerFlow]':
