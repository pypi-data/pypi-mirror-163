...
class MassDiscCompoundPowerFlow(_4219.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4040.MassDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4040.MassDiscPowerFlow]':
