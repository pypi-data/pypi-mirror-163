...
from mastapy.system_model.analyses_and_results.power_flows import _3970
...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_4131.ConicalGearSetCompoundPowerFlow):
    """AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3970.AGMAGleasonConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3970.AGMAGleasonConicalGearSetPowerFlow]':
