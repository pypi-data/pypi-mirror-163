...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4202, _4203, _4115
...
class StraightBevelDiffGearSetCompoundPowerFlow(_4115.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4074.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_compound_power_flow(self) -> 'List[_4202.StraightBevelDiffGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_power_flow(self) -> 'List[_4203.StraightBevelDiffGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4074.StraightBevelDiffGearSetPowerFlow]':
