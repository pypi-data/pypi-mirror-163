...
class ClutchConnectionCompoundPowerFlow(_4135.CouplingConnectionCompoundPowerFlow):
    """ClutchConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3985.ClutchConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3985.ClutchConnectionPowerFlow]':
