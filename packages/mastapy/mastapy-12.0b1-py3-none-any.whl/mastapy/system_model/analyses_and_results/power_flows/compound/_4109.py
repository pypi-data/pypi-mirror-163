...
class BevelDifferentialGearMeshCompoundPowerFlow(_4114.BevelGearMeshCompoundPowerFlow):
    """BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3975.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3975.BevelDifferentialGearMeshPowerFlow]':
