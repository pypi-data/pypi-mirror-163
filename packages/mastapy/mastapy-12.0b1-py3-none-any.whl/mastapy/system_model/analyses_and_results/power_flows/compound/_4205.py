...
class StraightBevelGearCompoundPowerFlow(_4113.BevelGearCompoundPowerFlow):
    """StraightBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4076.StraightBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4076.StraightBevelGearPowerFlow]':
