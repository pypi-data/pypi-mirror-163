...
class CVTPulleyCompoundPowerFlow(_4185.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4006.CVTPulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4006.CVTPulleyPowerFlow]':
