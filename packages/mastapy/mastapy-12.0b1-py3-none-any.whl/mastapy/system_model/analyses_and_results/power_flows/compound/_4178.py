...
class PartToPartShearCouplingConnectionCompoundPowerFlow(_4135.CouplingConnectionCompoundPowerFlow):
    """PartToPartShearCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4045.PartToPartShearCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4045.PartToPartShearCouplingConnectionPowerFlow]':
