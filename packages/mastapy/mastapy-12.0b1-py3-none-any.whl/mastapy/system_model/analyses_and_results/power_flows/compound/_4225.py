...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4223, _4224, _4115
...
class ZerolBevelGearSetCompoundPowerFlow(_4115.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4096.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4223.ZerolBevelGearCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4224.ZerolBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4096.ZerolBevelGearSetPowerFlow]':
