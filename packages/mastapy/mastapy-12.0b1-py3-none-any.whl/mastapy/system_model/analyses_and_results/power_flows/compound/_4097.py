...
class AbstractAssemblyCompoundPowerFlow(_4176.PartCompoundPowerFlow):
    """AbstractAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3964.AbstractAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3964.AbstractAssemblyPowerFlow]':
