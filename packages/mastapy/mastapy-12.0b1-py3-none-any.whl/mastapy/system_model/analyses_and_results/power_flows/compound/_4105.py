...
class BearingCompoundPowerFlow(_4133.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3972.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3972.BearingPowerFlow]':
