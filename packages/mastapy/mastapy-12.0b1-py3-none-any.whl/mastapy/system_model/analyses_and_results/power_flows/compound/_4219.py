...
class VirtualComponentCompoundPowerFlow(_4174.MountableComponentCompoundPowerFlow):
    """VirtualComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4090.VirtualComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4090.VirtualComponentPowerFlow]':
