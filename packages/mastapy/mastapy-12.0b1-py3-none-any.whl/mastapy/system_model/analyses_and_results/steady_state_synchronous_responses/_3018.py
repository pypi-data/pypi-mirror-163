...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3019, _3017, _2934
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2934.BevelGearSetSteadyStateSynchronousResponse):
    """SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3019.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3017.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
