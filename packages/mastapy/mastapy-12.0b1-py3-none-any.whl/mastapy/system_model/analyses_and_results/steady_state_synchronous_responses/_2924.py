...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import (
    _2925, _2927, _2929, _2936,
    _2937, _2959, _2940, _2945,
    _2947, _2960, _2963, _2965,
    _2974, _2972, _2975, _2981,
    _2988, _2991, _2993, _2994,
    _2996, _3000, _3003, _3004,
    _3005, _3007, _3009, _3013,
    _3014, _3018, _3022, _3027,
    _3030, _3037, _3040, _3042,
    _3045, _3048, _2917
)
...
class AssemblySteadyStateSynchronousResponse(_2917.AbstractAssemblySteadyStateSynchronousResponse):
    """AssemblySteadyStateSynchronousResponse
    ...
    @property
    def bearings(self) -> 'List[_2925.BearingSteadyStateSynchronousResponse]':
    ...
    @property
    def belt_drives(self) -> 'List[_2927.BeltDriveSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_2929.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bolted_joints(self) -> 'List[_2936.BoltedJointSteadyStateSynchronousResponse]':
    ...
    @property
    def bolts(self) -> 'List[_2937.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def cv_ts(self) -> 'List[_2959.CVTSteadyStateSynchronousResponse]':
    ...
    @property
    def clutches(self) -> 'List[_2940.ClutchSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_couplings(self) -> 'List[_2945.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_2947.ConceptGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_2960.CycloidalAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_2963.CycloidalDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_2965.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def fe_parts(self) -> 'List[_2974.FEPartSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_2972.FaceGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_2975.FlexiblePinAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_2981.HypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_2988.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_2991.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def mass_discs(self) -> 'List[_2993.MassDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def measurement_components(self) -> 'List[_2994.MeasurementComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def oil_seals(self) -> 'List[_2996.OilSealSteadyStateSynchronousResponse]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3000.PartToPartShearCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3003.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def point_loads(self) -> 'List[_3004.PointLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def power_loads(self) -> 'List[_3005.PowerLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def ring_pins(self) -> 'List[_3007.RingPinsSteadyStateSynchronousResponse]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3009.RollingRingAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3013.ShaftHubConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def shafts(self) -> 'List[_3014.ShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3018.SpiralBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3022.SpringDamperSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3027.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3030.StraightBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def synchronisers(self) -> 'List[_3037.SynchroniserSteadyStateSynchronousResponse]':
    ...
    @property
    def torque_converters(self) -> 'List[_3040.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3042.UnbalancedMassSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3045.WormGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3048.ZerolBevelGearSetSteadyStateSynchronousResponse]':
