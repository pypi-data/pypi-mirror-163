...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3049, _3047, _2934
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_2934.BevelGearSetSteadyStateSynchronousResponse):
    """ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3049.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3047.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
