...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3112, _3113, _3056
...
class HypoidGearSetCompoundSteadyStateSynchronousResponse(_3056.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """HypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2981.HypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_3112.HypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3113.HypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2981.HypoidGearSetSteadyStateSynchronousResponse]':
