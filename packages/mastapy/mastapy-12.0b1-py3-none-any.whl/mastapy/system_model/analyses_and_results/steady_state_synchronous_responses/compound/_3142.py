...
class RollingRingCompoundSteadyStateSynchronousResponse(_3089.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """RollingRingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3011.RollingRingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3011.RollingRingSteadyStateSynchronousResponse]':
