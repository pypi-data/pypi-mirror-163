...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3066
...
class ZerolBevelGearCompoundSteadyStateSynchronousResponse(_3066.BevelGearCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3049.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3049.ZerolBevelGearSteadyStateSynchronousResponse]':
