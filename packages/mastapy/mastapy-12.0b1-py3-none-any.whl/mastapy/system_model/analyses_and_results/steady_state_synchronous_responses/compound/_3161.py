...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse(_3155.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3032.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3032.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
