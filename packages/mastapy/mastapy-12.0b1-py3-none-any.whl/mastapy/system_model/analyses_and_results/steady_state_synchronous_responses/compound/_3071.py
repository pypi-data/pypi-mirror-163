...
class ClutchCompoundSteadyStateSynchronousResponse(_3087.CouplingCompoundSteadyStateSynchronousResponse):
    """ClutchCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2940.ClutchSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2940.ClutchSteadyStateSynchronousResponse]':
