...
class VirtualComponentCompoundSteadyStateSynchronousResponse(_3127.MountableComponentCompoundSteadyStateSynchronousResponse):
    """VirtualComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3043.VirtualComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3043.VirtualComponentSteadyStateSynchronousResponse]':
