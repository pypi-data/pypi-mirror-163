...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3087
...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponse(_3087.CouplingCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3000.PartToPartShearCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3000.PartToPartShearCouplingSteadyStateSynchronousResponse]':
