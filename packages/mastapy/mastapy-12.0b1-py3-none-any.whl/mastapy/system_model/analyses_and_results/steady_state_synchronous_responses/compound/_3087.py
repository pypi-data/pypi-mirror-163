...
class CouplingCompoundSteadyStateSynchronousResponse(_3148.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """CouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2956.CouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2956.CouplingSteadyStateSynchronousResponse]':
