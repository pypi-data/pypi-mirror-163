...
class MassDiscCompoundSteadyStateSynchronousResponse(_3172.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MassDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2993.MassDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2993.MassDiscSteadyStateSynchronousResponse]':
