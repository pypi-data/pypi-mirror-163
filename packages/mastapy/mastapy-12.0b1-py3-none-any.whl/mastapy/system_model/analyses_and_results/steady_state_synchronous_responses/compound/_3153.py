...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_3088.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3020.SpringDamperConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3020.SpringDamperConnectionSteadyStateSynchronousResponse]':
