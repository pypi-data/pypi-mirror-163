...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponse(_3099.CylindricalGearSetCompoundSteadyStateSynchronousResponse):
    """PlanetaryGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3002.PlanetaryGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3002.PlanetaryGearSetSteadyStateSynchronousResponse]':
