...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse(_3075.ComponentCompoundSteadyStateSynchronousResponse):
    """AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2918.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2918.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
