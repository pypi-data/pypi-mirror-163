...
class AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse(_3083.ConicalGearMeshCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2921.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2921.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
