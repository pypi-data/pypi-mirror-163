...
class RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponse(_3115.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3008.RingPinsToDiscConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3008.RingPinsToDiscConnectionSteadyStateSynchronousResponse]':
