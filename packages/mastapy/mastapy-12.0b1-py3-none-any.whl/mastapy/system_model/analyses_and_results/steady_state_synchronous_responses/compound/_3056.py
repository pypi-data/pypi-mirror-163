...
class AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse(_3084.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2922.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2922.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
