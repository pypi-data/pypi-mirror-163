...
class AbstractAssemblyCompoundSteadyStateSynchronousResponse(_3129.PartCompoundSteadyStateSynchronousResponse):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2917.AbstractAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2917.AbstractAssemblySteadyStateSynchronousResponse]':
