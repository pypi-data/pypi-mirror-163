...
class ConicalGearSetCompoundSteadyStateSynchronousResponse(_3110.GearSetCompoundSteadyStateSynchronousResponse):
    """ConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2950.ConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2950.ConicalGearSetSteadyStateSynchronousResponse]':
