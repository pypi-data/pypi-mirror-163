...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2929
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3061, _3062, _3068
...
class BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse(_3068.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2929.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gears_compound_steady_state_synchronous_response(self) -> 'List[_3061.BevelDifferentialGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3062.BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2929.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
