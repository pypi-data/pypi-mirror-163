...
from mastapy import _7471, _7465
from mastapy.system_model import _2147
from mastapy.system_model.analyses_and_results import _2590
...
class SingleAnalysis(_7465.MarshalByRefObjectPermanent):
    """SingleAnalysis
    ...
    def perform_analysis_with_progress(self, task_progress: '_7471.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2147.DesignEntity') -> '_2590.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2590.DesignEntityAnalysis') -> '_2590.DesignEntityAnalysis':
        """ 'ResultsFor' is the original name of this method.
