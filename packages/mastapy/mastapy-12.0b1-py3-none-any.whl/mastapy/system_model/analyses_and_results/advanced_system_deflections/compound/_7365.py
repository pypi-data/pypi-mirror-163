...
class CylindricalGearCompoundAdvancedSystemDeflection(_7376.GearCompoundAdvancedSystemDeflection):
    """CylindricalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_rating(self) -> '_446.CylindricalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7233.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7233.CylindricalGearAdvancedSystemDeflection]':
