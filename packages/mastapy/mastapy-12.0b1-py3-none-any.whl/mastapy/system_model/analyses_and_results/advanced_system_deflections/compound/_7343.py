...
class ComponentCompoundAdvancedSystemDeflection(_7397.PartCompoundAdvancedSystemDeflection):
    """ComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7210.ComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7210.ComponentAdvancedSystemDeflection]':
