...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7417, _7418, _7336
...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(_7336.BevelGearSetCompoundAdvancedSystemDeflection):
    """SpiralBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7289.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7417.SpiralBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7418.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7289.SpiralBevelGearSetAdvancedSystemDeflection]':
