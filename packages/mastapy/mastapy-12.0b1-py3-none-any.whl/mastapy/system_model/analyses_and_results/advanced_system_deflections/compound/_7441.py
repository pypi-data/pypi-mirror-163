...
class WormGearCompoundAdvancedSystemDeflection(_7376.GearCompoundAdvancedSystemDeflection):
    """WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_363.WormGearDutyCycleRating':
    ...
    @property
    def worm_gear_duty_cycle_rating(self) -> '_363.WormGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7312.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7312.WormGearAdvancedSystemDeflection]':
