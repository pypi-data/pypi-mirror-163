...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7441, _7442, _7378
...
class WormGearSetCompoundAdvancedSystemDeflection(_7378.GearSetCompoundAdvancedSystemDeflection):
    """WormGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7314.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def worm_gears_compound_advanced_system_deflection(self) -> 'List[_7441.WormGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_advanced_system_deflection(self) -> 'List[_7442.WormGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7314.WormGearSetAdvancedSystemDeflection]':
