...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7325
...
class RootAssemblyCompoundAdvancedSystemDeflection(_7325.AssemblyCompoundAdvancedSystemDeflection):
    """RootAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7282.RootAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7282.RootAssemblyAdvancedSystemDeflection]':
