...
class CouplingConnectionCompoundAdvancedSystemDeflection(_7383.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7224.CouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7224.CouplingConnectionAdvancedSystemDeflection]':
