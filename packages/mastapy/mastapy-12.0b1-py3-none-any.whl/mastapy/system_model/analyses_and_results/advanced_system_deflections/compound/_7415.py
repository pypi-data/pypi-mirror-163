...
class ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7321.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7285.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7285.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
