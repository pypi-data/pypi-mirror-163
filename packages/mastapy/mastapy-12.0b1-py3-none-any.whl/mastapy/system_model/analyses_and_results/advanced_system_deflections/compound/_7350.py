...
class ConicalGearCompoundAdvancedSystemDeflection(_7376.GearCompoundAdvancedSystemDeflection):
    """ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_528.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_gear_duty_cycle_rating(self) -> '_528.ConicalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7217.ConicalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7217.ConicalGearAdvancedSystemDeflection]':
