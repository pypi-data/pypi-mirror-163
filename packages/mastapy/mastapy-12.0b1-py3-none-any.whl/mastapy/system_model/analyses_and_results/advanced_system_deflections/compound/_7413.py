...
class ShaftCompoundAdvancedSystemDeflection(_7319.AbstractShaftCompoundAdvancedSystemDeflection):
    """ShaftCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7283.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7283.ShaftAdvancedSystemDeflection]':
