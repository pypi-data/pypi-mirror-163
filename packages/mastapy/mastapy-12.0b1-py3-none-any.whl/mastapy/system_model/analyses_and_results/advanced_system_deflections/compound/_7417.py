...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7334.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7287.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7287.SpiralBevelGearAdvancedSystemDeflection]':
