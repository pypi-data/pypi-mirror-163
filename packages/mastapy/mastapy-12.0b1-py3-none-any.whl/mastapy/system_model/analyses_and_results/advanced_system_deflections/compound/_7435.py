...
class TorqueConverterCompoundAdvancedSystemDeflection(_7355.CouplingCompoundAdvancedSystemDeflection):
    """TorqueConverterCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7305.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7305.TorqueConverterAdvancedSystemDeflection]':
