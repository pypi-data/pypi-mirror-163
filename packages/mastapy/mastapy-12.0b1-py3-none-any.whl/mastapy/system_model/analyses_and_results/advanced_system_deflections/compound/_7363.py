...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7319
...
class CycloidalDiscCompoundAdvancedSystemDeflection(_7319.AbstractShaftCompoundAdvancedSystemDeflection):
    """CycloidalDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7230.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7230.CycloidalDiscAdvancedSystemDeflection]':
