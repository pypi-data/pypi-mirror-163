...
class TorqueConverterConnectionCompoundAdvancedSystemDeflection(_7356.CouplingConnectionCompoundAdvancedSystemDeflection):
    """TorqueConverterConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7306.TorqueConverterConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7306.TorqueConverterConnectionAdvancedSystemDeflection]':
