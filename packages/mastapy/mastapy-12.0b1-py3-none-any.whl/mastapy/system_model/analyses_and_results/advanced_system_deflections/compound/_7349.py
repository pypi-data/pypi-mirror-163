...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7347, _7348, _7378
...
class ConceptGearSetCompoundAdvancedSystemDeflection(_7378.GearSetCompoundAdvancedSystemDeflection):
    """ConceptGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7216.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def concept_gears_compound_advanced_system_deflection(self) -> 'List[_7347.ConceptGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_advanced_system_deflection(self) -> 'List[_7348.ConceptGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7216.ConceptGearSetAdvancedSystemDeflection]':
