...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7371, _7372, _7378
...
class FaceGearSetCompoundAdvancedSystemDeflection(_7378.GearSetCompoundAdvancedSystemDeflection):
    """FaceGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7242.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def face_gears_compound_advanced_system_deflection(self) -> 'List[_7371.FaceGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_compound_advanced_system_deflection(self) -> 'List[_7372.FaceGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7242.FaceGearSetAdvancedSystemDeflection]':
