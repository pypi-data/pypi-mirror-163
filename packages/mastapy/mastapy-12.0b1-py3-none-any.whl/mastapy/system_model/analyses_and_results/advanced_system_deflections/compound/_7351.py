...
class ConicalGearMeshCompoundAdvancedSystemDeflection(_7377.GearMeshCompoundAdvancedSystemDeflection):
    """ConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7218.ConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7218.ConicalGearMeshAdvancedSystemDeflection]':
