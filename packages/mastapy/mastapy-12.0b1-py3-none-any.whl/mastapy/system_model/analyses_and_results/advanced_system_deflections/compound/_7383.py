...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7353.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7252.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7252.InterMountableComponentConnectionAdvancedSystemDeflection]':
