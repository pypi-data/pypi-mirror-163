...
class RollingRingConnectionCompoundAdvancedSystemDeflection(_7383.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RollingRingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7281.RollingRingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7281.RollingRingConnectionAdvancedSystemDeflection]':
