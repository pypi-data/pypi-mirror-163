...
class PartToPartShearCouplingCompoundAdvancedSystemDeflection(_7355.CouplingCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7268.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7268.PartToPartShearCouplingAdvancedSystemDeflection]':
