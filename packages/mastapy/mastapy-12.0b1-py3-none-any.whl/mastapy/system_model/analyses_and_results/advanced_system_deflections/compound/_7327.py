...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7194
...
class BeltConnectionCompoundAdvancedSystemDeflection(_7383.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """BeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7194.BeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7194.BeltConnectionAdvancedSystemDeflection]':
