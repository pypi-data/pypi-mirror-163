...
class ConceptGearCompoundAdvancedSystemDeflection(_7376.GearCompoundAdvancedSystemDeflection):
    """ConceptGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7214.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7214.ConceptGearAdvancedSystemDeflection]':
