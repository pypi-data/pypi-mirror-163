...
class CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection(_7342.CoaxialConnectionCompoundAdvancedSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7231.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7231.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
