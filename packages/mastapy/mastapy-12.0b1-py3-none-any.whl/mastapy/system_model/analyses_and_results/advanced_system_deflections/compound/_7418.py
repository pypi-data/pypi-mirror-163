...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7335.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7288.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7288.SpiralBevelGearMeshAdvancedSystemDeflection]':
