...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7423.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7299.StraightBevelPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7299.StraightBevelPlanetGearAdvancedSystemDeflection]':
