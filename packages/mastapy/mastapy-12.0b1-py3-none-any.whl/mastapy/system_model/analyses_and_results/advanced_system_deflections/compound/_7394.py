...
class MeasurementComponentCompoundAdvancedSystemDeflection(_7440.VirtualComponentCompoundAdvancedSystemDeflection):
    """MeasurementComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7264.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7264.MeasurementComponentAdvancedSystemDeflection]':
