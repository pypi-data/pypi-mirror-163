...
class CVTPulleyCompoundAdvancedSystemDeflection(_7406.PulleyCompoundAdvancedSystemDeflection):
    """CVTPulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7228.CVTPulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7228.CVTPulleyAdvancedSystemDeflection]':
