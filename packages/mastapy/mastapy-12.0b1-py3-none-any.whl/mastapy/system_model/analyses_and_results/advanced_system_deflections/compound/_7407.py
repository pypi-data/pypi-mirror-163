...
class RingPinsCompoundAdvancedSystemDeflection(_7395.MountableComponentCompoundAdvancedSystemDeflection):
    """RingPinsCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7277.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7277.RingPinsAdvancedSystemDeflection]':
