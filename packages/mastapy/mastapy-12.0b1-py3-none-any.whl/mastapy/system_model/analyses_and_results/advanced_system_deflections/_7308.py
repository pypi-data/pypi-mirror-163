...
class TorqueConverterTurbineAdvancedSystemDeflection(_7225.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2765.TorqueConverterTurbineSystemDeflection]':
