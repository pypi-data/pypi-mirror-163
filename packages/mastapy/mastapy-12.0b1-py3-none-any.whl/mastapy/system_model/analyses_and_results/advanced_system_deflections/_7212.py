...
class ConceptCouplingConnectionAdvancedSystemDeflection(_7224.CouplingConnectionAdvancedSystemDeflection):
    """ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2651.ConceptCouplingConnectionSystemDeflection]':
