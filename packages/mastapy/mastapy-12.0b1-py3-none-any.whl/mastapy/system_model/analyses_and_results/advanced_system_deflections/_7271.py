...
class PlanetaryConnectionAdvancedSystemDeflection(_7285.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """PlanetaryConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2723.PlanetaryConnectionSystemDeflection]':
