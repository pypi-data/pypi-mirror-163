...
class FEPartAdvancedSystemDeflection(_7184.AbstractShaftOrHousingAdvancedSystemDeflection):
    """FEPartAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2691.FEPartSystemDeflection]':
