...
class MeasurementComponentAdvancedSystemDeflection(_7311.VirtualComponentAdvancedSystemDeflection):
    """MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2714.MeasurementComponentSystemDeflection]':
