...
class BeltConnectionAdvancedSystemDeflection(_7252.InterMountableComponentConnectionAdvancedSystemDeflection):
    """BeltConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2633.BeltConnectionSystemDeflection]':
