...
class SynchroniserAdvancedSystemDeflection(_7286.SpecialisedAssemblyAdvancedSystemDeflection):
    """SynchroniserAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2758.SynchroniserSystemDeflection]':
