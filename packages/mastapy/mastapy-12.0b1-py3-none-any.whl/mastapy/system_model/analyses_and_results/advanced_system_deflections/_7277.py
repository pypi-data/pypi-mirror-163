...
class RingPinsAdvancedSystemDeflection(_7265.MountableComponentAdvancedSystemDeflection):
    """RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2728.RingPinsSystemDeflection]':
