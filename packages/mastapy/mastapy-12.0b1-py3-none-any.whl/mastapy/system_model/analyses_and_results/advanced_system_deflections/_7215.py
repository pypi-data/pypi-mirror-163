...
class ConceptGearMeshAdvancedSystemDeflection(_7246.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2654.ConceptGearMeshSystemDeflection]':
