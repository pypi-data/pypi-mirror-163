...
class PulleyAdvancedSystemDeflection(_7225.CouplingHalfAdvancedSystemDeflection):
    """PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2727.PulleySystemDeflection]':
