...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_840.UseAdvancedLTCAOptions':
        """UseAdvancedLTCAOptions: 'UseAdvancedLTCA' is the original name of this property."""

        temp = self.wrapped.UseAdvancedLTCA
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_840.UseAdvancedLTCAOptions)(value) if value is not None else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_840.UseAdvancedLTCAOptions'):
