...
class PlanetCarrierAdvancedSystemDeflection(_7265.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2724.PlanetCarrierSystemDeflection]':
