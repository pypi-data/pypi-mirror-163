...
class ShaftHubConnectionAdvancedSystemDeflection(_7221.ConnectorAdvancedSystemDeflection):
    """ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2735.ShaftHubConnectionSystemDeflection]':
