...
class ConceptCouplingAdvancedSystemDeflection(_7223.CouplingAdvancedSystemDeflection):
    """ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2653.ConceptCouplingSystemDeflection]':
