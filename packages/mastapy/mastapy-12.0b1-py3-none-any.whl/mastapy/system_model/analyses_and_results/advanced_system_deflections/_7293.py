...
class StraightBevelDiffGearAdvancedSystemDeflection(_7201.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2749.StraightBevelDiffGearSystemDeflection]':
