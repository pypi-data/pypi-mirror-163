...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7186
...
from mastapy.math_utility.convergence import _1535, _1534
from mastapy.utility_gui import _1804
from mastapy.system_model.drawing import _2183
...
class PartAdvancedSystemDeflection(_7460.PartStaticLoadAnalysisCase):
    """PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_7186.AdvancedSystemDeflection':
    ...
    @property
    def data_logger(self) -> '_1535.DataLogger':
        ...
        if _1535.DataLogger.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast data_logger to DataLogger. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    def create_viewable(self) -> '_2183.AdvancedSystemDeflectionViewable':
