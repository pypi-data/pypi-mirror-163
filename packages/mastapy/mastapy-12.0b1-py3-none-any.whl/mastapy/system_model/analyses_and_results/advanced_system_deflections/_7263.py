...
class MassDiscAdvancedSystemDeflection(_7311.VirtualComponentAdvancedSystemDeflection):
    """MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2713.MassDiscSystemDeflection]':
