...
class RingPinsAdvancedTimeSteppingAnalysisForModulation(_7001.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6857.RingPinsLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2728.RingPinsSystemDeflection':
