...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6986, _6987, _6928
...
class HypoidGearSetAdvancedTimeSteppingAnalysisForModulation(_6928.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def hypoid_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6986.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6987.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
