...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_6960.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2653.ConceptCouplingSystemDeflection':
