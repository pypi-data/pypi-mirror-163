...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6959.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2735.ShaftHubConnectionSystemDeflection':
