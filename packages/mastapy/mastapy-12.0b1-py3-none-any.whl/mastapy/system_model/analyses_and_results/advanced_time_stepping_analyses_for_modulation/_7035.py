...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7029.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2753.StraightBevelPlanetGearSystemDeflection':
