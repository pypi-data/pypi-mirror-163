...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6961.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2645.ClutchConnectionSystemDeflection':
