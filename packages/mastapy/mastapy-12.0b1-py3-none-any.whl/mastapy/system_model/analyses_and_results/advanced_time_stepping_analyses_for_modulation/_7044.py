...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(_6962.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6889.TorqueConverterTurbineLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2765.TorqueConverterTurbineSystemDeflection':
