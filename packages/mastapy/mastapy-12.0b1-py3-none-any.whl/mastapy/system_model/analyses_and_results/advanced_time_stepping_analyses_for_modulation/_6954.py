...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6952, _6953, _6983
...
class ConceptGearSetAdvancedTimeSteppingAnalysisForModulation(_6983.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2655.ConceptGearSetSystemDeflection':
    ...
    @property
    def concept_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6952.ConceptGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6953.ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation]':
