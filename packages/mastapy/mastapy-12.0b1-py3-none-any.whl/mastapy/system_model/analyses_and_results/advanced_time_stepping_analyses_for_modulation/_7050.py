...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6939.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2775.ZerolBevelGearSystemDeflection':
