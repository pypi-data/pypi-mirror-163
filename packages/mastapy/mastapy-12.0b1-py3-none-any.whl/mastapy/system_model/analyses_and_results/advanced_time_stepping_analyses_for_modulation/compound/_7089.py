...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6959.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6959.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
