...
class GearCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6981.GearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6981.GearAdvancedTimeSteppingAnalysisForModulation]':
