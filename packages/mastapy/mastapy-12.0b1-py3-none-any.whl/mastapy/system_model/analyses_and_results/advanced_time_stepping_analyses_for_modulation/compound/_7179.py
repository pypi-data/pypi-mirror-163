...
class ZerolBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7069.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7050.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7050.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
