...
class AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7132.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6919.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6919.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation]':
