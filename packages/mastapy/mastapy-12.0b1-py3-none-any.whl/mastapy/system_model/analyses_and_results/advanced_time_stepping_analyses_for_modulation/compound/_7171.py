...
class TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2292.TorqueConverterConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7042.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7042.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
