...
from mastapy.system_model.analyses_and_results.analysis_cases import _7458
...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7458.PartCompoundAnalysis):
    """PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7003.PartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7003.PartAdvancedTimeSteppingAnalysisForModulation]':
