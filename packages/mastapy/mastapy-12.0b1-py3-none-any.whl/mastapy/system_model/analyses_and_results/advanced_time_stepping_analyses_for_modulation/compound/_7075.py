...
class ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2282.ClutchConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6945.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6945.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
