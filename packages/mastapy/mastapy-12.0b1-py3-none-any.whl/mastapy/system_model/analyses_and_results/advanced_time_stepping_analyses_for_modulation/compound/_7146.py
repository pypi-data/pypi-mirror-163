...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7118.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2232.RollingRingConnection':
    ...
    @property
    def connection_design(self) -> '_2232.RollingRingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7017.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7017.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
