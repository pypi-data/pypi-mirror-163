...
class RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation(_7130.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2509.RingPins':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7013.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7013.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
