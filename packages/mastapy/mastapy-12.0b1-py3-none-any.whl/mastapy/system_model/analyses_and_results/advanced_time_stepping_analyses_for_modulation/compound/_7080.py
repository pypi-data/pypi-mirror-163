...
class ConceptCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2284.ConceptCouplingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6950.ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6950.ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
