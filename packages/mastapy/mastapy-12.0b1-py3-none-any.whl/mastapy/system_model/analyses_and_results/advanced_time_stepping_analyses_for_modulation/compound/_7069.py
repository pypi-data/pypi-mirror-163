...
class BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7057.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6939.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6939.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
