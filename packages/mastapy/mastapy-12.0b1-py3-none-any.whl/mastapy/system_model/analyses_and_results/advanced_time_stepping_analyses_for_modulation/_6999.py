...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_7046.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2713.MassDiscSystemDeflection':
