...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_7021.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2723.PlanetaryConnectionSystemDeflection':
