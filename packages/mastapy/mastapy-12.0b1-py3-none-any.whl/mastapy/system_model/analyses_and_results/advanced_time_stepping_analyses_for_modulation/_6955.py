...
class ConicalGearAdvancedTimeSteppingAnalysisForModulation(_6981.GearAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2660.ConicalGearSystemDeflection':
