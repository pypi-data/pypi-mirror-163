...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6982.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2770.WormGearMeshSystemDeflection':
