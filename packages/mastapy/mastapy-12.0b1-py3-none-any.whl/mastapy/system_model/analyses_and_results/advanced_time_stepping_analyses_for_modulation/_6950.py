...
class ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6961.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2651.ConceptCouplingConnectionSystemDeflection':
