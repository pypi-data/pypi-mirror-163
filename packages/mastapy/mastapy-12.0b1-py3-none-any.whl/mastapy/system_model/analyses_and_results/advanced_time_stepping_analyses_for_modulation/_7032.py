...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(_6939.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2752.StraightBevelGearSystemDeflection':
