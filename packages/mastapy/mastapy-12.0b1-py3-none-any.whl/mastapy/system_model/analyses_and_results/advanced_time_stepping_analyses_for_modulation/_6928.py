...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6957.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2629.AGMAGleasonConicalGearSetSystemDeflection':
