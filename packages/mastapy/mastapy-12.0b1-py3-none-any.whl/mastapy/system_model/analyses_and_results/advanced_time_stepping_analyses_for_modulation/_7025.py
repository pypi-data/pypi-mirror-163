...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7023, _7024, _6941
...
class SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6941.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def spiral_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7023.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7024.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
