...
class BevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6927.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2640.BevelGearMeshSystemDeflection':
