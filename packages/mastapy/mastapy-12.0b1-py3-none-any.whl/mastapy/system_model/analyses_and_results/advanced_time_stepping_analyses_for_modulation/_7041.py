...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6960.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2764.TorqueConverterSystemDeflection':
