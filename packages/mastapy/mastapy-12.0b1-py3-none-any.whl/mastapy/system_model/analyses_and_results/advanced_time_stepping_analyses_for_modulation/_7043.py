...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_6962.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2763.TorqueConverterPumpSystemDeflection':
