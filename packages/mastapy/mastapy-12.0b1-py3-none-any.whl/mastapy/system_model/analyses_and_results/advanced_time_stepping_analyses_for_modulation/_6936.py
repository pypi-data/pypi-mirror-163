...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6934, _6935, _6941
...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(_6941.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6934.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6935.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
