...
class CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(_7022.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2669.CycloidalAssemblySystemDeflection':
