...
class RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation(_6989.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2729.RingPinsToDiscConnectionSystemDeflection':
