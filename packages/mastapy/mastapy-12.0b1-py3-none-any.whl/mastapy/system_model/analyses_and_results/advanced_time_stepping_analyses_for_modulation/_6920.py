...
from mastapy.system_model.analyses_and_results.system_deflections import _2626, _2672, _2738
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6921.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2626.AbstractShaftSystemDeflection':
