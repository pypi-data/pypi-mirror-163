...
from mastapy.bearings.tolerances import _1867
...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def roundness_specification(self) -> '_1867.RoundnessSpecification':
    ...
    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6856.RingPinManufacturingError]':
