...
from mastapy.system_model.analyses_and_results.static_loads import _6829, _6830, _6828
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6828.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6829.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6829.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6830.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
