...
from mastapy.system_model.analyses_and_results.static_loads import _6824, _6812, _6793
...
class HarmonicLoadDataFluxImport(_6812.HarmonicLoadDataCSVImport['_6793.ElectricMachineHarmonicLoadFluxImportOptions']):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6824.InnerDiameterReference':
        ...
        return constructor.new_from_mastapy_type(_6824.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6824.InnerDiameterReference'):
