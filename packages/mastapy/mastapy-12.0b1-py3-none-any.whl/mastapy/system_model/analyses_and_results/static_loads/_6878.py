...
from mastapy.system_model.analyses_and_results.static_loads import _6876, _6877, _6744
...
class StraightBevelGearSetLoadCase(_6744.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6876.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6876.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6877.StraightBevelGearMeshLoadCase]':
