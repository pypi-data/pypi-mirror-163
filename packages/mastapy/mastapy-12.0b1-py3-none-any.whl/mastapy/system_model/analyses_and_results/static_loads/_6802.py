...
class FlexiblePinAssemblyLoadCase(_6866.SpecialisedAssemblyLoadCase):
    """FlexiblePinAssemblyLoadCase
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1550.LoadCaseOverrideOption':
    ...
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1550.LoadCaseOverrideOption'):
