...
class ConicalGearSetHarmonicLoadData(_6808.GearSetHarmonicLoadData):
    """ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_340.TESpecificationType':
        ...
        return constructor.new_from_mastapy_type(_340.TESpecificationType)(value) if value is not None else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_340.TESpecificationType'):
