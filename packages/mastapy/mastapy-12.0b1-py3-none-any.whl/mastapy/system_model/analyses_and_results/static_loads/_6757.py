...
from mastapy.system_model.analyses_and_results.static_loads import _6755, _6756, _6809
...
class ConceptGearSetLoadCase(_6809.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6755.ConceptGearLoadCase]':
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6755.ConceptGearLoadCase]':
    ...
    @property
    def concept_meshes_load_case(self) -> 'List[_6756.ConceptGearMeshLoadCase]':
