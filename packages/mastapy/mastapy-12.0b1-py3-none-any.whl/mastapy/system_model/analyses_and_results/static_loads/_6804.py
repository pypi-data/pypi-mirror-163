...
class GearLoadCase(_6838.MountableComponentLoadCase):
    """GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6805.GearManufactureError':
        ...
        if _6805.GearManufactureError.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6759.ConicalGearManufactureError':
        ...
        temp = self.wrapped.GearManufactureErrors
        if _6759.ConicalGearManufactureError.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6776.CylindricalGearManufactureError':
        ...
        temp = self.wrapped.GearManufactureErrors
        if _6776.CylindricalGearManufactureError.TYPE not in temp.__class__.__mro__:
