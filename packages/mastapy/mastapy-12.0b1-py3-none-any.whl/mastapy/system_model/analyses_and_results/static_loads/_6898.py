...
from mastapy.system_model.analyses_and_results.static_loads import _6896, _6897, _6809
...
class WormGearSetLoadCase(_6809.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6896.WormGearLoadCase]':
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6896.WormGearLoadCase]':
    ...
    @property
    def worm_meshes_load_case(self) -> 'List[_6897.WormGearMeshLoadCase]':
