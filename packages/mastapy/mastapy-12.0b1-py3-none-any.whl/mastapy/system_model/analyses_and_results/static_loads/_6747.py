...
class ClutchConnectionLoadCase(_6765.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self) -> '_1493.Vector2DListAccessor':
    ...
    def clutch_pressures(self, value: '_1493.Vector2DListAccessor'):
