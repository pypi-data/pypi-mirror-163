...
from mastapy.system_model.analyses_and_results.static_loads import _6832, _6833, _6828
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_6828.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6832.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_6832.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_6833.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
