...
class TorqueConverterLoadCase(_6767.CouplingLoadCase):
    """TorqueConverterLoadCase
    ...
    @property
    def lock_up_clutch_pressure_time_profile(self) -> '_1493.Vector2DListAccessor':
    ...
    def lock_up_clutch_pressure_time_profile(self, value: '_1493.Vector2DListAccessor'):
