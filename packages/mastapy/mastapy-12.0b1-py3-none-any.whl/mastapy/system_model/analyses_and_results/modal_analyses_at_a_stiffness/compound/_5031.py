...
class TorqueConverterCompoundModalAnalysisAtAStiffness(_4951.CouplingCompoundModalAnalysisAtAStiffness):
    """TorqueConverterCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4903.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4903.TorqueConverterModalAnalysisAtAStiffness]':
