...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4931.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4911.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4911.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
