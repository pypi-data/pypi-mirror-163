...
class PlanetaryConnectionCompoundModalAnalysisAtAStiffness(_5011.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """PlanetaryConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4868.PlanetaryConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4868.PlanetaryConnectionModalAnalysisAtAStiffness]':
