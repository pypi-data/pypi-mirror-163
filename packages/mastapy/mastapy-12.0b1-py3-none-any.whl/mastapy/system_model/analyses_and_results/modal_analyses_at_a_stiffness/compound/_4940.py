...
class ConceptCouplingCompoundModalAnalysisAtAStiffness(_4951.CouplingCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4812.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4812.ConceptCouplingModalAnalysisAtAStiffness]':
