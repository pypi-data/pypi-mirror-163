...
class SpiralBevelGearCompoundModalAnalysisAtAStiffness(_4930.BevelGearCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4885.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4885.SpiralBevelGearModalAnalysisAtAStiffness]':
