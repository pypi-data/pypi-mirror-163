...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4791
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import (
    _4922, _4924, _4927, _4934,
    _4933, _4955, _4935, _4940,
    _4945, _4957, _4959, _4963,
    _4970, _4969, _4971, _4978,
    _4985, _4988, _4989, _4990,
    _4992, _4994, _4999, _5000,
    _5001, _5003, _5005, _5010,
    _5009, _5015, _5016, _5021,
    _5024, _5027, _5031, _5035,
    _5039, _5042, _4914
)
...
class AssemblyCompoundModalAnalysisAtAStiffness(_4914.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """AssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4791.AssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def bearings(self) -> 'List[_4922.BearingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4924.BeltDriveCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4927.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4934.BoltedJointCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4933.BoltCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4955.CVTCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4935.ClutchCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4940.ConceptCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4945.ConceptGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4957.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4959.CycloidalDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4963.CylindricalGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4970.FEPartCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4969.FaceGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4971.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4978.HypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4985.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4988.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_4989.MassDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_4990.MeasurementComponentCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_4992.OilSealCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4994.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4999.PlanetCarrierCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_5000.PointLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_5001.PowerLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_5003.RingPinsCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5005.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5010.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_5009.ShaftCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5015.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5016.SpringDamperCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5021.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5024.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_5027.SynchroniserCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_5031.TorqueConverterCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5035.UnbalancedMassCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5039.WormGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5042.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4791.AssemblyModalAnalysisAtAStiffness]':
