...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4785
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4916
...
class AbstractShaftCompoundModalAnalysisAtAStiffness(_4916.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """AbstractShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4785.AbstractShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4785.AbstractShaftModalAnalysisAtAStiffness]':
