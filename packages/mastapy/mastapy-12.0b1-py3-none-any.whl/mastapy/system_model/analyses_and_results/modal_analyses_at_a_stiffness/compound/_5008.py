...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4921
...
class RootAssemblyCompoundModalAnalysisAtAStiffness(_4921.AssemblyCompoundModalAnalysisAtAStiffness):
    """RootAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4879.RootAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4879.RootAssemblyModalAnalysisAtAStiffness]':
