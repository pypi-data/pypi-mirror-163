...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5040, _5041, _4932
...
class ZerolBevelGearSetCompoundModalAnalysisAtAStiffness(_4932.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4913.ZerolBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5040.ZerolBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5041.ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4913.ZerolBevelGearSetModalAnalysisAtAStiffness]':
