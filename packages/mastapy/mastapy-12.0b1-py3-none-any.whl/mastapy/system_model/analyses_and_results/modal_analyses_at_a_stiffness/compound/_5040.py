...
class ZerolBevelGearCompoundModalAnalysisAtAStiffness(_4930.BevelGearCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4912.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4912.ZerolBevelGearModalAnalysisAtAStiffness]':
