...
class UnbalancedMassCompoundModalAnalysisAtAStiffness(_5036.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """UnbalancedMassCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4906.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4906.UnbalancedMassModalAnalysisAtAStiffness]':
