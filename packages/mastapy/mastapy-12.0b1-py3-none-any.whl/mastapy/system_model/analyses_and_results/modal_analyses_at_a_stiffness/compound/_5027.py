...
class SynchroniserCompoundModalAnalysisAtAStiffness(_5012.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """SynchroniserCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4899.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4899.SynchroniserModalAnalysisAtAStiffness]':
