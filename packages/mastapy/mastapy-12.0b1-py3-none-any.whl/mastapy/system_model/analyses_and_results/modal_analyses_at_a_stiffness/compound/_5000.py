...
class PointLoadCompoundModalAnalysisAtAStiffness(_5036.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PointLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4871.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4871.PointLoadModalAnalysisAtAStiffness]':
