...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5037, _5038, _4974
...
class WormGearSetCompoundModalAnalysisAtAStiffness(_4974.GearSetCompoundModalAnalysisAtAStiffness):
    """WormGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4910.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5037.WormGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5038.WormGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4910.WormGearSetModalAnalysisAtAStiffness]':
