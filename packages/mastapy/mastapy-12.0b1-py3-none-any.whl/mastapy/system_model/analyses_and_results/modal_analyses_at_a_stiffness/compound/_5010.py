...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4950.ConnectorCompoundModalAnalysisAtAStiffness):
    """ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4880.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4880.ShaftHubConnectionModalAnalysisAtAStiffness]':
