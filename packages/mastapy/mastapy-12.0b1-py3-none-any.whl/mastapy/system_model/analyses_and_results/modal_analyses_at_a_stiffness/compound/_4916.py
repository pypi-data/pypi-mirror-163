...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4786
...
class AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness(_4939.ComponentCompoundModalAnalysisAtAStiffness):
    """AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4786.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4786.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
