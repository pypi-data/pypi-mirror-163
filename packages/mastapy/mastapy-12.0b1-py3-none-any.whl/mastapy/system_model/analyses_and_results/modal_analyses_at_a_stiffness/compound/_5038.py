...
class WormGearMeshCompoundModalAnalysisAtAStiffness(_4973.GearMeshCompoundModalAnalysisAtAStiffness):
    """WormGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4908.WormGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4908.WormGearMeshModalAnalysisAtAStiffness]':
