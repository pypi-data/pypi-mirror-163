...
class ConceptGearCompoundModalAnalysisAtAStiffness(_4972.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4814.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4814.ConceptGearModalAnalysisAtAStiffness]':
