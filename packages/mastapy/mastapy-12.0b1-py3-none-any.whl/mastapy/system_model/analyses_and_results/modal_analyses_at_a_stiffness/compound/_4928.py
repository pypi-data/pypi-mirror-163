...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4798
...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness(_4925.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4798.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4798.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
