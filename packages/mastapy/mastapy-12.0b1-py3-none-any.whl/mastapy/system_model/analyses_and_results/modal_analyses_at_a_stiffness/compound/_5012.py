...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4914
...
class SpecialisedAssemblyCompoundModalAnalysisAtAStiffness(_4914.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """SpecialisedAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4883.SpecialisedAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4883.SpecialisedAssemblyModalAnalysisAtAStiffness]':
