...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4797
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4925, _4926, _4932
...
class BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness(_4932.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4797.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4925.BevelDifferentialGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4926.BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4797.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
