...
class OilSealCompoundModalAnalysisAtAStiffness(_4950.ConnectorCompoundModalAnalysisAtAStiffness):
    """OilSealCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4863.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4863.OilSealModalAnalysisAtAStiffness]':
