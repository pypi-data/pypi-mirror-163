...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_4952.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4887.SpringDamperConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4887.SpringDamperConnectionModalAnalysisAtAStiffness]':
