...
class FEPartCompoundModalAnalysisAtAStiffness(_4916.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """FEPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4841.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4841.FEPartModalAnalysisAtAStiffness]':
