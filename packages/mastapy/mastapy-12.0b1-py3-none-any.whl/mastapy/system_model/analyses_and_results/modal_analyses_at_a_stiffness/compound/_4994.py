...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4951
...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4951.CouplingCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4867.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4867.PartToPartShearCouplingModalAnalysisAtAStiffness]':
