...
class SpringDamperCompoundModalAnalysisAtAStiffness(_4951.CouplingCompoundModalAnalysisAtAStiffness):
    """SpringDamperCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4889.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4889.SpringDamperModalAnalysisAtAStiffness]':
