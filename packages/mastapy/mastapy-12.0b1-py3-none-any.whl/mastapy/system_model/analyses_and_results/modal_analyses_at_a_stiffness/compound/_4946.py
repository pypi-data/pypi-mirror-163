...
class ConicalGearCompoundModalAnalysisAtAStiffness(_4972.GearCompoundModalAnalysisAtAStiffness):
    """ConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4817.ConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4817.ConicalGearModalAnalysisAtAStiffness]':
