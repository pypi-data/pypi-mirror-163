...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4792
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4950
...
class BearingCompoundModalAnalysisAtAStiffness(_4950.ConnectorCompoundModalAnalysisAtAStiffness):
    """BearingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4792.BearingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4792.BearingModalAnalysisAtAStiffness]':
