...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4832, _4831, _4845
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4845.GearSetModalAnalysisAtAStiffness):
    """CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4832.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4831.CylindricalGearMeshModalAnalysisAtAStiffness]':
