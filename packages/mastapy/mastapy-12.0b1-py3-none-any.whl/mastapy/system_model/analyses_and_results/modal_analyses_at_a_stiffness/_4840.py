...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4839, _4838, _4845
...
class FaceGearSetModalAnalysisAtAStiffness(_4845.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4839.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4838.FaceGearMeshModalAnalysisAtAStiffness]':
