...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4912, _4911, _4802
...
class ZerolBevelGearSetModalAnalysisAtAStiffness(_4802.BevelGearSetModalAnalysisAtAStiffness):
    """ZerolBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4912.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4911.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
