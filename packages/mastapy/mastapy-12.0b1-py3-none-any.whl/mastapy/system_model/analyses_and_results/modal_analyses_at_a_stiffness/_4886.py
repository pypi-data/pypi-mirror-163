...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4885, _4884, _4802
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4802.BevelGearSetModalAnalysisAtAStiffness):
    """SpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4885.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4884.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
