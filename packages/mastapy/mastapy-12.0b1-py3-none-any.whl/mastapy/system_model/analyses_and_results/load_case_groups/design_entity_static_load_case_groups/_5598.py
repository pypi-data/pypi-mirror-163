...
TConnection = TypeVar('TConnection', bound='_2212.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6763.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5599.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    """ConnectionStaticLoadCaseGroup
