...
from mastapy.system_model.analyses_and_results.static_loads import _6862, _6718
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6862.RootAssemblyLoadCase]':
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7471.TaskProgress') -> 'List[_6718.LoadCase]':
