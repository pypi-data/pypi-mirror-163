...
from mastapy.system_model.analyses_and_results.analysis_cases import _7463
...
class MultibodyDynamicsAnalysis(_7463.TimeSeriesLoadAnalysisCase):
    """MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5386.MBDAnalysisOptions':
