...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5368, _5367, _5307
...
class HypoidGearSetMultibodyDynamicsAnalysis(_5307.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis):
    """HypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5368.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5368.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5367.HypoidGearMeshMultibodyDynamicsAnalysis]':
