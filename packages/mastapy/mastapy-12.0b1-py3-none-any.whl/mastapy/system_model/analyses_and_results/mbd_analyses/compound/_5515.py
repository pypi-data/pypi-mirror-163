...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5457
...
class HypoidGearCompoundMultibodyDynamicsAnalysis(_5457.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """HypoidGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5368.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5368.HypoidGearMultibodyDynamicsAnalysis]':
