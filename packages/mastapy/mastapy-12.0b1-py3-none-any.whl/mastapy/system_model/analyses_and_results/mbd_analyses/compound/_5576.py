...
class WormGearCompoundMultibodyDynamicsAnalysis(_5511.GearCompoundMultibodyDynamicsAnalysis):
    """WormGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5442.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5442.WormGearMultibodyDynamicsAnalysis]':
