...
class ConicalGearSetCompoundMultibodyDynamicsAnalysis(_5513.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5338.ConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5338.ConicalGearSetMultibodyDynamicsAnalysis]':
