...
class CouplingConnectionCompoundMultibodyDynamicsAnalysis(_5518.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5341.CouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5341.CouplingConnectionMultibodyDynamicsAnalysis]':
