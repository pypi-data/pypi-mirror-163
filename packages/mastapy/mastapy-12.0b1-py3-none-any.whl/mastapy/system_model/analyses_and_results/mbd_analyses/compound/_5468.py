...
class BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis(_5464.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5318.BevelDifferentialSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5318.BevelDifferentialSunGearMultibodyDynamicsAnalysis]':
