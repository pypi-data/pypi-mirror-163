...
class SpringDamperCompoundMultibodyDynamicsAnalysis(_5490.CouplingCompoundMultibodyDynamicsAnalysis):
    """SpringDamperCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5419.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5419.SpringDamperMultibodyDynamicsAnalysis]':
