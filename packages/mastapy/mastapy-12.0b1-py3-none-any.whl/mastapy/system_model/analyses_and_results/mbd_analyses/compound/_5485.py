...
class ConicalGearCompoundMultibodyDynamicsAnalysis(_5511.GearCompoundMultibodyDynamicsAnalysis):
    """ConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5337.ConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5337.ConicalGearMultibodyDynamicsAnalysis]':
