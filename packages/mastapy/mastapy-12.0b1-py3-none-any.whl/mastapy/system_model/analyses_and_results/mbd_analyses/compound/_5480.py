...
class ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5491.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5330.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5330.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
