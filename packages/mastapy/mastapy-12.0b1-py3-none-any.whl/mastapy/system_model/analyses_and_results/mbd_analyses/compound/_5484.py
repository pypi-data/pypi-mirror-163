...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5482, _5483, _5513
...
class ConceptGearSetCompoundMultibodyDynamicsAnalysis(_5513.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConceptGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5335.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5482.ConceptGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5483.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5335.ConceptGearSetMultibodyDynamicsAnalysis]':
