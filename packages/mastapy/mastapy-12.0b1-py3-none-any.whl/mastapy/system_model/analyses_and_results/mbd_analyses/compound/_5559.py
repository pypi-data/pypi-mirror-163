...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5470
...
class StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis(_5470.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5420.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5420.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
