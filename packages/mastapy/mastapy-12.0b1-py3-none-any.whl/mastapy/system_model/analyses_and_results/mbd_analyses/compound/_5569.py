...
class SynchroniserSleeveCompoundMultibodyDynamicsAnalysis(_5568.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserSleeveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5431.SynchroniserSleeveMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5431.SynchroniserSleeveMultibodyDynamicsAnalysis]':
