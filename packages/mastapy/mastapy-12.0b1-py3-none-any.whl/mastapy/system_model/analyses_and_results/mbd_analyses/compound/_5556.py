...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5491.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5417.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5417.SpringDamperConnectionMultibodyDynamicsAnalysis]':
