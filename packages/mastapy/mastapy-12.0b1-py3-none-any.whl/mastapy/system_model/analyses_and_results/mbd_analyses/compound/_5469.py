...
class BevelGearCompoundMultibodyDynamicsAnalysis(_5457.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """BevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5320.BevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5320.BevelGearMultibodyDynamicsAnalysis]':
