...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5491
...
class PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5491.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5392.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5392.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis]':
