...
class ComponentCompoundMultibodyDynamicsAnalysis(_5532.PartCompoundMultibodyDynamicsAnalysis):
    """ComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5329.ComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5329.ComponentMultibodyDynamicsAnalysis]':
