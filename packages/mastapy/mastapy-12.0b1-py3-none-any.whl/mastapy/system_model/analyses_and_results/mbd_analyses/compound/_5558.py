...
class StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis(_5469.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5421.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5421.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
