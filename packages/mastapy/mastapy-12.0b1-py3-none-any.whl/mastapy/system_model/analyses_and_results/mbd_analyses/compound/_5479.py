...
class ConceptCouplingCompoundMultibodyDynamicsAnalysis(_5490.CouplingCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5332.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5332.ConceptCouplingMultibodyDynamicsAnalysis]':
