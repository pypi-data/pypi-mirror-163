...
class SpringDamperHalfCompoundMultibodyDynamicsAnalysis(_5492.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """SpringDamperHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5418.SpringDamperHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5418.SpringDamperHalfMultibodyDynamicsAnalysis]':
