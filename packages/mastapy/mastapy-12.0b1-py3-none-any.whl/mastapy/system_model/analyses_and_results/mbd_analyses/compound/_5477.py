...
class CoaxialConnectionCompoundMultibodyDynamicsAnalysis(_5550.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CoaxialConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5328.CoaxialConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5328.CoaxialConnectionMultibodyDynamicsAnalysis]':
