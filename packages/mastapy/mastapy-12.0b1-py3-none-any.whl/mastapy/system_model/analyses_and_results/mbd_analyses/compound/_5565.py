...
class StraightBevelSunGearCompoundMultibodyDynamicsAnalysis(_5558.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5427.StraightBevelSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5427.StraightBevelSunGearMultibodyDynamicsAnalysis]':
