...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import (
    _5461, _5463, _5466, _5473,
    _5472, _5494, _5474, _5479,
    _5484, _5496, _5498, _5502,
    _5509, _5508, _5510, _5517,
    _5524, _5527, _5528, _5529,
    _5531, _5533, _5538, _5539,
    _5540, _5542, _5544, _5549,
    _5548, _5554, _5555, _5560,
    _5563, _5566, _5570, _5574,
    _5578, _5581, _5453
)
...
class AssemblyCompoundMultibodyDynamicsAnalysis(_5453.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """AssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5309.AssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5461.BearingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5463.BeltDriveCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5466.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5473.BoltedJointCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5472.BoltCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5494.CVTCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5474.ClutchCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5479.ConceptCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5484.ConceptGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5496.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5498.CycloidalDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5502.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5509.FEPartCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5508.FaceGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5510.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5517.HypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5524.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5527.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5528.MassDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5529.MeasurementComponentCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5531.OilSealCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5533.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5538.PlanetCarrierCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5539.PointLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5540.PowerLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5542.RingPinsCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5544.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5549.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5548.ShaftCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5554.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5555.SpringDamperCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5560.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5563.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5566.SynchroniserCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5570.TorqueConverterCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5574.UnbalancedMassCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5578.WormGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5581.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5309.AssemblyMultibodyDynamicsAnalysis]':
