...
class ClutchCompoundMultibodyDynamicsAnalysis(_5490.CouplingCompoundMultibodyDynamicsAnalysis):
    """ClutchCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5326.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5326.ClutchMultibodyDynamicsAnalysis]':
