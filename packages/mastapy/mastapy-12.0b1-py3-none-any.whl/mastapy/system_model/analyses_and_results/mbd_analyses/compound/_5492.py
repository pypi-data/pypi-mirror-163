...
class CouplingHalfCompoundMultibodyDynamicsAnalysis(_5530.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """CouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5342.CouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5342.CouplingHalfMultibodyDynamicsAnalysis]':
