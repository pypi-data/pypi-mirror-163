...
class CylindricalGearMeshCompoundMultibodyDynamicsAnalysis(_5512.GearMeshCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5351.CylindricalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5351.CylindricalGearMeshMultibodyDynamicsAnalysis]':
