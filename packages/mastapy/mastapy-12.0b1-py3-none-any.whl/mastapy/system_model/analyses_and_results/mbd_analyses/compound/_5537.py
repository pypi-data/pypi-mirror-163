...
class PlanetaryGearSetCompoundMultibodyDynamicsAnalysis(_5502.CylindricalGearSetCompoundMultibodyDynamicsAnalysis):
    """PlanetaryGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5396.PlanetaryGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5396.PlanetaryGearSetMultibodyDynamicsAnalysis]':
