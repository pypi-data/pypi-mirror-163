...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5506, _5507, _5513
...
class FaceGearSetCompoundMultibodyDynamicsAnalysis(_5513.GearSetCompoundMultibodyDynamicsAnalysis):
    """FaceGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5359.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5506.FaceGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5507.FaceGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5359.FaceGearSetMultibodyDynamicsAnalysis]':
