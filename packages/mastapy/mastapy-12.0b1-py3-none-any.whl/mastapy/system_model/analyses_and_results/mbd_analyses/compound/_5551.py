...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5453
...
class SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis(_5453.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5413.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5413.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
