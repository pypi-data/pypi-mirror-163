...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5558, _5559, _5471
...
class StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis(_5471.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5422.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5558.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5559.StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5422.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
