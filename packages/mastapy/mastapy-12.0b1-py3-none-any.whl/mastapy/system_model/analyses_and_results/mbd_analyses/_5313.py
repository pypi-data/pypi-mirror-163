...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5400, _5413
...
class BeltDriveMultibodyDynamicsAnalysis(_5413.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5400.PulleyMultibodyDynamicsAnalysis]':
