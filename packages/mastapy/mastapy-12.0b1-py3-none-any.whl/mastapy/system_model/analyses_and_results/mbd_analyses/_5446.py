...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5445, _5444, _5321
...
class ZerolBevelGearSetMultibodyDynamicsAnalysis(_5321.BevelGearSetMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5445.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5445.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5444.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
