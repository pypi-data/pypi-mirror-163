...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import (
    _5051, _5053, _5056, _5062,
    _5063, _5084, _5066, _5071,
    _5074, _5086, _5088, _5092,
    _5099, _5098, _5100, _5107,
    _5114, _5117, _5118, _5119,
    _5121, _5125, _5128, _5129,
    _5130, _5132, _5134, _5138,
    _5139, _5144, _5147, _5150,
    _5153, _5157, _5161, _5164,
    _5168, _5171, _5043
)
...
class AssemblyModalAnalysisAtASpeed(_5043.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self) -> 'List[_5051.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5053.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5056.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5062.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5063.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5084.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5066.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5071.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5074.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5086.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5088.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5092.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5099.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5098.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5100.FlexiblePinAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5107.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5114.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5117.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5118.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5119.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5121.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5125.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5128.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5129.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5130.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5132.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5134.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5138.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5139.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5144.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5147.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5150.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5153.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5157.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5161.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5164.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5168.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5171.ZerolBevelGearSetModalAnalysisAtASpeed]':
