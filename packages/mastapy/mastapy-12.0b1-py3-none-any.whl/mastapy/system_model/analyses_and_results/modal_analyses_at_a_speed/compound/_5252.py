...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5209
...
class PartToPartShearCouplingCompoundModalAnalysisAtASpeed(_5209.CouplingCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5125.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5125.PartToPartShearCouplingModalAnalysisAtASpeed]':
