...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5219, _5220, _5232
...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(_5232.GearSetCompoundModalAnalysisAtASpeed):
    """CylindricalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5092.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5219.CylindricalGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5220.CylindricalGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5092.CylindricalGearSetModalAnalysisAtASpeed]':
