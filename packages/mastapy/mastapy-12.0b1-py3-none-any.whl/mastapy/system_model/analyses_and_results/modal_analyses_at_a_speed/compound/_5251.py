...
class PartCompoundModalAnalysisAtASpeed(_7458.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5122.PartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5122.PartModalAnalysisAtASpeed]':
