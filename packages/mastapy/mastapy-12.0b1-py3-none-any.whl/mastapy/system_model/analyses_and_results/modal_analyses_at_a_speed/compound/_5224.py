...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_5197.ComponentCompoundModalAnalysisAtASpeed):
    """ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5095.ExternalCADModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5095.ExternalCADModelModalAnalysisAtASpeed]':
