...
class AbstractAssemblyCompoundModalAnalysisAtASpeed(_5251.PartCompoundModalAnalysisAtASpeed):
    """AbstractAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5043.AbstractAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5043.AbstractAssemblyModalAnalysisAtASpeed]':
