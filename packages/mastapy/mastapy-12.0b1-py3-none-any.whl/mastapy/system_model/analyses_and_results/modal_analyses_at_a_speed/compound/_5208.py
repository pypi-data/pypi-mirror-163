...
class ConnectorCompoundModalAnalysisAtASpeed(_5249.MountableComponentCompoundModalAnalysisAtASpeed):
    """ConnectorCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5079.ConnectorModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5079.ConnectorModalAnalysisAtASpeed]':
