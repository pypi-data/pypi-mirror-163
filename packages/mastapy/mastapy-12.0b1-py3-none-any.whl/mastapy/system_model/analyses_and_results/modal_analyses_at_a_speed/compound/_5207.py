...
class ConnectionCompoundModalAnalysisAtASpeed(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5078.ConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5078.ConnectionModalAnalysisAtASpeed]':
