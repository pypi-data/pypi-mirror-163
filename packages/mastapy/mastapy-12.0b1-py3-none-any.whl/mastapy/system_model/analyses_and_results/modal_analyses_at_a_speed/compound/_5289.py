...
class TorqueConverterCompoundModalAnalysisAtASpeed(_5209.CouplingCompoundModalAnalysisAtASpeed):
    """TorqueConverterCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5161.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5161.TorqueConverterModalAnalysisAtASpeed]':
