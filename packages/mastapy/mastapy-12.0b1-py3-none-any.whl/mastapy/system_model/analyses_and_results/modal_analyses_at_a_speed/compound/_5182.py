...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5053
...
class BeltDriveCompoundModalAnalysisAtASpeed(_5270.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """BeltDriveCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5053.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5053.BeltDriveModalAnalysisAtASpeed]':
