...
class ConicalGearCompoundModalAnalysisAtASpeed(_5230.GearCompoundModalAnalysisAtASpeed):
    """ConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5076.ConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5076.ConicalGearModalAnalysisAtASpeed]':
