...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5210
...
class PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed(_5210.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5123.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5123.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
