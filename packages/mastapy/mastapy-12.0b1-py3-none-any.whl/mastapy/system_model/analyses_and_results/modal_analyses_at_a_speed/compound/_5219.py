...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5230.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5091.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5091.CylindricalGearModalAnalysisAtASpeed]':
