...
class FaceGearMeshCompoundModalAnalysisAtASpeed(_5231.GearMeshCompoundModalAnalysisAtASpeed):
    """FaceGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5096.FaceGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5096.FaceGearMeshModalAnalysisAtASpeed]':
