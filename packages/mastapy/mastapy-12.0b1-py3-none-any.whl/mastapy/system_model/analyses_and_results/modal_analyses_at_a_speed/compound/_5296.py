...
class WormGearMeshCompoundModalAnalysisAtASpeed(_5231.GearMeshCompoundModalAnalysisAtASpeed):
    """WormGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5166.WormGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5166.WormGearMeshModalAnalysisAtASpeed]':
