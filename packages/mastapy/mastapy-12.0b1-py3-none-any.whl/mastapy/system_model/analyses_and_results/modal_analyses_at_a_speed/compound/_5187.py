...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5058
...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_5183.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5058.BevelDifferentialSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5058.BevelDifferentialSunGearModalAnalysisAtASpeed]':
