...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed(_5238.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5113.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5113.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
