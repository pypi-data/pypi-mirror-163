...
class SpringDamperConnectionCompoundModalAnalysisAtASpeed(_5210.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """SpringDamperConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5145.SpringDamperConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5145.SpringDamperConnectionModalAnalysisAtASpeed]':
