...
class CylindricalPlanetGearCompoundModalAnalysisAtASpeed(_5219.CylindricalGearCompoundModalAnalysisAtASpeed):
    """CylindricalPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5093.CylindricalPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5093.CylindricalPlanetGearModalAnalysisAtASpeed]':
