...
class RingPinsCompoundModalAnalysisAtASpeed(_5249.MountableComponentCompoundModalAnalysisAtASpeed):
    """RingPinsCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5132.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5132.RingPinsModalAnalysisAtASpeed]':
