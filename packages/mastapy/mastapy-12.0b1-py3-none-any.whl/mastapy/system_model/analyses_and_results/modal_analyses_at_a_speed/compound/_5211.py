...
class CouplingHalfCompoundModalAnalysisAtASpeed(_5249.MountableComponentCompoundModalAnalysisAtASpeed):
    """CouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5081.CouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5081.CouplingHalfModalAnalysisAtASpeed]':
