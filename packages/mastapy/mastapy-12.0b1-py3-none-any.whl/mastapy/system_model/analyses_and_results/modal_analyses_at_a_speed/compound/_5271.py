...
class SpiralBevelGearCompoundModalAnalysisAtASpeed(_5188.BevelGearCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5143.SpiralBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5143.SpiralBevelGearModalAnalysisAtASpeed]':
