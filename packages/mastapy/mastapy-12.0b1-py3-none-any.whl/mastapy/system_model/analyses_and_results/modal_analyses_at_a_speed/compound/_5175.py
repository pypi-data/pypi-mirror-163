...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5207.ConnectionCompoundModalAnalysisAtASpeed):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5046.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5046.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
