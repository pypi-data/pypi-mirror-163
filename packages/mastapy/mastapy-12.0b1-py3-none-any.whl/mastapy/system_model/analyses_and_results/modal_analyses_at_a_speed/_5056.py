...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5055, _5054, _5061
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_5061.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_5055.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_5054.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
