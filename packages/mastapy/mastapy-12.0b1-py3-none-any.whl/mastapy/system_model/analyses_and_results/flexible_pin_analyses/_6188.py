...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2834, _2870, _2793
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6185
...
class FlexiblePinAnalysisGearAndBearingRating(_6185.FlexiblePinAnalysis):
    """FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2834.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2834.CylindricalGearSetCompoundSystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2793.BearingCompoundSystemDeflection]':
