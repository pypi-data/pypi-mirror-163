...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6190, _6184
...
class FlexiblePinAnalysis(_6184.CombinationAnalysis):
    """FlexiblePinAnalysis
    ...
    @property
    def analysis_options(self) -> '_6190.FlexiblePinAnalysisOptions':
