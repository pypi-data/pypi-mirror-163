...
from mastapy.system_model.analyses_and_results.system_deflections import _2692, _2632
...
class FlexiblePinAnalysisConceptLevel(_6185.FlexiblePinAnalysis):
    """FlexiblePinAnalysisConceptLevel
    ...
    @property
    def flexible_pin_extreme_load_case(self) -> '_2692.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def flexible_pin_nominal_load_case(self) -> '_2692.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def planet_bearings_in_nominal_load(self) -> 'List[_2632.BearingSystemDeflection]':
