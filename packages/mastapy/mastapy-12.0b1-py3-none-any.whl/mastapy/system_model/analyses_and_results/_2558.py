...
from mastapy.system_model.analyses_and_results.analysis_cases import _7455
...
class CompoundAnalysis(_7465.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    def perform_analysis_with_progress(self, progress: '_7471.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2147.DesignEntity') -> 'Iterable[_7455.DesignEntityCompoundAnalysis]':
