...
class AbstractShaftOrHousingSystemDeflection(_2649.ComponentSystemDeflection):
    """AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3965.AbstractShaftOrHousingPowerFlow':
