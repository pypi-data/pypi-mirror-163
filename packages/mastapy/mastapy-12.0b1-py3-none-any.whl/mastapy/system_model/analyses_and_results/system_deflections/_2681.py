...
class CylindricalGearSystemDeflectionWithLTCAResults(_2679.CylindricalGearSystemDeflection):
    """CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_846.CylindricalGearLoadDistributionAnalysis':
