...
from mastapy.system_model.analyses_and_results.system_deflections import _2743, _2741, _2641
...
class SpiralBevelGearSetSystemDeflection(_2641.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4068.SpiralBevelGearSetPowerFlow':
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2743.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2741.SpiralBevelGearMeshSystemDeflection]':
