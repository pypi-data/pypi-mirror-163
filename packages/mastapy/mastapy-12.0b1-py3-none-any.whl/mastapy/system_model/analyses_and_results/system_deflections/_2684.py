...
class CylindricalPlanetGearSystemDeflection(_2681.CylindricalGearSystemDeflectionWithLTCAResults):
    """CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4015.CylindricalPlanetGearPowerFlow':
