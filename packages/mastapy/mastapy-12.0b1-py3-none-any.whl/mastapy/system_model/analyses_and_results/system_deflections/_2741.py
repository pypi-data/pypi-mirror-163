...
class SpiralBevelGearMeshSystemDeflection(_2640.BevelGearMeshSystemDeflection):
    """SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_393.SpiralBevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_393.SpiralBevelGearMeshRating':
    ...
    @property
    def connection_load_case(self) -> '_6868.SpiralBevelGearMeshLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4066.SpiralBevelGearMeshPowerFlow':
