...
class SpringDamperHalfCompoundSystemDeflection(_2824.CouplingHalfCompoundSystemDeflection):
    """SpringDamperHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2745.SpringDamperHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2745.SpringDamperHalfSystemDeflection]':
