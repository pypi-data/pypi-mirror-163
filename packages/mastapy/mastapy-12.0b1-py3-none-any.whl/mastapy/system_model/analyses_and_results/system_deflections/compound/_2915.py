...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2913, _2914, _2803
...
class ZerolBevelGearSetCompoundSystemDeflection(_2803.BevelGearSetCompoundSystemDeflection):
    """ZerolBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2774.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_system_deflection(self) -> 'List[_2913.ZerolBevelGearCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_system_deflection(self) -> 'List[_2914.ZerolBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2774.ZerolBevelGearSetSystemDeflection]':
