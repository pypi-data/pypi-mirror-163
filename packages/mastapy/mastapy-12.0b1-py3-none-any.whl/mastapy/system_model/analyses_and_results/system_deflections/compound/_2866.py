...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2822
...
class PartToPartShearCouplingCompoundSystemDeflection(_2822.CouplingCompoundSystemDeflection):
    """PartToPartShearCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2722.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2722.PartToPartShearCouplingSystemDeflection]':
