...
class CycloidalAssemblyCompoundSystemDeflection(_2885.SpecialisedAssemblyCompoundSystemDeflection):
    """CycloidalAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2669.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2669.CycloidalAssemblySystemDeflection]':
