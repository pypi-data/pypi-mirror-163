...
class TorqueConverterCompoundSystemDeflection(_2822.CouplingCompoundSystemDeflection):
    """TorqueConverterCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2764.TorqueConverterSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2764.TorqueConverterSystemDeflection]':
