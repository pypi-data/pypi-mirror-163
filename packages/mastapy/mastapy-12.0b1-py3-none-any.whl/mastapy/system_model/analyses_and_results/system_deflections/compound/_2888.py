...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2886, _2887, _2803
...
class SpiralBevelGearSetCompoundSystemDeflection(_2803.BevelGearSetCompoundSystemDeflection):
    """SpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2742.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2886.SpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2887.SpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2742.SpiralBevelGearSetSystemDeflection]':
