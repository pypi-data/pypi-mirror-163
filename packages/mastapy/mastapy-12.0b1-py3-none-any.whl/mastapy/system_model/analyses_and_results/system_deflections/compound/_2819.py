...
class ConicalGearSetCompoundSystemDeflection(_2846.GearSetCompoundSystemDeflection):
    """ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2659.ConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2659.ConicalGearSetSystemDeflection]':
