...
class ExternalCADModelCompoundSystemDeflection(_2810.ComponentCompoundSystemDeflection):
    """ExternalCADModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2686.ExternalCADModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2686.ExternalCADModelSystemDeflection]':
