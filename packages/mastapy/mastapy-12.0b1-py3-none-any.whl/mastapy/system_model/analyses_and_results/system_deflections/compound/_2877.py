...
class RollingRingAssemblyCompoundSystemDeflection(_2885.SpecialisedAssemblyCompoundSystemDeflection):
    """RollingRingAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2731.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2731.RollingRingAssemblySystemDeflection]':
