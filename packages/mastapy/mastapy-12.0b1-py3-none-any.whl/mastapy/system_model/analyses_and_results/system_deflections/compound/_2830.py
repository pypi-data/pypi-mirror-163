...
class CycloidalDiscCompoundSystemDeflection(_2786.AbstractShaftCompoundSystemDeflection):
    """CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2672.CycloidalDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2672.CycloidalDiscSystemDeflection]':
