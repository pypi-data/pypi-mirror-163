...
class SpecialisedAssemblyCompoundSystemDeflection(_2785.AbstractAssemblyCompoundSystemDeflection):
    """SpecialisedAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2740.SpecialisedAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2740.SpecialisedAssemblySystemDeflection]':
