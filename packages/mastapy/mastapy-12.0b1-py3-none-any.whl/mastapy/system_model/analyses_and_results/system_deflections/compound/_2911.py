...
class WormGearMeshCompoundSystemDeflection(_2845.GearMeshCompoundSystemDeflection):
    """WormGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2770.WormGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2770.WormGearMeshSystemDeflection]':
