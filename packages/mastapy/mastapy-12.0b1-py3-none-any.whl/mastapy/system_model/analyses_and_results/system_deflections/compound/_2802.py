...
class BevelGearMeshCompoundSystemDeflection(_2790.AGMAGleasonConicalGearMeshCompoundSystemDeflection):
    """BevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2640.BevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2640.BevelGearMeshSystemDeflection]':
