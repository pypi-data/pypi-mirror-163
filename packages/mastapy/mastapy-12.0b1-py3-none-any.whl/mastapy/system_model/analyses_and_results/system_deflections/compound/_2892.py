...
class StraightBevelDiffGearCompoundSystemDeflection(_2801.BevelGearCompoundSystemDeflection):
    """StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2749.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2749.StraightBevelDiffGearSystemDeflection]':
