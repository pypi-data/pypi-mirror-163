...
class SynchroniserCompoundSystemDeflection(_2885.SpecialisedAssemblyCompoundSystemDeflection):
    """SynchroniserCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2758.SynchroniserSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2758.SynchroniserSystemDeflection]':
