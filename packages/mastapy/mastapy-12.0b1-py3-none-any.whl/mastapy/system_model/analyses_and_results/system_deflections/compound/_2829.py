...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2809
...
class CycloidalDiscCentralBearingConnectionCompoundSystemDeflection(_2809.CoaxialConnectionCompoundSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2670.CycloidalDiscCentralBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2670.CycloidalDiscCentralBearingConnectionSystemDeflection]':
