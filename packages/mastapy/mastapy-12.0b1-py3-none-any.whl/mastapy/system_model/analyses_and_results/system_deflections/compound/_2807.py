...
class ClutchConnectionCompoundSystemDeflection(_2823.CouplingConnectionCompoundSystemDeflection):
    """ClutchConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2645.ClutchConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2645.ClutchConnectionSystemDeflection]':
