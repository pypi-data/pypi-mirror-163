...
class BeltDriveCompoundSystemDeflection(_2885.SpecialisedAssemblyCompoundSystemDeflection):
    """BeltDriveCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2634.BeltDriveSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2634.BeltDriveSystemDeflection]':
