...
class GuideDxfModelCompoundSystemDeflection(_2810.ComponentCompoundSystemDeflection):
    """GuideDxfModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2696.GuideDxfModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2696.GuideDxfModelSystemDeflection]':
