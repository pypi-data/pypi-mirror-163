...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2817.ConicalGearCompoundSystemDeflection):
    """AGMAGleasonConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2630.AGMAGleasonConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2630.AGMAGleasonConicalGearSystemDeflection]':
