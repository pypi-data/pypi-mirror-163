...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2819.ConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2703.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2703.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
