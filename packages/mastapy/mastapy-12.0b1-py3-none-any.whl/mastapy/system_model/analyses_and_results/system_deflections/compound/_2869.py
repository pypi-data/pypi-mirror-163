...
class PlanetaryConnectionCompoundSystemDeflection(_2884.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    """PlanetaryConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2723.PlanetaryConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2723.PlanetaryConnectionSystemDeflection]':
