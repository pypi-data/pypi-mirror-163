...
class ConceptGearMeshCompoundSystemDeflection(_2845.GearMeshCompoundSystemDeflection):
    """ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2654.ConceptGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2654.ConceptGearMeshSystemDeflection]':
