...
class BoltedJointCompoundSystemDeflection(_2885.SpecialisedAssemblyCompoundSystemDeflection):
    """BoltedJointCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2643.BoltedJointSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2643.BoltedJointSystemDeflection]':
