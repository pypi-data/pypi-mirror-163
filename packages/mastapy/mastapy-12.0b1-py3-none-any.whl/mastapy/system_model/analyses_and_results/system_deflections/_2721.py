...
class PartToPartShearCouplingHalfSystemDeflection(_2664.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4046.PartToPartShearCouplingHalfPowerFlow':
