...
class RollingRingConnectionSystemDeflection(_2701.InterMountableComponentConnectionSystemDeflection):
    """RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4059.RollingRingConnectionPowerFlow':
