...
from mastapy.system_model.analyses_and_results.modal_analyses import _4638, _4637, _4566
...
class WormGearSetModalAnalysis(_4566.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4638.WormGearModalAnalysis]':
    ...
    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4637.WormGearMeshModalAnalysis]':
