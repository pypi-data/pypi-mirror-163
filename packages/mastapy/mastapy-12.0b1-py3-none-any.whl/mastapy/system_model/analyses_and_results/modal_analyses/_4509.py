...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4510, _4512, _4515, _4521,
    _4522, _4544, _4525, _4530,
    _4533, _4546, _4548, _4552,
    _4561, _4560, _4562, _4570,
    _4577, _4580, _4581, _4582,
    _4587, _4592, _4595, _4596,
    _4597, _4599, _4601, _4605,
    _4606, _4612, _4615, _4618,
    _4621, _4625, _4629, _4632,
    _4639, _4642, _4502
)
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4643
...
class AssemblyModalAnalysis(_4502.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self) -> 'List[_4510.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4512.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4515.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4521.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4522.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4544.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4643.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4525.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4530.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4533.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4546.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4548.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4552.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4561.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4560.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4562.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4561.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4570.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4577.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4580.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4581.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4582.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4587.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4592.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4595.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4596.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4597.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4599.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4601.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4605.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4606.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4612.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4615.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4618.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4621.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4625.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4629.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4632.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4639.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4642.ZerolBevelGearSetModalAnalysis]':
