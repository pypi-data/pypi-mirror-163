...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4650, _4646
...
class SingleModeResults(_4646.DesignEntityModalAnalysisGroupResults):
    """SingleModeResults
    ...
    @property
    def all_rigidly_connected_groups(self) -> 'List[_4650.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_energy(self) -> 'List[_4650.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_kinetic_energy(self) -> 'List[_4650.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_strain_energy(self) -> 'List[_4650.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
