...
from mastapy.system_model.analyses_and_results.modal_analyses import _4551, _4550, _4566
...
class CylindricalGearSetModalAnalysis(_4566.GearSetModalAnalysis):
    """CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4551.CylindricalGearModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4550.CylindricalGearMeshModalAnalysis]':
