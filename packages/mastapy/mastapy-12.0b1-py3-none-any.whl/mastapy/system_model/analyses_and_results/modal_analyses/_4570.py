...
from mastapy.system_model.analyses_and_results.modal_analyses import _4569, _4568, _4508
...
class HypoidGearSetModalAnalysis(_4508.AGMAGleasonConicalGearSetModalAnalysis):
    """HypoidGearSetModalAnalysis
    ...
    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4569.HypoidGearModalAnalysis]':
    ...
    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4568.HypoidGearMeshModalAnalysis]':
