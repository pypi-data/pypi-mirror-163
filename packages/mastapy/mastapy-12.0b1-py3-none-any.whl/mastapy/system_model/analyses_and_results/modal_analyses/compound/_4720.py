...
class InterMountableComponentConnectionCompoundModalAnalysis(_4690.ConnectionCompoundModalAnalysis):
    """InterMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4571.InterMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4571.InterMountableComponentConnectionModalAnalysis]':
