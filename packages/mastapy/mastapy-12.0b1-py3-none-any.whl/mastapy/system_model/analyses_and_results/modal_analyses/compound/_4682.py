...
class ConceptCouplingConnectionCompoundModalAnalysis(_4693.CouplingConnectionCompoundModalAnalysis):
    """ConceptCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4528.ConceptCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4528.ConceptCouplingConnectionModalAnalysis]':
