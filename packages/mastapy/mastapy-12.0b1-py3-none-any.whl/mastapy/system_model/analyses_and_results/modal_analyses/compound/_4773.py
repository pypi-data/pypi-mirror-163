...
class TorqueConverterConnectionCompoundModalAnalysis(_4693.CouplingConnectionCompoundModalAnalysis):
    """TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4628.TorqueConverterConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4628.TorqueConverterConnectionModalAnalysis]':
