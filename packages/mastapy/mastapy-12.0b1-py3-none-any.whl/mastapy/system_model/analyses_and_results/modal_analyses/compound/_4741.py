...
class PointLoadCompoundModalAnalysis(_4777.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4596.PointLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4596.PointLoadModalAnalysis]':
