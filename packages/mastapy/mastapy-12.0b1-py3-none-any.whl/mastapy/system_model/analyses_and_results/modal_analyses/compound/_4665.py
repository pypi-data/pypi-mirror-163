...
from mastapy.system_model.analyses_and_results.modal_analyses import _4512
...
class BeltDriveCompoundModalAnalysis(_4753.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4512.BeltDriveModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4512.BeltDriveModalAnalysis]':
