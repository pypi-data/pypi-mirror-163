...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4717, _4718, _4661
...
class HypoidGearSetCompoundModalAnalysis(_4661.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """HypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4570.HypoidGearSetModalAnalysis]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis(self) -> 'List[_4717.HypoidGearCompoundModalAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis(self) -> 'List[_4718.HypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4570.HypoidGearSetModalAnalysis]':
