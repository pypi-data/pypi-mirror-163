...
class ExternalCADModelCompoundModalAnalysis(_4680.ComponentCompoundModalAnalysis):
    """ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4557.ExternalCADModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4557.ExternalCADModelModalAnalysis]':
