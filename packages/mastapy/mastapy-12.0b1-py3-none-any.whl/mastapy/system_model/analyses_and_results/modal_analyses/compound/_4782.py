...
class ZerolBevelGearMeshCompoundModalAnalysis(_4672.BevelGearMeshCompoundModalAnalysis):
    """ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4640.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4640.ZerolBevelGearMeshModalAnalysis]':
