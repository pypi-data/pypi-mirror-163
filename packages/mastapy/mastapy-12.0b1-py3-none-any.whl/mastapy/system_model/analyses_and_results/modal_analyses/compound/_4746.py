...
class RollingRingAssemblyCompoundModalAnalysis(_4753.SpecialisedAssemblyCompoundModalAnalysis):
    """RollingRingAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4601.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4601.RollingRingAssemblyModalAnalysis]':
