...
class ConnectionCompoundModalAnalysis(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4537.ConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4537.ConnectionModalAnalysis]':
