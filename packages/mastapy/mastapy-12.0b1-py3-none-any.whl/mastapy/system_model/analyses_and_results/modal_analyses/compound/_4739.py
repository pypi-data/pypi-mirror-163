...
class PlanetaryGearSetCompoundModalAnalysis(_4704.CylindricalGearSetCompoundModalAnalysis):
    """PlanetaryGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4594.PlanetaryGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4594.PlanetaryGearSetModalAnalysis]':
