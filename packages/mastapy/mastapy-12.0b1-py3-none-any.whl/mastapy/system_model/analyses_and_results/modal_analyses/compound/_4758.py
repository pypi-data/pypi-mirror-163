...
class SpringDamperConnectionCompoundModalAnalysis(_4693.CouplingConnectionCompoundModalAnalysis):
    """SpringDamperConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4613.SpringDamperConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4613.SpringDamperConnectionModalAnalysis]':
