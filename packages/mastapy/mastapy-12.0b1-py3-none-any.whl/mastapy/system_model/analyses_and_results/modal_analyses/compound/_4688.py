...
class ConicalGearMeshCompoundModalAnalysis(_4714.GearMeshCompoundModalAnalysis):
    """ConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4534.ConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4534.ConicalGearMeshModalAnalysis]':
