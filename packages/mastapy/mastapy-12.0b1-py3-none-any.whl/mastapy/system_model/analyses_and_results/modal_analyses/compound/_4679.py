...
class CoaxialConnectionCompoundModalAnalysis(_4752.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CoaxialConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4526.CoaxialConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4526.CoaxialConnectionModalAnalysis]':
