...
class VirtualComponentCompoundModalAnalysis(_4732.MountableComponentCompoundModalAnalysis):
    """VirtualComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4633.VirtualComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4633.VirtualComponentModalAnalysis]':
