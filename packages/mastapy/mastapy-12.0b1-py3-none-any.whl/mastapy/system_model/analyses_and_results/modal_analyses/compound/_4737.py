...
class PartToPartShearCouplingHalfCompoundModalAnalysis(_4694.CouplingHalfCompoundModalAnalysis):
    """PartToPartShearCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4591.PartToPartShearCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4591.PartToPartShearCouplingHalfModalAnalysis]':
