...
class AGMAGleasonConicalGearSetCompoundModalAnalysis(_4689.ConicalGearSetCompoundModalAnalysis):
    """AGMAGleasonConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4508.AGMAGleasonConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4508.AGMAGleasonConicalGearSetModalAnalysis]':
