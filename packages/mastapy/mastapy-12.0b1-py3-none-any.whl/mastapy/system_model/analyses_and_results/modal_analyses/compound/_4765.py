...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4763, _4764, _4673
...
class StraightBevelGearSetCompoundModalAnalysis(_4673.BevelGearSetCompoundModalAnalysis):
    """StraightBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4621.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis(self) -> 'List[_4763.StraightBevelGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis(self) -> 'List[_4764.StraightBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4621.StraightBevelGearSetModalAnalysis]':
