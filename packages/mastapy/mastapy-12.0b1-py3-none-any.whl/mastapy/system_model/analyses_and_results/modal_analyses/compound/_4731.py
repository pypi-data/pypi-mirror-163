...
class MeasurementComponentCompoundModalAnalysis(_4777.VirtualComponentCompoundModalAnalysis):
    """MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4582.MeasurementComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4582.MeasurementComponentModalAnalysis]':
