...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4662
...
class RootAssemblyCompoundModalAnalysis(_4662.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4604.RootAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4604.RootAssemblyModalAnalysis]':
