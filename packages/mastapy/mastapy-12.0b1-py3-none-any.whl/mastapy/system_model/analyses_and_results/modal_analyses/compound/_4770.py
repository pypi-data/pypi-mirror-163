...
class SynchroniserPartCompoundModalAnalysis(_4694.CouplingHalfCompoundModalAnalysis):
    """SynchroniserPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4626.SynchroniserPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4626.SynchroniserPartModalAnalysis]':
