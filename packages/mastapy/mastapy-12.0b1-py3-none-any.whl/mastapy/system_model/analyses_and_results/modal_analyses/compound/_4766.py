...
class StraightBevelPlanetGearCompoundModalAnalysis(_4760.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4622.StraightBevelPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4622.StraightBevelPlanetGearModalAnalysis]':
