...
class StraightBevelGearMeshCompoundModalAnalysis(_4672.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4619.StraightBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4619.StraightBevelGearMeshModalAnalysis]':
