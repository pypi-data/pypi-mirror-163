...
from mastapy.system_model.analyses_and_results.modal_analyses import _4513
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4672
...
class BevelDifferentialGearMeshCompoundModalAnalysis(_4672.BevelGearMeshCompoundModalAnalysis):
    """BevelDifferentialGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4513.BevelDifferentialGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4513.BevelDifferentialGearMeshModalAnalysis]':
