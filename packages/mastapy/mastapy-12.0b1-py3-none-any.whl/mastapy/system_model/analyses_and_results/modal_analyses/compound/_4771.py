...
class SynchroniserSleeveCompoundModalAnalysis(_4770.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4627.SynchroniserSleeveModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4627.SynchroniserSleeveModalAnalysis]':
