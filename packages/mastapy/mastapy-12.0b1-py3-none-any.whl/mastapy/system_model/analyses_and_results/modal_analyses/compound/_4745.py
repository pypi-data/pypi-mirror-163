...
class RingPinsToDiscConnectionCompoundModalAnalysis(_4720.InterMountableComponentConnectionCompoundModalAnalysis):
    """RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4600.RingPinsToDiscConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4600.RingPinsToDiscConnectionModalAnalysis]':
