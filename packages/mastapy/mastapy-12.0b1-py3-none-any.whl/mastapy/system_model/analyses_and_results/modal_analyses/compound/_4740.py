...
class PlanetCarrierCompoundModalAnalysis(_4732.MountableComponentCompoundModalAnalysis):
    """PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4595.PlanetCarrierModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4595.PlanetCarrierModalAnalysis]':
