...
class AGMAGleasonConicalGearCompoundModalAnalysis(_4687.ConicalGearCompoundModalAnalysis):
    """AGMAGleasonConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4507.AGMAGleasonConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4507.AGMAGleasonConicalGearModalAnalysis]':
