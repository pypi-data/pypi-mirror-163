...
class CycloidalAssemblyCompoundModalAnalysis(_4753.SpecialisedAssemblyCompoundModalAnalysis):
    """CycloidalAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4546.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4546.CycloidalAssemblyModalAnalysis]':
