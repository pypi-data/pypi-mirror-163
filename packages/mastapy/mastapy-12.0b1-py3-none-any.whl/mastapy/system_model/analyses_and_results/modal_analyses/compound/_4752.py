...
class ShaftToMountableComponentConnectionCompoundModalAnalysis(_4658.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """ShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4608.ShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4608.ShaftToMountableComponentConnectionModalAnalysis]':
