...
class PartToPartShearCouplingCompoundModalAnalysis(_4692.CouplingCompoundModalAnalysis):
    """PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4592.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4592.PartToPartShearCouplingModalAnalysis]':
