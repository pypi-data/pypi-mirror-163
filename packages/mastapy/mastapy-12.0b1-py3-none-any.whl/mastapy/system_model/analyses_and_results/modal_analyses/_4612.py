...
from mastapy.system_model.analyses_and_results.modal_analyses import _4611, _4610, _4520
...
class SpiralBevelGearSetModalAnalysis(_4520.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4611.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4610.SpiralBevelGearMeshModalAnalysis]':
