...
class StraightBevelGearMeshModalAnalysis(_4518.BevelGearMeshModalAnalysis):
    """StraightBevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2750.StraightBevelGearMeshSystemDeflection':
