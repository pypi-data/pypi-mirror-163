...
class BevelDifferentialSunGearModalAnalysis(_4514.BevelDifferentialGearModalAnalysis):
    """BevelDifferentialSunGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2639.BevelDifferentialSunGearSystemDeflection':
