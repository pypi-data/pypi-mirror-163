...
class BoltCompoundSteadyStateSynchronousResponseOnAShaft(_3334.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """BoltCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3199.BoltSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3199.BoltSteadyStateSynchronousResponseOnAShaft]':
