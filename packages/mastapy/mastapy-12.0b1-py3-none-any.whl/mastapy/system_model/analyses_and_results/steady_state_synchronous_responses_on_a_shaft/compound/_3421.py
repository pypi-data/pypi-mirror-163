...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft(_3414.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3292.StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3292.StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft]':
