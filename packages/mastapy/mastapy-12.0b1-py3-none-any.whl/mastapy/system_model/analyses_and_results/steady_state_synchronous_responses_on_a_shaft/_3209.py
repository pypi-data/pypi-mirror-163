...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3210, _3208, _3238
...
class ConceptGearSetSteadyStateSynchronousResponseOnAShaft(_3238.GearSetSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def concept_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3210.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3208.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
