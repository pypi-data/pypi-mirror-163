...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3192, _3190, _3196
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(_3196.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3192.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3190.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft]':
