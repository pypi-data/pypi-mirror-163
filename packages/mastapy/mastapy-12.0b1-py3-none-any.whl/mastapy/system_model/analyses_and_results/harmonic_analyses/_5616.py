...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5614, _5615, _5621
...
class BevelDifferentialGearSetHarmonicAnalysis(_5621.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5614.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_harmonic_analysis(self) -> 'List[_5614.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5615.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_harmonic_analysis(self) -> 'List[_5615.BevelDifferentialGearMeshHarmonicAnalysis]':
