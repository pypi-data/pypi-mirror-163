...
class RollingRingCompoundHarmonicAnalysis(_5835.CouplingHalfCompoundHarmonicAnalysis):
    """RollingRingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5722.RollingRingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5722.RollingRingHarmonicAnalysis]':
