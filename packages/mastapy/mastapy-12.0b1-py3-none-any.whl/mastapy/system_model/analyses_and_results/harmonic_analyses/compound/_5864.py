...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_5830.ConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5695.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5695.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
