...
class WormGearMeshCompoundHarmonicAnalysis(_5855.GearMeshCompoundHarmonicAnalysis):
    """WormGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5756.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5756.WormGearMeshHarmonicAnalysis]':
