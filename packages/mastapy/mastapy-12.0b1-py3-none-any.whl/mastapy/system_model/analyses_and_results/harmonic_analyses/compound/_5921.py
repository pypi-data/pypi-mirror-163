...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5919, _5920, _5856
...
class WormGearSetCompoundHarmonicAnalysis(_5856.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5757.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis(self) -> 'List[_5919.WormGearCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis(self) -> 'List[_5920.WormGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5757.WormGearSetHarmonicAnalysis]':
