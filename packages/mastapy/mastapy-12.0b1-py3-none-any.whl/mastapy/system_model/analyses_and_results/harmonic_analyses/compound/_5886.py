...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_5861.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5719.RingPinsToDiscConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5719.RingPinsToDiscConnectionHarmonicAnalysis]':
