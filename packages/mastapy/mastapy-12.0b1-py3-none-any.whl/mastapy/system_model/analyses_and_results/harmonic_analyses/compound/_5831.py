...
class ConnectionCompoundHarmonicAnalysis(_7451.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5639.ConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5639.ConnectionHarmonicAnalysis]':
