...
class MeasurementComponentCompoundHarmonicAnalysis(_5918.VirtualComponentCompoundHarmonicAnalysis):
    """MeasurementComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5703.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5703.MeasurementComponentHarmonicAnalysis]':
