...
class ShaftHubConnectionCompoundHarmonicAnalysis(_5832.ConnectorCompoundHarmonicAnalysis):
    """ShaftHubConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5725.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5725.ShaftHubConnectionHarmonicAnalysis]':
