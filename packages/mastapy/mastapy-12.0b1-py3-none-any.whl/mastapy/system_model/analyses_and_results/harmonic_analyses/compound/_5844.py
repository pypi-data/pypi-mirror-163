...
class CylindricalGearMeshCompoundHarmonicAnalysis(_5855.GearMeshCompoundHarmonicAnalysis):
    """CylindricalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5652.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5652.CylindricalGearMeshHarmonicAnalysis]':
