...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5901, _5902, _5814
...
class StraightBevelDiffGearSetCompoundHarmonicAnalysis(_5814.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelDiffGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5738.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_harmonic_analysis(self) -> 'List[_5901.StraightBevelDiffGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_harmonic_analysis(self) -> 'List[_5902.StraightBevelDiffGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5738.StraightBevelDiffGearSetHarmonicAnalysis]':
