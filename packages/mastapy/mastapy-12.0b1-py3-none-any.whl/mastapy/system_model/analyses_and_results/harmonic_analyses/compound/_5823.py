...
class ConceptCouplingConnectionCompoundHarmonicAnalysis(_5834.CouplingConnectionCompoundHarmonicAnalysis):
    """ConceptCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5630.ConceptCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5630.ConceptCouplingConnectionHarmonicAnalysis]':
