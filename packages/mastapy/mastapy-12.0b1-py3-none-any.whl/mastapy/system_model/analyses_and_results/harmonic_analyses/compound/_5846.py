...
class CylindricalPlanetGearCompoundHarmonicAnalysis(_5843.CylindricalGearCompoundHarmonicAnalysis):
    """CylindricalPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5654.CylindricalPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5654.CylindricalPlanetGearHarmonicAnalysis]':
