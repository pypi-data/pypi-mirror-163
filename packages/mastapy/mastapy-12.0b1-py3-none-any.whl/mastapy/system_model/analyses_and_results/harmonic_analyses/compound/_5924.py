...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5922, _5923, _5814
...
class ZerolBevelGearSetCompoundHarmonicAnalysis(_5814.BevelGearSetCompoundHarmonicAnalysis):
    """ZerolBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5760.ZerolBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5922.ZerolBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5923.ZerolBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5760.ZerolBevelGearSetHarmonicAnalysis]':
