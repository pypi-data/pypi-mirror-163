...
class CylindricalGearCompoundHarmonicAnalysis(_5854.GearCompoundHarmonicAnalysis):
    """CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5651.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5651.CylindricalGearHarmonicAnalysis]':
