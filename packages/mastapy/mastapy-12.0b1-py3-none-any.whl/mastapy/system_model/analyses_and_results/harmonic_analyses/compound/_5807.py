...
class BevelDifferentialGearCompoundHarmonicAnalysis(_5812.BevelGearCompoundHarmonicAnalysis):
    """BevelDifferentialGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5614.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5614.BevelDifferentialGearHarmonicAnalysis]':
