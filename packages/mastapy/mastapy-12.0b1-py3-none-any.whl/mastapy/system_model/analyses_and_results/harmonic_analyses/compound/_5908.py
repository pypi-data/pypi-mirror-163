...
class StraightBevelSunGearCompoundHarmonicAnalysis(_5901.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5743.StraightBevelSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5743.StraightBevelSunGearHarmonicAnalysis]':
