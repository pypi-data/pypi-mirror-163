...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5812.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5736.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5736.StraightBevelDiffGearHarmonicAnalysis]':
