...
class CVTCompoundHarmonicAnalysis(_5806.BeltDriveCompoundHarmonicAnalysis):
    """CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5645.CVTHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5645.CVTHarmonicAnalysis]':
