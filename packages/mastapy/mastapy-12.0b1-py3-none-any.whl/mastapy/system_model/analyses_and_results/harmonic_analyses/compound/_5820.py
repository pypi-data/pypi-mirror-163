...
class CoaxialConnectionCompoundHarmonicAnalysis(_5893.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5627.CoaxialConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5627.CoaxialConnectionHarmonicAnalysis]':
