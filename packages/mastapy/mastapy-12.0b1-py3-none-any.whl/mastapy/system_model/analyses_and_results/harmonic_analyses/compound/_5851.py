...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5849, _5850, _5856
...
class FaceGearSetCompoundHarmonicAnalysis(_5856.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5671.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def face_gears_compound_harmonic_analysis(self) -> 'List[_5849.FaceGearCompoundHarmonicAnalysis]':
    ...
    @property
    def face_meshes_compound_harmonic_analysis(self) -> 'List[_5850.FaceGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5671.FaceGearSetHarmonicAnalysis]':
