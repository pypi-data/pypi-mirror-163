...
class SpiralBevelGearCompoundHarmonicAnalysis(_5812.BevelGearCompoundHarmonicAnalysis):
    """SpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5730.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5730.SpiralBevelGearHarmonicAnalysis]':
