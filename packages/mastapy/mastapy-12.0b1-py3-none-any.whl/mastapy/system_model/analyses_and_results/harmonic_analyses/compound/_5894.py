...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5796
...
class SpecialisedAssemblyCompoundHarmonicAnalysis(_5796.AbstractAssemblyCompoundHarmonicAnalysis):
    """SpecialisedAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5728.SpecialisedAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5728.SpecialisedAssemblyHarmonicAnalysis]':
