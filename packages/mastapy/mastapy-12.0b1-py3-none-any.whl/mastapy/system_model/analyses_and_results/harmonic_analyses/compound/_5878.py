...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysis(_5835.CouplingHalfCompoundHarmonicAnalysis):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5708.PartToPartShearCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5708.PartToPartShearCouplingHalfHarmonicAnalysis]':
