...
class ConicalGearCompoundHarmonicAnalysis(_5854.GearCompoundHarmonicAnalysis):
    """ConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5636.ConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5636.ConicalGearHarmonicAnalysis]':
