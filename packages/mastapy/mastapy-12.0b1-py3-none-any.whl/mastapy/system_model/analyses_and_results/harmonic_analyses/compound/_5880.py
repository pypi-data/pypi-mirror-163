...
class PlanetaryGearSetCompoundHarmonicAnalysis(_5845.CylindricalGearSetCompoundHarmonicAnalysis):
    """PlanetaryGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5712.PlanetaryGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5712.PlanetaryGearSetHarmonicAnalysis]':
