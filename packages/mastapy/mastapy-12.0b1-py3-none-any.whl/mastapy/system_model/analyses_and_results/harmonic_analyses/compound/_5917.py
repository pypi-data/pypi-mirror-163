...
class UnbalancedMassCompoundHarmonicAnalysis(_5918.VirtualComponentCompoundHarmonicAnalysis):
    """UnbalancedMassCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5753.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5753.UnbalancedMassHarmonicAnalysis]':
