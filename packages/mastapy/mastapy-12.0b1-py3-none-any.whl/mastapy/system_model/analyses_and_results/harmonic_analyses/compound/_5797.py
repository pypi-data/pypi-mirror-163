...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5798
...
class AbstractShaftCompoundHarmonicAnalysis(_5798.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    """AbstractShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5604.AbstractShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5604.AbstractShaftHarmonicAnalysis]':
