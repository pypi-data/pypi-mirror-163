...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5791, _5779
...
class HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic(_5779.HarmonicAnalysisResultsBrokenDownByLocationWithinAHarmonic):
    """HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic
    ...
    @property
    def acceleration(self) -> '_5791.ResultsForResponseOfANodeOnAHarmonic':
    ...
    @property
    def displacement(self) -> '_5791.ResultsForResponseOfANodeOnAHarmonic':
    ...
    @property
    def force(self) -> '_5791.ResultsForResponseOfANodeOnAHarmonic':
    ...
    @property
    def velocity(self) -> '_5791.ResultsForResponseOfANodeOnAHarmonic':
