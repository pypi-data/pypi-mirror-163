...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5781, _5788
...
class ResultsForOrderIncludingSurfaces(_5788.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5781.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
