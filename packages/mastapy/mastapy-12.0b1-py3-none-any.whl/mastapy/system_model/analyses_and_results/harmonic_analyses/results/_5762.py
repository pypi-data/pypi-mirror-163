...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5765, _5763
...
class ExcitationSourceSelection(_5763.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5765.HarmonicSelection]':
