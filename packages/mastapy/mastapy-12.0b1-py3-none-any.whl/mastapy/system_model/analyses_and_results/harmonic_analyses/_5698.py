...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5696, _5697, _5695
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(_5695.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5696.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis(self) -> 'List[_5696.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5697.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis(self) -> 'List[_5697.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
