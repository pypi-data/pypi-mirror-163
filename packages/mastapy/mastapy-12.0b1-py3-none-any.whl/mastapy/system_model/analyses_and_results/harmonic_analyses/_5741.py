...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5739, _5740, _5621
...
class StraightBevelGearSetHarmonicAnalysis(_5621.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5739.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_harmonic_analysis(self) -> 'List[_5739.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5740.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis(self) -> 'List[_5740.StraightBevelGearMeshHarmonicAnalysis]':
