...
class StraightBevelDiffGearMesh(_2243.BevelGearMesh):
    """StraightBevelDiffGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_957.StraightBevelDiffGearMeshDesign':
    ...
    @property
    def straight_bevel_diff_gear_mesh_design(self) -> '_957.StraightBevelDiffGearMeshDesign':
