...
from mastapy.system_model.optimization import _2179, _2177
...
TStep = TypeVar('TStep', bound='_2177.OptimizationStep')


class OptimizationStrategy(_2179.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
