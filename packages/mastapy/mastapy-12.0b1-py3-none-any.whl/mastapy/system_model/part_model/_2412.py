...
from mastapy.system_model.part_model import _2389, _2421, _2419
from mastapy.math_utility.measured_data import _1525
from mastapy.system_model import _2162
from mastapy._internal.cast_exception import CastException
from mastapy.materials.efficiency import _289
...
class PowerLoad(_2419.VirtualComponent):
    """PowerLoad
    ...
    @property
    def electric_machine_search_region_specification_method(self) -> '_2389.ElectricMachineSearchRegionSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_2389.ElectricMachineSearchRegionSpecificationMethod)(value) if value is not None else None

    @electric_machine_search_region_specification_method.setter
    def electric_machine_search_region_specification_method(self, value: '_2389.ElectricMachineSearchRegionSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ElectricMachineSearchRegionSpecificationMethod = value

    @property
    def engine_fuel_consumption_grid(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def engine_fuel_consumption_grid(self, value: '_1525.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.EngineFuelConsumptionGrid = value

    @property
    def engine_torque_grid(self) -> '_1525.GriddedSurfaceAccessor':
    ...
    def engine_torque_grid(self, value: '_1525.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    def include_in_torsional_stiffness_calculation(self, value: 'bool'):
        self.wrapped.IncludeInTorsionalStiffnessCalculation = bool(value) if value else False
    ...
    @property
    def oil_pump_detail(self) -> '_289.OilPumpDetail':
    ...
    @property
    def single_blade_details(self) -> '_2421.WindTurbineSingleBladeDetails':
