...
from mastapy.system_model.part_model import _2377
...
class FEPart(_2377.AbstractShaftOrHousing):
    """FEPart
    ...
    def create_fe_substructure(self) -> '_2322.FESubstructure':
    ...
    def create_fe_substructure_with_name(self, name: 'str') -> '_2322.FESubstructure':
        """ 'CreateFESubstructure' is the original name of this method.
    ...
    def remove_fe_substructure(self, fe_substructure: '_2322.FESubstructure') -> 'bool':
    ...
    def select_fe_substructure(self, fe_substructure: '_2322.FESubstructure'):
