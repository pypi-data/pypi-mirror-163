...
from mastapy.system_model.part_model.part_groups import _2428, _2426
...
class ConcentricPartGroup(_2426.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2428.ConcentricPartGroupParallelToThis]':
