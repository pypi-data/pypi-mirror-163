...
from mastapy.system_model.part_model import _2401, _2404
...
class PlanetCarrier(_2404.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_2228.PlanetarySocket]':
    ...
    def attach_carrier_shaft(self, shaft: '_2422.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2422.Shaft', offset: Optional['float'] = float('nan')):
