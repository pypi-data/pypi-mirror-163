...
from mastapy.utility.enums import _1775
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1775.BearingForceArrowOption':
        ...
        return constructor.new_from_mastapy_type(_1775.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1775.BearingForceArrowOption'):
