...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6923, _6924
...
class AdvancedTimeSteppingAnalysisForModulationModeViewOptions(_0.APIBase):
    ...
    @property
    def excitations_type(self) -> '_6923.AtsamExcitationsOrOthers':
        """AtsamExcitationsOrOthers: 'ExcitationsType' is the original name of this property."""

        temp = self.wrapped.ExcitationsType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_6923.AtsamExcitationsOrOthers)(value) if value is not None else None

    @excitations_type.setter
    def excitations_type(self, value: '_6923.AtsamExcitationsOrOthers'):
    ...
    @property
    def mode_view_options(self) -> '_6924.AtsamNaturalFrequencyViewOption':
        """AtsamNaturalFrequencyViewOption: 'ModeViewOptions' is the original name of this property."""

        temp = self.wrapped.ModeViewOptions
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_6924.AtsamNaturalFrequencyViewOption)(value) if value is not None else None

    @mode_view_options.setter
    def mode_view_options(self, value: '_6924.AtsamNaturalFrequencyViewOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
