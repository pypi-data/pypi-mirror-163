...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5767, _5766
from mastapy.utility import _1549
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self) -> '_1448.Range':
    ...
    def filtering_frequency_range(self, value: '_1448.Range'):
        value = value.wrapped if value else None
        self.wrapped.FilteringFrequencyRange = value

    @property
    def filtering_method(self) -> '_5767.ModalContributionFilteringMethod':
        ...
        return constructor.new_from_mastapy_type(_5767.ModalContributionFilteringMethod)(value) if value is not None else None

    @filtering_method.setter
    def filtering_method(self, value: '_5767.ModalContributionFilteringMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FilteringMethod = value

    @property
    def frequency_range(self) -> '_1448.Range':
    ...
    def frequency_range(self, value: '_1448.Range'):
        value = value.wrapped if value else None
    ...
    @property
    def index_range(self) -> '_1549.IntegerRange':
    ...
    @index_range.setter
    def index_range(self, value: '_1549.IntegerRange'):
        value = value.wrapped if value else None
        self.wrapped.IndexRange = value

    @property
    def modes_to_display(self) -> '_5766.ModalContributionDisplayMethod':
        """ModalContributionDisplayMethod: 'ModesToDisplay' is the original name of this property."""

        temp = self.wrapped.ModesToDisplay
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5766.ModalContributionDisplayMethod)(value) if value is not None else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5766.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
