...
from mastapy.electric_machines.harmonic_load_data import (
    _1345, _1342, _1347, _1346
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility_gui.charts import (
    _1814, _1815, _1805, _1810,
    _1812
)
...
class ElectricMachineHarmonicLoadDataBase(_1346.SpeedDependentHarmonicLoadData):
    """ElectricMachineHarmonicLoadDataBase
    ...
    @property
    def force_distribution_3d(self) -> '_1814.ThreeDVectorChartDefinition':
    ...
    @property
    def temporal_spatial_harmonics_chart(self) -> '_1815.TwoDChartDefinition':
        """TwoDChartDefinition: 'TemporalSpatialHarmonicsChart' is the original name of this property.
        ...
        if _1815.TwoDChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast temporal_spatial_harmonics_chart to TwoDChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))
    ...
    def use_log_scale_for_temporal_spatial_harmonics_chart(self, value: 'bool'):
        self.wrapped.UseLogScaleForTemporalSpatialHarmonicsChart = bool(value) if value else False

    @property
    def stator_axial_loads(self) -> '_1347.StatorToothLoadInterpolator':
    ...
    @property
    def stator_radial_loads(self) -> '_1347.StatorToothLoadInterpolator':
    ...
    @property
    def stator_tangential_loads(self) -> '_1347.StatorToothLoadInterpolator':
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', slice_index: 'int') -> '_1479.MultipleFourierSeriesInterpolator':
    ...
    def stator_tooth_load_interpolator_for(self, harmonic_load_data_type: '_1345.HarmonicLoadDataType', slice_index: 'int') -> '_1347.StatorToothLoadInterpolator':
