...
from mastapy.electric_machines import _1251, _1271
...
class VShapedMagnetLayerSpecification(_1271.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def upper_flux_barrier_web_specification(self) -> '_1251.FluxBarrierOrWeb':
        ...
        return constructor.new_from_mastapy_type(_1251.FluxBarrierOrWeb)(value) if value is not None else None

    @upper_flux_barrier_web_specification.setter
    def upper_flux_barrier_web_specification(self, value: '_1251.FluxBarrierOrWeb'):
