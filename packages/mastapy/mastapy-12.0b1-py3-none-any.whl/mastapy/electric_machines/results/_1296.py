...
from mastapy.electric_machines.results import _1310, _1311
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def linear_dq_model_chart(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def on_load_results(self) -> '_1310.OnLoadElectricMachineResults':
    ...
    @property
    def open_circuit_results(self) -> '_1311.OpenCircuitElectricMachineResults':
    ...
    @property
    def all_on_load_results(self) -> 'List[_1310.OnLoadElectricMachineResults]':
    ...
    @property
    def all_open_circuit_results(self) -> 'List[_1311.OpenCircuitElectricMachineResults]':
    ...
    @property
    def on_load_results_for_slices(self) -> 'List[_1310.OnLoadElectricMachineResults]':
    ...
    @property
    def open_circuit_results_for_slices(self) -> 'List[_1311.OpenCircuitElectricMachineResults]':
