...
class AbstractStator(_0.APIBase):
    ...
    def stator_length(self, value: 'float'):
        self.wrapped.StatorLength = float(value) if value else 0.0
    ...
    def stator_material_database(self, value: 'str'):
        self.wrapped.StatorMaterialDatabase.SetSelectedItem(str(value) if value else '')

    @property
    def tooth_and_slot(self) -> '_1230.AbstractToothAndSlot':
        ...
        if _1230.AbstractToothAndSlot.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def tooth_and_slot_of_type_cad_tooth_and_slot(self) -> '_1235.CADToothAndSlot':
        ...
        temp = self.wrapped.ToothAndSlot
        if _1235.CADToothAndSlot.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def tooth_and_slot_of_type_tooth_and_slot(self) -> '_1282.ToothAndSlot':
        ...
        temp = self.wrapped.ToothAndSlot
        if _1282.ToothAndSlot.TYPE not in temp.__class__.__mro__:
