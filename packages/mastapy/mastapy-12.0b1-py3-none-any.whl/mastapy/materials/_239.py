...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self) -> '_1493.Vector2DListAccessor':
    ...
    @bh_curve.setter
    def bh_curve(self, value: '_1493.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.BHCurve = value

    @property
    def bh_curve_plot(self) -> '_1815.TwoDChartDefinition':
    ...
    @property
    def bh_curve_extrapolation_method(self) -> '_238.BHCurveExtrapolationMethod':
        ...
        return constructor.new_from_mastapy_type(_238.BHCurveExtrapolationMethod)(value) if value is not None else None

    @bh_curve_extrapolation_method.setter
    def bh_curve_extrapolation_method(self, value: '_238.BHCurveExtrapolationMethod'):
