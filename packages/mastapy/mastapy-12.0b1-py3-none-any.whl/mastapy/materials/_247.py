...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_250.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new_from_mastapy_type(_250.ISO76StaticSafetyFactorLimits)(value) if value is not None else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_250.ISO76StaticSafetyFactorLimits'):
    ...
    @property
    def driven_machine_characteristics(self) -> '_282.WorkingCharacteristics':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_282.WorkingCharacteristics)(value) if value is not None else None

    @driven_machine_characteristics.setter
    def driven_machine_characteristics(self, value: '_282.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def driving_machine_characteristics(self) -> '_282.WorkingCharacteristics':
    ...
    def driving_machine_characteristics(self, value: '_282.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gearing_type(self) -> '_246.GearingTypes':
        """GearingTypes: 'GearingType' is the original name of this property."""

        temp = self.wrapped.GearingType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_246.GearingTypes)(value) if value is not None else None

    @gearing_type.setter
    def gearing_type(self, value: '_246.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transmission_application(self) -> '_278.TransmissionApplications':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_278.TransmissionApplications)(value) if value is not None else None

    @transmission_application.setter
    def transmission_application(self, value: '_278.TransmissionApplications'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TransmissionApplication = value

    @property
    def wind_turbine_standard(self) -> '_281.WindTurbineStandards':
        """WindTurbineStandards: 'WindTurbineStandard' is the original name of this property."""

        temp = self.wrapped.WindTurbineStandard
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_281.WindTurbineStandards)(value) if value is not None else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_281.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def air_properties(self) -> '_234.AirProperties':
    ...
    @property
    def vehicle_dynamics(self) -> '_280.VehicleDynamicsProperties':
