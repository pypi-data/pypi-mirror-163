...
from mastapy.materials import _249, _265
...
class Material(_1785.NamedDatabaseItem):
    """Material
    ...
    @property
    def hardness_type(self) -> '_249.HardnessType':
        """HardnessType: 'HardnessType' is the original name of this property."""

        temp = self.wrapped.HardnessType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_249.HardnessType)(value) if value is not None else None

    @hardness_type.setter
    def hardness_type(self, value: '_249.HardnessType'):
    ...
    @property
    def standard(self) -> '_265.MaterialStandards':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_265.MaterialStandards)(value) if value is not None else None
