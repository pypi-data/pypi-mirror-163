...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_229.AcousticRadiationEfficiencyInputType':
        """AcousticRadiationEfficiencyInputType: 'InputType' is the original name of this property."""

        temp = self.wrapped.InputType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_229.AcousticRadiationEfficiencyInputType)(value) if value is not None else None

    @input_type.setter
    def input_type(self, value: '_229.AcousticRadiationEfficiencyInputType'):
    ...
    @property
    def radiation_efficiency_curve(self) -> '_1493.Vector2DListAccessor':
    ...
    def radiation_efficiency_curve(self, value: '_1493.Vector2DListAccessor'):
