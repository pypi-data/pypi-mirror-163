...
from mastapy.bearings.bearing_results.rolling import _1956, _1947
...
class LoadedDeepGrooveBallBearingRow(_1947.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1956.LoadedDeepGrooveBallBearingResults':
