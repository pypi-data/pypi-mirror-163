...
from mastapy.bearings.bearing_results.rolling import _1995, _1947
...
class LoadedThreePointContactBallBearingRow(_1947.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1995.LoadedThreePointContactBallBearingResults':
