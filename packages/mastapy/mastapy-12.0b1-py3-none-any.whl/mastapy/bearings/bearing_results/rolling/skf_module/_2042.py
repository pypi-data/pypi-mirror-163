...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self) -> '_2020.AdjustedSpeed':
    ...
    @property
    def bearing_loads(self) -> '_2022.BearingLoads':
    ...
    @property
    def bearing_rating_life(self) -> '_2023.BearingRatingLife':
    ...
    @property
    def dynamic_axial_load_carrying_capacity(self) -> '_2024.DynamicAxialLoadCarryingCapacity':
    ...
    @property
    def frequencies(self) -> '_2025.Frequencies':
    ...
    @property
    def friction(self) -> '_2027.Friction':
    ...
    @property
    def grease_life_and_relubrication_interval(self) -> '_2031.GreaseLifeAndRelubricationInterval':
    ...
    @property
    def minimum_load(self) -> '_2035.MinimumLoad':
    ...
    @property
    def static_safety_factors(self) -> '_2043.StaticSafetyFactors':
    ...
    @property
    def viscosities(self) -> '_2044.Viscosities':
