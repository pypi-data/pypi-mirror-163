...
from mastapy.bearings.bearing_results.rolling.skf_module import _2021, _2040
...
class AdjustedSpeed(_2040.SKFCalculationResult):
    """AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_2021.AdjustmentFactors':
