...
from mastapy.bearings.bearing_results.rolling import _2016, _1973
...
class LoadedNonBarrelRollerBearingResults(_1973.LoadedRollerBearingResults):
    """LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_2016.SMTRibStressResults':
