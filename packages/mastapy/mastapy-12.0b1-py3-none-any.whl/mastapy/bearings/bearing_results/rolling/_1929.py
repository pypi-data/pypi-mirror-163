...
from mastapy.bearings.bearing_results.rolling import _1926
...
class LoadedAngularContactThrustBallBearingElement(_1926.LoadedAngularContactBallBearingElement):
    """LoadedAngularContactThrustBallBearingElement
