...
from mastapy.bearings.bearing_results.rolling import _1927
...
class LoadedAngularContactThrustBallBearingResults(_1927.LoadedAngularContactBallBearingResults):
    """LoadedAngularContactThrustBallBearingResults
