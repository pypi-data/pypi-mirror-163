...
from mastapy.bearings.bearing_results.rolling import _1965, _1954
...
class LoadedNeedleRollerBearingRow(_1954.LoadedCylindricalRollerBearingRow):
    """LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1965.LoadedNeedleRollerBearingResults':
