...
from mastapy.bearings.bearing_results.rolling import _1984, _1974
...
class LoadedSphericalRollerRadialBearingRow(_1974.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1984.LoadedSphericalRollerRadialBearingResults':
