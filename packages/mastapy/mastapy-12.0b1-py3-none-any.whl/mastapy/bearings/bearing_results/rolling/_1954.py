...
from mastapy.bearings.bearing_results.rolling import _1953, _1965, _1969
...
class LoadedCylindricalRollerBearingRow(_1969.LoadedNonBarrelRollerBearingRow):
    """LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1953.LoadedCylindricalRollerBearingResults':
