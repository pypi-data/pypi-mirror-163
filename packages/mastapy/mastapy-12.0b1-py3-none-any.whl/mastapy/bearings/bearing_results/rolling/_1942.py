...
from mastapy.bearings.bearing_results.rolling import _1941, _1939
...
class LoadedAxialThrustNeedleRollerBearingRow(_1939.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1941.LoadedAxialThrustNeedleRollerBearingResults':
