...
from mastapy.bearings.bearing_results.rolling import _1949, _1974
...
class LoadedCrossedRollerBearingRow(_1974.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1949.LoadedCrossedRollerBearingResults':
