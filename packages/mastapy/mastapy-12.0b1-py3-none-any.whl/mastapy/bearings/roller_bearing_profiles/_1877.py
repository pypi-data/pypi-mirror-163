...
from mastapy.bearings.roller_bearing_profiles import (
    _1885, _1879, _1880, _1881,
    _1882, _1883, _1884, _1886
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1840.RollerBearingProfileTypes':
        ...
        return constructor.new_from_mastapy_type(_1840.RollerBearingProfileTypes)(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1840.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1885.RollerBearingProfile':
        ...
        if _1885.RollerBearingProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1879.RollerBearingConicalProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1879.RollerBearingConicalProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1880.RollerBearingCrownedProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1880.RollerBearingCrownedProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1881.RollerBearingDinLundbergProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1881.RollerBearingDinLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1882.RollerBearingFlatProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1882.RollerBearingFlatProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1883.RollerBearingJohnsGoharProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1883.RollerBearingJohnsGoharProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1884.RollerBearingLundbergProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1884.RollerBearingLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1886.RollerBearingUserSpecifiedProfile':
        ...
        temp = self.wrapped.ActiveProfile
        if _1886.RollerBearingUserSpecifiedProfile.TYPE not in temp.__class__.__mro__:
