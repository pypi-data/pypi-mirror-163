...
from mastapy.bearings import _1849
from mastapy.bearings.bearing_designs.fluid_film import _2130
...
class TiltingPadThrustBearing(_2130.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1849.TiltingPadTypes':
        """TiltingPadTypes: 'TiltingPadType' is the original name of this property."""

        temp = self.wrapped.TiltingPadType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1849.TiltingPadTypes)(value) if value is not None else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1849.TiltingPadTypes'):
