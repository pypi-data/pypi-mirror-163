...
from mastapy.bearings import _1825
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import _2107, _2104
...
class TaperRollerBearing(_2104.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1825.BearingMeasurementType':
        ...
        return constructor.new_from_mastapy_type(_1825.BearingMeasurementType)(value) if value is not None else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1825.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_2107.RollerRibDetail':
        ...
        temp = self.wrapped.MajorRibDetail
        type_ = temp.GetType()
