...
class CylindricalRollerBearing(_2104.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    @property
    def permissible_axial_load_default_calculation_method(self) -> '_1891.CylindricalRollerMaxAxialLoadMethod':
        ...
        return constructor.new_from_mastapy_type(_1891.CylindricalRollerMaxAxialLoadMethod)(value) if value is not None else None

    @permissible_axial_load_default_calculation_method.setter
    def permissible_axial_load_default_calculation_method(self, value: '_1891.CylindricalRollerMaxAxialLoadMethod'):
