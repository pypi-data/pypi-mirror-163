...
from mastapy.bearings import (
    _1841, _1819, _1820, _1821,
    _1818, _1844
)
from mastapy.bearings.bearing_designs.rolling import (
    _2090, _2094, _2095, _2101,
    _2111, _2089, _2118, _2098,
    _2086, _2110
)
from mastapy._internal.python_net import python_net_import
from mastapy.materials import _236
from mastapy.utility import _1543
from mastapy.bearings.bearing_designs import _2074
...
class RollingBearing(_2074.DetailedBearing):
    """RollingBearing
    ...
    @property
    def cage_bridge_shape(self) -> '_2090.CageBridgeShape':
        """CageBridgeShape: 'CageBridgeShape' is the original name of this property."""

        temp = self.wrapped.CageBridgeShape
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2090.CageBridgeShape)(value) if value is not None else None

    @cage_bridge_shape.setter
    def cage_bridge_shape(self, value: '_2090.CageBridgeShape'):
    ...
    @property
    def cage_material(self) -> '_1821.BearingCageMaterial':
        """BearingCageMaterial: 'CageMaterial' is the original name of this property."""

        temp = self.wrapped.CageMaterial
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1821.BearingCageMaterial)(value) if value is not None else None

    @cage_material.setter
    def cage_material(self, value: '_1821.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def catalogue(self) -> '_1818.BearingCatalog':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1818.BearingCatalog)(value) if value is not None else None
    ...
    @property
    def sleeve_type(self) -> '_2111.SleeveType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2111.SleeveType)(value) if value is not None else None
    ...
    @property
    def type_information(self) -> '_2089.BearingTypeExtraInformation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2089.BearingTypeExtraInformation)(value) if value is not None else None
    ...
    @property
    def geometric_constants(self) -> '_2098.GeometricConstants':
    ...
    @property
    def history(self) -> '_1543.FileHistory':
    ...
    @property
    def protection(self) -> '_2086.BearingProtection':
    ...
    @property
    def skf_seal_frictional_moment_constants(self) -> '_2110.SKFSealFrictionalMomentConstants':
