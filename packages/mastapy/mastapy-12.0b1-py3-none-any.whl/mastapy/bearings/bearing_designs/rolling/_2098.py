...
from mastapy.bearings.bearing_designs.rolling import _2099, _2100
...
class GeometricConstants(_0.APIBase):
    ...
    @property
    def geometric_constants_for_rolling_frictional_moments(self) -> '_2099.GeometricConstantsForRollingFrictionalMoments':
    ...
    @property
    def geometric_constants_for_sliding_frictional_moments(self) -> '_2100.GeometricConstantsForSlidingFrictionalMoments':
