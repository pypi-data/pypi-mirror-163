...
from mastapy.bearings import _1838
from mastapy.bearings.bearing_designs.rolling import _2083
...
class ThrustBallBearing(_2083.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1838.OuterRingMounting':
        """OuterRingMounting: 'OuterRingMounting' is the original name of this property."""

        temp = self.wrapped.OuterRingMounting
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1838.OuterRingMounting)(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1838.OuterRingMounting'):
