...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2120, _2119
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2120.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2119.AbstractXmlVariableAssignment]':
