...
from mastapy.bearings.bearing_designs.concept import _2139, _2141
...
class ConceptAxialClearanceBearing(_2141.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2139.BearingNodePosition':
        """BearingNodePosition: 'NodePosition' is the original name of this property."""

        temp = self.wrapped.NodePosition
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2139.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2139.BearingNodePosition'):
