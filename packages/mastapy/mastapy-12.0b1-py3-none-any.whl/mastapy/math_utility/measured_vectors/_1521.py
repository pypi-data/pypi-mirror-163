...
class NodeResults(_0.APIBase):
    ...
    @property
    def node_results_in_local_coordinate_system(self) -> '_1519.ForceAndDisplacementResults':
    ...
    @property
    def node_results_in_world_coordinate_system(self) -> '_1519.ForceAndDisplacementResults':
