...
from mastapy.math_utility.optimisation import _1504
...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1504.OptimizationVariable]':
    ...
    @property
    def target_history(self) -> 'List[_1504.OptimizationVariable]':
    ...
    def add_input_history(self, value: '_1504.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1504.OptimizationVariable'):
