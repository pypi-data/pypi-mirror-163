...
from mastapy.math_utility.optimisation import _1517, _1516
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def integer_range(self) -> '_1549.IntegerRange':
    ...
    def integer_range(self, value: '_1549.IntegerRange'):
    ...
    @range.setter
    def range(self, value: '_1448.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def specification_type(self) -> '_1517.TargetingPropertyTo':
        """TargetingPropertyTo: 'SpecificationType' is the original name of this property."""

        temp = self.wrapped.SpecificationType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1517.TargetingPropertyTo)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1517.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1516.SpecifyOptimisationInputAs':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1516.SpecifyOptimisationInputAs)(value) if value is not None else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1516.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
