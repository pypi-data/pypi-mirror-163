...
from mastapy.math_utility import _1475
...
class MassProperties(_0.APIBase):
    ...
    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_1475.InertiaTensor':
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_1475.InertiaTensor':
