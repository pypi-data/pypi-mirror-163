...
from mastapy.cycloidal import _1421, _1420, _1415
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1421.RingPinsDesign':
    ...
    @property
    def disc_phases(self) -> 'List[_1420.NamedDiscPhase]':
    ...
    @property
    def discs(self) -> 'List[_1415.CycloidalDiscDesign]':
