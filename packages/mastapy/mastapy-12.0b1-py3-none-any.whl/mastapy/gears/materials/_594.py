...
from mastapy.materials import _279, _276, _277
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self) -> '_279.VDI2736LubricantType':
        """VDI2736LubricantType: 'Lubricant' is the original name of this property."""

        temp = self.wrapped.Lubricant
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_279.VDI2736LubricantType)(value) if value is not None else None

    @lubricant.setter
    def lubricant(self, value: '_279.VDI2736LubricantType'):
    ...
    @property
    def material(self) -> '_593.PlasticCylindricalGearMaterial':
    ...
    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_276.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
    ...
    @property
    def bending_stress_cycle_data(self) -> 'List[_276.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
    ...
    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_277.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
    ...
    @property
    def contact_stress_cycle_data(self) -> 'List[_277.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
