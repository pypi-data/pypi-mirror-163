...
from mastapy.gears.materials import _598, _584
...
class BevelGearMaterial(_584.GearMaterial):
    """BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_598.SNCurveDefinition':
        """SNCurveDefinition: 'SNCurveDefinition' is the original name of this property."""

        temp = self.wrapped.SNCurveDefinition
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_598.SNCurveDefinition)(value) if value is not None else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_598.SNCurveDefinition'):
