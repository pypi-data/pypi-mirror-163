...
from mastapy.gears.gear_designs.cylindrical import _1072, _1005
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.gears import _328
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.rating.cylindrical import _469, _445
from mastapy.materials import _247, _258
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1072.TolerancedMetalMeasurements':
        ...
        return constructor.new_from_mastapy_type(_1072.TolerancedMetalMeasurements)(value) if value is not None else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1072.TolerancedMetalMeasurements'):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_469.MisalignmentContactPatternEnhancements':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_469.MisalignmentContactPatternEnhancements)(value) if value is not None else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_469.MisalignmentContactPatternEnhancements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_design_constraint_settings(self) -> '_1005.CylindricalGearDesignConstraints':
    ...
    @property
    def general_transmission_properties(self) -> '_247.GeneralTransmissionProperties':
    ...
    @property
    def lubrication_detail(self) -> '_258.LubricationDetail':
    ...
    @property
    def settings(self) -> '_445.CylindricalGearDesignAndRatingSettingsItem':
