...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _407, _405
...
class KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating(_405.KlingelnbergConicalMeshSingleFlankRating):
    """KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_407.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
    ...
    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_407.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
