...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _408, _405
...
class KlingelnbergCycloPalloidHypoidMeshSingleFlankRating(_405.KlingelnbergConicalMeshSingleFlankRating):
    """KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_408.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
    ...
    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_408.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
