...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _409
...
class KlingelnbergCycloPalloidHypoidGearMeshRating(_402.KlingelnbergCycloPalloidConicalGearMeshRating):
    """KlingelnbergCycloPalloidHypoidGearMeshRating
    ...
    @property
    def kn3030_pitting_and_bending_klingelnberg_mesh_single_flank_rating(self) -> '_409.KlingelnbergCycloPalloidHypoidMeshSingleFlankRating':
    ...
    @property
    def kn3030_scuffing_klingelnberg_mesh_single_flank_rating(self) -> '_409.KlingelnbergCycloPalloidHypoidMeshSingleFlankRating':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_969.KlingelnbergCycloPalloidHypoidGearMeshDesign':
