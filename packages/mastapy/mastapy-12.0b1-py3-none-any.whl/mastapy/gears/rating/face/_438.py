...
from mastapy.gears.rating.face import _441, _439
from mastapy.gears.load_case.face import _871
from mastapy.gears.rating.cylindrical.iso6336 import _504, _506
...
class FaceGearMeshRating(_351.GearMeshRating):
    """FaceGearMeshRating
    ...
    @property
    def active_flank(self) -> '_317.GearFlanks':
        ...
        return constructor.new_from_mastapy_type(_317.GearFlanks)(value) if value is not None else None

    @property
    def face_gear_mesh(self) -> '_982.FaceGearMeshDesign':
    ...
    @property
    def gear_set_rating(self) -> '_441.FaceGearSetRating':
    ...
    @property
    def mesh_load_case(self) -> '_871.FaceMeshLoadCase':
    ...
    @property
    def mesh_single_flank_rating(self) -> '_504.ISO63362006MeshSingleFlankRating':
