...
from mastapy.gears.rating import _344, _345
...
class AbstractGearSetRating(_1203.AbstractGearSetAnalysis):
    """AbstractGearSetRating
    ...
    @property
    def gear_mesh_ratings(self) -> 'List[_344.AbstractGearMeshRating]':
    ...
    @property
    def gear_ratings(self) -> 'List[_345.AbstractGearRating]':
