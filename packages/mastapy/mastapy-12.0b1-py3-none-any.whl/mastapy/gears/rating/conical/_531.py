...
class ConicalGearSetDutyCycleRating(_353.GearSetDutyCycleRating):
    """ConicalGearSetDutyCycleRating
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self) -> 'List[_534.ConicalMeshDutyCycleRating]':
    ...
    @property
    def conical_mesh_duty_cycle_ratings(self) -> 'List[_534.ConicalMeshDutyCycleRating]':
