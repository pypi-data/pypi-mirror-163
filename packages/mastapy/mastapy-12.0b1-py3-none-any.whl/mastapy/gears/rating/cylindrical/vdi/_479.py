...
from mastapy.gears.rating.cylindrical.din3990 import _522
...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_509.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        if _509.ISO6336AbstractMetalGearSingleFlankRating.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_501.ISO63361996GearSingleFlankRating':
        ...
        temp = self.wrapped.ISOGearRating
        if _501.ISO63361996GearSingleFlankRating.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_503.ISO63362006GearSingleFlankRating':
        ...
        temp = self.wrapped.ISOGearRating
        if _503.ISO63362006GearSingleFlankRating.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_505.ISO63362019GearSingleFlankRating':
        ...
        temp = self.wrapped.ISOGearRating
        if _505.ISO63362019GearSingleFlankRating.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_522.DIN3990GearSingleFlankRating':
        ...
        temp = self.wrapped.ISOGearRating
        if _522.DIN3990GearSingleFlankRating.TYPE not in temp.__class__.__mro__:
