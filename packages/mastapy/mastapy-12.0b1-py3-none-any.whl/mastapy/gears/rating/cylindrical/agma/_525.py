...
from mastapy.gears.gear_designs.cylindrical import _1018, _1062
from mastapy.gears.rating.cylindrical.agma import _527, _524
...
class AGMA2101MeshSingleFlankRating(_458.CylindricalMeshSingleFlankRating):
    """AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_1062.ScuffingTemperatureMethodsAGMA':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1062.ScuffingTemperatureMethodsAGMA)(value) if value is not None else None
    ...
    @property
    def thermal_reduction_factor_factors_and_exponents(self) -> '_527.ThermalReductionFactorFactorsAndExponents':
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_524.AGMA2101GearSingleFlankRating]':
    ...
    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_524.AGMA2101GearSingleFlankRating]':
