...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_518.ToothFlankFractureAnalysisPoint':
    ...
    @property
    def watch_points(self) -> 'List[_518.ToothFlankFractureAnalysisPoint]':
