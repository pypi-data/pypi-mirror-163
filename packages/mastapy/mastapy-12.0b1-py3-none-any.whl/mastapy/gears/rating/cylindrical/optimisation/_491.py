...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def helix_angle_optimisation_results(self) -> '_492.OptimisationResultsPair[_495.SafetyFactorOptimisationStepResultAngle]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_495.SafetyFactorOptimisationStepResultAngle](temp) if temp is not None else None

    @property
    def normal_module_optimisation_results(self) -> '_492.OptimisationResultsPair[_497.SafetyFactorOptimisationStepResultShortLength]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_497.SafetyFactorOptimisationStepResultShortLength](temp) if temp is not None else None

    @property
    def pressure_angle_optimisation_results(self) -> '_492.OptimisationResultsPair[_495.SafetyFactorOptimisationStepResultAngle]':
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_492.OptimisationResultsPair[_496.SafetyFactorOptimisationStepResultNumber]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_496.SafetyFactorOptimisationStepResultNumber](temp) if temp is not None else None

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_493.SafetyFactorOptimisationResults[_495.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_normal_module_optimisation_results(self) -> 'List[_493.SafetyFactorOptimisationResults[_497.SafetyFactorOptimisationStepResultShortLength]]':
    ...
    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_493.SafetyFactorOptimisationResults[_495.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_493.SafetyFactorOptimisationResults[_496.SafetyFactorOptimisationStepResultNumber]]':
    ...
    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_493.SafetyFactorOptimisationResults[_495.SafetyFactorOptimisationStepResultAngle]]':
