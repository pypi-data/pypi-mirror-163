...
class AGMAScuffingResultsRow(_474.ScuffingResultsRow):
    """AGMAScuffingResultsRow
    ...
    def central_film_thickness_isothermal(self, value: 'float'):
        self.wrapped.CentralFilmThicknessIsothermal = float(value) if value else 0.0
    ...
    def central_film_thickness_with_inlet_shear_heating(self, value: 'float'):
        self.wrapped.CentralFilmThicknessWithInletShearHeating = float(value) if value else 0.0
    ...
    def hertzian_stress(self, value: 'float'):
        self.wrapped.HertzianStress = float(value) if value else 0.0
    ...
    def slideto_roll_ratio(self, value: 'float'):
        self.wrapped.SlidetoRollRatio = float(value) if value else 0.0
    ...
    def specific_film_thickness_with_filter_cutoff_wave_length_isothermal(self, value: 'float'):
        self.wrapped.SpecificFilmThicknessWithFilterCutoffWaveLengthIsothermal = float(value) if value else 0.0
    ...
    def specific_film_thickness_with_filter_cutoff_wave_length_with_inlet_shear_heating(self, value: 'float'):
        self.wrapped.SpecificFilmThicknessWithFilterCutoffWaveLengthWithInletShearHeating = float(value) if value else 0.0
    ...
    def thermal_loading_parameter(self, value: 'float'):
        self.wrapped.ThermalLoadingParameter = float(value) if value else 0.0
    ...
    def thermal_reduction_factor(self, value: 'float'):
        self.wrapped.ThermalReductionFactor = float(value) if value else 0.0
