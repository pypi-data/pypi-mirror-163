...
class MicroPittingResultsRow(_0.APIBase):
    ...
    def mesh(self, value: 'str'):
        self.wrapped.Mesh = str(value) if value else ''
    ...
    @property
    def position_on_pinion(self) -> '_1016.CylindricalGearProfileMeasurement':
    ...
    @property
    def position_on_wheel(self) -> '_1016.CylindricalGearProfileMeasurement':
