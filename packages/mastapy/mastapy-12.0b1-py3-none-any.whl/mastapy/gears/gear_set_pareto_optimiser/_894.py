...
from mastapy.utility.reporting_property_framework import _1747
...
from mastapy.gears.analysis import _1203
...
TAnalysis = TypeVar('TAnalysis', bound='_1203.AbstractGearSetAnalysis')
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self) -> '_1747.CustomChartType':
        ...
        return constructor.new_from_mastapy_type(_1747.CustomChartType)(value) if value is not None else None
    ...
    @property
    def select_chart_type(self) -> '_1510.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1510.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value is not None else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1510.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
    ...
    @property
    def optimiser(self) -> '_896.DesignSpaceSearchBase[TAnalysis, TCandidate]':
        ...
        if _896.DesignSpaceSearchBase[TAnalysis, TCandidate].TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_cylindrical_gear_set_pareto_optimiser(self) -> '_895.CylindricalGearSetParetoOptimiser':
        ...
        temp = self.wrapped.Optimiser
        if _895.CylindricalGearSetParetoOptimiser.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_face_gear_set_pareto_optimiser(self) -> '_898.FaceGearSetParetoOptimiser':
        ...
        temp = self.wrapped.Optimiser
        if _898.FaceGearSetParetoOptimiser.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_gear_set_pareto_optimiser(self) -> '_902.GearSetParetoOptimiser':
        ...
        temp = self.wrapped.Optimiser
        if _902.GearSetParetoOptimiser.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_hypoid_gear_set_pareto_optimiser(self) -> '_903.HypoidGearSetParetoOptimiser':
        ...
        temp = self.wrapped.Optimiser
        if _903.HypoidGearSetParetoOptimiser.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_design_space_search(self) -> '_906.MicroGeometryDesignSpaceSearch':
        ...
        temp = self.wrapped.Optimiser
        if _906.MicroGeometryDesignSpaceSearch.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_909.MicroGeometryGearSetDesignSpaceSearch':
        ...
        temp = self.wrapped.Optimiser
        if _909.MicroGeometryGearSetDesignSpaceSearch.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_spiral_bevel_gear_set_pareto_optimiser(self) -> '_928.SpiralBevelGearSetParetoOptimiser':
        ...
        temp = self.wrapped.Optimiser
        if _928.SpiralBevelGearSetParetoOptimiser.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_straight_bevel_gear_set_pareto_optimiser(self) -> '_929.StraightBevelGearSetParetoOptimiser':
        ...
        temp = self.wrapped.Optimiser
        if _929.StraightBevelGearSetParetoOptimiser.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def bars(self) -> 'List[_892.BarForPareto[TAnalysis, TCandidate]]':
    ...
    @property
    def input_sliders(self) -> 'List[_904.InputSliderForPareto[TAnalysis, TCandidate]]':
