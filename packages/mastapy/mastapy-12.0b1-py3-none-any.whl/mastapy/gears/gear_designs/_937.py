...
from mastapy.utility.property import _1792
...
class DesignConstraintsCollection(_1785.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1792.DeletableCollectionMember[_935.DesignConstraint]]':
