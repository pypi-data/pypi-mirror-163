...
class GearSetDesign(_939.GearDesignComponent):
    """GearSetDesign
    ...
    @property
    def active_ltcafe_model(self) -> '_1188.GearSetFEModel':
        ...
        if _1188.GearSetFEModel.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1191.CylindricalGearSetFEModel':
        ...
        temp = self.wrapped.ActiveLTCAFEModel
        if _1191.CylindricalGearSetFEModel.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_1194.ConicalSetFEModel':
        ...
        temp = self.wrapped.ActiveLTCAFEModel
        if _1194.ConicalSetFEModel.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_1188.GearSetFEModel':
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1191.CylindricalGearSetFEModel':
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_1194.ConicalSetFEModel':
    ...
    @property
    def transmission_properties_gears(self) -> '_319.GearSetDesignGroup':
    ...
    @property
    def gears(self) -> 'List[_938.GearDesign]':
    ...
    @property
    def ltcafe_models(self) -> 'List[_1188.GearSetFEModel]':
