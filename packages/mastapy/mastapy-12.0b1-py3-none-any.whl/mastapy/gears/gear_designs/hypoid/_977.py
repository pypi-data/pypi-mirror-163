...
from mastapy.gears.gear_designs.hypoid import _978, _976, _979
...
class HypoidGearMeshDesign(_1182.AGMAGleasonConicalGearMeshDesign):
    """HypoidGearMeshDesign
    ...
    @property
    def hypoid_gear_set(self) -> '_978.HypoidGearSetDesign':
    ...
    @property
    def hypoid_meshed_gears(self) -> 'List[_979.HypoidMeshedGearDesign]':
