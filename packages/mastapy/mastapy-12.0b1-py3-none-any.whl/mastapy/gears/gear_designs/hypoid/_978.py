...
from mastapy.gears.gear_designs.hypoid import _976, _977
...
class HypoidGearSetDesign(_1183.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_976.HypoidGearDesign]':
    ...
    @property
    def hypoid_gears(self) -> 'List[_976.HypoidGearDesign]':
    ...
    @property
    def meshes(self) -> 'List[_977.HypoidGearMeshDesign]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_977.HypoidGearMeshDesign]':
