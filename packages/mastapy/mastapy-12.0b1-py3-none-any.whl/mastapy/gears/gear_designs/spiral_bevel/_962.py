...
from mastapy.gears.gear_designs.spiral_bevel import _960, _961
...
class SpiralBevelGearSetDesign(_1170.BevelGearSetDesign):
    """SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_960.SpiralBevelGearDesign]':
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_960.SpiralBevelGearDesign]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_961.SpiralBevelGearMeshDesign]':
