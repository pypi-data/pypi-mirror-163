...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1119, _1107, _1114
...
class CylindricalGearTriangularEndModificationAtOrientation(_0.APIBase):
    ...
    @property
    def linear(self) -> '_1119.SingleCylindricalGearTriangularEndModification':
        ...
        if _1119.SingleCylindricalGearTriangularEndModification.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def linear_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1107.LinearCylindricalGearTriangularEndModification':
        ...
        temp = self.wrapped.Linear
        if _1107.LinearCylindricalGearTriangularEndModification.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def linear_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1114.ParabolicCylindricalGearTriangularEndModification':
        ...
        temp = self.wrapped.Linear
        if _1114.ParabolicCylindricalGearTriangularEndModification.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parabolic(self) -> '_1119.SingleCylindricalGearTriangularEndModification':
    ...
    @property
    def parabolic_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1107.LinearCylindricalGearTriangularEndModification':
    ...
    @property
    def parabolic_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1114.ParabolicCylindricalGearTriangularEndModification':
