...
class CylindricalGearTriangularEndModification(_569.Modification):
    """CylindricalGearTriangularEndModification
    ...
    @property
    def root_left(self) -> '_1101.CylindricalGearTriangularEndModificationAtOrientation':
    ...
    @property
    def root_right(self) -> '_1101.CylindricalGearTriangularEndModificationAtOrientation':
    ...
    @property
    def tip_left(self) -> '_1101.CylindricalGearTriangularEndModificationAtOrientation':
    ...
    @property
    def tip_right(self) -> '_1101.CylindricalGearTriangularEndModificationAtOrientation':
