...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1121, _1115
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    @property
    def involute_inspection_points(self) -> 'List[_1121.TotalProfileReliefWithDeviation]':
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1115.ProfileFormReliefWithDeviation]':
