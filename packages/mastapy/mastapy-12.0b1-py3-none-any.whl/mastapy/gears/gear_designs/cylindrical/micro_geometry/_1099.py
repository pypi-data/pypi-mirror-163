...
class CylindricalGearToothMicroGeometry(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_1085.CylindricalGearFlankMicroGeometry':
    ...
    @property
    def right_flank(self) -> '_1085.CylindricalGearFlankMicroGeometry':
    ...
    @property
    def flanks(self) -> 'List[_1085.CylindricalGearFlankMicroGeometry]':
    ...
    @property
    def both_flanks(self) -> '_1085.CylindricalGearFlankMicroGeometry':
    ...
    @property
    def gear(self) -> '_1091.CylindricalGearMicroGeometryBase':
    ...
    @property
    def gear_of_type_cylindrical_gear_micro_geometry(self) -> '_1090.CylindricalGearMicroGeometry':
    ...
    @property
    def gear_of_type_cylindrical_gear_micro_geometry_per_tooth(self) -> '_1094.CylindricalGearMicroGeometryPerTooth':
