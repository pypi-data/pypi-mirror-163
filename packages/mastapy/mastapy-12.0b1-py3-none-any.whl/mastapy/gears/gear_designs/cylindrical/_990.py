...
from mastapy.gears.gear_designs.cylindrical import _1048, _1027, _1058
...
class BacklashSpecification(_1058.RelativeValuesSpecification['BacklashSpecification']):
    """BacklashSpecification
    ...
    @property
    def left_flank(self) -> '_1048.LinearBacklashSepcification':
    ...
    @property
    def right_flank(self) -> '_1048.LinearBacklashSepcification':
    ...
    @property
    def angular_backlash(self) -> 'List[_1027.CylindricalMeshAngularBacklash]':
    ...
    @property
    def flanks(self) -> 'List[_1048.LinearBacklashSepcification]':
    ...
    @property
    def both_flanks(self) -> '_1048.LinearBacklashSepcification':
