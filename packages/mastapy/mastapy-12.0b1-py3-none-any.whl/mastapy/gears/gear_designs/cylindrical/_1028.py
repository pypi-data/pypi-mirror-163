...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_1029.CylindricalMeshedGearFlank':
    ...
    @property
    def right_flank(self) -> '_1029.CylindricalMeshedGearFlank':
    ...
    @property
    def flanks(self) -> 'List[_1029.CylindricalMeshedGearFlank]':
    ...
    @property
    def both_flanks(self) -> '_1029.CylindricalMeshedGearFlank':
