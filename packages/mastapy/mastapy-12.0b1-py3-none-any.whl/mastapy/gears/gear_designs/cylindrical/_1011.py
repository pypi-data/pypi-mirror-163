...
from mastapy.gears.micro_geometry import _561
...
class CylindricalGearMicroGeometrySettings(_1547.IndependentReportablePropertiesBase['CylindricalGearMicroGeometrySettings']):
    """CylindricalGearMicroGeometrySettings
    ...
    @property
    def flank_side_with_zero_face_width(self) -> '_561.FlankSide':
    ...
    def flank_side_with_zero_face_width(self, value: '_561.FlankSide'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FlankSideWithZeroFaceWidth = value

    @property
    def micro_geometry_lead_tolerance_chart_view(self) -> '_1112.MicroGeometryLeadToleranceChartView':
    ...
    def micro_geometry_lead_tolerance_chart_view(self, value: '_1112.MicroGeometryLeadToleranceChartView'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MicroGeometryLeadToleranceChartView = value

    @property
    def scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self) -> '_1035.DoubleAxisScaleAndRange':
    ...
    def scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self, value: '_1035.DoubleAxisScaleAndRange'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
