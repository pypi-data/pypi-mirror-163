...
class CylindricalGearDefaults(_1554.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self) -> '_1080.FinishStockType':
    ...
    def finish_stock_type(self, value: '_1080.FinishStockType'):
    ...
    @property
    def rough_cutter_creation_settings(self) -> '_712.RoughCutterCreationSettings':
    ...
    @property
    def system_of_fits_defaults(self) -> '_1129.DIN3967SystemOfGearFits':
