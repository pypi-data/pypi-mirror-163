...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1126
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_1126.CylindricalAccuracyGrader):
    """CylindricalAccuracyGraderWithProfileFormAndSlope
