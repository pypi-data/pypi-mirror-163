...
from mastapy.gears.gear_designs.conical import _1139
from mastapy.math_utility import _1477
from mastapy._internal.implicit import overridable, enum_with_selected_value
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.gear_designs.bevel import _1179, _1177, _1178
...
class BevelGearSetDesign(_1183.AGMAGleasonConicalGearSetDesign):
    """BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1139.BacklashDistributionRule':
        ...
        return constructor.new_from_mastapy_type(_1139.BacklashDistributionRule)(value) if value is not None else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1139.BacklashDistributionRule'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BacklashDistributionRule = value

    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1477.MaxMinMean':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1477.MaxMinMean)(value) if value is not None else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1477.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def round_cutter_specifications(self) -> '_1179.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1179.WheelFinishCutterPointWidthRestrictionMethod)(value) if value is not None else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1179.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1177.ToothProportionsInputMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1177.ToothProportionsInputMethod)(value) if value is not None else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1177.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothProportionsInputMethod = value

    @property
    def tooth_taper_root_line_tilt_method(self) -> '_338.SpiralBevelRootLineTilt':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_338.SpiralBevelRootLineTilt)(value) if value is not None else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_338.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
