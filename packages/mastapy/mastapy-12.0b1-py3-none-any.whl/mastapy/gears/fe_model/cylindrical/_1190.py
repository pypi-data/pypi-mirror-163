...
class CylindricalGearMeshFEModel(_1186.GearMeshFEModel):
    """CylindricalGearMeshFEModel
    ...
    def stiffness_wrt_contacts_for(self, gear: '_1185.GearFEModel', flank: '_317.GearFlanks') -> 'List[_825.GearContactStiffness]':
    ...
    def stiffness_wrt_contacts_for_with_progress(self, gear: '_1185.GearFEModel', flank: '_317.GearFlanks', progress: '_7471.TaskProgress') -> 'List[_825.GearContactStiffness]':
        """ 'StiffnessWrtContactsFor' is the original name of this method.
    ...
    def generate_stiffness_wrt_contacts_for(self, progress: '_7471.TaskProgress'):
    ...
    def generate_stiffness_wrt_contacts_for_flank(self, flank: '_317.GearFlanks', progress: '_7471.TaskProgress'):
        """ 'GenerateStiffnessWrtContactsFor' is the original name of this method.
