...
from mastapy.gears.fe_model.conical import _1195
...
class ConicalSetFEModel(_1188.GearSetFEModel):
    """ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1195.FlankDataSource':
        """FlankDataSource: 'FlankDataSource' is the original name of this property."""

        temp = self.wrapped.FlankDataSource
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1195.FlankDataSource)(value) if value is not None else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1195.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
