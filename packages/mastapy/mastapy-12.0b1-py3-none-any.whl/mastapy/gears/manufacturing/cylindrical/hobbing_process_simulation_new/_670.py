...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _675, _662, _689
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_675.ProcessSimulationInput':
        ...
        if _675.ProcessSimulationInput.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_662.HobbingProcessSimulationInput':
        ...
        temp = self.wrapped.Inputs
        if _662.HobbingProcessSimulationInput.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_689.WormGrindingProcessSimulationInput':
        ...
        temp = self.wrapped.Inputs
        if _689.WormGrindingProcessSimulationInput.TYPE not in temp.__class__.__mro__:
