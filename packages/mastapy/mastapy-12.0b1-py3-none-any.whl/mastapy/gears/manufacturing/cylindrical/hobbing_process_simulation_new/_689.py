...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _681, _675
...
class WormGrindingProcessSimulationInput(_675.ProcessSimulationInput):
    """WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_681.WormGrinderManufactureError':
