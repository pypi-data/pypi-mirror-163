...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _650
...
class ProcessLeadCalculation(_0.APIBase):
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_650.CalculateLeadDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_650.CalculateLeadDeviationAccuracy':
