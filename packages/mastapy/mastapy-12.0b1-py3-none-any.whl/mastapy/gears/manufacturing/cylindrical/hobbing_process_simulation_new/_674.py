...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _652
...
class ProcessProfileCalculation(_0.APIBase):
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_652.CalculateProfileDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_652.CalculateProfileDeviationAccuracy':
