...
class CylindricalGearShaper(_708.InvoluteCutterDesign):
    """CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1064.ShaperEdgeTypes':
        """ShaperEdgeTypes: 'ShaperEdgeType' is the original name of this property."""

        temp = self.wrapped.ShaperEdgeType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1064.ShaperEdgeTypes)(value) if value is not None else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1064.ShaperEdgeTypes'):
