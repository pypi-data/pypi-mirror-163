...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _722, _727
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self) -> '_722.CylindricalCutterSimulatableGear':
    ...
    @property
    def stock_removed_at_designed_sap(self) -> '_727.FinishStockPoint':
    ...
    @property
    def stock_removed_at_reference_diameter(self) -> '_727.FinishStockPoint':
    ...
    @property
    def stock_removed_at_rough_tip_form(self) -> '_727.FinishStockPoint':
    ...
    @property
    def finish_stock_indexed_arcs(self) -> 'List[_727.FinishStockPoint]':
    ...
    @property
    def gear_fillet_points(self) -> 'List[_719.NamedPoint]':
    ...
    @property
    def main_profile_finish_stock(self) -> 'List[_727.FinishStockPoint]':
