...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_1076.ToothThicknessSpecificationBase':
    ...
    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_1036.FinishToothThicknessDesignSpecification':
    ...
    @property
    def tooth_thickness_specification_of_type_readonly_tooth_thickness_specification(self) -> '_1056.ReadonlyToothThicknessSpecification':
    ...
    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_1075.ToothThicknessSpecification':
