...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _754, _741
...
class AxialShaverRedressing(_754.ShaverRedressing['_741.ConventionalShavingDynamics']):
    """AxialShaverRedressing
