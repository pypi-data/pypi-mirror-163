...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _754, _745
...
class PlungeShaverRedressing(_754.ShaverRedressing['_745.PlungeShaverDynamics']):
    """PlungeShaverRedressing
