...
class PlungeShaverSettings(_0.APIBase):
    ...
    @property
    def lead_display_method(self) -> '_635.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_635.MicroGeometryDefinitionMethod'):
    ...
    @property
    def profile_display_method(self) -> '_635.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_635.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
