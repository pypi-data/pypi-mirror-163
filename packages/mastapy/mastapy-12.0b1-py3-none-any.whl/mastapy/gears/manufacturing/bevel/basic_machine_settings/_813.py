...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _811
...
class BasicConicalGearMachineSettingsGenerated(_811.BasicConicalGearMachineSettings):
    """BasicConicalGearMachineSettingsGenerated
