...
class ConicalSetMicroGeometryConfigBase(_1217.GearSetImplementationDetail):
    """ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_316.DeflectionFromBendingOption':
        ...
        return constructor.new_from_mastapy_type(_316.DeflectionFromBendingOption)(value) if value is not None else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_316.DeflectionFromBendingOption'):
