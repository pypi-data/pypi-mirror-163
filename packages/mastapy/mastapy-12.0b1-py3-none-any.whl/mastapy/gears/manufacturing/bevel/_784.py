...
from mastapy.gears.manufacturing.bevel.cutters import _805, _806
...
class ConicalWheelManufacturingConfig(_766.ConicalGearManufacturingConfig):
    """ConicalWheelManufacturingConfig
    ...
    @property
    def specified_machine_settings(self) -> '_811.BasicConicalGearMachineSettings':
        ...
        if _811.BasicConicalGearMachineSettings.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_812.BasicConicalGearMachineSettingsFormate':
        ...
        temp = self.wrapped.SpecifiedMachineSettings
        if _812.BasicConicalGearMachineSettingsFormate.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_813.BasicConicalGearMachineSettingsGenerated':
        ...
        temp = self.wrapped.SpecifiedMachineSettings
        if _813.BasicConicalGearMachineSettingsGenerated.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def wheel_finish_cutter(self) -> '_805.WheelFinishCutter':
    ...
    @property
    def wheel_rough_cutter(self) -> '_806.WheelRoughCutter':
