...
from mastapy.gears.manufacturing.bevel import _767, _776, _783
...
class ConicalSetMicroGeometryConfig(_783.ConicalSetMicroGeometryConfigBase):
    """ConicalSetMicroGeometryConfig
    ...
    @property
    def gear_micro_geometry_configuration(self) -> 'List[_767.ConicalGearMicroGeometryConfig]':
    ...
    @property
    def meshes(self) -> 'List[_776.ConicalMeshMicroGeometryConfig]':
