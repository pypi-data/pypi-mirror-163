...
class CylindricalMeshLoadDistributionAtRotation(_832.GearMeshLoadDistributionAtRotation):
    """CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_1109.MeshAlignment':
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_848.CylindricalGearMeshLoadedContactLine]':
