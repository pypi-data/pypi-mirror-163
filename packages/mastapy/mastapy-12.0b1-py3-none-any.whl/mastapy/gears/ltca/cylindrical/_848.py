...
class CylindricalGearMeshLoadedContactLine(_833.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_849.CylindricalGearMeshLoadedContactPoint]':
