...
from mastapy.gears.gear_two_d_fe_analysis import _886
...
class CylindricalGearSetLoadDistributionAnalysis(_836.GearSetLoadDistributionAnalysis):
    """CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def tiff_analysis(self) -> '_886.CylindricalGearSetTIFFAnalysis':
    ...
    @property
    def meshes(self) -> 'List[_847.CylindricalGearMeshLoadDistributionAnalysis]':
