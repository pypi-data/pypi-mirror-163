...
from mastapy.gears.cylindrical import _1197, _1196
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1197.CylindricalGearLTCAContactCharts':
    ...
    @property
    def contact_charts_as_text_file(self) -> '_1196.CylindricalGearLTCAContactChartDataAsTextFile':
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_846.CylindricalGearLoadDistributionAnalysis':
    ...
    @property
    def other_gear_load_distribution_analysis(self) -> '_846.CylindricalGearLoadDistributionAnalysis':
    ...
    def contact_patch_as_text(self, result_type: '_817.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str', start_rotation_index: Optional['int'] = 0):
    ...
    def contact_patch_detailed(self, result_type: '_817.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int', start_rotation_index: Optional['int'] = 0) -> '_1473.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_817.ContactResultType', include_tip_contact: 'bool', start_rotation_index: Optional['int'] = 0) -> '_1473.GriddedSurface':
        """ 'ContactPatch' is the original name of this method.
