...
from mastapy.nodal_analysis.component_mode_synthesis import _225, _220, _216
from mastapy.nodal_analysis.dev_tools_analyses import _176
from mastapy.utility import _1538
...
class CMSModel(_0.APIBase):
    ...
    @property
    def software_used_for_reduction(self) -> '_225.SoftwareUsedForReductionType':
        ...
        return constructor.new_from_mastapy_type(_225.SoftwareUsedForReductionType)(value) if value is not None else None
    ...
    @property
    def fe_model(self) -> '_176.FEModel':
    ...
    @property
    def reduction_information(self) -> '_1538.AnalysisRunInformation':
    ...
    @property
    def reduction_options(self) -> '_220.CMSOptions':
    ...
    @property
    def element_face_groups(self) -> 'List[_216.CMSElementFaceGroup]':
