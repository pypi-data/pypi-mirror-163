...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def elastic_modulus_components(self) -> '_198.ElasticModulusOrthotropicComponents':
    ...
    @property
    def poissons_ratio_components(self) -> '_211.PoissonRatioOrthotropicComponents':
    ...
    @property
    def shear_modulus_components(self) -> '_213.ShearModulusOrthotropicComponents':
    ...
    @property
    def thermal_expansion_coefficient_components(self) -> '_214.ThermalExpansionOrthotropicComponents':
