...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1221, _1222
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def constrained_surface_type(self) -> '_1221.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new_from_mastapy_type(_1221.ContactPairConstrainedSurfaceType)(value) if value is not None else None
    ...
    @property
    def reference_surface_type(self) -> '_1222.ContactPairReferenceSurfaceType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1222.ContactPairReferenceSurfaceType)(value) if value is not None else None
