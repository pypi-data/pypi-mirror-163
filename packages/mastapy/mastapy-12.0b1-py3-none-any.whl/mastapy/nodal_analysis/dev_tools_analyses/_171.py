...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_190.MassMatrixType':
        """MassMatrixType: 'MassMatrixType' is the original name of this property."""

        temp = self.wrapped.MassMatrixType
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_190.MassMatrixType)(value) if value is not None else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_190.MassMatrixType'):
