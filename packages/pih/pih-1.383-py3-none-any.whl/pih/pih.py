...
class PIH:
    ...
    class ACTION:
        ...
        def create_user_documents(full_name: FullName, tab_number: str, pc: LoginPasswordPair, polibase: LoginPasswordPair, email: LoginPasswordPair) -> bool:
            ...
            return RPC_COMMANDS.TEMPLATE.create_user_documents(PIH.PATH.IT.get_NEW_EMPLORERS(f"{FullNameTool.from_string(full_name)}.docx"), date_now_string, full_name, tab_number, pc, polibase, email)
