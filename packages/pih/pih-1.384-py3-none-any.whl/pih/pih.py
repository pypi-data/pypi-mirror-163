...
class PIH:
    ...
    class ACTION:
        ...
        def create_user_documents(full_name: FullName, tab_number: str, pc: LoginPasswordPair, polibase: LoginPasswordPair, email: LoginPasswordPair) -> bool:
            ...
            return RPC_COMMANDS.TEMPLATE.create_user_documents(PIH.PATH.IT.NEW_EMPLOYERS(f"{full_name_string}.docx"), date_now_string, full_name_string, tab_number, pc, polibase, email)
