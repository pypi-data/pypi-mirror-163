...
class PIH:
    ...
    class RESULT:
        ...
        class EXTRACT:
            ...
            def as_full_name(mark_object: dict) -> FullName:
                return FullNameTool.from_string(PIH.RESULT.EXTRACT.parameter(mark_object, FIELD_NAME_COLLECTION.FULL_NAME))
            ...
            def description(object: dict) -> str:
                result = PIH.RESULT.EXTRACT.parameter(object, FIELD_NAME_COLLECTION.DESCRIPTION)
    ...
    class COMBINE:
        ...
        def ad_user_by_tab_number(value: str) -> dict:
            mark_data = ResultUnpack.unpack_first_data(PIH.RESULT.ORION.by_tab_number(value))
            if mark_data is not None:
                return ResultUnpack.unpack_first_data(PIH.RESULT.AD.by_full_name(PIH.RESULT.EXTRACT.as_full_name(mark_data)))
            return None
