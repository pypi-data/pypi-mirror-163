...
class RPC_COMMANDS:
    ...
    class ORION:
        ...
        @staticmethod
        def ping() -> str:
            return RPC.call(RPC_COMMANDS.ORION.create_rpc_command(CONST.RPC.PING_COMMAND))
    ...
    class TEMPLATE:
        ...
        @staticmethod
        def create_user_documents(path:str, date_now_string: str, full_name: str, tab_number: str, pc: LoginPasswordPair, polibase: LoginPasswordPair, email: LoginPasswordPair) -> rpcCommand:
            return DataTools.rpc_unrepresent(RPC.call(RPC_COMMANDS.TEMPLATE.create_rpc_command("create_user_documents"), (path, date_now_string, full_name, tab_number, pc, polibase, email)))
