...
from pih.const import CONST, EXECUTOR, FIELD_NAME_COLLECTION, LOCAL_COMMAND_LIST_DICT, FIELD_COLLECTION, PASSWORD
...
class PIH:
    ...
    class CHECK:
        ...
        def login(value: str) -> bool:
            pattern = r"([a-z]{"+ str(CONST.NAME_POLICY.FULL_NAME_PART_ITEM_MIN_LENGTH) + ",}[0-9]*)"
        ...
        def name_length(value: str) -> bool:
            return len(value) >= CONST.NAME_POLICY.FULL_NAME_PART_ITEM_MIN_LENGTH
    ...
    class ACTION:
        ...
        def create_user_documents(full_name: FullName, tab_number: str, pc: LoginPasswordPair, polibase: LoginPasswordPair, email: LoginPasswordPair) -> bool:
            return RPC_COMMANDS.TEMPLATE.create_user_template(full_name, tab_number, pc, polibase, email)
