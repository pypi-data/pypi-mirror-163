...
class RPC_COMMANDS:
    ...
    class TEMPLATE:
        ...
        @staticmethod
        def create_user_documents(path :str, full_name: str, tab_number: str, pc: LoginPasswordPair, polibase: LoginPasswordPair, email: LoginPasswordPair) -> rpcCommand:
            return DataTools.rpc_unrepresent(RPC.call(RPC_COMMANDS.TEMPLATE.create_rpc_command("create_user_documents"), (path, full_name, tab_number, pc, polibase, email)))
