...
def add_extension(lst, ext):
    """
    It takes a list of strings and adds a given extension to each string in the list
    
    :param lst: a list of strings
    :param ext: the extension to add to the end of each item in the list
    :return: A list of strings with the extension added to each string.
    """
