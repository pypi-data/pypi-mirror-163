...
class TensorDescriptorProto :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_tensorflow_2fcompiler_2fxla_2fstream_5fexecutor_2fdnn_2eproto);
    return ::descriptor_table_tensorflow_2fcompiler_2fxla_2fstream_5fexecutor_2fdnn_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
public:
  ...
  AlgorithmProto_TuningKnobsEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_tensorflow_2fcompiler_2fxla_2fstream_5fexecutor_2fdnn_2eproto);
    return ::descriptor_table_tensorflow_2fcompiler_2fxla_2fstream_5fexecutor_2fdnn_2eproto.file_level_metadata[1];
  }
...
class AlgorithmProto :
 ...
 public:
  ...
  PROTOBUF_NAMESPACE_ID::UInt64Value* release_workspace_size();
...
class AlgorithmConfigProto :
 ...
 public:
  ...
  inline AlgorithmConfigProto* New() const final {
    return CreateMaybeMessage<AlgorithmConfigProto>(nullptr);
  }
...
inline void AlgorithmProto::set_allocated_workspace_size(PROTOBUF_NAMESPACE_ID::UInt64Value* workspace_size) {
  ...
  if (workspace_size) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(workspace_size)->GetArena();
...
inline void AlgorithmConfigProto::clear_scratch_size() {
  if (has_scratch_size()) {
    optional_scratch_size_.scratch_size_ = PROTOBUF_LONGLONG(0);
