class issim:
  def __init__(self):
    ...
    if len(shape1) != len(shape2):
      print("This function is for testing if two shapes with completely declared side lengths are similar. Please use eqsolve.findsim() to try to find mising side lengths.")
    else:
      sim = ""
      scales = []
