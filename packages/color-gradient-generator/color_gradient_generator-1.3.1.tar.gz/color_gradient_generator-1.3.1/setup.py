...
This tool will allow you to generate a color gradient from RGB, decimal or hexadecimal. The source code is available on [GitHub](https://github.com/MrPRAINGLE/color-gradient-generator-python).
