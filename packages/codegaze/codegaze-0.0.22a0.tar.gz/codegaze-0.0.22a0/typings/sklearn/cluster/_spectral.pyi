...
def spectral_clustering(affinity, *, n_clusters=..., n_components=..., eigen_solver=..., random_state=..., n_init=..., eigen_tol=..., assign_labels=..., verbose=...): # -> Any:
