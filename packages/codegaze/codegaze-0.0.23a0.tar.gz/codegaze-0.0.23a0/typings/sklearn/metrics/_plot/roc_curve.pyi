...
class RocCurveDisplay:
    ...
    @classmethod
    def from_estimator(cls, estimator, X, y, *, sample_weight=..., drop_intermediate=..., response_method=..., pos_label=..., name=..., ax=..., **kwargs):
    ...
    @classmethod
    def from_predictions(cls, y_true, y_pred, *, sample_weight=..., drop_intermediate=..., pos_label=..., name=..., ax=..., **kwargs):
