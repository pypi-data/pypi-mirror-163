...
from .tasks.function import FunctionExecution
from .tasks.powershell import PowershellExecution
from .tasks.r import RExecution
from .tasks.sql import StoredProcedureExecution
from .tasks.email import EmailExecution
    ...
    def __exit__(self, exc_type, exc_value, exc_tb):
        ...
        if exc_value:
            if exc_type == UserExitException:
                ...
                logging.error(f"Job failed: {self.error_message}")
                if self.on_error:
