...
class CreateMeasurementFormInstanceRequest(_serialization.Model):  # pylint: disable=too-many-instance-attributes
...
class ImportMeasurementFormSchema(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        extra_schemas: Optional[List["_models.MeasurementFormLinkedSchemaDto"]] = None,
        validation_rule_id: Optional[str] = None,
        **kwargs
    ):
        """
...
class MeasurementFormDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype extra_schemas: list[~ignos.api.client.models.MeasurementFormLinkedSchemaDto]
    :ivar validation_rule: Required.
    :vartype validation_rule: ~ignos.api.client.models.ValidationRuleDto
    """
    ...
    _attribute_map = {
        ...
        "source": {"key": "source", "type": "str"},
        "extra_schemas": {"key": "extraSchemas", "type": "[MeasurementFormLinkedSchemaDto]"},
        "validation_rule": {"key": "validationRule", "type": "ValidationRuleDto"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        validation_rule: "_models.ValidationRuleDto",
        customer_id: Optional[str] = None,
        customer_name: Optional[str] = None,
        part_number: Optional[str] = None,
        part_revision: Optional[str] = None,
        ...
        **kwargs
        ...
        :paramtype extra_schemas: list[~ignos.api.client.models.MeasurementFormLinkedSchemaDto]
        :keyword validation_rule: Required.
        :paramtype validation_rule: ~ignos.api.client.models.ValidationRuleDto
        """
        super().__init__(**kwargs)
        self.id = id
        self.schema_id = schema_id
...
class MeasurementFormElementValueAuditDto(_serialization.Model):
...
class SaveToolRequest(_serialization.Model):
    ...
    def __init__(self, *, schema_id: str, element_id: str, sequence: str, tools: Optional[List[str]] = None, **kwargs):
        """
        :keyword schema_id: Required.
        :paramtype schema_id: str
        :keyword element_id: Required.
...
class UpdateCompanyUserRequest(_serialization.Model):
    ...
    def __init__(self, *, name: str, roles: List[str], **kwargs):
        """
        :keyword name: Required.
        :paramtype name: str
        :keyword roles: Required.
...
class WorkorderTraceItemDto(_serialization.Model):
    ...
    def __init__(self, *, sequence: str, serial_number: Optional[str] = None, lot: Optional[str] = None, **kwargs):
        """
        :keyword sequence: Required.
        :paramtype sequence: str
        :keyword serial_number:
