...
def _main():
    ...
    parser = ArgumentParser(
        ...
        epilog="\n".join([
            ...
            "    * NAME is user-defined, any value except 'globals' is allowed",
            "  reset",
            ...
            "  %(prog)s create nginx queues 6 ports 80,443",
            "    * creates an ADQ-enabled traffic class of 6 queues for ports 80 and 443",
            "  %(prog)s create redis mode shared ports 6379-6382 cpus 2,4,6,8",
