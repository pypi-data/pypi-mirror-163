...
class ConnectorProtocol(Protocol):
    ...
    def connect(self, host: str, port: int, username: str, userpwd: str, schema: str) -> Any:
        """
...
class DbApiHook(BaseHook):
    ...
    def __init__(self, request_info, *args, schema: Optional[str] = None, log_sql: bool = True, **kwargs):
        super().__init__()
    ...
    def get_conn(self):
        ...
        db_request_info = self.get_connection()

        return self.connector.connect(**db_request_info)
