...
# 公告区：
- 十分抱歉我们在v0.4系列版本中犯下的目录引用错误，现已在v0.5系列中修复！请各位及时更新！
- nb安装已同步！
...
更多配置项请查看 [config.py](nonebot-plugin-admin-hello/config.py)

入群欢迎配置事项查看 [/utilss/config.py](nonebot-plugin-admin-hello/hello/utilss/config.py)
