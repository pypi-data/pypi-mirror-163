import { S as SvelteComponent, i as init, s as safe_not_equal, aa as add_render_callback, q as create_component, u as mount_component, l as listen, v as transition_in, w as transition_out, x as destroy_component, K as component_subscribe, X, L as assign, M as StatusTracker, m as space, k as empty, c as insert, N as get_spread_update, O as get_spread_object, y as group_outros, z as check_outros, e as detach, a6 as tick, D as binding_callbacks, f as element, b as attr, H as src_url_equal, t as toggle_class, d as append, o as destroy_each, r as run_all, h as text, j as set_data, ad as add_resize_listener, n as noop } from './index.096bab80.js';
import { B as Block } from './Block.5d4a3494.js';
import { B as BlockLabel } from './BlockLabel.c5b68dcc.js';
import { M as ModifyUpload } from './ModifyUpload.38c74bbb.js';
import { g as get_styles } from './styles.db46e346.js';
import { I as Image } from './Image.0fbc4d23.js';
...
function create_if_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*style*/ 64) blocklabel_changes.disable = typeof /*style*/ ctx[6].container === "boolean" && !/*style*/ ctx[6].container;
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*selected_image, can_zoom, value, $_*/ 41120) {
			...
			if (!current || dirty[0] & /*classes*/ 4096 && div0_class_value !== (div0_class_value = "grid gap-2 " + /*classes*/ ctx[12] + " svelte-1g9btlg")) {
...
function create_if_block_1(ctx) {
	...
	modifyupload.$on("clear", /*clear_handler*/ ctx[18]);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(img, "click", /*click_handler*/ ctx[19]),
					listen(div1, "keydown", /*on_keydown*/ ctx[16])
				];
		...
		p(ctx, dirty) {
			if (!current || dirty[0] & /*value, selected_image*/ 160 && !src_url_equal(img.src, img_src_value = /*value*/ ctx[5][/*selected_image*/ ctx[7]])) {
				attr(img, "src", img_src_value);
			}

			if (dirty[0] & /*selected_image, el, value*/ 1184) {
...
function create_each_block_1(ctx) {
	...
	let mounted;
	let dispose;
	const assign_button = () => /*button_binding*/ ctx[20](button, i);
	const unassign_button = () => /*button_binding*/ ctx[20](null, i);

	function click_handler_1() {
		return /*click_handler_1*/ ctx[21](/*i*/ ctx[29]);
	}
	...
	return {
		c() {
			...
			if (!src_url_equal(img.src, img_src_value = /*image*/ ctx[27])) attr(img, "src", img_src_value);

			attr(button, "class", button_class_value = "gallery-item !flex-none !h-9 !w-9 transition-all duration-75 " + (/*selected_image*/ ctx[7] === /*i*/ ctx[29]
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*value*/ 32 && !src_url_equal(img.src, img_src_value = /*image*/ ctx[27])) {
				attr(img, "src", img_src_value);
			}

			if (dirty[0] & /*selected_image*/ 128 && button_class_value !== (button_class_value = "gallery-item !flex-none !h-9 !w-9 transition-all duration-75 " + (/*selected_image*/ ctx[7] === /*i*/ ctx[29]
			? '!ring-2 !ring-orange-500 hover:!ring-orange-500'
			: 'scale-90 transform') + " svelte-1g9btlg")) {
...
function create_else_block_1(ctx) {
	let p;
	let t_value = /*$_*/ ctx[15]("interface.empty") + "";
	let t;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*$_*/ 32768 && t_value !== (t_value = /*$_*/ ctx[15]("interface.empty") + "")) set_data(t, t_value);
		},
		d(detaching) {
...
function create_each_block(ctx) {
	...
	function click_handler_2() {
		return /*click_handler_2*/ ctx[23](/*i*/ ctx[29]);
	}
...
// (62:0) <Block  {visible}  variant="solid"  color="grey"  padding={false}  {elem_id}  disable={typeof style.container === "boolean" && !style.container} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*style*/ 64) block_changes.disable = typeof /*style*/ ctx[6].container === "boolean" && !/*style*/ ctx[6].container;

			if (dirty[0] & /*value, height, style, classes, show_label, selected_image, can_zoom, $_, container, el, next, label, loading_status*/ 64999 | dirty[1] & /*$$scope*/ 1) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*selected_image, value*/ 160) {
		...
		if ($$self.$$.dirty[0] & /*selected_image*/ 128) {
			scroll_to_img(selected_image);
		}

		if ($$self.$$.dirty[0] & /*window_height, height*/ 768) {
			$$invalidate(13, can_zoom = window_height >= height);
		}

		if ($$self.$$.dirty[0] & /*style*/ 64) {
