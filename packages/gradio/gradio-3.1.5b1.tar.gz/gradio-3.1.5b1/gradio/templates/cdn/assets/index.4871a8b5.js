...
import { I as Image } from './Image.daca253e.js';
...
function create_else_block(ctx) {
	...
	let current;
	let if_block0 = /*selected_image*/ ctx[7] !== null && create_if_block_2(ctx);
	const if_block_creators = [create_if_block_1, create_else_block_1];
	const if_blocks = [];

	function select_block_type_1(ctx, dirty) {
		if (/*value*/ ctx[5].length === 0) return 0;
		return 1;
	}
	...
	return {
		c() {
			...
			toggle_class(div, "min-h-[350px]", /*style*/ ctx[6].height !== "auto");
			toggle_class(div, "max-h-[55vh]", /*style*/ ctx[6].height !== "auto");
			toggle_class(div, "xl:min-h-[450px]", /*style*/ ctx[6].height !== "auto");
		},
		m(target, anchor) {
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*classes*/ 4096 && div_class_value !== (div_class_value = "grid gap-2 " + /*classes*/ ctx[12] + " svelte-1g9btlg")) {
...
function create_default_slot(ctx) {
	...
	let if_block0 = /*show_label*/ ctx[1] && create_if_block_3(ctx);
