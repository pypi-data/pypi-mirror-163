...
def test_flattenHierarchical():
    ...
    with tempdir():
        ...
        # the encoding number used here (2) is a real
        # one which uses integer coding values. See
        # hierarchy.codingDataType
        with open('coding2.tsv', 'wt') as f:
            f.write(hier)
