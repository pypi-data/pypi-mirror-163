...
40 PRINT
50 PRINT TAB(13);"generator by Jack Hauber (c1973)"
60 PRINT TAB(17);"solver by Richard Schaal"
...
140 GOTO 200
150 PRINT:PRINT:PRINT "This program will simulate a near-sighted mouse in a ";
160 PRINT "maze.":PRINT "You select the difficulty factor - size!"
170 PRINT "You may have a maze of any size permitted by the size of"
180 PRINT "your terminal. Dimensions less than 5 are too trivial."
