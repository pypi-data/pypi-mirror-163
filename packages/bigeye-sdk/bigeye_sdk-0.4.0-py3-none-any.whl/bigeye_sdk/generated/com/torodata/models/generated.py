...
# sources: Constants.proto, Core.proto, Datawatch.proto, FeatureProviders.proto, Forecast.proto, ModelService.proto
...
class RowCreationTimeFailure(betterproto.Message):
    failed_column_id: int = betterproto.int32_field(1)
    message: str = betterproto.string_field(2)


@dataclass
class MultipleColumnsForTable(betterproto.Message):
    table_id: int = betterproto.int32_field(1)
...
class RowCreationTimeResponse(betterproto.Message):
    column_ids_set_as_metric_time: List[int] = betterproto.int32_field(1)
    column_ids_not_valid_metric_time: List[int] = betterproto.int32_field(2)
    cohort_matches_actually_table_ids: List[int] = betterproto.int32_field(3)
    table_ids_with_multiple_specified_columns: List[
        "MultipleColumnsForTable"
    ] = betterproto.message_field(4)
    column_ids_failed_to_set_as_metric_time: List[
...
class MetricSuiteResponse(betterproto.Message):
    ...
    row_creation_time_response: "RowCreationTimeResponse" = betterproto.message_field(4)
...
class SchemaServiceStub(betterproto.ServiceStub):
    ...
    async def get_schemas(self, *, warehouse_id: List[int] = []) -> SchemaList:
...
class SourceServiceStub(betterproto.ServiceStub):
    ...
    async def get_sources(self) -> GetSourceListResponse:
        """Get sources"""
