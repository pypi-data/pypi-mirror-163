...
class Characters(enum.Enum):
    Shaggy = {"name": "Shaggy", "slug": "character_shaggy", "NameInPerks" : "Shaggy"}
    Reindog = {"name": "Reindog", "slug": "character_creature", "NameInPerks" : "ReinDog"}
    StevenUniverse = {"name": "Steven Universe", "slug": "character_steven", "NameInPerks" : "StevenUniverse"}
    Garnet = {"name": "Garnet", "slug": "character_garnet", "NameInPerks" : "Garnet" }
    HarleyQuinn = {"name": "Harley Quinn", "slug": "character_harleyquinn", "NameInPerks" : "HarleyQuinn"}
    AryaStark = {"name": "Arya Stark", "slug": "character_arya", "NameInPerks" : "Arya"}
    Finn = {"name": "Finn", "slug": "character_finn", "NameInPerks" : "Finn"}
    Taz = {"name": "Taz", "slug": "character_taz", "NameInPerks" : "C015"}
    WonderWoman = {"name": "Wonder Woman", "slug": "character_wonder_woman", "NameInPerks" : "WonderWoman"}
    Jake = {"name": "Jake", "slug": "character_jake", "NameInPerks" : "Jake"}
    Superman = {"name": "Superman", "slug": "character_superman", "NameInPerks" : "Superman"}
    Batman = {"name": "Batman", "slug": "character_batman", "NameInPerks" : "Batman"}
    BugsBunny = {"name": "BugsBunny", "slug": "character_bugs_bunny", "NameInPerks" : "BugsBunny"}
    TomAndJerry = {"name": "Tom & Jerry", "slug": "character_tom_and_jerry", "NameInPerks" : "TomAndJerry"}
    Velma = {"name": "Velma", "slug": "character_velma", "NameInPerks" : "Velma"}
    IronGiant = {"name": "Iron Giant", "slug": "character_C017", "NameInPerks" : "C017"}
    LebronJames = {"name": "Lebron James", "slug": "character_C016", "NameInPerks" : "C016"}

def get_character_display_from_perk_associated_name(associated_name):
    for char in Characters:
        if char.value["NameInPerks"] == associated_name:
...
def get_perk_object_by_attribute(attribute : PerkValue, value):
    for perk in Perks:
        if value == perk.value[attribute.value]:
            return perk