...
def lib_operation(type: typing.Union[int, str] = 'DELETE'):
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __.
...
def liboverride_operation(
        type: typing.Union[int, str] = 'OVERRIDE_LIBRARY_CREATE_HIERARCHY',
        selection_set: typing.Union[int, str] = 'SELECTED'):
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __.

    :param type: Library Override Operation * OVERRIDE_LIBRARY_CREATE_HIERARCHY Create -- Make a local override of the selected linked data-blocks, and their hierarchy of dependencies. * OVERRIDE_LIBRARY_RESET Reset -- Reset the selected local override to their linked references values. * OVERRIDE_LIBRARY_CLEAR_SINGLE Clear -- Delete the selected local overrides and relink their usages to the linked data-blocks if possible, else reset them and mark them as non editable.
    :type type: typing.Union[int, str]
    ...
    :type selection_set: typing.Union[int, str]
    '''
...
def liboverride_troubleshoot_operation(
        type: typing.Union[int, str] = 'OVERRIDE_LIBRARY_RESYNC_HIERARCHY',
        selection_set: typing.Union[int, str] = 'SELECTED'):
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __.
