...
def gltf(filepath: str = "",
    ...
    :param export_anim_single_armature: Export all Armature Actions, Export all actions of a single armature. WARNING: works only if you exports a single armature
