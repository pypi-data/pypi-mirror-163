def download():
    ...
    import sys
    import os
    git.Git("https://github.com/pharmapsychotic/clip-interrogator").clone("https://github.com/pharmapsychotic/clip-interrogator.git")
    git.Git("https://github.com/salesforce/BLIP").clone("https://github.com/salesforce/BLIP.git")
    git.Git("https://github.com/openai/CLIP").clone("https://github.com/openai/CLIP.git")
    package=('./CLIP')
    pip.main(['install', package])
    #sys.path.append('../BLIP/')
    os.chdir('./BLIP')
def image_extractor(image_path):
    import clip
    import gc
    import numpy as np
    import os
    ...
    ViTB32 = get_bool('Enter True or False for Model ViTB32')#True #@param{type:"boolean"}
    ViTB16 = get_bool('Enter True or False for Model ViTB16')#True #@param{type:"boolean"}
    ViTL14 = get_bool('Enter True or False for Model ViTL14')#False #@param{type:"boolean"}
    ViTL14_336px = get_bool('Enter True or False for Model ViTL14_336px')#False #@param{type:"boolean"}
    RN101 = get_bool('Enter True or False for Model RN101')#False #@param{type:"boolean"}
    RN50 = get_bool('Enter True or False for Model RN50')#True #@param{type:"boolean"}
    RN50x4 = get_bool('Enter True or False for Model RN50x4')#False #@param{type:"boolean"}
    RN50x16 = get_bool('Enter True or False for Model RN50x16')#False #@param{type:"boolean"}
    RN50x64 = get_bool('Enter True or False for Model RN50x64')#False #@param{type:"boolean"}
    models = []
