...
class RepositoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.notify_se_registry = channel.unary_unary(
                '/proxima.de.proto.RepositoryService/notify_se_registry',
...
class RepositoryServiceServicer(object):
    ...
    def notify_se_registry(self, request, context):
        """Post process after se registry
        For repository check the next lsn
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RepositoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'notify_se_registry': grpc.unary_unary_rpc_method_handler(
                    servicer.notify_se_registry,
...
class RepositoryService(object):
    ...
    @staticmethod
    def notify_se_registry(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/proxima.de.proto.RepositoryService/notify_se_registry',
