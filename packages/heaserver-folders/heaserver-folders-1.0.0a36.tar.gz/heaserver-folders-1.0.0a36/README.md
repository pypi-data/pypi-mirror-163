...
PowerShell, execute:
```
Invoke-RestMethod -Uri http://localhost:8080/folders/root/items -Method GET -Headers @{'accept' = 'application/json'}`
```
In MacOS or Linux, the equivalent command is:
```
curl -X GET http://localhost:8080/folders/root/items -H 'accept: application/json'
```
