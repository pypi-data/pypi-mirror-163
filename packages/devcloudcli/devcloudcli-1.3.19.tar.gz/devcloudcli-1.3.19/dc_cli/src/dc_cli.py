...
SUB_TOOLS={
  ...
  "k8s-services":['kind','kubespray','microk8s','kubeadm','minikube','openshift','rancher-k3s','rancher-rke2','smart-edge-open','starlingx','tanzu','aether'],
  "intel-dev-tools":['intel-auto-deploy','intel-auto-test','intel-code-scans','mgt-console'],
  "oneapi-toolkits":['ai-analytics-toolkit','base-toolkit','intel-vtune','iot-toolkit','scikit-learn','xgboost','modin'],
...
TOOLS={
  ...
  "model-zoo":['pytorch-model-zoo','tensorflow-hub','intel-ai-model-zoo','intel-openvino-model-zoo'],
  ...
  "seo-samples":['sample-cdn-application','smart-city-app','telemetry-sample-app','video-anlaytics-services-sample'],
...
enable_list_k8s = ['kind','microk8s','minikube','rancher-k3s']
