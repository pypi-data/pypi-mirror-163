# -*- coding: utf-8 -*-
#
# pytest-line-profiler documentation build configuration file, created by
...
project = 'pytest-line-profiler'
copyright = '2015, Martín Gaitán'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-line-profiler Documentation',
     [author], 1)
]
