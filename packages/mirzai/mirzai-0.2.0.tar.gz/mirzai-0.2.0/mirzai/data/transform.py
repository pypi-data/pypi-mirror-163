# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_data.transform.ipynb.

# %% auto 0
__all__ = ['CO2_REGION', 'log_transform_y', 'TakeDerivative', 'SNV', 'DropSpectralRegions']

# %% ../nbs/05_data.transform.ipynb 3
...
# %% ../nbs/05_data.transform.ipynb 7
CO2_REGION = [2389,  2269]

# %% ../nbs/05_data.transform.ipynb 8
...
# %% ../nbs/05_data.transform.ipynb 11
...
# %% ../nbs/05_data.transform.ipynb 15
