...
class ScanScreen(module_base.ModuleScreen):
    ...
    def do_setup_screen(self, module: module.ScanModule):
        ...
        self.check_show_power_spec = QtWidgets.QCheckBox("Show Power Spectrum")
        self.check_show_compressed_spec = QtWidgets.QCheckBox("Compress Spectrum")
    ...
    def bind_gui_elements(self):
        ...
        bind_gui.connect_to_property(self.check_show_compressed_spec, self.module.settings.show_compress_spec)
    ...
    def init_plot(self):
        ...
        self.spec_plot.set_title(f"Spectrum of - {settings.ChannelNames[self.module.settings.channel_id.value]}")
    ...
    def update_plot(self): 
        ...
        if current_data.stream.get_stream_length() > 1:
            ...
            spec = sci_math.calc_fft(current_data.stream.get_channel(0), samplerate=samplefrq, powerspectrum=calc_power_spec, compress=compress_spec)
