    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.37.1.a0",
        "aws_prototyping_sdk.pdk_nag>=0.5.5, <0.6.0",
        "cdk-nag>=2.15.44, <3.0.0",
        "constructs>=10.1.76, <11.0.0",
        "jsii>=1.64.0, <2.0.0",
        "projen>=0.61.11, <0.62.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
