...
def hare_upload(web,file1,record_path,qbinfo):
    ...
    try:
        web.driver.find_elements_by_name('pt_gen[imdb][link]')[0].send_keys(file1.imdburl)
    ...
    try:
        web.driver.find_elements_by_name('pt_gen[douban][link]')[0].send_keys(file1.doubanurl)
    ...
    try:
        web.driver.find_elements_by_name('pt_gen[bangumi][link]')[0].send_keys(file1.bgmurl)
    ...
    try:
        web.driver.find_elements_by_name('url_poster')[0].send_keys(re.findall(r'\[img\](.*)\[/img\]',file1.douban_info))
    except Exception as r:
    ...
    try:
        ...
        web.driver.find_elements_by_name('screenshots')[0].send_keys(file1.screenshoturl.replace('[img]','').replace('[/img]',''))
    except Exception as r:
    ...
    try:
        web.driver.find_elements_by_name('descr')[0].send_keys(file1.douban_info)
        logger.info('已成功填写简介')
    except Exception as r:
    ...
    try:
        ...
        web.driver.find_elements_by_name('technical_info')[0].send_keys(file1.mediainfo)
    except Exception as r:
