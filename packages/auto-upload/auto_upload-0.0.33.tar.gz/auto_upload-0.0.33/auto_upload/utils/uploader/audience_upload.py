...
def audience_upload(web,file1,record_path,qbinfo):
    ...
    try:
        #web.driver.find_elements_by_name('douban_id')[0].click()
        web.driver.find_elements_by_name('douban_id')[0].send_keys(file1.doubanurl)
    ...
    try:
        ...
        if 'anime' in file1.pathinfo.type.lower():
            ...
            checkbox=web.driver.find_elements_by_xpath('/html/body/table[2]/tbody/tr[2]/td/form/table/tbody/tr[15]/td[2]/input[7]')[0]
    ...
    try:
        ...
        if file1.Audio_Format.upper()=='AAC':
            ...
            select_source_sel_ob.select_by_value('26')
            ...
            select_source_sel_ob.select_by_value('22')
        elif 'M4A' in file1.Audio_Format.upper():
            select_source_sel_ob.select_by_value('24')
        else:
            select_source_sel_ob.select_by_value('6')
    except Exception as r:
    ...
    logger.info('制作组已成功选择Other')
    

    try:
        if not file1.sublan=='' and ('简' in file1.sublan or '繁' in file1.sublan or '中' in file1.sublan):
            checkbox=web.driver.find_elements_by_xpath('/html/body/table[2]/tbody/tr[2]/td/form/table/tbody/tr[15]/td[2]/input[4]')
            if len(checkbox)>0:
                checkbox=checkbox[0]
                if not checkbox.is_selected():
                    checkbox.click()
