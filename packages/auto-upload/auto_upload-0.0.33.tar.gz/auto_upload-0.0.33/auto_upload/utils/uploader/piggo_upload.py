...
def piggo_upload(web,file1,record_path,qbinfo):
    ...
    try:
        #web.driver.find_elements_by_name('pt_gen')[0].click()
        web.driver.find_elements_by_name('pt_gen')[0].send_keys(file1.doubanurl)
    ...
    try:
        #web.driver.find_elements_by_name('technical_info')[0].click()
