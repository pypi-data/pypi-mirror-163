...
setup(
    ...
    description=(
        "Type annotations for boto3.ChimeSDKMediaPipelines 1.24.55 service generated with"
        " mypy-boto3-builder 7.11.6"
    ),
    classifiers=[
    ...
    package_data={"": ["LICENSE"], "mypy_boto3_chime_sdk_media_pipelines": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
        "Documentation": (
