...
def __get_exists_file(file: str):
    """查找目录优先级: support.py目录 > project跟目录 > HUB目录(~/.winwin_hub) > HOME目录(~)"""
    dirs = [os.path.dirname(os.path.abspath(__file__)), PROJECT_HOME, HUB_HOME, USER_HOME]
    for _dir in dirs:
