    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource algolia {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "algolia Pulumi Package - Development Version"


setup(name='sw_pulumi_algolia',
      version=VERSION,
      ...
      keywords='pulumi algolia category/cloud',
