...
def step_delete(ctx: util.CliContext, step_id: int) -> None:
    ...
    util.echo_msg(response, 'Step successfully deleted!', ctx.debug, ctx.parse)
...
def step_validate(ctx: util.CliContext, file: str, inventory: tuple) -> None:
    ...
    util.echo_msg(response, 'Step successfully validated!', ctx.debug, ctx.parse)
...
def step_execution_delete(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Step execution successfully deleted!', ctx.debug, ctx.parse)
...
def step_execution_report(ctx: util.CliContext, execution_id: int, file: str, less: bool, localize: bool) -> None:
    ...
    util.get_report(response, file, 'step-execution_{}'.format(execution_id), less, less, localize, ctx.debug, ctx.parse)
...
def step_execution_kill(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Step execution successfully killed!', ctx.debug, ctx.parse)
...
def step_execution_re_execute(ctx: util.CliContext, execution_id: int) -> None:
    ...
    util.echo_msg(response, 'Step execution successfully re-executed!', ctx.debug, ctx.parse)
