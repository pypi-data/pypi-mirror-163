...
class CliContext(object):
    ...
    """
    def __init__(self, host: Optional[str], port: Optional[int], ssl: bool, debug: bool, parse: bool):
        if host is None:
...
def echo_msg(response: Union[str, requests.Response], ok_message: str = 'Success!', debug: bool = False,
             parse: bool = False) -> None:
    """
    ...
    :param parse: Show non formatted json output
    :return: None
    """
    ...
    if debug:
        if parse:
            detailed_msg = get_response_data(response)
        else:
...
def echo_list(response: Union[str, requests.Response], to_print: List[str], less: bool = False,
              localize: bool = False, debug: bool = False, parse: bool = False) -> None:
    """
...
def get_report(response: Union[str, requests.Response], file_path: str, file_details: str, echo_only: bool = False,
               less: bool = False, localize: bool = False, debug: bool = False, parse: bool = False) -> None:
    """
